...
<wea:layout attributes="{'expandAllGroup':'true'}">
		...
		<% 
		 ...
		 String sql="select a.requestid,b.id,a.id as mainid ,a.sqr,a.tbrq,a.bh,b.xqsl,b.hpmc,(select name from cptcapital where id=b.hpmc) as name,b.hpmc as datatype,b.ggxh,b.dw ,(select unitname from LgcAssetUnit where id= b.dw) as dwname,b.sgsl,b.dj,b.je "+
