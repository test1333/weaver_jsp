...
<%
	...
	if(sqlwhere.equals("")){
		sqlwhere = "operateitem="+operateitem;
	...
	<BODY>
		...
		<%
			if(cmd.equals("sr")){
				...
				String tableString = ""+
					...
					"<head>"+
						"<col width=\"30%\" text=\""+SystemEnv.getHtmlLabelNames("674,1867", user.getLanguage())+"\" column=\"operateUserId\" orderkey=\"operateUserId\" transmethod=\"weaver.splitepage.transform.SptmForCowork.getResourceNameLink\"/>"+
						"<col width=\"30%\" text=\""+SystemEnv.getHtmlLabelName(1276, user.getLanguage())+"\" column=\"operateDate\" orderkey=\"operateDate\" otherpara=\"column:operateTime\" transmethod=\"weaver.splitepage.transform.SptmForCowork.combineDateTime\" />"+
						"<col width=\"40%\" text=\""+SystemEnv.getHtmlLabelNames("108,110", user.getLanguage())+"\" column=\"clientAddress\" orderkey=\"clientAddress\" />"+
					"</head>"+
					"</table>";
		...
		<%}else {
			...
			String tableString = ""+
				...
				"<head>"+
					"<col width=\"15%\" text=\""+SystemEnv.getHtmlLabelName(97, user.getLanguage())+"\" column=\"operateDate\" orderkey=\"operateDate\" otherpara=\"column:operateTime\" transmethod=\"weaver.splitepage.transform.SptmForCowork.combineDateTime\" />"+	
					...
					"<col width=\"10%\" text=\""+SystemEnv.getHtmlLabelName(99, user.getLanguage())+"\" column=\"operateUserId\" orderkey=\"operateUserId\" transmethod=\"weaver.splitepage.transform.SptmForCowork.getResourceNameLink\"/>"+

					
					"<col width=\"15%\" text=\""+SystemEnv.getHtmlLabelName(63, user.getLanguage())+"\" column=\"operateType\" orderkey=\"operateType\"  otherpara=\"" + user.getLanguage() + "\" transmethod=\"weaver.splitepage.transform.SptmForCowork.getTypeName\" />"+
					"<col width=\"15%\" text=\""+SystemEnv.getHtmlLabelName(101, user.getLanguage())+"\" column=\"lableId\"  orderkey=\"lableId\" otherpara=\"" + user.getLanguage() + "\" transmethod=\"weaver.splitepage.transform.SptmForCowork.getItemLableName\"/>"+
					"<col width=\"20%\" text=\""+SystemEnv.getHtmlLabelName(106, user.getLanguage())+"\" column=\"relatedName\" orderkey=\"relatedName\"/>"+
					"<col width=\"15%\" text=\""+SystemEnv.getHtmlLabelName(108, user.getLanguage())+SystemEnv.getHtmlLabelName(110, user.getLanguage())+"\" column=\"clientAddress\" orderkey=\"clientAddress\"/>"+
				"</head>"+
				"</table>";
