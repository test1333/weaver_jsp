	...
	<tr width="100%">
		...
		<td width="100%">
    	    <TABLE style="height:100%;" cellpadding="0px" cellspacing="0px"  width="100%" align="right">
				...
				<td id="tdSignInfoLine12">
			        	 <a href="http://www.shmeea.edu.cn" target="_blank"><font size="3px" color="#FFFFFF" style="font-size:14px">官网</font></a>
				</td>	
				...
				<%if(PortalUtil.isShowToMsgPage()) {%>
                        <td onClick="window.location.href='/rdeploy/chatproject/main.jsp';" title="社交工作平台" id="imAddress" style="width:40px;background:url(/rdeploy/assets/img/cproj/chatPortal.png) no-repeat scroll center 50%;"  class="backgroundPosition"  >
			        ...
			        <!-- 帮助 -->
			        <!--<td onClick="alert('帮助')" title="<%=SystemEnv.getHtmlLabelName(354,user.getLanguage())%>" >
