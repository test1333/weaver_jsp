...
function test1(){
	...
	// 
	jQuery("#"+s_emp+nowRow).bindPropertyChange(function(){ 
	...
	//	alert("s_emp change !! ret_val = " + change_val);
		if(change_val == "0"){
	...
	jQuery("#"+s_date+nowRow).bindPropertyChange(function(){ 
	...
	jQuery("#"+s_time+nowRow).bindPropertyChange(function(){ 
	...
	jQuery("#"+e_date+nowRow).bindPropertyChange(function(){ 
//	jQuery("input[id='"+e_date+nowRow+"']").bind("propertychange",function(){ 	
	...
	jQuery("#"+e_time+nowRow).bindPropertyChange(function(){ 
...
function checkSomeVal(index){
	...
	jQuery(tmp_s_date).val("");jQuery(tmp_s_date+"span").text("");
	jQuery(tmp_s_time).val("");jQuery(tmp_s_time+"span").text("");
	jQuery(tmp_e_date).val("");jQuery(tmp_e_date+"span").text("");
	jQuery(tmp_e_time).val("");jQuery(tmp_e_time+"span").text("");
}