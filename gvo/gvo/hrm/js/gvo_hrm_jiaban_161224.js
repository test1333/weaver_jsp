...
function checkSomeVal(index) {
	...
	jQuery(tmp_s_date + "span").text("");
	jQuery(tmp_s_time).val("");
	jQuery(tmp_s_time + "span").text("");
	jQuery(tmp_e_date).val("");
	jQuery(tmp_e_date + "span").text("");
	jQuery(tmp_e_time).val("");
	jQuery(tmp_e_time + "span").text("");
}