		...
		<tr>	
			<td>
				<table border=0 cellspacing=2 cellpadding=2 Style="width:100%; font-size:8pt;table-layout:fixed">
				   ...
				   %>
				        <tr>
					            <td width=22.5%><%=itResourceNames.get(k)%>   <a href="/workflow/request/AddRequestIframe.jsp?workflowid=1257" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;<img style=" width: 60px; height: 21px; overflow: hidden; display: table-cell; vertical-align: middle; text-align: center; *font: 18px arial;" src="/images/ljjy1.png" border="0"></a>   </td>
					        <%					        
