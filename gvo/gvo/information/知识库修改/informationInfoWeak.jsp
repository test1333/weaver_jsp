...
<table width="1200" height="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="center" valign="middle"> 
<tr><td  valign="top">
 <table width="250" border="1" bordercolor="#CCCCCC" align="left" cellpadding="0" cellspacing="0">
 
 <tr>
   <td>
    <div class="weak">
	   <a href="/gvo/information/informationInfoWeak.jsp"><img src="/gvo/information/images/strucimg.jpg"></a>
	   <h3>弱电类</h3>
	   <div class="weakleft">
	   <a href="/gvo/information/weak/informationInfo-Complex.jsp">综合布线</a>
	   <a href="/gvo/information/weak/informationInfo-video.jsp">视频系统</a>
	   <a href="/gvo/information/weak/informationInfo-monitor.jsp">监控系统</a>
	   </div>
	   <div class="weakright">
	   <a href="/gvo/information/weak/informationInfo-internet.jsp">网络</a>	   
	   <a href="/gvo/information/weak/informationInfo-Access.jsp">考勤门禁</a>	   
	   <a href="/gvo/information/weak/informationInfo-phone.jsp">电话</a>
	   </div>
	</div>
   </td>
  </tr>
<table width="940" border="1" bordercolor="#CCCCCC" align="right" cellpadding="0" cellspacing="0"><tr><td>
<TABLE width="100%" >
	...
	<tr>
		<td valign="top" width="80%">
            ...
            String sqlWhere = " where details2 in (0,1,2,3,4,5) ";
