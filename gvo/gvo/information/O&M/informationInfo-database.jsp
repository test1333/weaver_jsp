...
<tr><td  valign="top">  
 ...
 <tr>
   <td>
    <div class="om"><a href="/gvo/information/informationInfoO&M.jsp"><img src="/gvo/information/images/strucimgy.jpg"></a>
	   <h3>运维类</h3>
	     <div class="omleft">
...
<TABLE width="100%" >
	...
	<tr>
		<td valign="top" width="80%">
            ...
            String sqlWhere = " where details2=8 ";
		...
		//	}
            ...
            tableString =" <table  tabletype=\"none\" pagesize=\""+perpage+"\" >"+
						   ...
						   "				<col width=\"29%\" text=\"问题发生原因\" column=\"reason\" orderkey=\"reason\"  />"+
                           "				<col width=\"29%\" text=\"解决方案\" column=\"solution\" orderkey=\"solution\"  />"+
                           "			</head>"+
                           "</table>";
         %>
