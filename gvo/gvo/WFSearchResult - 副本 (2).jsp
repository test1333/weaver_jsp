...
if(user.getUID() > 1){
	...
	while(RecordSet.next()){
		...
		sql_dt="select count(1) as count from  ofs_todo_data a where   a.userid ='"+tmp_uid+"' and a.isremark='0'";
...
String sql_ec="select pcurl,requestname from ofs_todo_data where userid in(249) and isremark='0' order by id desc";
...
function winopen1(url) {
	wopener = window.open('http://222.92.108.195:10182'+url);
	checkOpener();
}
