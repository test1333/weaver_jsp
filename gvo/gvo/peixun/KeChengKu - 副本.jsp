										...
										<tbody>
											...
											<tr class=datalight>
												...
												<tr class=datalight>
													...
													%>
													<tr>
														<Td><span style="border:0px solid #000000;width:175px;text-overflow:ellipsis; white-space:nowrap; overflow:hidden;" title="<%=kcmc%>"><%=kcmc%></span></Td>
														<Td><%=js_name%></Td>
														<Td><a href="/formmode/view/AddFormMode.jsp?type=3&modeId=542&formId=-193&billid=<%=kj_id%>&opentype=0&customid=562&viewfrom=fromsearchlist" target="_blank" style="text-decoration:underline !important">详情点击</a></Td>
													</Tr>
													<%
													}
													%>
