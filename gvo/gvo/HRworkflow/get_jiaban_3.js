...
//	jQuery("input[id='"+s_emp+i+"']").bind("propertychange",function(){ 	
	jQuery("#"+s_emp+i).bindPropertyChange(function () {	
		...
		get_some_Times(tmp_s_emp,tmp_s_date,tmp_s_time,tmp_e_date,tmp_e_time,tmp_g_date,tmp_y_jbxss);
	});
...
function get_some_Times(s_emp,s_date,s_time,e_date,e_time,g_date,y_jbxss){
