jQuery(document).ready(function(){
	...
	if(	res== false) { window.top.Dialog.alert("3天前的加班不允许提报");
	return res;
	}
	//检查提交时间
	var result = true;
		...
		if(result == false)  window.top.Dialog.alert("加班类型或班次，不能为空");
	   ...
	   // var result = true;
        ...
        if(result == false)  window.top.Dialog.alert("当前加班非节假日加班,不能提交！");
		//return result;
		//工作性质检查
		//修改内容
