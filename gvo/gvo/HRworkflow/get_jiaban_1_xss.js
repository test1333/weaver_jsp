...
var y_ygxss_s = "field8985_"; //员工填写小时数
...
//	jQuery("input[id='"+s_emp_s+nowRow+"']").bind("propertychange",function(){ 	
	jQuery("#"+s_emp_s+nowRow).bindPropertyChange(function () {
		...
		var tmp_y_ygxss = "#" + y_ygxss_s + nowRow;
		
		get_some_Times_s(tmp_s_emp,tmp_s_date,tmp_s_time,tmp_e_date,tmp_e_time,tmp_g_date,tmp_y_jbxss,tmp_y_ygxss);
	});
...
function get_some_Times_s(s_emp,s_date,s_time,e_date,e_time,g_date,y_jbxss,y_ygxss){
