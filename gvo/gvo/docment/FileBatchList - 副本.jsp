	...
	<tr>
		<td valign="top">
            ...
            String fromSql  = " from (select x.imagefileid,x.filesize,x.imagefilename,x.docid,dd.maincategory,dd.subcategory,dd.seccategory, "
							 +" ddl.operateuserid,ddl.operatedate||' '||ddl.operatetime as oper_time from ( "
							 +" select im.imagefileid,im.filesize,docid,im.imagefilename from  imagefile im "
           ...
           // out.println("select "+ backfields + fromSql + " where " + sqlWhere);
            ...
            tableString =" <table instanceid=\"workflowRequestListTable\" tabletype=\"checkbox\" pagesize=\""+perpage+"\" >"+
                           ...
                           " 				<col width=\"15%\" text=\"主目录\" column=\"main_name\" orderkey=\"main_name\"  />"+
               			   " 				<col width=\"15%\" text=\"二级目录\" column=\"sec_name\" orderkey=\"sec_name\"  />"+
               	           " 				<col width=\"15%\" text=\"三级目录\" column=\"sub_name\" orderkey=\"sub_name\"  />"+
                           "			</head>"+
                           "</table>";
         %>
