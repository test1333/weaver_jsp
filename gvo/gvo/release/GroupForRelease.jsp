...
<%
	...
	url_1 = "/gvo/release/releaseInfo_wev8.jsp";
		
	url_2 = "/gvo/release/releaseInfoHistory_wev8.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">物品放行</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">放行列表<span id="allNum_span"></span></a>
				</li>
				<li class="">
