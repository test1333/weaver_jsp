...
<HTML>
	...
	<BODY>
		...
		<%
		String backfields = "a.requestid,b.creatertype,b.requestname,b.workflowid,b.creater,b.createdate, b.createtime, a.bxdh ,a.dqr, a.sqr, case when b.currentnodetype >=3 then '归档' else '未归档' end as isdone,b.lastoperatedate ";
			  
		String fromSql  = " v_gvo_print a join workflow_requestbase b on a.requestid=b.requestid ";
		...
		if(!"".equals(begindate)){
			sqlWhere +=" and a.dqr>='"+begindate+"' ";
			if(!"".equals(enddate)){
				sqlWhere +=" and a.dqr<='"+enddate+"' ";
			}
		}else{
			if(!"".equals(enddate)){
				sqlWhere +=" and a.dqr<='"+enddate+"' ";
		...
		"			<head>";
			...
			"               <col width=\"10%\" text=\"预计付款日\" column=\"dqr\" orderkey=\"dqr\"/>"+
