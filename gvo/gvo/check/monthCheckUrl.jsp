...
<%
   String checkstatus = Util.null2String(request.getParameter("checkstatus"));
   ...
   session.setAttribute("checkbmjl",checkbmjl);
   session.setAttribute("checkbmzg",checkbmzg);
	String url_1 = "";
	url_1 = "/gvo/check/undoMonthCheck.jsp";
	String url_2 = "/gvo/check/monthCheck.jsp";
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">考核</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">待考核<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_2%>">已考核<span id="allNum_span"></span></a>
				</li>
		    </ul>
