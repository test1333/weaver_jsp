...
if(operation.equalsIgnoreCase("changepassword")&&adtype.equals("1")) {
    ...
    //	String id = ""+user.getUID() ;
    	...
    	String passwordold= Util.getEncrypt(Util.null2String(fu.getParameter("passwordold")));
    	String passwordnew= Util.getEncrypt(Util.null2String(fu.getParameter("passwordnew")));
...
//update by fanggsh TD4233 end
    ...
    if(operation.equalsIgnoreCase("addresourcebasicinfo")){
	  ...
	  String residentplace = Util.null2String(Util.fromScreen3(fu.getParameter("residentplace"),user.getLanguage()));
      ...
      String subcmpanyid1 = DepartmentComInfo.getSubcompanyid1(departmentid);
		...
		try{
			...
			rst.executeSql("update hrmresource set countryid=(select countryid from HrmLocations where id="+locationid+"),residentplace='"+residentplace+"' where id="+id);
			if(falg){
