...
<HTML>
	...
	<BODY>
		...
		<%
		String backfields = "a.requestid,b.creatertype,b.requestname,b.workflowid,b.creater,b.createdate, b.createtime, a.bxdh ,a.dqr, a.sqr, case when b.currentnodetype >=3 then '归档' else '未归档' end as isdone ";
