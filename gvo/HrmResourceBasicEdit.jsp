				...
				<wea:layout type="2col" attributes="{'expandAllGroup':'true'}">     
		       	...
		       	<wea:item>
		       		...
		       		<input class=inputstyle type=hidden name=oldresourceimage value="<%=photoid%>">
						...
						<%}else{%>
						<wea:item><%=SystemEnv.getHtmlLabelName(15707,user.getLanguage())%></wea:item>
						<wea:item><input class=inputstyle type=file name=photoid value='<%=photoid%>' style="width: 300px"></wea:item>
						<wea:item>&nbsp;</wea:item>
					...
					<wea:item><input class=inputstyle type=text name=email value='<%=email%>' style="width: 300px"></wea:item>
