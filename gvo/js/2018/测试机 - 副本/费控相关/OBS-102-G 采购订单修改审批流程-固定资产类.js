...
var cgsqdh="#field51762";//采购订单修改流程
var xghcgsl_dt="#field51769_";//修改后数量 明细1
var yzccgddsl_dt="#field51796_";//已交货数量 明细1
var ycgsl_dt="#field51768_";//原采购数量 明细1
var xghygdj_dt="#field51776_";//修改后单价 明细1
var yygdj_dt="#field51771_";//原单价 明细1
var xghcgje_dt="#field53495_";//修改后采购金额 明细1

var yjq_dt1="#field51774_";//原交期 明细1
var xghjq_dt1="#field51775_";//修改后交期 明细1
var sm_dt1 ="#field51776_";//税码 明细1
var xghsm_dt1 ="#field51777_";//修改后税码 明细1
var yscbs_dt1="#field51800_";//原删除标识 明细1
var xghscbs_dt1="#field51801_";//修改后删除标识 明细1	
