...
var bxje="#field53242";//报销金额
var qxje="#field53244";//付款金额
var cjzje="#field53229";//冲预付款金额
var fphm_dt1 = "#field53934_";//明细1 发票号码
var sfcf_dt1 = "#field53272_";//明细1 是否重复
var fkjeyb="#field53241";//付款金额原币
var htwfje="#field53232";//合同未付金额
var cgddh ="#field49429";//采购订单号
var cgddlc="#field49430";//采购订单流程
var sfhtkz = "#field53233";  //是否合同控制
var bcfue = "#field53244";  //付款金额
var htwfe = "#field52853";   //合同未付金额

var sqdjje_dt1 =  "#field53266_";//冻结金额
var bcbxecny_dt1 = "#field53268_";//本次报销额
var ysje_dt1 = "#field55121_";//预算金额

var podh_dt1 = "#field47631_";//po单号
var ysssqj_dt1 = "#field53264_";//预算所属期间
var fycdbm_dt1 = "#field47633_";//费用承担部门
var yskm_dt1 = "#field53274_";//预算科目
var dbddh_dt1 = "#field47632_";//内部订单号
var zzch_dt1 = "#field53892_";//主资产号
var xmyfbh_dt1 = "#field53273_";//项目研发编号
jQuery(document).ready(function(){
	...
	jQuery(cgddh).bindPropertyChange(function (){ 
		...
		if(cgddh_val !=""){
			...
			var rqnames="";
			var flag="";
			var result=getRQID(cgddh_val,'PO01');
...
function getotherinfo(index){
	...
	//alert(cgddlc_val);alert(ysssqj_dt1_val);alert(fycdbm_dt1_val);alert(yskm_dt1_val);
	 jQuery.ajax({
             type: "POST",
             url: "/gvo/costcontrol/getcptreiminfo.jsp",
             ...
             success: function(data){
                       ...
                       // alert(data);
						if(data != ""){
							...
							jQuery(xmyfbh_dt1+index).val(tmp_arr[1]);
							jQuery(xmyfbh_dt1+index+"span").text(tmp_arr[1]);
							jQuery(dbddh_dt1+index).val(tmp_arr[2]);
							jQuery(dbddh_dt1+index+"span").text(tmp_arr[2]);
							jQuery(zzch_dt1+index).val(tmp_arr[3]);
							jQuery(zzch_dt1+index+"span").text(tmp_arr[3]);
...
function bind(index){
	jQuery(bcbxecny_dt1+index).bindPropertyChange(function (){ 
		var bcbxecny_dt1_val = jQuery(bcbxecny_dt1+index).val();
		jQuery(ysje_dt1+index).val(bcbxecny_dt1_val);
