...
<script type="text/javascript">
  var hswrmbje="#field15904";//核算为人民币金额
    var lxkyje="#field10223";//立项可用金额
    var sfcg ="#field15861";//是否超过5000W
    var xzht="#field15875";//选择合同卡片
    var jd_dt1="#field15892_";//明细1-阶段
    var bl_dt1="#field15893_";//明细1-比例
    var je_dt1="#field15912_";//明细1-金额
    var fkrq_dt1="#field15906_";//明细1-付款日期
    var sfyy="#field15869";//是否用印
    var gz="#field15870";//公章
    var htz="#field15871";//合同章
    var frz="#field15872";//法人章
    var frqz="#field15873";//法人签字
	var sfwlx="#field15941";//是否为立项
