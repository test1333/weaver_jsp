...
<script type="text/javascript">
     var ysssqj_dt1="#field6495_";//预算所属期间
    var cbzx_dt1="#field10830_";//成本中心
    var km_dt1="#field6498_";//科目
    var sqje_dt1="#field6503_";//申请金额
    var ndkyje_dt1="#field11879_";//年度可用金额
     
    var fplx_dt1="#field12489_";//发票类型
    var fphm_dt1="#field12490_";//发票号码
    var sfcf_dt1="#field12492_";//是否重复
	
	var djbh="#field6477";//单据编号
