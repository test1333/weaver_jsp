...
<script type="text/javascript">
    var ysssqj_dt1="#field7244_";//预算所属期间
    var cbzx_dt1="#field7246_";//成本中心
    var km_dt1="#field7247_";//科目
    var sqje_dt1="#field7252_";//申请金额
    var ndkyje_dt1="#field11876_";//年度可用金额
    
    var fplx_dt1="#field12465_";//发票类型
    var fphm_dt1="#field12466_";//发票号码
    var sfcf_dt1="#field12468_";//是否重复
	var djbh="#field7227";//单据编号

	var bxr = "#field12564";//报销人
	var bxr_mx = "#field7261_";//员工明细
