...
<% 
	...
	String serverUrl = "http://10.1.96.16:8082";   // 需要跳转服务域名(或IP)及端口的地址
	...
	// 发送对方接受页面
	String url_str = serverUrl+"/gvo/sendFor/acceptOtherRequestInfo.jsp?x_login=" + ulXf+"&requestid="+requestid;
