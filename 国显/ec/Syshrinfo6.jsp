...
<%@ page import="gvo.ecsysn.SysOAHrmMidTable"%>
...
<%
	...
	RCMenu += "{同步中间表数据,javascript:onCheckup1(),_self} " ;
	RCMenuHeight += RCMenuHeightStep ;

%>
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
	<FORM id=report name=report action=/gvo/Syshrinfo6.jsp method=post>
		...
		if("1".equals(multiIds)){
			  SysOAHrmMidTable aa = new SysOAHrmMidTable();
			aa.sysHrActivitycode();
			aa.sysHrJobtitlecode();
			boolean isOver = true;
			if(isOver){
...
<wea:group context="同步中间表" attributes="test">
