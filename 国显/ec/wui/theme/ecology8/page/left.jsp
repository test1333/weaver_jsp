...
<%!
	...
	public List getPortalMenus(User user) throws Exception {
		...
		String sql = "select id,infoname,subcompanyid,pid from hpinfo h where infoname is not null and subcompanyid>0   and isuse=1  and id in (" + homepageUtil.getShareHomapage(user)+ ") order by pid,ordernum1,id";
		if (user.getUID() == 1) {
			sql = "select id,infoname,subcompanyid,pid from hpinfo h where infoname is not null  and subcompanyid>0  and isuse=1 order by  pid,ordernum1,id";
		}
