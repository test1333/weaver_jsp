...
<%
	...
	String comid = "";
	if(id != 1){
		sql = "select id,supsubcomid from hrmsubcompany where id=(select subcompanyid1 from hrmresource where id="+id+")";
		RecordSet.executeSql(sql);
		if(RecordSet.next()){
			comid = Util.null2String(RecordSet.getString("supsubcomid"));
		}
	}
	...
	String RedirectFile = Util.null2String(request.getParameter("RedirectFile")) ;
        //门户样式
        RedirectFile="/bsdt/port.jsp";
		if("224".equals(comid)){
			 RedirectFile="/bsdt/portv3.jsp";
		}
