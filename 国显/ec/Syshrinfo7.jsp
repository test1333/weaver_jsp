...
<%@ page import="gvo.ecsysn.SysnOAMatrixInfo"%>
...
<%
	...
	RCMenu += "{同步矩阵数据,javascript:onCheckup1(),_self} " ;
	RCMenuHeight += RCMenuHeightStep ;

%>
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
	<FORM id=report name=report action=/gvo/Syshrinfo7.jsp method=post>
		...
		if("1".equals(multiIds)){
			  SysnOAMatrixInfo aa = new SysnOAMatrixInfo();
			aa.sysnMatrix();
			boolean isOver = true;
			if(isOver){
