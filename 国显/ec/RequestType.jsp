			...
			<ul class="tab_menu">
				...
				<%}
				 ...
				 %>
				 	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 	<a href="/bsdt/port.jsp" style="float:right"> <div style="text-decoration:underline"><%=SystemEnv.getHtmlLabelName(1500, user.getLanguage())%></div> </a>
             </ul>
	    ...
	    <div id="rightBox" class="e8_rightBox">
			...
			<div class="tab_box">
				<div>
				    ...
				    {
					String url = "/workflow/request/RequestTypeShow.jsp?needPopupNewPage=true&dfdfid=b&needall=0&selectedContent="+selectedContent+"";
					if(offical.equals("1")){
