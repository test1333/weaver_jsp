          ...
          <li class="dropdown">
			...
			<div class="line"></div></li>  
                ...
                <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1061&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">借款流程</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=981&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">还款申请</a>
						</li>	
					</ul>
				</li>
                <li><div class="line"></div></li>
