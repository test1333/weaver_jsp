...
<SCRIPT src="/bsdt/js/bootstrap.js"></SCRIPT>    
    <header class="header navbar navbar-default bg-white">
      ...
      <div class="navbar-header nav-bar aside">
		...
		<!--门户logo
		<a class="nav-brand"><img src="images/logo-lan.png"></a> -->
        <a class="nav-brand"><img src="images/logo-hn.png"></a>
      ...
      <div class="collapse navbar-collapse">
			...
			<li><div class="line"></div></li>  
                <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu">
						...
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1062&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">差旅费报销流程（有事前申请）</a>
						</li>		
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=901&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">差旅费报销流程（无事前申请）</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1001&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">业务招待费报销流程（无事前申请）</a>
						</li>
						<li>
						...
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1063&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">培训费报销流程（有事前申请）</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1044&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">公共费用分摊报销流程</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1021&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">工资计提申请流程</a>
						</li>
					</ul>
				</li>
				<li><div class="line"></div></li>  
                <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1341&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">FI-002-B-员工借款流程-VXG/BY/GY</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=981&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">FI-003-B-员工还款流程-VXG/BY/GY</a>
						</li>	
					</ul>
				</li>
                ...
                <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1233&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">预算追加申请（费用类）</a>
						</li>

						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1234&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">预算变更申请（费用类）</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1235&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">预算追加申请流程（设备类资产）</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1236&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">预算追加申请流程（非设备类资产）</a>
						</li>
						<!--<li>
						...
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1237&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">跨年预算申请流程</a>
						</li>
                ...
                <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu">
						<li>
		<a href="/workflow/request/AddRequest.jsp?workflowid=1467&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）SC-010-B-立项申请流程-非专项费用类-VXG/GY/BY/HVT</a>
						</li>
					         <li>
		...
		<li>
		<a href="/workflow/request/AddRequest.jsp?workflowid=1401&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">IPD-106-A-新产品新技术项目立项流程-VXG</a>
		</li>	
					</ul>
				</li>
                <li><div class="line"></div></li>
<li class="dropdown-submenu">
					<a><span>IPD管理</span>&nbsp;&nbsp;&nbsp;<b class="caret"></b>
					</a>
					<ul class="dropdown-menu">
<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1503&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）OBS-111-C-合同申请流程-立项类-S-HVT</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1441&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）IPD-104-A-研发项目跨法人委托开发流程-IPD-VXG</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1481&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）IPD-105-A-前沿技术项目立项流程-VXG</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1401&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）IPD-106-A-新产品新技术项目立项流程-VXG</a>
						</li>
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1461&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）FI-048-A-研发项目员工报销流程-一般费用-BS-VXG</a>
                                                </li>	
<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1464&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）FI-049-A-研发项目员工报销流程-差旅费有事前申请-BS-VXG</a>
                                                </li>
<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1465&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）FI-050-A-研发项目员工报销流程-差旅费无事前申请-BS-VXG</a>
                                                </li>
<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1468&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）SC-031-A-研发项目领料管理流程-S-VXG</a>
                                                </li>
<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1469&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">（新）SC-032-A-研发项目退料管理流程-S-VXG</a>
                                                </li>				
					</ul>
				</li>
                <li><div class="line"></div></li>
				...
				<a><span>立项类合同</span>&nbsp;&nbsp;&nbsp;<b class="caret"></b></a>
					<ul class="dropdown-menu">
						...
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1141&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">合同付款申请流程（云谷）</a>
						</li>
					</ul>
				</li>
				<li><div class="line"></div></li>
				...
				<a><span>非立项类合同</span>&nbsp;&nbsp;&nbsp;<b class="caret"></b></a>
					<ul class="dropdown-menu">
						...
						<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1323&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">合同付款申请流程（云谷）</a>
						</li>
					</ul>
				</li>
				<li><div class="line"></div></li> 
                <li class="dropdown-submenu">
					...
					<ul class="dropdown-menu">
                                                <li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=882&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">对公报销支付流程</a>
						</li>
		                                <li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=884&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">对公预付款流程</a>
						</li>
		                                <li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1322&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">对公支付申请流程（其他类）</a>
						</li>
												<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=275&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">合同付款申请流程（云谷非立项类）</a>
												...
												<li>
							<a href="/workflow/request/AddRequest.jsp?workflowid=1141&isagent=0&beagenter=0&f_weaver_belongto_userid=" target="_blank">合同付款申请流程（云谷立项类）</a>
						</li>
												<li>
        ...
        <li class="dropdown">
       	...
       	<li class="dropdown">
            <a href="/bsdt/port_contract.jsp" class="dropdown-toggle">
          ...
          <li class="hidden-xs">
            ...
            <section class="dropdown-menu animated fadeInUp input-s-lg">
              <section class="panel bg-white">
                ...
                <%
                	String workflowSql = "select t1.requestid,t1.workflowid, t1.requestname, t1.requestnamenew,t2.receivetime,t1.createdate, t1.createtime,t2.userid from workflow_requestbase t1 left join workflow_currentoperator t2 on t1.requestid=t2.requestid where (t1.deleted <> 1 or t1.deleted is null or t1.deleted = '') and t2.userid in ("+accountall_son+") and t2.usertype = 0 and (t1.deleted = 0 or t1.deleted is null) and ((t2.isremark = 0 and (t2.takisremark is null or t2.takisremark = 0)) or t2.isremark in ('1', '5', '8', '9', '7')) and (t1.deleted = 0 or t1.deleted is null) and t2.islasttimes = 1 and (nvl(t1.currentstatus, -1) = -1 or (nvl(t1.currentstatus, -1) = 0 and t1.creater in ("+accountall_son+"))) and t1.workflowid in (select id from workflow_base where (isvalid = '1' or isvalid = '3')) and t1.workflowid not in (select Workflow from uf_ECPortBpmExclude) ";
                rs.executeSql(workflowSql);
                while(rs.next()){
                	%>
                	 <a href="#" onclick="openWorkFolw_define('<%=rs.getInt("requestid") %>','<%=rs.getInt("userid") %>')" class="media list-group-item">
