...
<%
	...
	RCMenu += "{同步组织结构数据,javascript:onCheckup1(),_self} " ;
	RCMenuHeight += RCMenuHeightStep ;

%>
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
	<FORM id=report name=report action=/gvo/Syshrinfo4.jsp method=post>
...
<wea:group context="同步组织结构" attributes="test">
