...
<%@ page import="gvo.ecsysn.SysnGVOOrganize"%>
...
<%
	...
	RCMenu += "{同步所有数据,javascript:onCheckup1(),_self} " ;
	RCMenuHeight += RCMenuHeightStep ;

%>
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
	<FORM id=report name=report action=/gvo/Syshrinfo2.jsp method=post>
		...
		if("1".equals(multiIds)){
			SysnGVOOrganize aa = new SysnGVOOrganize();
			 aa.execute();
			boolean isOver = true;
			if(isOver){
...
<wea:group context="同步所有" attributes="test">
