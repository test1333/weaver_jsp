...
<%
		...
		if (!"".equals(tableName)) {
			...
			if (rs.next()) {
				...
				sqrq = rs.getString("sqrq");//填写日期
				ccmd = rs.getString("ccmd");//出差目的
			...
			boolean is = rs.executeSql(sql_2);
			while(rs.next()){
				String tmp_id = Util.null2String(rs.getString("id"));
				String emp_code = Util.null2String(rs.getString("gh"));
				String start_date = Util.null2String(rs.getString("jhccksrq"));
				String start_time = Util.null2String(rs.getString("jhcckssj"));
				String end_date = Util.null2String(rs.getString("jsjsrq"));
				String end_time = Util.null2String(rs.getString("jsjssj"));
				String leave_time = Util.null2String(rs.getString("jhccxss"));
