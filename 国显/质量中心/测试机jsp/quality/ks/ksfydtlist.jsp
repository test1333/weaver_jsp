...
%>
<body>
		<div style="margin:0 auto; width:96%;"><table id="fytable" class="table text-nowrap" style="word-break:break-all; word-wrap:break-word;font-size:12px;"></table></div>
...
<script src="/static/bootstrap-3.3.7-dist/js/FileSaver.min.js"></script> 
	...
	var queryCondition = "<%=queryConditon%>";
	//var $table;
   ...
   // function InitMainTable () {
      ...
      $('#fytable').bootstrapTable({
            url: '/jsp/quality/action/getfydata.jsp?type=ksfydt&queryCondition='+queryCondition,//请求后台的URL（*）
            method: 'GET',                       //是否显示行间隔色
