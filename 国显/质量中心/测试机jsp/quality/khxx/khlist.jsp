...
<%
	...
	String htmlxxzl = qu.getSelectOption("xxzl");
%>
<!DOCTYPE html>
<html>
<head>
...
String gjgkmc = Util.null2String(request.getParameter("gjgkmc"));//顾客名称
String gjcpmc = Util.null2String(request.getParameter("gjcpmc"));//产品名称
String gjsccq = Util.null2String(request.getParameter("gjsccq"));//生产产区
String gjxxbh = Util.null2String(request.getParameter("gjxxbh"));//信息编号
String gjcpxh = Util.null2String(request.getParameter("gjcpxh"));//产品型号
String gjbeginDate = Util.null2String(request.getParameter("gjbeginDate"));//发生日期-开始
String gjendDate = Util.null2String(request.getParameter("gjendDate"));//发生日期-结束
String gjxxzl = Util.null2String(request.getParameter("gjxxzl"));//信息种类
String gjcpzt = Util.null2String(request.getParameter("gjcpzt"));//产品状态
String gjcpjd = Util.null2String(request.getParameter("gjcpjd"));//产品阶段
...
<body>
	<div class="container">
		<FORM id=report name=report action="/jsp/quality/khxx/khlist.jsp" method=post>
				<div class="row mt-10">
				<input type="hidden" id="seltab" name="seltab" value="0"></input> 
				<input type="hidden" id="sel1" name="sel1" value="0"></input> 
				<input type="hidden" id="sel2" name="sel2" value="0"></input>
						...
						<div class="col-md-6 ">
							<div class="btn-group" data-toggle="buttons" id="maintab">
								<label class="btn btn22" onclick="changeselect('khmc')">
									<input type="radio" name="options" id="optionkhmc">客户名称
								</label> 
								<label class="btn btn22" onclick="changeselect('sccq')">
						...
						<div class="col-md-3 ">
							...
							<div style="position: absolute; left: 60%;">
								<select class="selectpicker" id="mainss" disabled="disabled" data-width="100px">
									<option value="khxx" select>客户信息</option>
								</select>
		...
		<div class="row collapse" id="demo">
				...
				<table class="table-bordered table-condensed" style="margin-top:10px;width: 100%;max-width: 100%">
				   ...
				   <tbody>
				      ...
				      <tr>
				         ...
				         <td class="sf2"><input type="text" id="gjxxbh" name="gjxxbh" class="form-control" value="<%=gjxxbh%>"/></td>
				...
				<div class="row mt-10">
					<div class="col-md-12"
						...
						<div id='khxxlist' style="margin-top:10px">
						<iframe src="/jsp/quality/khxx/khdtlist.jsp?queryCondition=<%=queryConditon%>" id="mainFrame"
	...
	window.onload = function() {
		...
		height1 = height1 + 'px';
		document.getElementById('khxxlist').style.height = height1;
	}
		jQuery(document).ready(function() {
			...
			if(gjxxzl != ""){
				$("#gjxxzl").selectpicker('val', gjxxzl);
			}
			if(gjcpzt != ""){
		...
		function search1() {
			...
			//alert(seltab);
			//alert(jQuery("#mainss").val())
			//alert(jQuery("#mainss2").val())
			//alert(jQuery("#beginDate").val())
