...
String gjkxyzd = Util.null2String(request.getParameter("gjkxyzd"));
String gjkxzl = Util.null2String(request.getParameter("gjkxzl"));
...
jo.put("gjkxyzd", gjkxyzd);
jo.put("gjkxzl", gjkxzl);
...
<body>
	<div class="container">
		<FORM id=report name=report action="/jsp/quality/kx/kxlist.jsp"
				method=post>
		<div class="row mt-10">
						...
						<div class="col-md-3 ">
							...
							<div style="position: absolute; left: 60%;">
								<select class="selectpicker" id="mainss" disabled="disabled"  data-width="100px" >
									<option value="kx" select>客需</option>
								</select>
				...
				<table class="table-bordered table-condensed" style="margin-top:10px;width: 100%;max-width: 100%">
				   ...
				   <tbody>
				      ...
				      <tr>
				         ...
				         <td class="sf2">
				         <select id="gjkxzl" name="gjkxzl"  class="form-control selectpicker"  data-live-search="true" title="请选择" data-width="80%" data-height="80%">
								<%=htmlbyzl%>
							 </select>
				         </td>
		...
		<div class="row mt-10">
			<div class="col-md-12"
				...
				<div id='kxlist' style="margin-top:10px">
				<iframe src="/jsp/quality/kx/kxdtlist.jsp?queryCondition=<%=queryConditon%>" id="mainFrame"
	...
	window.onload = function() {
		...
		height1 = height1 + 'px';
		document.getElementById('kxlist').style.height = height1;
	}
		jQuery(document).ready(function() {
			...
			if(gjkxyzd != ""){
				$("#gjkxyzd").selectpicker('val', gjkxyzd);
			}
			if(gjkxzl != ""){
				$("#gjkxzl").selectpicker('val', gjkxzl);
			}
			if(gjcpzt != ""){
