...
<%
	...
	String flagcount = Util.null2String(request.getParameter("flagcount"));
...
%>
	...
	<input type="hidden" name="flagcount"  id="flagcount" value="<%=flagcount%>">
	<%
...
//System.out.println("-1421--belongtoshow-"+belongtoshow);
								        	...
								        	String popedomOtherpara = "column:viewtype+column:isremark+column:isprocessed+column:nodeid+column:workflowid+"+scope;
												...
												RecordSet.execute("select count(1) as count "+fromSql);
