...
var wlglfw="#field51012";//物料管理范围
var wlglfw_dt1="#field51013_";//明细1 物料管理范围
var je_dt1 = "#field50685_";//明细1 金额
var kmkyje_dt1 = "#field53942_";//明细1 科目可用金额
var djje_dt1 = "#field53943_";//明细1 冻结金额

var fycdbm_dt1 = "#field50989_";//明细1 费用承担部门
var fyqj_dt1 = "#field50990_";//明细1 费用期间
var yskm_dt1 = "#field50987_";//明细1 预算科目
var fycdfb="#field50668";
...
function getAllJe(yskm,fycdbm,fyqj){
	...
	for(var index =0;index <indexnum0;index++){
			if(jQuery(kmkyje_dt1+index).length>0){	
				...
				if(fycdbm_dt1_val == fycdbm && fyqj_dt1_val.substring(0,4) == fyqj.substring(0,4) && yskm_dt1_val==yskm){
