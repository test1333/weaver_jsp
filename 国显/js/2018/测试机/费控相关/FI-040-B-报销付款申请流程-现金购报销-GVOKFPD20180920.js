...
var cgddh ="#field56285";//采购订单号
var cgddlc="#field56286";//采购订单流程
var fyssqj_dt = "#field56241_";//费用所属期间
var ddzje = "#field56288";//订单总金额
var bcbxzje = "#field56295";//本次报销总金额

var cgsqdh_dt1 = "#field57447_";//采购申请单号
var hxmh_dt1 = "#field57448_";//行项目号
var fycdzt_dt1 = "#field57935_";//费用承担主体
var fycdbm_dt1 = "#field57936_";//费用承担部门
var fyssqj_dt1 = "#field56241_";//费用所属期间
var yskm_dt1 = "#field56242_";//预算科目
var djje_dt1 = "#field58087_";//冻结金额
var wsje_dt1 = "#field56246_";//未税金额
jQuery(document).ready(function(){
	...
	checkCustomize = function () {
		...
		if(Number(bcbxzje_val)>Number(ddzje_val)){
			Dialog.alert("本次报销总金额必须小于订单总金额，请检查");
			return false;
		}
