...
var wlglfw="#field51014";//物料管理范围
var wlglfw_dt1="#field51015_";//明细1 物料管理范围
var je_dt1 = "#field50755_";//明细1 金额
var kmkyje_dt1 = "#field53940_";//明细1 科目可用金额
var djje_dt1 = "#field53941_";//明细1 冻结金额
var fyqj_dt1 = "#field51001_";//明细1 费用期间
var yskm_dt1 = "#field51000_";//明细1 预算科目
var yslx_dt1 = "#field52011_";//明细1 预算类型
var fycdfb="#field54752";
	...
	checkCustomize = function () {
		...
		for(var index =0;index <indexnum0;index++){
			if(jQuery(wlglfw_dt1+index).length>0){	
				...
				//alert(wlglfw_dt1_val);
				if(wlglfw_dt1_val == "集团化"){
			...
			if(jQuery(kmkyje_dt1+index).length>0){	
				...
				if(yslx_dt1_val != "1"){
					if(accSub(kmkyje_dt1_val,djje_dt1_val)<Number(je_dt1_val)){
						...
						if(yskm_dt1_val !=""  && fyqj_dt1_val !=""){
							var allje_val=getAllJe(yskm_dt1_val,fyqj_dt1_val);
...
function getAllJe(yskm,fyqj){
	...
	for(var index =0;index <indexnum0;index++){
			if(jQuery(kmkyje_dt1+index).length>0){	
				...
				if(fyqj_dt1_val.substring(0,4) == fyqj.substring(0,4) && yskm_dt1_val==yskm){
