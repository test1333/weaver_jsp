...
<script type="text/javascript">
   var ysssqj_dt1="#field6738_";//预算所属期间
    var cbzx_dt1="#field6740_";//成本中心
    var km_dt1="#field6741_";//科目
    var sqje_dt1="#field6746_";//申请金额
    var ndkyje_dt1="#field11875_";//年度可用金额
    
        
      var fplx_dt1="#field12485_";//发票类型
    var fphm_dt1="#field12486_";//发票号码
    var sfcf_dt1="#field12488_";//是否重复
	
	var djbh="#field6719";//单据编号
