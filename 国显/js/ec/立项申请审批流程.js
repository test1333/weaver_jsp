...
<script type="text/javascript">
   ...
   var sbyszje="#field13147";//设备预算总金额
   var sbyssyje="#field13148";//设备预算剩余金额
   var sblxje="#field13149";//设备立项金额
       jQuery(document).ready(function(){
       	   var xmlx_val=jQuery(xmlx).val();
       	  showordiaplaydt1(xmlx_val);
		  jQuery(sbyszje).attr("readonly", "readonly");
       	  jQuery(sbyssyje).attr("readonly", "readonly");
                ...
                checkCustomize = function () {
                	...
                	if(xmlx_val == '0'||xmlx_val == '2'||xmlx_val == '3'){
                       ...
                       var indexnum0=jQuery("#indexnum0").val(); 
                        ...
                        var sblxje_val=jQuery(sblxje).val();
                		var sbyssyje_val=jQuery(sbyssyje).val();
                		if(sblxje_val ==''){
                			sblxje_val = '0';	
                	       }
                	   	if(sbyssyje_val ==''){
                		...
                		if(Number(sblxje_val)>Number(sbyssyje_val)){
                		   Dialog.alert("立项金额不能超过设备预算剩余金额");
                		   return false;
                        }
                   }
                	return true;
