...
<script type="text/javascript">
     var hswrmbje="#field8050";//核算为人民币金额
    var lxkyje="#field10223";//立项可用金额
       var sfcg ="#field8165";//是否超过5000W
    var xzht="#field8223";//选择合同卡片
    var jd_dt1="#field8161_";//明细1-阶段
    var bl_dt1="#field8162_";//明细1-比例
    var je_dt1="#field11181_";//明细1-金额
    var fkrq_dt1="#field9794_";//明细1-付款日期
     var sfyy="#field8063";//是否用印
    var gz="#field8064";//公章
    var htz="#field8065";//合同章
    var frz="#field8066";//法人章
    var frqz="#field8067";//法人签字
    var htksrq="#field8052";//合同开始日期
    var htjsrq="#field8053";//合同结束日期
          ...
          checkCustomize = function () {
        	      ...
        	      if(htjsrq_val<htksrq_val){
          	      ...
          	      if(Number(hswrmbje_val)>Number(lxkyje_val)){
          	      	  Dialog.alert("合同金额超过关联项目的立项可用金额,请检查");
          	      	  return false;
          	     }
