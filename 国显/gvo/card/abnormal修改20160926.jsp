...
<%
      ...
      String sql = " select key_id,emp_code,chn_name,att_datetime,machineid,inorout from v_ats_originality_data where convert(varchar(20),att_datetime,23) = '"+abnormalDate+"' "
