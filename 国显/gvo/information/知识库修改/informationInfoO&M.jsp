...
String type_name = Util.null2String(request.getParameter("type_name"));  
String details2_name = Util.null2String(request.getParameter("details2_name"));  
String recorddate_name = Util.null2String(request.getParameter("recorddate_name"));


String imagefilename = "/images/hdDOC.gif";
String titlename = "运维类列表";
String needfav ="1";
String needhelp ="";
%>
...
<tr>
	...
	<TD>类别</TD>
		<td><input class=inputstyle id='type_name' name=type_name size="20" value="<%=type_name%>" ></td>
    <TD>二级分类</TD>
		<td><input class=inputstyle id='details2_name' name=details2_name size="20" value="<%=details2_name%>" ></td>
    <TD>登记日期</TD>
		<td><input class=inputstyle id='recorddate_name' name=recorddate_name size="20" value="<%=recorddate_name%>" ></td>
	<TD class=field>
...
<tr><td  valign="top"> 
 ...
 <tr>
   <td>
    <div class="om">
	<a href="/gvo/information/informationInfoO&M.jsp"><img src="/gvo/information/images/strucimgy.jpg"></a>
	   <h3>运维类</h3>
	     <div class="omleft">
	        <a href="/gvo/information/O&M/informationInfo-desktop.jsp">桌面支持</a>
	        <a href="/gvo/information/O&M/informationInfo-Meeting.jsp">会务</a>
	        <a href="/gvo/information/O&M/informationInfo-database.jsp">数据库</a>
	     </div>
		 <div class="omright">
	        <a href="/gvo/information/O&M/informationInfo-storage.jsp">存储</a>
	        <a href="/gvo/information/O&M/informationInfo-server.jsp">服务器</a>
	     </div> 
	</div>
   </td>
  </tr>
...
<TABLE width="100%" >
	...
	<tr>
		<td valign="top" width="80%">
            ...
            String sqlWhere = " where details2 in (6,7,8,9,10) ";
