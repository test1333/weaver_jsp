...
<div class="waikuang" style="width:100%; height:auto; border:0; margin:0; padding:0;">
  <div class="top" style="width:100%; font-size:40px; padding:0; height:auto; margin-top:60px;">
     <div class="logo" style=" width:38%; float:left; text-align:right; padding:0; margin:0;"><img src="/gvo/visitor/logoff.png"></img></div>
	 <div class="wenzi" style="width:61%; float:right; text-align:left; padding:0; margin:0;"><span>访客登记、物品放行</span></div>
  </div>
