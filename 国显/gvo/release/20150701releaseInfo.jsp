...
<TABLE width="100%">
	<tr>
		<td valign="top">
            ...
            String fromSql  = " from (select f2.requestid,f2.id,f2.sqr,f2.sqrbm,f2.sjfxrq,f2.sqrq,f2.sqqrlxfs,f2.dcr1,f2.sqfxrq,f2.ccyy,f1.f2.bz,wpmc,f1.ggxh,f1.dw,f1.sl from formtable_main_234_dt1 f1 left join formtable_main_234 f2 on f1.mainid = f2.id) za ";
			
            String sqlWhere = " requestid in(select requestid from workflow_requestbase where currentnodetype in (1,2,3,4) ) "
            +" and za.sjfxrq is null ";
		   ...
		   if(!"".equals(sqrbm_name)){
			...
			if(!"".equals(dcr1_name)){
				...
				sqlWhere += " and za.dcr1 ="+dcr1_name+" ";
			}
            ...
            tableString =" <table  tabletype=\"none\" pagesize=\""+perpage+"\" >"+
                           ...
                           "				<col width=\"12%\" text=\"申请人联系方式\" column=\"sqqrlxfs\" orderkey=\"sqqrlxfs\"  />"+
						   " 				<col width=\"7%\" text=\"物品名称\" column=\"wpmc\" orderkey=\"wpmc\"  />"+
						   " 				<col width=\"12%\" text=\"规格型号\" column=\"ggxh\" orderkey=\"ggxh\"  />"+
                           " 				<col width=\"6%\" text=\"单位\" column=\"dw\" orderkey=\"dw\"  />"+
						   " 				<col width=\"6%\" text=\"数量\" column=\"sl\" orderkey=\"sl\"  />"+
                           "				<col width=\"6%\" text=\"放行登记\" column=\"desc_1\" orderkey=\"requestid\" href=\"releaseEdit.jsp\" linkkey=\"id\" linkvaluecolumn=\"id\" target=\"_blank\" />"+ 
						   " 				<col width=\"10%\" text=\"备注\" column=\"bz\" orderkey=\"bz\"  />"+
