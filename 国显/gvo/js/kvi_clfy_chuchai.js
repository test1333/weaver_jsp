...
var aboutWf = "#field13245";
var aboutWf_span = aboutWf + "span";
var sqlwhere =" where workflow_requestbase.workflowid in(1248) ";
...
function aboutWfBrowser() {
	...
	var id1 = window
			.showModalDialog("/systeminfo/BrowserMain.jsp?url=/gvo/js/jsp/MultiRequestBrowser_1.jsp?sqlwhere="+ sqlwhere);	
	if (id1) {
		var ids = id1.id;           
