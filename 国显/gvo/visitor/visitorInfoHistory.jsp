...
<style type="text/css">  
    .first {  
        ...
        border:none;  
		/*将第一个border设置为none后，看其效果*/  
        /***红色边框外侧存在黑色的边框，形成双边框现象***/  
    }  
    .second {  
        border:solid 1px #F00;  
        /***红色边框外侧存在黑色的边框，形成双边框现象***/  
...
<%
	...
	User tmp_user = (User)session.getAttribute("weaver_user@bean");
	int uid_1 = tmp_user.getUID();
if(uid_1!=-10&&uid_1!=1) {
...
<tr>
	...
	<TD align="center" valign="middle" >
	       <input type="submit" value="立即查询" class="first">
     </TD>
	 <TD align="center" valign="middle" >
	       <input type="button" value="返回访客登记首页" onClick="window.open('/gvo/visitor/visitorInfo.jsp')">
     </TD>
</tr>
...
<TABLE width="100%">
	<tr>
		<td valign="top">
            <%
            String backfields = " za.requestid,za.id,za.bfz,za.bfzlxdh,za.lfdw,za.lfr,za.lfrq,za.lfsj,za.fklx,za.cphm,za.lfsjbn,za.lksjbn,za.yyh,za.fzc,za.lfrs,decode(za.clsfjrcq,0,'是',1,'否','无记录') as sfjrcq ";
		   ...
		   if(!"".equals(lfr_name)){
			...
			if(!"".equals(yyh_name)){
				...
				sqlWhere += "and za.yyh like '%"+yyh_name+"%' ";
			}
		...
		//	}
           ...
           // out.println("select "+ backfields + fromSql + " where " + sqlWhere);
            ...
            tableString =" <table  tabletype=\"none\" pagesize=\""+perpage+"\" >"+
                           ...
                           "			<head>"+
						   " 				<col width=\"6%\" text=\"预约编号\" column=\"yyh\" orderkey=\"yyh\"  />"+
                           " 				<col width=\"20%\" text=\"访客姓名\" column=\"lfr\" orderkey=\"lfr\"  />"+
						   "				<col width=\"6%\" text=\"被访人\" column=\"bfz\" orderkey=\"bfz\" transmethod=\"weaver.hrm.resource.ResourceComInfo.getLastname\" />"+
                           "				<col width=\"6%\" text=\"联系电话\" column=\"bfzlxdh\" orderkey=\"bfzlxdh\"  />"+
						   " 				<col width=\"6%\" text=\"车牌号码\" column=\"cphm\" orderkey=\"cphm\"  />"+
						   " 				<col width=\"5%\" text=\"车辆进入\" column=\"sfjrcq\" orderkey=\"sfjrcq\"  />"+
                           " 				<col width=\"20%\" text=\"来访公司\" column=\"lfdw\" orderkey=\"lfdw\"  />"+
