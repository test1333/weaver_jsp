...
jQuery(s_emp).bindPropertyChange(function(){
			var vl = jQuery(hoiTYPE).val();
if(vl != 'L_014') get_some_Times(s_emp,s_date,s_time,e_date,e_time);
});

//jQuery(s_date).bind("propertychange",function()
jQuery(s_date).bindPropertyChange(function(){
		var vl = jQuery(hoiTYPE).val();
if(vl != 'L_014') get_some_Times(s_emp,s_date,s_time,e_date,e_time);});

//jQuery(e_date).bind("propertychange",function()
jQuery(e_date).bindPropertyChange(function(){
		var vl = jQuery(hoiTYPE).val();
if(vl != 'L_014') get_some_Times(s_emp,s_date,s_time,e_date,e_time);});

//jQuery(s_time).bind("propertychange",function()
jQuery(s_time).bindPropertyChange(function(){
		var vl = jQuery(hoiTYPE).val();
if(vl != 'L_014') get_some_Times(s_emp,s_date,s_time,e_date,e_time);});

//jQuery(e_time).bind("propertychange",function()
jQuery(e_time).bindPropertyChange(function(){
		var vl = jQuery(hoiTYPE).val();
if(vl != 'L_014') get_some_Times(s_emp,s_date,s_time,e_date,e_time);});

//jQuery(hoiTYPE).bind("propertychange",function()
jQuery(hoiTYPE).bindPropertyChange(function(){
		var vl = jQuery(hoiTYPE).val();
if(vl != 'L_014') get_some_Times(s_emp,s_date,s_time,e_date,e_time);});
