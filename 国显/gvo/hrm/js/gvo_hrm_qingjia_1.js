...
jQuery(s_emp).bind("propertychange",function(){		get_some_Times(s_emp,s_date,s_time,e_date,e_time);});

jQuery(s_date).bind("propertychange",function(){	get_some_Times(s_emp,s_date,s_time,e_date,e_time);});

jQuery(e_date).bind("propertychange",function(){	get_some_Times(s_emp,s_date,s_time,e_date,e_time);});

jQuery(s_time).bind("propertychange",function(){	get_some_Times(s_emp,s_date,s_time,e_date,e_time);});

jQuery(e_time).bind("propertychange",function(){	get_some_Times(s_emp,s_date,s_time,e_date,e_time);});
