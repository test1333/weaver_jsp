...
out.println("##  " + date2during + " ; " + WorkflowComInfo.getDateDuringSql(date2during) + "<br>");
...
<TABLE class=Shadow>
		...
		<FORM id=weaver name=SearchForm style="margin-bottom:0" action="MultiRequestBrowser_2.jsp" method=post>
