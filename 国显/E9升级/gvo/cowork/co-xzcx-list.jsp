...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<td>
		<%
		String backfields = "id,name,(select typename from cowork_types where id=t.typeid) as typename,createdate,creater,cjsj ,case when status='0' then '正常' else '结束' end as status,remark,floorNum,topdiscussid,disid,(select COWORKID||'/'||FLOORNUM as linkvalue from COWORK_DISCUSS where id=t.topdiscussid) as linkvalue";
		...
		operateString+
		"			<head>";
				tableString +="<col width=\"20%\" text=\"主题\" column=\"name\" orderkey=\"name\"  href=\"javascript:Viewitem('{0}')\" linkkey=\"id\" linkvaluecolumn=\"id\"/>"+ 
							...
							"<col width=\"10%\"  text=\"楼号\" column=\"floorNum\" orderkey=\"floorNum\"  href=\"javascript:ViewCoworkDiscuss('{0}')\" linkkey=\"id\" linkvaluecolumn=\"linkvalue\" /> "+
	...
	function Viewitem(id){
      window.open("/spa/cowork/static/index.html#/cowork/"+id,"_blank");
    }
