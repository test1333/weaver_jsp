...
<%!
	public String grtlftMenu(List elements, User user) {
		...
		sfcm.append("<script>");
		sfcm.append(" jQuery(document).ready(function(){jQuery('.mettingLi').click(function(){jQuery(this).addClass('add').siblings().removeClass('add');});jQuery('.mettingLi').eq(0).click();})");
