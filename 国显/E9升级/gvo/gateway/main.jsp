	                       			...
	                       			<ul style = "height:100%;">
                                        ...
                                        %>
                                         		<li style = "height:17.5%">
                                                    <a href="/spa/document/index.jsp?id=<%=companynewsItem.get("docid") %>" onclick="hideUnread(<%=companynewsItem.get("docid")%>)" target="_blank">
	                         	...
	                         	<div class = "noticeTitle" style = "height:20%">
	                       		...
	                       		<div class = "noticeContent" style = "height:70%">
	                       			<ul style = "height:100%;">
                                        ...
                                        %>
                                         		<li style = "height:17.5%">
                                                    <a href="/spa/document/index.jsp?id=<%=noticeBulletinItem.get("docid") %>" onclick="hideUnread(<%=noticeBulletinItem.get("docid")%>)" target="_blank">
	                         	...
	                         	<div class = "cultureTitle" style="height:20%">
	                       		...
	                       		<%if("1".equals(isCultureMX) && isKvi == false ){ %> 
		                       		<div class = "newCultureContent" style = "height:70%">
	                                    ...
	                                    %>
	                                         		<li style = "height:17.5%">
	                                                    <a href="/spa/document/index.jsp?id=<%=newCultureItem.get("docid") %>" onclick="hideUnread(<%=newCultureItem.get("docid")%>)" target="_blank">
	                        ...
	                        <div class="item addUpdate modelLast " id="NewGuide" url="">
	                         	<div class = "newGuideTitle" style = "height:20%">
	                       		...
	                       		<div class = "newGuideContent" style = "height:70%">
                                    ...
                                    %>
                                         		<li style = "height:17.5%">
                                                    <a href="/spa/document/index.jsp?id=<%=newGuideItem.get("docid") %>" onclick="hideUnread(<%=newGuideItem.get("docid")%>)" target="_blank">
