...
<%
	...
	int fromformmode = Util.getIntValue(Util.null2String(request.getParameter("fromformmode")), 0);
%>
<!--以下是显示定制组件所需的js -->
...
%>
	...
	<FORM id=weaver name=frmmain method=post action="gvo_tydb.jsp?offical=<%=offical %>&officalType=<%=officalType %>&viewType=<%=viewType %>">
	<%
...
userlist.add(Belongtoid + "");
		...
		if (isovertime == 1) {
			...
			//}
			sqlwhere +=" and (t1.deleted = 0 or t1.deleted is null) and ((t2.isremark = '0' and (t2.takisremark is null or t2.takisremark = 0)) or t2.isremark in ('1', '5', '8', '9', '7')) and (t1.deleted = 0 or t1.deleted is null) and t2.islasttimes = 1 ";
			//if (!Util.null2String(SearchClause.getWhereclauseOs()).equals("")) {
            //    sqlwhereos += " " + SearchClause.getWhereclauseOs();
           // }
			sqlwhereos +=" and userid = "+userID+" and islasttimes = 1  and isremark = '0' ";
		}
		...
		if (isovertime == 1) {
			...
			sqlwhere = "where  (t1.deleted <> 1 or t1.deleted is null or t1.deleted='') and t1.requestid = t2.requestid and t2.userid = " + userID + " and t2.usertype=" + usertype;
			//if (!Util.null2String(SearchClause.getWhereClause()).equals("")) {
			//	sqlwhere += " and " + SearchClause.getWhereClause();
			//}
			sqlwhere +=" and (t1.deleted = 0 or t1.deleted is null) and ((t2.isremark = '0' and (t2.takisremark is null or t2.takisremark = 0)) or t2.isremark in ('1', '5', '8', '9', '7')) and (t1.deleted = 0 or t1.deleted is null) and t2.islasttimes = 1 ";
			...
			<table width=100% height=94% border="0" cellspacing="0" cellpadding="0">
				<tr>
										...
										<tr>
											<td valign="top" class="_xTableOuter"><%
												...
												String os_currentnodeotherpara = "column:requestid";
                                                 if(isopenos && isovertime != 1&&fromformmode != 1){
					...
					if(!userIDAll.equals(String.valueOf(user.getUID()))){
										        		...
										        		operateString +=" <popedom async=\"false\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWFSearchResultOperation\" otherpara=\""+popedomOtherpara+"\" otherpara2=\""+popedomUserpara+"\" ></popedom> ";
													...
													if (isMultiSubmit && iswaitdo == 1) {
														if( "1".equals(belongtoshow)){
                                                                    tableString = " <table instanceid=\"workflowRequestListTable\" pageId=\""+pageId+"\"   tabletype=\"checkbox\" pagesize=\""
                                                                            ...
                                                                            + " <checkboxpopedom  id=\"checkbox\"  popedompara=\"column:workflowid+column:isremark+column:requestid+column:nodeid+column:userid\" showmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWFSearchResultCheckBox\" />" ;
                                                                    ...
                                                                    tableString += "<col width=\"19%\" display=\""+hasrequestname+"\" text=\""
                                                                                ...
                                                                                + "\" column=\"requestname\" orderkey=\"t1.requestname\" linkkey=\"requestid\" linkvaluecolumn=\"requestid\" target=\"_fullwindow\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWfNewLinkWithTitle2\"  otherpara=\""
                                                                                + para2 + "\"  pkey=\"requestname+gvo.e9sj.WorkFlowTransMethodE8.getWfNewLinkWithTitle\" />";
																}else{
														tableString = " <table instanceid=\"workflowRequestListTable\" pageId=\""+pageId+"\"   tabletype=\"checkbox\" pagesize=\""
																+ PageIdConst.getPageSize(pageId,user.getUID())
																+ "\" >"
                                                        ...
                                                        tableString += operateString + "<head>";
																	...
																	tableString += "<col width=\"19%\" display=\""+hasrequestname+"\" text=\""
																	+ SystemEnv.getHtmlLabelName(1334, user.getLanguage())
																	+ "\" column=\"requestname\" orderkey=\"t1.requestname\" linkkey=\"requestid\" linkvaluecolumn=\"requestid\" target=\"_fullwindow\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWfNewLinkWithTitle\"  otherpara=\""
																	+ para2 + "\"  pkey=\"requestname+gvo.e9sj.WorkFlowTransMethodE8.getWfNewLinkWithTitle\"  />";
																}
														tableString += "<col width=\"10%\" display=\""+hasworkflowname +"\"  text=\"" + SystemEnv.getHtmlLabelName(259, user.getLanguage())
																	+ "\" column=\"workflowid\" orderkey=\"t1.workflowid\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWorkflowname\" />";
														tableString += "<col width=\"6%\" display=\""+hascreater +"\"   text=\"" + SystemEnv.getHtmlLabelName(882, user.getLanguage())
																+ "\" column=\"creater\" orderkey=\"t1.creater\"  otherpara=\"column:creatertype\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWFSearchResultName\" />";
													
														tableString += " <col width=\"10%\" display=\""+hascreatedate +"\" id=\"createdate\" text=\""
																	+ SystemEnv.getHtmlLabelName(722, user.getLanguage())
																	+ "\" column=\"createdate\" orderkey=\"t1.createdate,t1.createtime\" otherpara=\"column:createtime\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWFSearchResultCreateTime\" />";
														tableString += "<col width=\"8%\" display=\""+hasrequestlevel +"\"  id=\"quick\" text=\"" + SystemEnv.getHtmlLabelName(15534, user.getLanguage())
																	+ "\" column=\"requestlevel\"  orderkey=\"t1.requestlevel\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWFSearchResultUrgencyDegree\" otherpara=\""
																	+ user.getLanguage() + "\"/>";													   												
														tableString += "<col width=\"10%\" display=\""+hasreceivetime +"\"  text=\""
																	+ SystemEnv.getHtmlLabelName(17994, user.getLanguage())
																	+ "\" column=\"receivedate\" orderkey=\"receivedate,receivetime\" otherpara=\"column:receivetime\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWFSearchResultCreateTime\" />";
														tableString += "<col width=\"8%\" display=\""+hascurrentnode +"\"  id=\"hurry\" text=\"" + SystemEnv.getHtmlLabelName(18564,user.getLanguage())
																	+ "\" column=\"currentnodeid\" otherpara=\""+os_currentnodeotherpara+"\" orderkey=\""+os_currentnodeorderby +"\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getCurrentNode\"/>";
														...
														tableString += "<col width=\"15%\" display=\""+hasreceivedpersons +"\"  text=\"" + SystemEnv.getHtmlLabelName(16354, user.getLanguage()) + "\" column=\"requestid\" otherpara=\"" + para4
																	+ "\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getUnOperators\"/>";
														...
														tableString = " <table instanceid=\"workflowRequestListTable\" pageId=\""+pageId+"\"   tabletype=\"checkbox\" pagesize=\""
																...
																+ "\" >"
																+ " <checkboxpopedom  id=\"checkbox\"  popedompara=\"column:viewtype+column:isremark+column:isprocessed\" showmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWFSearchRstCkBoxForMsg\" />";
														tableString += temptableString ;
														tableString += operateString + "			<head>";
								        	...
								        	String popedomOtherpara = "column:viewtype+column:isremark+column:isprocessed+column:nodeid+column:workflowid+"+scope;
													...
													if (isMultiSubmit && iswaitdo == 1) {
														...
														tableString = " <table instanceid=\"workflowRequestListTable\" tabletype=\"none\" pageId=\""+pageId+"\" cssHandler=\"com.weaver.cssRenderHandler.request.CheckboxColorRender\" pagesize=\"" + PageIdConst.getPageSize(pageId,user.getUID()) + "\" >";
															...
															tableString += " <col width=\"19%\" display=\""+hasrequestname+"\"  text=\""
																	+ SystemEnv.getHtmlLabelName(1334, user.getLanguage())
																	+ "\" column=\"requestname\" orderkey=\"requestname\"  linkkey=\"requestid\" linkvaluecolumn=\"requestid\" target=\"_fullwindow\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWfNewLinkWithTitle\"  otherpara=\""
																	+ para2 + "\"  pkey=\"requestname+gvo.e9sj.WorkFlowTransMethodE8.getWfNewLinkWithTitle\"/>";
															tableString += " <col width=\"10%\"  display=\""+hasworkflowname +"\"  text=\"" + SystemEnv.getHtmlLabelName(259, user.getLanguage())
																	+ "\" column=\"workflowid\" orderkey=\"t1.workflowid\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWorkflowname\" />";
															
															tableString += " <col width=\"6%\" display=\""+hascreater +"\"  text=\"" + SystemEnv.getHtmlLabelName(882, user.getLanguage())
																	+ "\" column=\"creater\" orderkey=\"creater\"  otherpara=\"column:creatertype\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWFSearchResultName\" />";
															tableString += "<col display=\""+hascreatedate +"\" width=\"10%\"  text=\""
																	+ SystemEnv.getHtmlLabelName(722, user.getLanguage())
																	+ "\" column=\"createdate\" orderkey=\"t1.createdate,t1.createtime\" otherpara=\"column:createtime\" transmethod=\"gvo.e9sj.WorkFlowTransMethodE8.getWFSearchResultCreateTime\" />";
															tableString += " <col width=\"8%\" display=\""+hasrequestlevel +"\"   text=\"" + SystemEnv.getHtmlLabelName(15534, user.getLanguage())
