											...
											<td valign="top" class="_xTableOuter"><%
												...
												String os_currentnodeotherpara = "column:requestid";
                                                 if(isopenos && isovertime != 1&&fromformmode != 1){
                                                    ...
                                                    fromSql = " from (select "+backfields0+" from (select "+backfields+" "+fromSql+""+sqlWhere+" and t2.isremark not in(2,4,8,9) and t2.islasttimes=1 and t1.workflowid not in(641,13,1,2,3,4,9,741) and  nvl(t2.takisremark,0) not in(-2) union all(select  "+backfieldsOs+" from ofs_todo_data "+sqlwhereos+" and islasttimes=1 and isremark=0) ) t1 ) t1 ";
