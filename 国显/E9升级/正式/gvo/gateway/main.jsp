...
.tip {
	...
	<body >
		...
		<div class="container" id ="contentUpdate" style = "min-height: 610px;position: relative;" >
				...
				<div class="rightContent"  style = "">
                	...
                	<div id="btnContent">
                		<ul class="btns">
                			...
                			<a href = "/wui/index.html#/main" target="_blank" id="OAPortal"><li id = "oaMain" ></li></a>
			...
			<div class="content" id = "content" style = "height:calc(100% - 100px);position:relative;position:fixed;top:100px;">
	                       		...
	                       		<div class = "qualityContent" style = "height:70%">
                                    ...
                                    %>
                                         		<li style = "height:17.5%">
                                                    <a href="/spa/document/index.jsp?id=<%=qualityBulletinItem.get("docid") %>" onclick="hideUnread(<%=qualityBulletinItem.get("docid")%>)" target="_blank">
	                         	...
	                         	<div class = "cultureTitle" style="height:20%">
	                       		...
	                       		<%if("1".equals(isCultureMX) && isKvi == false ){ %> 
		                       		<div class = "newCultureContent" style = "height:70%">
	                                    ...
	                                    %>
	                                         		<li style = "height:17.5%;position: relative;">
	                                                    <a style = "display: inline-block;max-width: 97%" class = "doc_a" href="/spa/document/index.jsp?id=<%=newCultureItem.get("docid") %>" onclick="hideUnread(<%=newCultureItem.get("docid")%>)" target="_blank">
