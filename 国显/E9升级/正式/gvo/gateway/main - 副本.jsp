...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="common/css/fx.css?v=20191231" />
		<link rel="stylesheet" type="text/css" href="common/css/gdt-style.css?v=20191123" />
				...
				<div class="rightContent"  style = "">
                	...
                	<div id="btnContent">
                		<ul class="btns">
                			...
                			<a href = "/wui/main.jsp" target="_blank" id="OAPortal"><li id = "oaMain" ></li></a>
				...
				<div id="continar" >
					<div id="itemContent" >
						...
						<div class="row Layout" >
	                        ...
	                        <div class="item dynamic1 open addUpdate ie8-border-radius model" id="gzzd" >
	                       		...
	                       		<div class = "newsContent" style = "height:70%">
	                       			<ul style = "height:100%;">
                                        ...
                                        %>
                                         		<li style = "height:17.5%;position: relative;">
                                                    <a style = "display: inline-block;max-width: 97%" class = "doc_a" href="/docs/docs/DocDsp.jsp?id=<%=companynewsItem.get("docid") %>" onclick="hideUnread(<%=companynewsItem.get("docid")%>)" target="_blank">
	                        ...
	                        <!-- 我的待办-->
	                        <a href = "<%=todo %>" target="_blank" class="todoWork">
	                       ...
	                       <div class="item dynamic1 open addUpdate model" id="tz" >
	                         	...
	                         	<div class = "noticeTitle" style = "height:20%">
	                       		...
	                       		<div class = "noticeContent" style = "height:70%">
	                       			<ul style = "height:100%;">
                                        ...
                                        %>
                                         		<li style = "height:17.5%;position: relative;">
                                                    <a style = "display: inline-block;max-width: 97%" class = "doc_a" href="/docs/docs/DocDsp.jsp?id=<%=noticeBulletinItem.get("docid") %>" onclick="hideUnread(<%=noticeBulletinItem.get("docid")%>)" target="_blank">
	                        ...
	                        <!--会议中心 -->
	                        <a href = "<%=metting%>" target = "_blank" class="meetingCenter">
		                       		...
		                       		<div class = "newCultureContent" style = "height:70%">
		                       			...
		                       			<%
	                                            for (int i=0;i<newCultureList.size();i++ ) {
	                                                ...
	                                                Integer docid_gateway = (Integer )newCultureItem.get("docid");
	                                    %>
	                                         		<li style = "height:17.5%;position: relative;">
	                                                    <a style = "display: inline-block;max-width: 97%" class = "doc_a" href="/docs/docs/DocDsp.jsp?id=<%=newCultureItem.get("docid") %>" onclick="hideUnread(<%=newCultureItem.get("docid")%>)" target="_blank">
	                        ...
	                        <div class="item addUpdate modelLast " id="NewGuide" url="">
	                         	<div class = "newGuideTitle" style = "height:20%">
	                       		...
	                       		<div class = "newGuideContent" style = "height:70%">
                                    ...
                                    %>
                                         		<li style = "height:17.5%;position: relative;">
                                                    <a style = "display: inline-block;max-width: 97%"  class = "doc_a" href="/docs/docs/DocDsp.jsp?id=<%=newGuideItem.get("docid") %>" onclick="hideUnread(<%=newGuideItem.get("docid")%>)" target="_blank">
