...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		String fromSql  =  " from DocDetail  t1,uf_co_hdbm_mt t3";
		fromSql = fromSql.replaceAll("<", "&lt;");
		String sqlWhere =  " t1.id=t3.wd and t3.sfyx='0'  and ( ( t1.docstatus = 7 and  ((t1.doccreaterid="+userid+" or t1.ownerid="+userid+")) ) or t1.docstatus in ('1','2','5')  )   and  (isreply!=1 or isreply is null)  and seccategory!=0 and (ishistory is null or ishistory = 0) ";
		if(!"".equals(bt)){
		...
		operateString+
		"			<head>";
				tableString +="<col width=\"60%\" text=\"标题\" column=\"hdbt\" orderkey=\"hdbt\"  linkvaluecolumn=\"id\" linkkey=\"id\" href=\"/spa/document/index.jsp\" target=\"_fullwindow\"/>"+ 
