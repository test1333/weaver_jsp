	...
	<div id = "forum">
			...
			<div>
				<ul class = "header_ul">
					...
					<li class = "hed_mea head_forum">
						<a href = "/spa/cowork/static/index.html#/main/cowork/main" target="_blank" class = "a">我的论坛</a>
					</li>
					<li class = "hed_mea">
						<a href = "/spa/cowork/static/index.html#/main/cowork/relateMe" target="_blank" class = "a">与我相关</a>
					</li>
					<li class = "hed_mea">
						<a href = "/spa/cowork/static/index.html#/main/cowork/collect" target="_blank" class = "a" >我的收藏</a>
					</li>
					<li class = "hed_mea">
						<a href = "/spa/cowork/static/index.html#/main/cowork/mine" target="_blank" class = "a">我的贴子</a>
					</li>
					<li id = "seacher">
					...
					<div class = "news_tg_ul_dt1">
						...
						int rtcount = 1;
							...
							while(rs.next()){
								...
								String linkvalue = "";
								sql_dt = "select COWORKID,FLOORNUM from COWORK_DISCUSS where id="+topdiscussid;
								rs_dt.execute(sql_dt);
								if(rs_dt.next()){
									linkvalue = Util.null2String(rs_dt.getString("COWORKID"))+"/"+ Util.null2String(rs_dt.getString("FLOORNUM"));
								}
								rtcount++;
						%>
							<li class = "news_li">
								...
								<div class = "news_content">
									<a href = "" target="_blank" class = "a rttj" value="<%=linkvalue%>">	
										<%=rtbt%>
									</a>
								</div>
					...
					<div>
						...
						%>
							<li class = "news_li" >
								<div class = "nwes_order"><%=xh%></div>
								<div class = "news_content" >
									<a href = "/spa/document/index.jsp?id=<%=docid%>" target="_blank" class = "a">
										<%=hdbt%>
									</a>
								</div>
		...
		<div class = "footer">
			<div class = "footer_div">
				<ul class = "footer_ul">
					<li class = "footer_li">
						<a href = "/spa/document/index.jsp?id=361406" target="_blank">
					...
					<li class = "footer_li">
						<a href = "/spa/document/index.jsp?id=361391" target="_blank">
							<div class = "footer_img">
					...
					<li class = "footer_li">
						<a href = "/spa/document/index.jsp?id=361530" target="_blank">
							<div class = "footer_img">
