	...
	while(hfm.next()){
		...
		<%if(!fieldValue.equals("0")&&!fieldValue.equals("") ){%>
      	...
      	<wea:item>
      		...
      		<input class=inputstyle type=file name=photoid value="<%=fieldValue%>" style="width: 300px">
...
function onShowDepartment(){
    url=encode("/hrm/company/DepartmentBrowserByDec.jsp?isedit=1&rightStr=HrmResourceEdit:Edit&selectedids="+resourcebasicinfo.departmentid.value);
    url = "/systeminfo/BrowserMain.jsp?mouldID=hrm&url="+url;
    return url;
