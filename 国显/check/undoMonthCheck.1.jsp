...
Calendar now = Calendar.getInstance();
	...
	String dqny=now_year+"-"+now_month;
...
%>
	...
	String sqlWhere = "";
     ...
     backfields = " id ,ygbm,khny,gh,ygxm,jxfs,jxdj,jxje,bzsm  "; 
	 ...
	 String dealsql="select id "+fromSql+sqlWhere;
...
%>
	...
	function commitALL(){
		...
		var xhr = null;
				...
				if (null != xhr) {
					xhr.open("GET","/gvo/check/commitAll.jsp?dealsql="+dealsql+"&status"+status, false);
					xhr.onreadystatechange = function () {
						if (xhr.readyState == 4) {
							if (xhr.status == 200) {
								var text = xhr.responseText;
