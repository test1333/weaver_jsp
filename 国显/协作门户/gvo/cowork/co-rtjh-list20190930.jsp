...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<td>
		<%
		String backfields = "t.id,dis.id as dis,case when dis.topdiscussid = 0 then dis.id else dis.topdiscussid end as topdiscussid,dis.createdate||' '||substr(dis.createtime,0,5) as cjsj";
		String fromSql  =  " from ( select t1.id,t1.name,t1.status,t1.typeid,t1.creater,t1.principal,t1.begindate,t1.enddate,t1.replyNum,t1.readNum,t1.lastdiscussant,t1.lastupdatedate,t1.lastupdatetime,t1.isApproval,t1.approvalAtatus,t1.isTop,t2.cotypeid, case when t3.sourceid is not null then 1 when t2.cotypeid is not null then 0 end as jointype  from cowork_items t1 left join "+
					...
					" ("+CoworkService.getPartnerShareSql(userid+"")+")  t3 on t3.sourceid=t1.id ) t,cowork_discuss dis,cowork_cream cre";
		fromSql = fromSql.replaceAll("<", "&lt;");
		String sqlWhere =  " 1 = 1 and t.id=dis.coworkid and dis.id=cre.discussID and cre.status='0' and jointype is not null and (t.approvalAtatus=0 or (t.approvalAtatus=1 and (creater="+userid+" or principal="+userid+" or cotypeid is not null)))  ";
		...
		operateString+
		"			<head>";
				tableString +="<col width=\"80%\" text=\"主题\" column=\"topdiscussid\" orderkey=\"topdiscussid\" transmethod='gvo.cowork.PortalTransUtil.getJhTitle' href=\"javascript:ViewCoworkDiscuss('{0}')\" linkkey=\"id\" linkvaluecolumn=\"topdiscussid\"/>"+ 
