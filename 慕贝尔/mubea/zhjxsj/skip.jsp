...
<%
 int user_id = user.getUID();
  ...
  String ccz = Util.null2String(request.getParameter("ccz"));
 String sql="select workcode ,Convert(varchar,GETDATE(),120) now from hrmresource where id="+ccz;
 String workcode="";
 String nowtime="";
 rs.executeSql(sql);
 if(rs.next()){
 ...
 String UName="MUBEA"+workcode;
 String ConvertString=UName+"CN"+Remark+"0379";
 MD5 md5 = new MD5();

 String Md5Info= md5.getMD5ofStr(ConvertString);
 //out.print(ConvertString);
 //out.print(Md5Info);
%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <body>
        <form name="LoginSubmit" action="https://www.cwt-online.com.cn/TicketClient/User/SSOLogin.aspx" method="POST">
            ...
            <input type="hidden" name='CompanyId' value="0379" />
