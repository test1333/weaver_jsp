...
<%
	...
	if("ck".equals(type)){
		 ...
		 String modeid=da.getmodeid(remark,"","",starttime,endtime,"");
		 response.sendRedirect("/formmode/view/AddFormMode.jsp?modeId=86&formId=-144&type=0&Id=405&billid="+modeid);  	
