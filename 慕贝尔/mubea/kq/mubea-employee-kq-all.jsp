...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		if(userid == 1 || userid == 181 || userid==3232){
		...
		<FORM id=report name=report action="/mubea/kq/mubea-employee-kq-all.jsp" method=post>
		...
		String sqlWhere =  " b.em_id=c.fempid and c.fempid=e.fempid and c.fattendday=e.fattendday and e.fempid=f.fempid and e.fattendday=f.fattendday and a.workcode=b.code and b.em_id=d.em_id  and (c.flateminute>0  or c.fearlyminute>0  or c.FAbsentHour>0 ) and a.status <4 and CONVERT(varchar(100),c.fattendday, 23)<'"+currentdate+"'";	
		if(userid !=1&&userid != 181 && userid != 3232){
			sqlWhere = sqlWhere+" and left(CONVERT(varchar(100),c.fattendday, 23),7) in('"+yearmonth+"','"+lastmonth+"')";
			sqlWhere = sqlWhere+" and a.id ="+userid;
		}else{
