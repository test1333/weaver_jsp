...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<%
		String backfields = "fid,a.id,left(CONVERT(varchar(100),c.fattendday, 23),7) as month,CONVERT(varchar(100),c.fattendday, 23) as fattendday ,c.flateminute,c.flatetimes,c.fearlyminute,c.fearlytimes,c.FAbsentHour,c.FAbsentTimes";
		String fromSql  =  " from hrmresource a,mubeaLink.AIS20130117115038.dbo.hm_employees b,mubeaLink.AIS20130117115038.dbo.HR_ATS_EmpAttendTotal c, mubeaLink.AIS20130117115038.dbo.HM_EmployeesAddInfo d";
		String sqlWhere =  " b.em_id=c.fempid and a.workcode=b.code and b.em_id=d.em_id and d.HRMS_Userfield_60='IDL - Normal Office' and (c.flateminute>0 or c.flatetimes>0 or c.fearlyminute>0 or c.fearlytimes>0  or c.FAbsentHour>0 or c.FAbsentTimes>0) and a.status <4 and CONVERT(varchar(100),c.fattendday, 23)<'"+currentdate+"'";	
		...
		String orderby =  " c.fattendday desc "  ;
		String tableString = "";
		String operateString= "";
		  tableString =" <table tabletype=\"none\" pagesize=\""+ PageIdConst.getPageSize(out_pageId,user.getUID(),PageIdConst.HRM)+"\"  pageId=\""+out_pageId+"\" >"+         
				   "	   <sql backfields=\""+backfields+"\" sqlform=\""+fromSql+"\" sqlwhere=\""+Util.toHtmlForSplitPage(sqlWhere)+"\"  sqlorderby=\""+orderby+"\"  sqlprimarykey=\"id\" sqlsortway=\"desc\" sqlisdistinct=\"fid\" />"+
		operateString+
		"			<head>";
				tableString +="<col width=\"10%\" text=\"Employee\" column=\"id\" orderkey=\"id\" transmethod='weaver.proj.util.ProjectTransUtil.getResourceNamesWithLink' />"+ 
                		...
                		"<col width=\"10%\" text=\"Late Hours\" column=\"flateminute\" orderkey=\"flateminute\" />"+ 
                		"<col width=\"10%\" text=\"Times for Late\" column=\"flatetimes\" orderkey=\"flatetimes\" />"+     
						"<col width=\"10%\" text=\"Early Leave Hours\" column=\"fearlyminute\" orderkey=\"fearlyminute\" />"+                               
						"<col width=\"10%\" text=\"Early Leave Times\" column=\"fearlytimes\" orderkey=\"fearlytimes\" />"+    
						"<col width=\"10%\" text=\"Absent Hours\" column=\"FAbsentHour\" orderkey=\"FAbsentHour\" />"+                               
						"<col width=\"10%\" text=\"Absent Times\" column=\"FAbsentTimes\" orderkey=\"FAbsentTimes\" />"+                                                          
						"</head>"+
		 "</table>";
	//showExpExcel="false"
	%>
