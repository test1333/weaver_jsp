...
jQuery(document).ready(function () {
    ...
    // var fieldsArr2 = [t0.ggxh1, t0.ggxh2, t0.ggxh3, t0.ggxh4, t0.ggxh5] // 规格型号1
    // var fieldsArr3 = [t0.sl1, t0.sl2, t0.sl3, t0.sl4, t0.sl5] // 数量1
    // var fieldsArr4 = [t0.dw1, t0.dw2, t0.dw3, t0.dw4, t0.dw5] // 单位1
    // var fieldsArr5 = [t0.xqrq1, t0.xqrq2, t0.xqrq3, t0.xqrq4, t0.xqrq5] // 需求日期1
    // var fieldsArr01 = [t0.sblx01, t0.sblx02, t0.sblx03, t0.sblx04, t0.sblx05] // 设备类型01
    // var fieldsArr02 = [t0.ggxh01, t0.ggxh02, t0.ggxh03, t0.ggxh04, t0.ggxh05] // 规格型号01
    // var fieldsArr03 = [t0.sl01, t0.sl02, t0.sl03, t0.sl04, t0.sl05] // 数量01
    // var fieldsArr04 = [t0.dw01, t0.dw02, t0.dw03, t0.dw04, t0.dw05] // 单位01
    // var fieldsArr05 = [t0.jq01, t0.jq02, t0.jq03, t0.jq04, t0.jq05] // 交期01
    var typeArr = [t0.sslb1, t0.sslb2, t0.sslb3, t0.sslb4, t0.sslb5] // 所属类别
    // var exchangeRate = [t0.hl01, t0.hl02, t0.hl03, t0.hl04, t0.hl05] // 币别
    ...
    // var priceArr2 = [t0.wbdj01, t0.wbdj02, t0.wbdj03, t0.wbdj04, t0.wbdj05] // 外币单价

    for (var i = 0; i < typeArr.length; i++) {
        var tmpType = _C.v(typeArr[i])
        if (tmpType !== '') {
            if (!((tmpType === '0' && _C.v(assetArr[i]) === '') || tmpType === '1')) {
  ...
  //  jQuery('#xmmc').hide()
   ...
   // var superDeptVal = _C.v(t0.superDept)
    ...
    //if (superDeptVal === '642' || superDeptVal === '651' || superDeptVal === '656') {
     //   jQuery('#xmmc').show()
...
//    _C.v(t0.bbzj, sumTotal('1'))
  //  _C.v(t0.wbzj, sumTotal('2'))
   ...
   // console.log('sum2=' + sumTotal('2'))
	...
	var brr_8 = ["#field28605","#field28606","#field28607","#field28608","#field28609"];
	...
	for(var i=0; i<sel_arr_1.length; i++){
     ...
     //          alert("调试 请忽略..  " + " NO. --> " + i + "  KEY --> " +  tmp_sel_val);
		if(tmp_sel_val == '0'  || tmp_sel_val == '1'){
			...
			if(tmp_bz_val == '4'){
				...
				price_all_1 = accAdd(price_all_1,tmp_s_val);
                                ...
                                var tmp_s_val = accMul( jQuery(brr_3[i]).val(), jQuery(brr_8[i]).val());
				price_all_2 = accAdd(price_all_2,tmp_s_val);
			}
		}
	}
    ...
    function sumTotal (flag) {
        ...
        for (var i = 0; i < typeArr.length; i++) {
            var tmpSum = 0;
            if (flag === '1') {
               if ((_C.v(typeArr[i]) === '0' && _C.v(assetArr[i]) === '') || _C.v(typeArr[i]) === '1') {
           //     if (flag === '1') {
