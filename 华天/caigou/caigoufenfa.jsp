...
String qgr = Util.null2String(request.getParameter("qgr"));
 ...
 String caigy =  Util.null2String((String)session.getAttribute("caigy"));
String tmc_pageId = "caigou111";
%>
...
if(!"".equals(caigy)){
RCMenu += "{分发,javascript:fenfa(),_self} " ;
RCMenuHeight += RCMenuHeightStep ;
}
%>
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
	<FORM id=report name=report action=/htkj/caigou/caigoufenfa.jsp  method=post>
		...
		function fenfa(){
            ...
            if(ids!=null && ids!=""){
			  //alert(ids);
				...
				if (null != xhr) {
					xhr.open("GET","/htkj/caigou/fenfa.jsp?id="+ids+"&cgjl="+cgjl+"&cgy="+cgy, false);
