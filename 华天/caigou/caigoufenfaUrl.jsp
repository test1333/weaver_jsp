...
<%
    String caigy = Util.null2String(request.getParameter("caigy"));
	session.setAttribute("caigy",caigy);
	String url_1 = "";
	url_1 = "/htkj/caigou/caigoufenfa.jsp";
	String url_2 = "/htkj/caigou/caigoufenfa1.jsp";
	String url_3 = "/htkj/caigou/caigoufenfa2.jsp";
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">请购分发</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">未分发<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_2%>">已分发<span id="allNum_span"></span></a>
				</li>
		    </ul>
