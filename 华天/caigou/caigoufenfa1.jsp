...
String qgr = Util.null2String(request.getParameter("qgr"));
 ...
 String caigy =  (String)session.getAttribute("caigy");

String tmc_pageId = "caigou112";
%>
...
RCMenu += "{撤回,javascript:back(),_self} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
	<FORM id=report name=report action=/htkj/caigou/caigoufenfa1.jsp  method=post>
	...
	String sqlWhere = "";
	 ...
	 sqlWhere = " where 1=1 and status in ('1','2') ";
...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(tmc_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+tmc_pageId +"\">"+
	" <checkboxpopedom  id=\"checkbox\" popedompara=\"column:id\" showmethod=\"htkj.alarm.AlarmUtil.getCanBack\" />"+
		...
		function back(){
            ...
            if(ids!=null && ids!=""){
			  //alert(ids);
				...
				if (null != xhr) {
					xhr.open("GET","/htkj/caigou/back.jsp?id="+ids+"&cgjl="+cgjl+"&cgy="+cgy, false);
