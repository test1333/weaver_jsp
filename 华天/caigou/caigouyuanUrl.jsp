...
<%
	...
	String url_1 = "";
	url_1 = "/htkj/caigou/caigouyuan.jsp";
	String url_2 = "/htkj/caigou/caigouyuan1.jsp";
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">请购列表</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">未询价<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_2%>">已询价<span id="allNum_span"></span></a>
				</li>
		    </ul>
