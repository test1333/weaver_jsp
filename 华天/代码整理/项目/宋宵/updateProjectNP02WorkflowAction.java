 ...
 */
public class updateProjectNP02WorkflowAction implements Action{
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                String sql_up = " update cus_fielddata set process='资源分配',processid='NP02'  where  id= "+project_name+" "
