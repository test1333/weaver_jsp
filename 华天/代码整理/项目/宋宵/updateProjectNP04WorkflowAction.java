 ...
 */
public class updateProjectNP04WorkflowAction implements Action{
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                String sql_up = " update cus_fielddata set process='评估客户审核',processid='NP04'  where  id= "+project_name+" "
