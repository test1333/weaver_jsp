 ...
 */
public class updateProjectNP10WorkflowAction implements Action{
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                String sql_up = " update cus_fielddata set process='确认收款',processid='NP10'  where  id= "+project_name+" "
