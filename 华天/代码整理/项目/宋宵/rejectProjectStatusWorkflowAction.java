 ...
 */
public class rejectProjectStatusWorkflowAction implements Action {
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                String sql_up = " update cus_fielddata set process='',processid=''  where  id= "+project_name+" "
