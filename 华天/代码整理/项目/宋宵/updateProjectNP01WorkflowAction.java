 ...
 */
public class updateProjectNP01WorkflowAction implements Action{
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                String sql_up = " update cus_fielddata set process='项目发起',processid='NP01'  where  id= "+project_name+" "
