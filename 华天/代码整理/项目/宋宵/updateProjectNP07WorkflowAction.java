 ...
 */
public class updateProjectNP07WorkflowAction implements Action{
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                String sql_up = " update cus_fielddata set process='信息联络单',processid='NP07'  where  id= "+project_name+" "
