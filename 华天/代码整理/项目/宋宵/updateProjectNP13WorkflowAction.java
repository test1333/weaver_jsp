 ...
 */
public class updateProjectNP13WorkflowAction implements Action{
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                String sql_up = " update cus_fielddata set process='样品试制',processid='NP13'  where  id= "+project_name+" "
