 ...
 */
public class updateProjectNP05WorkflowAction implements Action{
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            rs.executeSql(sql);
            if (rs.next()) {
                String project_name = Util.null2String(rs.getString("xmmc"));
                ...
                String sql_up = " update cus_fielddata set process='项目立项',processid='NP05'  where  id= "+project_name+" "
