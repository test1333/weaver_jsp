 ...
 */
public class updateProjectNP17WorkflowAction implements Action {
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                String sql_up = " update cus_fielddata set process='项目中止',processid='NP17'  where  id= "+project_name+" "
