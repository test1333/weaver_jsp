 ...
 */
public class updateProjectNP11WorkflowAction implements Action{
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                String sql_up = " update cus_fielddata set process='高层确认',processid='NP11'  where  id= "+project_name+" "
