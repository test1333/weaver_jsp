...
/**
 * Created by adore on 16/4/20.
 */
public class rejectProjectNP09WorkflowAction implements Action {
    ...
    public String execute(RequestInfo info) {
        ...
        if (!" ".equals(tableName)) {
            ...
            if (rs.next()) {
                ...
                rs.executeSql(sql);
                if(rs.next()) {
                    String proj_process = Util.null2String(rs.getString("process"));
                    String proj_processid = Util.null2String(rs.getString("processid"));

                    tmp_process = proj_process.replaceAll("产品设计客户审核", "产品设计");
                    tmp_processid = proj_processid.replaceAll("NP09", "NP06");
