...
<%
	String url_1 = "";
	url_1 = "/htkj/alarm/alarmHold.jsp";
	String url_2 = "/htkj/alarm/alarmHold1.jsp";
	String url_3 = "/htkj/alarm/alarmHold2.jsp";
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">预警信息</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">待处理<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_2%>">处理中<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_3%>">结束<span id="allNum_span"></span></a>
				</li>
		    </ul>
