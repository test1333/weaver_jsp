...
if(!"".equals(ProjID)){
String sql_jzm=" update cus_fielddata set cnjzm=(select cnjzm from prj_fielddata where id= "+ProjID+" and scope='ProjCustomFieldReal') where id= "+ProjID+" and scope='ProjCustomFieldReal'";
RecordSet.executeSql(sql_jzm);
}
/*查看项目成员*/
