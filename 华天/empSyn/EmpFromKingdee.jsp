...
<%@ page import="seahonor.action.custom.wcc.GetWccContactInfo"%>
...
if(userid == 1)  isShow = true;
int count_cc1 = 0;

String s_sql = "select count(id) as count_cc1 from HrmRoleMembers where roleid in(25,70) and resourceid="+userid;
RecordSet.executeSql(s_sql);
while(RecordSet.next()){
	count_cc1 = RecordSet.getInt("count_cc1");
}

if(count_cc1>0)  isShow = true;
...
%>
	...
	<FORM id=report name=report action=# method=post>
		...
		if("1".equals(multiIds)){
			GetWccContactInfo  job = new GetWccContactInfo(); 
...
<wea:group context="同步扫描机数据" attributes="test">

<wea:item>&nbsp;&nbsp;</wea:item><wea:item>&nbsp;&nbsp;</wea:item><wea:item>&nbsp;&nbsp;</wea:item>
		<wea:item>
		<table width="30%">
			<tr>
				<td><input name="hi1" type="button" value="同步数据" class="e8_btn_top" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;  max-width: 100px;width:100px;height:30px;font-size:15px;" onClick="onCheckup()"></td>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
