...
<HTML>
	...
	<BODY>
		...
		String backfields = "d.description status,"+
							...
							" case when b.peracceptancemonth = '' then '' when LEFT(SUBSTRING(b.peracceptancemonth,6,2),1)='0' then SUBSTRING(b.peracceptancemonth,7,1) +'月' else SUBSTRING(b.peracceptancemonth,6,2) +'月' end  peracceptancemonth, b.peroutmoney ";
