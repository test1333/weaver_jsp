...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		RCMenu += "{再推送,javascript:dodata(),_self} " ;
		
		RCMenuHeight += RCMenuHeightStep ; 
		%>
		<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
		<FORM id=report name=report action="/wg/wy/fail-wyjc-list.jsp" method=post>
			<input type="hidden" name="requestid" value="">
			<table id="topTitle" cellpadding="0" cellspacing="0">
				<tr>
					<td></td>
					<td class="rightSearchSpan" style="text-align:right;">
					<input type="button"  value="再推送" class="e8_btn_top" onClick="dodata()" />
		...
		String sqlWhere =  " 1=1 and status='1' and paybank='0' ";
		...
		tableString +="<col width=\"10%\" text=\"付款银行\" column=\"paybankname\" orderkey=\"paybankname\"  />"+ 
			...
			"<col width=\"8%\" text=\"付款金额\" column=\"paymount\" orderkey=\"paymount\" />"+ 
			"<col width=\"8%\" text=\"申请人\" column=\"reqman\" orderkey=\"reqman\"  transmethod='weaver.proj.util.ProjectTransUtil.getResourceNamesWithLink'/>"+ 
			"<col width=\"8%\"  text=\"申请部门\" column=\"reqdept\" orderkey=\"reqdept\"  transmethod=\"weaver.hrm.company.DepartmentComInfo.getDepartmentname\" />"+
			"<col width=\"8%\"  text=\"申请日期\" column=\"reqdate\" orderkey=\"reqdate\"  />"+
			...
			"<col width=\"8%\"  text=\"付款日期\" column=\"paydate\" orderkey=\"paydate\"  />"+
			"<col width=\"10%\"  text=\"失败原因\" column=\"errtxt\" orderkey=\"errtxt\"  />"+
