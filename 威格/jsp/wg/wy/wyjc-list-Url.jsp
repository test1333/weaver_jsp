...
<%
	String url_1 = "/wg/wy/undo-wyjc-list.jsp";
	String url_2 = "/wg/wy/fail-wyjc-list.jsp";
	String url_3 = "/wg/wy/success-wyjc-list.jsp";
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">招商付款清单</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       <li class="current">
					<a target="tabcontentframe" href="<%=url_1%>"><span id="allNum_span">待处理</span></a>
				</li>
				<li>
					<a target="tabcontentframe" href="<%=url_2%>"><span id="allNum_span">处理失败</span></a>
				</li>
				<li>
					<a target="tabcontentframe" href="<%=url_3%>"><span id="allNum_span">处理成功</span></a>
				</li>
