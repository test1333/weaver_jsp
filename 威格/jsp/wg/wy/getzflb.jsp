...
%>
	...
	<FORM id=report name=report action=/wg/wy/getzflb.jsp method=post>
		...
		if("1".equals(multiIds)){	
			String  result = "";	
			GetZfList ei = new GetZfList();
			result=ei.getList(beginDate,endDate);
...
<wea:group context="查询并更新支付结果" attributes="test">
...
<wea:item>查询日期</wea:item>
	...
	<wea:item>&nbsp;&nbsp;</wea:item>
		...
		<table width="30%">
			...
			<tr>
				<td><input name="hi1" type="button" value="查询并更新" class="e8_btn_top_first" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;  max-width: 100px;width:100px;height:30px;font-size:15px;" onClick="onCheckup()"></td>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<script type="text/javascript">	
				...
				function onCheckup(){
					...
					if(beginDate == "" || endDate==""){
						window.top.Dialog.alert("开始和结束日期必填");
						return;
					}
					 top.Dialog.confirm('是否查询并更新',function(){
       					 document.report.multiIds.value = "1";
						document.report.submit();
   					 });
