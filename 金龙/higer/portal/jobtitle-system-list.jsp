		...
		<div class = "applicant_link">
			<ul>
                <%
                   ...
                   String sql = "select subsystem_name,subsystem_url from uf_hg_auth_list where function_type='10' and website_type='portal' and(user_id is null or user_id=(select loginid from hrmresource where id='"+userid+"')) order by subsystem_seq_no asc";
                   rs.execute(sql);
                   while(rs.next()){
                 ...
                 %>
					...
					<li class="itemcolor"><%=subsystem_name%></li>
			    	</a>
                <%
                   } 
                %>
