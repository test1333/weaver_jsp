		...
		<tbody>
			...
			%>
				<tr>
					...
					<td class="reqdetail" width="*" title="我的任务P" >
						<a class="ellipsis" href="<%=url%>" target="_blank"><font class="font"><font class="font"><span class="reqname" ><%=task_name%></span></font></font></a>
					</td>
					<td ><font class="font"><%=proj_name%></font></td>
					<td >
