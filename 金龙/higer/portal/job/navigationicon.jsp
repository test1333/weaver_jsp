...
<%
        ...
        String wjobcount = "0";
        String loginid = "";
    	String sql = "select count(1) as oajobcount from tm_taskinfo where  status=1 and (principalid="+userid+" or id in(select taskid from tm_taskpartner where partnerid="+userid+") or id in(select taskid from tm_tasksharer where sharerid="+userid+") )" ;
        rs.execute(sql);
        if(rs.next()){
...
<body>
	<div class = "navifation">
		<ul >
            ...
            <a href="/higer/portal/job/myjob-oa-more.jsp" target="_blank">
				<div class = "list_logo">
					<div class = "imgbox">
