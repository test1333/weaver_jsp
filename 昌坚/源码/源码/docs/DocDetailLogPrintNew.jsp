	...
	<FORM id=searchfrm name=searchfrm method=post>
		<wea:layout type="4col">
			...
			<%
				...
				String tableString=""+
					   "<table datasource=\"weaver.docs.docs.DocDataSource.getPrintLog\" sourceparams=\"id:"+docid+"+operateuserid:"+creater+"+fromdate:"+fromdate+"+todate:"+todate+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.DOC_PRINTDOCLOG,user.getUID(),PageIdConst.DOC)+"\" tabletype=\"none\">"+
					   ...
					   "</table>";      
			  %>
			  <input type="hidden" name="pageId" id="pageId" value="<%= PageIdConst.DOC_PRINTDOCLOG %>"/>
