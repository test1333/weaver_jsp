...
if(aboutdoc == '-1')
{
	DEFAULT_URL = '/weaver/weaver.file.FileDownload?frompdfview=1&fileid=' + pdfimagefileid+'&requestid='+requestid;
}
else{
	DEFAULT_URL = '/weaver/weaver.homepage.HomepageCreateImage?aboutdoc='+aboutdoc+'&fileid=' + pdfimagefileid+'&requestid='+requestid;
}
