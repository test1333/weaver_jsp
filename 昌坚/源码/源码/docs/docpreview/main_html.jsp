...
<%
	...
	try{
		...
		<%
				 ...
				 %>
				 <iframe id="htmlShowContent" frameborder="0" style="width:100%;height:100%;" src="<%="/weaver/weaver.file.FileDownload?fileid="+htmlFileId+"&requestid="+requestid+"&desrequestid="+desrequestid%>" onload="hideLoading();displayRightMenu(this);
				 <%
				if("1".equals(iscopycontrol)){
					%>
						addCopycontrol();
