...
<%
		...
		<div id="imageShow" class="pdfViewer">
			<div class="page" style="width:816px;overflow:auto">
				<div style="padding:80px;">
					<img style="margin:auto;display:block;max-width:100%;cursor:pointer" src="/weaver/weaver.file.FileDownload?fileid=<%=imageFileId%>"/>
				</div>
			</div>
	...
	%>
		...
		<iframe id="htmlShowContent" frameborder="0" style="width:100%;height:100%;" src="<%="/weaver/weaver.file.FileDownload?fileid="+imageFileId+"&requestid="+requestid+"&desrequestid="+desrequestid%>" onload="hideLoading();displayRightMenu(this);"></iframe>
		</body></html>
