...
<form name="frmmain" id="frmmain" method="post" action="DocCommonContent.jsp?offical=<%=offical %>&officalType=<%=officalType %>&fromadvancedmenu=<%=fromAdvancedMenu%>&infoId=<%=infoId%>">
