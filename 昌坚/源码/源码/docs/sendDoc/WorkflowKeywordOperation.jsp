...
if(operation.equals("AddSave")){
    ...
    if(isDialog.equals("1")){
	    if(isentrydetail.equals("1")){
	    	 response.getWriter().println("<html><script type='text/javascript'>parent.parent.getParentWindow(parent).parent.location.href='/docs/sendDoc/DocKeywordTab.jsp?_fromURL=2&optype=0&refresh=2&id="+id+"';parent.parent.getParentWindow(parent).closeDialog();</script></html>");
	    	//response.sendRedirect("WorkflowKeyword_frm.jsp?keywordId="+id);
		}else{
			if(from.equals("edit")){//从编辑页面过来新建同级节点
				response.getWriter().println("<html><script type='text/javascript'>parent.parent.getParentWindow(parent).location.href='/docs/sendDoc/WorkflowKeywordEdit.jsp?optype=1&refresh=2&id="+parentId+"';parent.parent.getParentWindow(parent).closeDialog();</script></html>");
				...
				if("".equals(id) || id.equals("0")){//如果没有父节点
					...
					response.getWriter().println("<html><script type='text/javascript'>parent.parent.getParentWindow(parent).parent.location.href='/docs/sendDoc/DocKeywordTab.jsp?_fromURL=2&optype=1&refresh=2&id="+id+"';parent.parent.getParentWindow(parent).closeDialog();</script></html>");
				}
			}else{
				response.getWriter().println("<html><script type='text/javascript'>parent.parent.getParentWindow(parent).parent.location.href='/docs/sendDoc/DocKeywordTab.jsp?_fromURL=1&refresh=1';parent.parent.getParentWindow(parent).closeDialog();</script></html>");
			}
		}
    }else{
    ...
    if(isDialog.equals("1")){
	    if(isentrydetail.equals("1")){
	    	 response.getWriter().println("<html><script type='text/javascript'>parent.parent.getParentWindow(parent).parent.location.href='/docs/sendDoc/DocKeywordTab.jsp?_fromURL=2&refresh=1&id="+id+"';parent.parent.getParentWindow(parent).closeDialog();</script></html>");
	    	//response.sendRedirect("WorkflowKeyword_frm.jsp?keywordId="+id);
		}else{
			if(from.equals("edit")){//从编辑页面过来新建同级节点
				response.getWriter().println("<html><script type='text/javascript'>parent.parent.getParentWindow(parent).location.href='/docs/sendDoc/WorkflowKeywordEdit.jsp?optype=1&refresh=1&id="+parentId+"';parent.parent.getParentWindow(parent).closeDialog();</script></html>");
			}else if(from.equals("nextedit")){//从编辑页面过来新建下级节点
				RecordSet.executeSql(" select parentId from Workflow_Keyword where id="+parentId);
				id = "";
				if(RecordSet.next()){
				...
				if("".equals(id) || id.equals("0")){//如果没有父节点
					response.getWriter().println("<html><script type='text/javascript'>parent.parent.getParentWindow(parent).parent.location.href='/docs/sendDoc/DocKeywordTab.jsp?_fromURL=2&refresh=1&id="+parentId+"';parent.parent.getParentWindow(parent).closeDialog();</script></html>");
				}else{
					response.getWriter().println("<html><script type='text/javascript'>parent.parent.getParentWindow(parent).location.href='/docs/sendDoc/WorkflowKeywordEdit.jsp?optype=1&refresh=1&id="+id+"';parent.parent.getParentWindow(parent).closeDialog();</script></html>");
				}
			}else{
				response.getWriter().println("<html><script type='text/javascript'>parent.parent.getParentWindow(parent).parent.location.href='/docs/sendDoc/DocKeywordTab.jsp?_fromURL=1&refresh=1';parent.parent.getParentWindow(parent).closeDialog();</script></html>");
			}
    ...
    //if(isDialog.equals("1"))
    //	response.getWriter().println("<html><script type='text/javascript'>parent.getParentWindow(window).location.href='WorkflowKeyword_frm.jsp?keywordId="+hisParentId+"'</script></html>");
   // else{
