	...
	<FORM id=searchfrm name=searchfrm method=post>
		<wea:layout type="4col">
			...
			<%
				...
				String tableString=""+
					   "<table datasource=\"weaver.docs.docs.DocDataSource.getDownloadLog2\" sourceparams=\"id:"+docid+"+operateuserid:"+creater+"+fromdate:"+fromdate+"+todate:"+todate+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.DOC_DOWNLOADDOCLOG,user.getUID(),PageIdConst.DOC)+"\" tabletype=\"none\">"+
					   "<sql backfields=\"*\"  sqlform=\"temp\" sqlorderby=\"id\"  sqlprimarykey=\"id\" sqlsortway=\"desc\"  />"+
					   "<head>";
					   		tableString+=	 "<col width=\"20%\"  text=\""+SystemEnv.getHtmlLabelName(97,user.getLanguage())+"\" column=\"operatedate\" otherpara=\"column:operatetime\"  orderkey=\"operatedate\" />";
					   		tableString += "<col width=\"15%\" transmethod=\"weaver.splitepage.transform.SptmForDoc.getName\"  otherpara=\""+user.getLogintype()+"\"  text=\""+SystemEnv.getHtmlLabelName(99,user.getLanguage())+"\" column=\"operateuserid\" orderkey=\"operateuserid\"/>";
							...
							tableString += "<col width=\"25%\"  text=\""+SystemEnv.getHtmlLabelName(229,user.getLanguage())+"\" column=\"subject\" orderkey=\"operatetype\"/>";
					   ...
					   "</table>";      
			  %>
			  <input type="hidden" name="pageId" id="pageId" value="<%= PageIdConst.DOC_DOWNLOADDOCLOG %>"/>
