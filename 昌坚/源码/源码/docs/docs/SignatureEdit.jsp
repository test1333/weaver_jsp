...
<wea:layout type="2col">
    ...
    <wea:item>
    	...
    	<span id="markNameSpan" style="display:none"><img align=absMiddle src="/images/BacoError_wev8.gif"></span>
    	<%}else{
    	%>
      	<span><%=markName%></span>
    	<%
    ...
    <wea:item>
    	...
    	<%if(Util.getIntValue(operatelevel) > 0){ %>
    <INPUT TYPE="file" id="markPic" NAME="markPic"  class=InputStyle accept="image/gif,image/jpeg,image/png"><%=SystemEnv.getHtmlLabelName(23258,user.getLanguage()) %>
    	<%
    	} %>
    </wea:item>
    <wea:item attributes="{'colspan':'full'}">
    <img id="markImg" src="/weaver/weaver.file.SignatureDownLoad?markId=<%=markId%>" style="display: <%=markId==0?"none":"" %>" onerror="jsonerror()" ></img>
    </wea:item>
	</wea:group>
</wea:layout>
</form>
