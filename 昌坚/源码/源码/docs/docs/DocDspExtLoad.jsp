...
boolean wps_office_signature = Util.null2String(request.getParameter("wps_office_signature")).equals("1");
...
<%
				...
				if (rs.next()) {
%>
   	 						document.getElementById("WebOffice").AppendMenu("158","<%=SystemEnv.getHtmlLabelName(58,user.getLanguage())%>");
<%
				}
