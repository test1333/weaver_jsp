...
document.getElementById('loading-msg').innerHTML = "<%=SystemEnv.getHtmlLabelName(19945, language)%>";
</script>
...
function openFavouriteBrowser(){
	...
	window.showModalDialog('/systeminfo/BrowserMain.jsp?url=/favourite/FavouriteBrowser.jsp&fav_pagename='+favpagename+'&fav_uri='+favuri+'&fav_querystring='+favquerystring+'&mouldID=doc');
}
