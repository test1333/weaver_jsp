...
<wea:layout type="2col">
    ...
    <wea:item><INPUT TYPE="text" class=InputStyle NAME="markName" value="" onChange='checkinput("markName","markNamespan")'><span id=markNamespan><IMG src='/images/BacoError_wev8.gif' align=absMiddle></span></wea:item>
    <wea:item><%=SystemEnv.getHtmlLabelName(18695,user.getLanguage())%></wea:item>
    <wea:item><INPUT TYPE="file" id="markPic" NAME="markPic"  class=InputStyle" accept="image/gif,image/jpeg,image/png" onchange="changeMarkImg(this)"><%=SystemEnv.getHtmlLabelName(23258,user.getLanguage()) %></wea:item>
