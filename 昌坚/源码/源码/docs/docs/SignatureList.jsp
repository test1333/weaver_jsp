...
parent.setTabObjName('<%=SystemEnv.getHtmlLabelName(16473,user.getLanguage())%>')
});
</script>
<HTML><HEAD>
...
<%
String backfields = "markId, hrmresid, MarkName, markDate,subcompanyid";
...
String tableString=""+
  ...
  "<head>"+							 
	 "<col width=\"30%\" text=\""+SystemEnv.getHtmlLabelName(179,user.getLanguage())+"\" column=\"hrmresid\" orderkey=\"hrmresid\" transmethod=\"weaver.general.WorkFlowTransMethod.getWFSearchResultName\" otherpara=\"0\" target=\"_self\"/>"+
  	 "<col width=\"50%\" text=\""+SystemEnv.getHtmlLabelName(18694,user.getLanguage())+"\" column=\"MarkName\" orderkey=\"MarkName\" transmethod=\""+MarkNametransmethod+"\" otherpara=\""+MarkNamePara+"\" />"+
