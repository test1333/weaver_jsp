...
<!--目录管理权限设置-->
<%
   int[] labels = {611,1507,19467};
   int operationcode = MultiAclManager.OPERATION_TREEFIELDDIR;
   int categorytype = MultiAclManager.CATEGORYTYPE_TREEFIELD;
...
<input type="hidden" name="pageId" id="pageId" value="<%= PageIdConst.DOC_TREECATEGORADMINLIST %>"/>
<%
if(messageid !=0) {
%>
