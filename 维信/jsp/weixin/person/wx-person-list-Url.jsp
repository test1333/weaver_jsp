...
<%
	...
	String url_1 = "";
	url_1 = "/weixin/person/wx-person-list.jsp";
	String url_2 = "/weixin/person/wx-person-xlr-list.jsp";
	String url_3 = "/weixin/person/wx-person-ygx-list.jsp";
	String url_4 = "/weixin/person/wx-person-fq-list.jsp";
%>
		...
		<div class="e8_boxhead">
		    ...
		    <ul class="tab_menu">
		       <li class="current">
				...
				<li>
					<a target="tabcontentframe" href="<%=url_2%>">新录入<span id="allNum_span"></span></a>
				</li>
				<li>
					<a target="tabcontentframe" href="<%=url_3%>">已更新<span id="allNum_span"></span></a>
				</li>
				<li>
					<a target="tabcontentframe" href="<%=url_4%>">废弃<span id="allNum_span"></span></a>
				</li>
