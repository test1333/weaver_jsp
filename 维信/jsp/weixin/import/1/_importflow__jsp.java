...
public class _importflow__jsp extends com.caucho.jsp.JavaPage
{
...
String multiIds = Util.null2String(request.getParameter("multiIds"));
      ...
      out.print((SystemEnv.getHtmlLabelName(32814,user.getLanguage()) ));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelName(20536,user.getLanguage()) ));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print(( PageIdConst.HRM_ONLINEUSER ));
...
if(userightmenu!=1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jsp_GroupTag_1 == null) {
            ...
            _jsp_GroupTag_1.setContext("\u5bfc\u5165\u6d41\u7a0b");
            _jsp_GroupTag_1.setAttributes("test");
          }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("weixin/import/importflow.jsp"), 1295234182820497240L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("systeminfo/init_wev8.jsp"), 7913764235393281413L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("wui/common/page/initWui.jsp"), 2630307552094196134L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string124 = "\r\n							".toCharArray();
    _jsp_string99 = "visible".toCharArray();
    ...
    _jsp_string89 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string95 = "px\" height=\"".toCharArray();
    ...
    _jsp_string100 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();
    ...
    _jsp_string98 = "hidden".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string66 = "\r\n\r\n<BODY>\r\n\r\n<div id=\"tabDiv\">\r\n	<span class=\"toggleLeft\" id=\"toggleLeft\" title=\"".toCharArray();
