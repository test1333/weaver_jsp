...
public class _ExcelIn__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((dateNowStr));
      out.write(_jsp_string136, 0, _jsp_string136.length);
      out.print((SystemEnv.getHtmlLabelName(25649,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("weixin/import/ExcelIn.jsp"), -4429459726553672417L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string142 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parent.getDialog(window).close();\">\r\n      ".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
