...
var prdtid2_dt1 = "field6706_";//明细1 prdtid
	...
	checkCustomize = function () {
        ...
        for(var index=0; index<indexnum0;index++){
            if(jQuery(je_dt1+index).length>0){
                ...
                var yje_dt1_val = jQuery(yje_dt1+index).val();
                if(je_dt1_val == ""){
                    je_dt1_val = "0";
                }
                if(yje_dt1_val == ""){
                ...
                if(Number(je_dt1_val)>Number(yje_dt1_val)){
                    alert("明细 第"+countnum+"行明细修改后的金额大于原金额,请检查");
                    return false;
                }
