...
<%@ page import="zx.hr.sysn.SysnOrgDataAction"%>
...
<%
	...
	RCMenu += "{同步人员数据,javascript:onCheckup1(),_self} " ;
	RCMenuHeight += RCMenuHeightStep ;

%>
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
	<FORM id=report name=report action=/zx/Syshrinfo.jsp method=post>
		...
		if("1".equals(multiIds)){
			SysnOrgDataAction aa = new SysnOrgDataAction();
			aa.sysOrg();
			aa.sysJobtitle();
		    aa.sysPerson();
			boolean isOver = true;
