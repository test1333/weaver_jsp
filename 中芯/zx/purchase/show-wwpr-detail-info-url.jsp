...
function MainCallback1(checkids){
    var dialog = parent.getDialog(window);
    var parentWin = parent.getParentWindow(window);
    parentWin.savefc(checkids);
    dialog.closeByHand();
}
...
<%
	...
	String url_1 = "";
	url_1 = "/zx/purchase/show-wwpr-detail-info.jsp?rqid="+rqid+"&currentrqid="+currentrqid;
%>
