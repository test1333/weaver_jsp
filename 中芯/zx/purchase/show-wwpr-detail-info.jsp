...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	String tablename = "formtable_main_176";
	%>
	<BODY>
		<div id="tabDiv">
		...
		"			<head>";
				tableString +=
						"<col width=\"8%\" text=\"项目编号\" column=\"cgpzxmbh\" orderkey=\"cgpzxmbh\" />"+
