...
<table class="e8_tblForm">
    <TBODY>
     ...
     <tr id="tr_virtualtype" style="display: none">
     	<td class="e8_tblForm_label" width="20%">组织维度</td>
     	<td class="e8_tblForm_field">
     		<select id="HrmCompanyVirtual" name="HrmCompanyVirtual">
     			<option value="0">行政组织</option>
     			<%
     ...
     <!--  <tr>
		<td class="e8_tblForm_label">布局</td>
		<td class="e8_tblForm_field">
			<button type="button" class="copybtn2" onclick="onShowModeBrowser('layoutid','layoutidspan','2')" title="选择模板"></button>
	...
	<!-- 布局级别 -->
    <!--  <TR>
       <td class="e8_tblForm_label" width="20%">布局级别</TD>
       <TD class="e8_tblForm_field">
