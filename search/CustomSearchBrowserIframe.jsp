...
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/formmode/search/CustomSearchBrowserIframe.jsp" method=post>
	    ...
	    <%
		    ...
		    if(rs.getDBType().equalsIgnoreCase("oracle")){
	    		sql = "select a.id,a.modeid,(select modename from modeinfo where id=a.modeid ) as modename,a.customname,a.customdesc "+
	    			"from mode_customsearch a,modeinfo b,modeTreeField c where a.modeid=b.id and b.modetype=c.id and nvl(c.isdelete,0)<>1"+sqlWhere;
	    	}else{
	    		sql = "select a.id,a.modeid,(select modename from modeinfo where id=a.modeid ) as modename,a.customname,a.customdesc "+
				"from mode_customsearch a,modeinfo b,modeTreeField c where a.modeid=b.id and b.modetype=c.id and isnull(c.isdelete,0)<>1"+sqlWhere;
	    	}
