...
String params = "customname="+customname+"&modeid="+modeid+"&othercallback="+othercallback+"&appid="+appid;
%>
 ...
 <script type="text/javascript">
		...
		$(function(){
		    $('.e8_box').Tabs({
		        ...
		        staticOnLoad:true,
		        objName:"<%=SystemEnv.getHtmlLabelNames("18214,30947",user.getLanguage())%>"
		   	});
		}); 
	</script>
	<div class="e8_box demo2">
		  <div class="e8_boxhead">
		   ...
		   <div class="tab_box">
		        <div>
		            <iframe src="CustomSearchBrowserInResourceIframe.jsp?<%=params %>" onload="if(typeof(update)=='function'){update()}" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
		        </div>
		   </div>
	</div> 
