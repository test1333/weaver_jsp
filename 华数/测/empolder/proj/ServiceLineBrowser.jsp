...
<tr>
<td valign="top">
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="ServiceLineBrowser.jsp" method=post>
...
<%
int i=0;
sql = "select * from serviceLine where isShow = '0'"+sqlwhere+" and (personnel_1 like '%,"+userID+",%' or personnel_1 like '%,"+userID+"' or personnel_1 like '%"+userID+",%' or personnel_1 = '"+userID+"') order by order_o,id";
