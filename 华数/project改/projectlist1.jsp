	...
	<wea:layout type="table" attributes="{'cols':'6','cws':'13%,20%,13%,20%,13%,21%,'}">
		<wea:group context="查询条件" >
		  ...
		  <option	value=-1></option> 
			...
			<wea:item>
			<button type="button" class=Calendar id="selectBeginDate" onclick="onshowPlanDate('sqrq1','selectBeginDateSpan')"></BUTTON> 
              	<SPAN id=selectBeginDateSpan ><%=sqrq1%></SPAN> 
              	<INPUT type="hidden" name="sqrq1" id="sqrq1" value="<%=sqrq1%>">  
				
				&nbsp;&nbsp;&nbsp;&nbsp;——&nbsp;&nbsp;&nbsp;&nbsp;
				 <button type="button" class=Calendar id="selectEndDate" onclick="onshowPlanDate('sqrq2','endDateSpan')"></BUTTON> 
            	<SPAN id=endDateSpan><%=sqrq2%></SPAN> 
            	<INPUT type="hidden" name="sqrq2"  id="sqrq2"  value="<%=sqrq2%>">  
