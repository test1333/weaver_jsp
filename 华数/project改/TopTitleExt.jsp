...
<script language="javascript">	
	...
	Ext.onReady(function() {
		...
		tbItems=[
			...
			{iconCls:"btn_Favorite", tooltip:'<%=SystemEnv.getHtmlLabelName(18753, user.getLanguage())%>',handler: function(){window.showModalDialog("/favourite/FavouriteBrowser.jsp?fav_pagename="+pagename+"&fav_uri=<%=uri %>&fav_querystring=<%=querystring %>");}},
