	  ...
	  <TABLE id=AccessoryTable class="ViewForm" style="margin-top:10px;">
		...
		<COL width="15%">
          ...
          <TR>
          	<TD >会议纪要名称</TD>
          	<td class=field>
          		<input type=text class=inputStyle id="meetingname" name="meetingname" style="width:40%"><IMG src='/images/BacoError.gif' align=absMiddle>
          	</td>
         </TR>
         <TR class=spacing>
          	<TD class=line colspan=2></TD></TR>
...
sub onshowProject(spanname,inputename)
		...
		id1 = window.showModalDialog("/systeminfo/BrowserMain.jsp?url=/interface/MultiCommonBrowser.jsp?type=browser.xgxm&beanids=&splitflag=,"&tmpids,"new","dialogHeight: 600px, dialogWidth: 400px;")
