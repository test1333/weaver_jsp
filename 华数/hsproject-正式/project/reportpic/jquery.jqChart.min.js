(function (a) {
    ...
    function ob(a, b, c, d, e) {
        jb.call(this, a, b, c, d, e)
    }
    ob.prototype = new jb;
    ob.constructor = ob;
    ob.prototype.begin = function (a) {
        this.startTime = d.addSeconds(a, this.delayTime);
        this.endTime = d.addSeconds(this.startTime, this.duration);
        this.object[this.option] = this.from;
        this.lastIsSet = false
    };
    ob.prototype.animate = function (a) {
        if (a >= this.endTime) {
            if (!this.lastIsSet) {
                this.object[this.option] = this.to;
                this.lastIsSet = true;
    ...
    S.prototype = new O;
    S.constructor = S;
    S.prototype.mouseDown = function (d) {
    ...
    S.prototype.mouseMove = function (d) {
    ...
    S.prototype.touchStart = function (d) {
    ...
    S.prototype.touchMove = function (d) {
    ...
    e.support_canvas = function () {
        return !!document.createElement("canvas").getContext
    };
    e.use_excanvas = !e.support_canvas() ? true : false;
    e.isTouchDevice = !!("ontouchstart" in window);
    e.isGestureDevice = !!("ongesturestart" in window);
    e.checkIfRetinaDisplay = function () {
        var a = "(-webkit-min-device-pixel-ratio: 1.5),                      (min--moz-device-pixel-ratio: 1.5),                      (-o-min-device-pixel-ratio: 3/2),                      (min-resolution: 1.5dppx)";
        return window.devicePixelRatio > 1 ? true : window.matchMedia && window.matchMedia(a).matches ? true : false
    };
    e.isRetinaDisplay = e.checkIfRetinaDisplay();
    e.prototype = {
        ...
        _highlightShapes: function (g) {
            ...
            if (d.result !== false)
                if (e.use_excanvas) this.hlRenderer._render(b);
                else {
        ...
        toDataURL: function (a) {
            return e.use_excanvas ? null : this.canvas.toDataURL(a)
        },
    ...
    kb.prototype = {
        ...
        _getMainLine: function () {
            var b = this.crossOffsetX,
                c = this.crossOffsetY,
                a = new n(this.x1 + b, this.y1 + c, this.x2 + b, this.y2 + c);
        ...
        _getTickMarks: function (c, p) {
            ...
            for (var m = [], g = this.crossOffsetX, h = this.crossOffsetY, j = this.offset, i = c.position == "inside", r = this._getMarkInterval(c, p), b = c.length, o = this._getIntervals(r, c, p), d, f, e, a, l = 0; l < o.length; l++) {
                var k = this.getPosition(o[l]);
                switch (this.location) {
                    case "left":
                        f = a = k;
        ...
        setOptions: function (c) {
            ...
            this.majorTickMarks = new Hb(b.majorTickMarks);
            if (b.minorTickMarks) {
                this.minorTickMarks = new Hb(b.minorTickMarks);
                this.minorTickMarks.major = this.majorTickMarks
            }
            if (b.majorGridLines) this.majorGridLines = new Gb(b.majorGridLines);
            if (b.minorGridLines) {
                this.minorGridLines = new Gb(b.minorGridLines);
                this.minorGridLines.major = this.majorGridLines
            }
            this.isAxisVertical = this.isVertical();
            this.title = new X(b.title)
        },
    ...
    c.prototype.calculateBounds = function (a) {
        if (a == null) return;
        for (var b = h, c = h, e = k, f = k, d = 0; d < a.length; d += 2) {
            var g = a[d],
                i = a[d + 1];
            b = Math.min(b, g);
            c = Math.min(c, i);
    ...
    i.prototype.render = function (d, o) {
        ...
        var h = n(this.x),
            ...
            a = this.context;
        if (this.xDecrease) {
            var l = a.series.realYAxis.getCrossing(),
    ...
    Ib.prototype.hitTest = function (f, g, a) {
    ...
    Ib.prototype.render = function (a, m) {
        if (!this.visible) return;
    ...
    Jb.prototype = new c;
    Jb.constructor = new Jb;
    Jb.prototype.render = function (a, d) {
        if (!this.visible) return;
    ...
    bb.prototype.hitTest = function (e, f, a) {
        if (!this.useHitTestArea) a = 0;
    ...
    bb.prototype.render = function (a, d) {
        if (!this.visible) return;
        c.prototype.render.call(this, a, d);
        a.beginPath();
        var b = Math.max(0, this.radius);
    ...
    qb.prototype = new c;
    qb.constructor = new qb;
    qb.prototype.hitTest = function (d, e) {
        var b = this.x,
            c = this.y,
    ...
    qb.prototype.render = function (a, i) {
        if (!this.visible) return;
        if (this.startAngle == this.endAngle) return;
        c.prototype.render.call(this, a, i);
        a.beginPath();
        var g = Math.round(this.x),
            h = Math.round(this.y),
            b = this.startAngle,
            d = this.endAngle;
        if (e.use_excanvas) {
            var f = 2 * Math.PI - .000125;
            if (d - b >= f) d = b + f
        }
        a.moveTo(g, h);
        a.arc(g, h, Math.round(this.radius), b, d, false);
        a.closePath();
        this.fillStyle != null && a.fill();
        this.strokeStyle != null && this.lineWidth > 0 && a.stroke()
    };
    ...
    u.prototype = new c;
    u.constructor = new u;
    u.prototype.hitTest = function (k, l, g) {
        var e = this.context;
    ...
    u.prototype.createHighlightMark = function (c) {
        if (c == -1) return null;
        var d = this.context,
            f = this.pts,
            g = d.points[c / 2],
            e = 5,
            b = new bb(f[c] - e, f[c + 1] - e, e);
    ...
    u.prototype.getCenter = function (g) {
    ...
    C.prototype = new u;
    C.constructor = new C;
    C.prototype.renderPoints = function (a, c, i) {
        var g = c.length;
        if (g <= 2) return;
        if (this.strokeDashArray) {
    ...
    v.prototype = new u;
    v.constructor = new v;
    v.prototype.renderPoints = function (f, i) {
        var g = .4,
            h = this.closed,
            b = [];
        a.merge(b, i);
    ...
    v.prototype.render = function (a, f) {
        if (!this.visible) return;
    ...
    v.prototype.getControlPoints = function (d, f, a, b, e, g, j) {
    ...
    ib.prototype.render = function (d, h) {
        if (!this.visible) return;
        ...
        if (g < 2) return;
        var f;
        if (this.isCurve) f = new v(e);
        else f = new C(e);
        d.beginPath();
        d.moveTo(e[0], e[1]);
        f.renderPoints(d, e, true);
        d.lineTo(a[0], a[1]);
        if (this.isCurve) f = new v(a);
        else f = new C(a);
    ...
    Q.prototype = new u;
    Q.constructor = new Q;
    Q.prototype.hitTest = function (j, a, h) {
        var k = this.context;
        if (k && k.points) return u.prototype.hitTest.call(this, j, a, h);
    ...
    Q.prototype.render = function (a, h) {
        if (!this.visible) return;
    ...
    gb.prototype = new c;
    gb.constructor = gb;
    gb.prototype.hitTest = function (b, c, a) {
        return this.boundsHitTest(b, c, a)
    };
    gb.prototype.render = function (e) {
        if (!this.visible) return;
        var b = new Image,
            c = this.x,
            d = this.y,
    ...
    gb.prototype._createHighlightShape = function (b) {
        var a = new i;
    ...
    pb.prototype = new c;
    pb.constructor = new pb;
    pb.prototype.hitTest = function (e, f, c) {
    ...
    pb.prototype._getTooltipOrigin = function (a) {
        return {
            x: a.locX,
            y: a.locY
        }
    };
    pb.prototype.render = function (d) {
        if (!this.visible) return;
    ...
    X.prototype._render = function (a) {
    ...
    X.prototype.setOptions = function (c) {
    ...
    Fb.prototype = new X;
    Fb.constructor = Fb;
    Fb.prototype._render = function (f) {
        var c = this.chart;
    ...
    lb.prototype._setShapeSettings = function (a) {
    ...
    lb.prototype._render = function (c) {
    ...
    lb.prototype.getPadding = function () {
    ...
    Gb.prototype._setLineSettings = function (a) {
        a.strokeStyle = this.strokeStyle;
        a.lineWidth = this.lineWidth;
        a.strokeDashArray = this.strokeDashArray
    };
    ...
    Hb.prototype.isInside = function () {
        return this.position == "inside"
    };
    Hb.prototype._setLineSettings = function (a) {
        a.strokeStyle = this.strokeStyle;
        a.lineWidth = this.lineWidth;
        a.strokeDashArray = this.strokeDashArray
    };
    ...
    Mb.prototype._setSettings = function (a) {
        a.fillStyle = this.fillStyle;
        a.strokeStyle = this.strokeStyle;
        a.lineWidth = this.lineWidth
    };
    Mb.prototype.setOptions = function (c) {
        var b = a.extend({}, this.defaults, c || {});
        a.extend(this, b)
    };
    ...
    yb.prototype = new S;
    yb.constructor = yb;
    yb.prototype.mouseWheel = function (d, c) {
        if (!c) return;
        var a = this.view.axes.getZoomableAxes();
        a.length > 0 && d.preventDefault();
        for (var b = 0; b < a.length; b++) a[b]._mouseWheelZoom(c);
    ...
    U.prototype = new O;
    U.constructor = U;
    U.prototype.canStart = function (a) {
    ...
    U.prototype.mouseMove = function () {
    ...
    U.prototype.keyDown = function (a) {
        if (a.which == 27) {
            a.preventDefault();
            this.stopTool()
        }
    ...
    N.prototype = new O;
    N.constructor = N;
    N.prototype.canStart = function (d) {
    ...
    N.prototype.touchMove = function (b) {
        b.preventDefault();
    ...
    N.prototype.getTwoTouchPointData = function (b) {
        var a = {
            x1: b[0].locX,
            y1: b[0].locY,
            x2: b[1].locX,
    ...
    function g(b) {
        ...
        e.call(this, b);
        this.timer = new Tb(a.proxy(this.partialUpdate, this));
        this.storyboard = new Pb(a.proxy(this._renderShapes, this));
        this.defaultTool = new yb(this);
        this.currentTool = this.defaultTool;
        this.mouseDownTools.push(new W(this));
        this.mouseDownTools.push(new U(this));
        this.touchMoveTools.push(new N(this))
    }
    g.prototype = new e;
    g.constructor = g;
    g.prototype._createElements = function (c) {
        e.prototype._createElements.call(this, c);
        if (e.use_excanvas) {
        ...
        this.border = new lb;
        this.paletteColors = new Kb;
        this.title = new X;
        this.title.chart = this;
        this.legend = new mb;
        this.legend.chart = this;
        this.watermark = new Fb(this);
        this.toolbar = new Nb(this);
        this.series = new w(this);
        this.axes = new o(this)
    };
    g.prototype._setOptions = function (h) {
        ...
        this.options = c;
        e.prototype._setOptions.call(this, c);
        var d = h || {};
        ...
        var g = this._width = this.elem.width(),
        ...
        this._setCanvasSize(this.canvas, g, f);
        this._setCanvasSize(this.chCanvas, g, f);
        this._setCanvasSize(this.hlCanvas, g, f);
        this.areaCanvas && this._setCanvasSize(this.areaCanvas, g, f);
        this.update()
    };
    g.prototype._mouseEnter = function (a) {
        e.prototype._mouseEnter.call(this, a);
        this.toolbar.show()
    };
    g.prototype._mouseLeave = function (a) {
        e.prototype._mouseLeave.call(this, a);
        this.toolbar.hide()
    };
    ...
    g.prototype._arrange = function () {
        ...
        if (this.legend._isHorizontal()) {
            this.gridArea.width = Math.round(f - o);
            this.gridArea.height = Math.round(g - (n + this.title.height + this.legend.height))
        } else {
            this.gridArea.width = Math.round(f - (o + this.legend.width));
    ...
    g.prototype._processMouseMove = function () {
    ...
    g.prototype._initTouchInput = function (c) {
        e.prototype._initTouchInput.call(this, c);
        var b = this.touchInput[0];
    ...
    g.prototype._processTouchStart = function (b) {
    ...
    g.prototype._processTouchMove = function (b) {
        if (!this.gridArea.isTouchOver) return;
        var a = this.touchInput[0];
        b.preventDefault();
        this._processTouchEvents();
    ...
    g.prototype._clearRenderers = function () {
        e.prototype._clearRenderers.call(this);
        this.chRenderer && this.chRenderer._clear()
    };
    g.prototype._getClosestShapeAtX = function (f, g) {
        for (var c = null, j = h, k = g.locX, d = f.length - 1; d >= 0; d--) {
            var a = f[d];
            if (!a.context || a.isLegendItem || a.isAxisLabel) continue;
    ...
    g.prototype._getClosestShapeAtY = function (c, d) {
    ...
    g.prototype._getShapesAtX = function (g, c, e, f) {
        var b = [c],
            d = [c.context.series];
        a.each(e, function () {
    ...
    g.prototype._getTooltipShapes = function (h, i, g, c) {
        var b = null,
        ...
        } else b = e.prototype._getTooltipShapes.call(this, h, i, g, c);
        if (b) {
    ...
    g.prototype._getTooltipText = function (d) {
    ...
    g.prototype._initCrosshairs = function (a) {
    ...
    g.prototype._renderCrosshairs = function (e, f) {
        if (!this.hasCrosshairs) return;
        var c = this.gridArea;
    ...
    g.prototype._renderSelectionRect = function (g, h) {
        var b = this.gridArea,
            c = b.fitHor(g.locX),
            e = b.fitVer(g.locY),
            d = b.fitHor(h.locX),
    ...
    g.prototype._clearSelectionRect = function () {
        this.chRenderer._clear()
    };
    g.prototype._initZooming = function () {
        var b = this;
        b.canZoomVer = false;
        b.canZoomHor = false;
    ...
    g.prototype._triggerShapeEvent = function (c, a) {
    ...
    g.prototype.clear = function () {
        ...
        e.use_excanvas && this.areaRenderer._clear()
    };
    g.prototype._setClip = function (b) {
        var a = this.gridArea;
        b.beginPath();
        b.rect(a.x, a.y, a.width, a.height);
        b.clip()
    };
    g.prototype._createShapes = function () {
        var b = {},
            h = this.gridArea,
            c = b.shapes = [];
    ...
    g.prototype._renderShapes = function () {
        var i = e.isRetinaDisplay,
            d = this._width,
            c = this._height;
        if (i) {
            this._setRetinaDispOpts(this.canvas, d, c);
            this._setRetinaDispOpts(this.chCanvas, d, c);
            this._setRetinaDispOpts(this.hlCanvas, d, c)
        }
        this.shapeRenderer._clear();
        e.use_excanvas && this.areaRenderer._clear();
        var j = this.gridArea,
        ...
        var h = b.gaShapes;
        if (e.use_excanvas) this.areaRenderer._render(h);
        else {
            this.ctx.save();
            this._setClip(this.ctx);
            this.shapeRenderer._renderShadows(h);
            this.shapeRenderer._render(h);
            this.ctx.restore()
        }
        this.shapeRenderer._render(b.axesShapes);
        var g = b.nonGridAreaSerShapes;
        g.length > 0 && this.elem.trigger("seriesShapesRendering", [g]);
        this.shapeRenderer._renderShadows(g);
        this.shapeRenderer._render(g);
        var f = b.serShapes;
        f.length > 0 && this.elem.trigger("seriesShapesRendering", [f]);
        if (e.use_excanvas) this.areaRenderer._render(f);
        else {
            this.ctx.save();
            this._setClip(this.ctx);
            this.shapeRenderer._renderShadows(f);
            this.shapeRenderer._render(f);
            this.ctx.restore()
        }
        this.shapeRenderer._render(b.postAxisShapes);
    ...
    g.prototype.stringFormat = function (b, c) {
    ...
    g.prototype.findAxis = function (a) {
    ...
    g.prototype.partialDelayedUpdate = function () {
        this.timer.kick()
    };
    g.prototype.partialUpdate = function () {
        this.series._initVisibleData();
        this.axes._resetWH();
        var a = false;
        this.axes._initRanges();
    ...
    g.prototype.highlightData = function (c) {
        var a = e.prototype.highlightData.call(this, c);
        if (a) {
            var b = a[0].getCenter();
    ...
    M.prototype = new c;
    M.constructor = new M;
    M.prototype.createElements = function (a, h, i, e, d, g) {
        var c = [],
            f = g / 2,
            b = new n(a, h, a, i);
        c.push(b);
    ...
    function fb(f, c, e, d, a, b) {
        M.call(this, f, c, e, d, a, b)
    }
    fb.prototype = new M;
    fb.constructor = new fb;
    fb.prototype.createElements = function (b, e, f, o, l, m) {
        var d = [],
            g = Math.floor(m / 2),
            b = Math.round(b),
            a = Math.round(o),
    ...
    fb.prototype.render = function (d) {
        if (!this.visible) return;
        c.prototype.render.call(this, d);
        for (var b = 0; b < this.items.length; b++) {
            var a = this.items[b];
    ...
    fb.prototype.getTooltipColor = function () {
    ...
    function Kb(a) {
        ...
        this.colorsGrayScale = Sb();
        this.defaults = {
            type: "default"
        };
        this.setOptions(a)
    }
    Kb.prototype.setOptions = function (c) {
        var b = a.extend({}, this.defaults, c || {});
        a.extend(this, b)
    };
    ...
    Kb.prototype.getColor = function (b) {
        var a = this.getColors(this.type),
            c = a.length;
        b %= c;
        return a[b]
    };
    Kb.prototype.getColors = function (a) {
    ...
    V.prototype._setLineSettings = function (a) {
    ...
    V.prototype.getShape = function (c, d, b, f) {
    ...
    mb.prototype._isHorizontal = function () {
        return this.location == "top" || this.location == "bottom" ? true : false
    };
    mb.prototype._init = function () {
        this.items = [];
    ...
    mb.prototype._measure = function () {
    ...
    mb.prototype._arrange = function () {
        if (this.visible == false) return;
    ...
    mb.prototype.setOptions = function (b) {
        if (b != null && typeof b.title == "string") {
            b.title = {
                text: b.title
            };
    ...
    B.prototype._render = function (b) {
        ...
        this.border._render(b);
        var c = this._renderPlots(b);
        this._renderGridLines(b);
        a.merge(b, c)
    };
    B.prototype._renderSeries = function (d) {
    ...
    B.prototype._renderPlots = function (f) {
        for (var d = [], g = this.chart.axes.items, e = 0; e < g.length; e++) {
            var h = g[e],
                b = this._getPlotBands(h);
            if (b) {
                a.merge(f, b.shapes);
                a.merge(d, b.texts)
            }
            var c = this._getPlotLines(h);
            if (c) {
                a.merge(f, c.shapes);
                a.merge(d, c.texts)
            }
    ...
    B.prototype._getGridLines = function (a, b, j) {
    ...
    B.prototype._getPlotLines = function (h) {
        var g = h.plotLines;
        if (g == null || a.isArray(g) != true) return null;
        for (var e = this, j = [], k = [], i = 0; i < g.length; i++) {
            var d = new Rb;
            if (!h.isAxisVertical) d.defaults.title.hAlign = "right";
            d.setOptions(g[i]);
            var f = d.lineWidth / 2,
                m = h.getPosition(d.value),
                c = new X(d.title);
            c.chart = this.chart;
            c._measure();
            if (h.isAxisVertical) {
            ...
            var l = new n(x1, y1, x2, y2);
            d._setLineSettings(l);
            j.push(l);
            c._render(k)
        }
        return {
    ...
    B.prototype._getPlotBands = function (g) {
        var k = g.plotBands;
        if (k == null || a.isArray(k) != true) return null;
        for (var l = this, q = [], r = [], p = 0; p < k.length; p++) {
            var d = new Qb;
    ...
    w.prototype.setOptions = function (e) {
        this.items = [];
    ...
    w.prototype._initCategories = function () {
    ...
    w.prototype._initRanges = function () {
        for (var e = h, d = k, c = h, b = k, g = this.items, f = 0; f < g.length; f++) {
            var a = g[f];
            if (e > a.min) e = a.min;
            if (d < a.max) d = a.max;
    ...
    w.prototype._findClusters = function (g, f) {
    ...
    w.prototype._findStackedClusters = function (h, e) {
    ...
    w.prototype._getSeriesFromType = function (e) {
    ...
    w.prototype._getStackedSeriesFromType = function (e, f) {
    ...
    w.prototype._getStackedGroupsFromType = function (c) {
        var b = [];
    ...
    w.prototype.getSeries = function (a) {
        return this.items[a]
    };
    ...
    f.prototype = {
        ...
        _addShapeAnimation: function (e, g, f) {
            ...
            var a = new ob(b, e, "visible", false, true),
                c = a.duration / f,
                d = a.delayTime + g * c;
            a.delayTime = d;
            a.duration = c;
        ...
        _addLengthAnimation: function (b) {
            ...
            var c = new jb(a, b, "length", 0, b.getLength());
        ...
        _setShapeSettings: function (a, c) {
            ...
            a.miterLimit = this.miterLimit;
            a.strokeDashArray = this.strokeDashArray;
            e.setShadows(a, this, this.chart);
        ...
        _initXYData: function () {
            for (var l = this.data, g = h, f = k, e = h, d = k, m = l.length, j = 0; j < m; j++) {
                var i = l[j];
                if (i == null) continue;
                var c = i[0];
                if (e > c) e = c;
        ...
        _initCatValueData: function () {
            for (var j = this.data, i = h, g = k, f = [], l = j.length, e = 0; e < l; e++) {
                var d = j[e];
                if (d == null) {
                    f.push((e + 1).toString());
                    continue
        ...
        _initXYDataRange: function (n, p) {
            for (var m = this.data, i = h, g = k, f = h, e = k, o = m.length, j = 0; j < o; j++) {
                var d = m[j];
        ...
        _initCatValueDataRange: function (j, m) {
            for (var i = this.data, e = h, d = k, c = [], l = i.length, b = 0; b < l; b++) {
                var f = i[b];
                if (f == null) {
                    c.push((b + 1).toString());
                    continue
        ...
        _initVisibleXYData: function () {
            ...
            for (var n = this.data, g = h, f = k, p = n.length, j = 0; j < p; j++) {
                var i = n[j];
                if (i == null) continue;
                var c = i[1];
        ...
        _initVisibleCatValueData: function () {
            ...
            var e = this.realXAxis,
                ...
                j = !b.isNull(n);
            if (!l && !j) return;
            for (var m = this.data, i = h, g = k, p = m.length, d = 0; d < p; d++) {
                var f = m[d];
                if (f == null) continue;
                var c = f;
                if (a.isArray(f)) c = f[1];
                if (b.isNull(c)) continue;
                if (l && d + 1 < o || j && d > n) continue;
                if (i > c) i = c;
                if (g < c) g = c
            }
            this.min = i;
        ...
        _initVisibleCatValueDataRange: function (p, r) {
            ...
            var c = this.realXAxis,
                ...
                i = !b.isNull(m);
            if (!j && !i) return;
            for (var l = this.data, f = h, e = k, q = l.length, a = 0; a < q; a++) {
                var o = l[a];
                if (o == null) continue;
                if (j && a + 1 < n || i && a > m) continue;
                for (var g = p; g < r; g++) {
                    var d = o[g];
                    if (f > d) f = d;
                    if (e < d) e = d
        ...
        _initVisibleXYDataRange: function (q, s) {
            ...
            for (var o = this.data, g = h, f = k, r = o.length, j = 0; j < r; j++) {
                var i = o[j];
                if (i == null) continue;
                var p = i[0];
        ...
        _calcStackedData: function (r, t, s) {
            for (var n = h, m = k, l = h, j = k, g = [], u = r.length, p = {}, f = 0; f < u; f++) {
                var c = r[f];
                if (c == null) {
                    g.push((f + 1).toString());
                    continue
                ...
                if (this.xAxisType == "CategoryAxis")
                    if (a.isArray(c) == false) g.push((f + 1).toString());
                    else g.push(c[0]);
                else {
                    var d = c[0];
                    if (a.type(d) == "date") d = d.getTime();
                    if (l > d) l = d;
                    if (j < d) j = d
                }
                for (var q = this._getXValue(c, f), b = {
                        positive: 0,
                        negative: 0
                    }, e = null, o = t.index - 1; o >= 0; o--) {
                    e = s[o].dataValues[q];
                    if (e) {
            ...
            if (this.xAxisType == "CategoryAxis") i.categories = g;
            else {
                i.minX = l;
                i.maxX = j
            }
        ...
        _calcVisibleStackedData: function (s, w, u) {
            if (this.realYAxis.zoomEnabled) return;
            var e = this.realXAxis,
                j = e.visibleMinimum || e.minimum,
                i = e.visibleMaximum || e.maximum,
                m = !b.isNull(j),
                l = !b.isNull(i);
            if (!m && !l) return;
            if (e.skipEmptyDays) {
                j = e._addEmptyDaysOffset(j);
                i = e._addEmptyDaysOffset(i)
            }
            for (var o = h, n = k, x = s.length, q = {}, g = 0; g < x; g++) {
                var d = s[g];
                if (d == null) continue;
                if (this.xAxisType == "CategoryAxis") {
                    if (m && g + 1 < j || l && g > i) continue
                } else {
                    var t = d[0];
                    if (m && t < j || l && t > i) continue
                }
                for (var r = this._getXValue(d, g), c = {
                        positive: 0,
                        negative: 0
                    }, f = null, p = w.index - 1; p >= 0; p--) {
                    f = u[p].dataValues[r];
                    if (f) {
        ...
        _getDataPointLabel: function (i, j, d, c, f) {
            var g = i >= this.realYAxis.getCrossing(),
                h = this._getLabelText(f),
                b = new q(h);
            e.setShadows(b, this, this.chart);
        ...
        _getPrevStackedPosition: function (c, i, d, h, f, g) {
            for (var b = i - 1; b >= 0; b--) {
                var a = c[b].dataValues[d];
                if (!a) continue;
                var e = this._scaleValue(c, a.value, d);
                if (g) {
                    if (a.value == a.positive) return f.getPosition(e)
                } else if (a.value == a.negative) return f.getPosition(e)
            }
            return h
        },
        ...
        _calcColumnScale: function (k) {
            for (var e = [], b = 0; b < k.length; b++) a.merge(e, k[b].data || []);
            e.sort(function (a, b) {
                return a[0] - b[0]
            });
            for (var c, d, g = h, b = 0; b < e.length - 1; b++) {
                c = e[b][0];
                if (a.type(c) == "date") c = c.getTime();
                d = e[b + 1][0];
                if (a.type(d) == "date") d = d.getTime();
                if (c != d) g = Math.min(g, d - c)
            }
            var i = this.realXAxis,
                j = i.series,
                f = j.maxX - j.minX;
            if (i.skipEmptyDays) f -= i.totalEmptyDaysTicks;
            f = Math.min(.5, g / f);
            return f
        },
        ...
        setOptions: function (c) {
            var b = a.extend({}, this.defaults, c || {});
            a.extend(this, b);
            if (b.markers != null) this.markers = new V(b.markers)
        },
        defaults: {
            nullHandling: "break",
            lineCap: "butt",
    ...
    L.prototype = new f;
    L.constructor = L;
    L.prototype._render = function (b) {
        if (!this.data) return;
        var a = this._getXAxisType();
        this.xAxisType = a;
        switch (a) {
    ...
    L.prototype._renderCatValueData = function (j) {
    ...
    L.prototype._renderXYData = function (i) {
    ...
    L.prototype._renderLargeXYData = function (s) {
    ...
    L.prototype._createShape = function (c, b) {
        var a = new C(c);
    ...
    ab.prototype = new L;
    ab.constructor = ab;
    ab.prototype._createShape = function (i, h) {
        var g = [];
        a.merge(g, i);
        var c = new C(g);
    ...
    ab.prototype._isAnchoredToOrigin = function () {
        return true
    };
    ...
    zb.prototype = new ab;
    zb.constructor = zb;
    zb.prototype._createShape = function (i, h) {
        var g = [];
        a.merge(g, i);
        var d = new v(g);
        this._setShapeSettings(d);
    ...
    p.prototype = new f;
    p.constructor = p;
    p.prototype._createXAxis = function () {
        var b = {
                location: "left",
                orientation: "x"
            },
    ...
    p.prototype._createYAxis = function () {
        var a = new m({
            location: "bottom",
            orientation: "y"
        });
    ...
    p.prototype._findXAxis = function (b) {
        var a = this._findAxis(b, this.axisX);
        if (a != null) return a;
        var c;
        if (this.categories) c = F;
        else c = m;
        for (var d = 0; d < b.length; d++) {
            a = b[d];
    ...
    p.prototype._findYAxis = function (b) {
        var a = this._findAxis(b, this.axisY);
        if (a != null) return a;
        for (var c = 0; c < b.length; c++) {
            a = b[c];
    ...
    p.prototype._render = function (a) {
        if (!this.data) return;
        switch (this.xAxisType) {
            case "LinearAxis":
            case "DateTimeAxis":
    ...
    p.prototype._renderCatData = function (p) {
        ...
        for (var u = [], r = [], C = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, c, l, d = 0; d < m; d++) {
            ...
            if (g == null) continue;
            l = Math.round(this.realXAxis.getCatPosition(F) - o - h);
    ...
    p.prototype._renderLinearData = function (l) {
        var g = this.chart.gridArea,
            w = g.x,
            D = w + g.width,
            d = this.realYAxis.getCrossingPosition();
        d = b.fitInRange(d, w, D);
        d = Math.round(d);
        for (var m = this.data.length, z = g.height / this.realXAxis.getZoom(), C = this._getSeriesFromThisType(), B = this._calcColumnScale(C) * z, o = this.pointWidth * B, t = [], q = [], A = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, c, p, e = 0; e < m; e++) {
            var k = this.data[e];
            ...
            l.push(h);
            this._addAnimation(h, e, m);
            this._addMarkerAndLabel(t, q, y, p, e, m, null, j, A, s)
        }
        a.merge(l, t);
        a.merge(l, q)
    };
    p.prototype._addAnimation = function (d, g, f) {
        var b = this._getAnimation();
        if (!b || b.enabled === false) return;
        var a = new jb(b, d, "xDecrease", d.width, 0),
            c = a.duration / f,
            e = a.delayTime + g * c;
        a.delayTime = e;
        a.duration = c;
    ...
    p.prototype._correctMarkerPosition = function (a, e, d) {
    ...
    p.prototype._getPixelMargins = function (a) {
    ...
    p.prototype._isAnchoredToOrigin = function () {
        return true
    };
    p.prototype._getDataPointLabel = function (k, g, l, f, h) {
    ...
    p.prototype._initColors = function (a) {
        this.fillStyle = this.fillStyle || a
    };
    ...
    Z.prototype = new f;
    Z.constructor = Z;
    Z.prototype._initData = function () {
        if (!this.data) return;
        ...
        if (a.isArray(c) == false) return;
        for (var l = h, j = k, i = h, g = k, e = h, d = k, r = c.length, b = 0; b < r; b++) {
            var n = c[b][0],
                o = c[b][1],
                f = c[b][2];
    ...
    G.prototype = new f;
    G.constructor = G;
    G.prototype._render = function (a) {
        if (!this.data) return;
        switch (this.xAxisType) {
            case "LinearAxis":
            case "DateTimeAxis":
    ...
    G.prototype._renderCatData = function (p) {
        ...
        for (var t = [], r = [], y = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, g, c = 0; c < l; c++) {
            ...
            if (e == null) continue;
            f = Math.round(this.realXAxis.getCatPosition(f) + o);
    ...
    G.prototype._renderLinearData = function (m) {
        var j = this.chart.gridArea,
            z = j.y,
            x = j.y + j.height,
        ...
        c = Math.round(c);
        for (var n = this.data.length, u = j.width / this.realXAxis.getZoom(), y = this._getSeriesFromThisType(), w = this._calcColumnScale(y) * u, o = this.pointWidth * w, r = [], p = [], v = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, e, f, d = 0; d < n; d++) {
            var k = this.data[d];
            if (k == null || a.isArray(k) == false) continue;
            e = k[0];
            var h = k[1];
            ...
            m.push(g);
            this._addAnimation(g, d, n);
            if (this.realYAxis.isValueVisible(h) === false) continue;
            this._addMarkerAndLabel(r, p, e, t, d, n, null, h, v, q)
        }
        a.merge(m, r);
        a.merge(m, p)
    };
    G.prototype._addAnimation = function (d, g, f) {
        var b = this._getAnimation();
        if (!b || b.enabled === false) return;
        var a = new jb(b, d, "yDecrease", d.height, 0),
            c = a.duration / f,
            e = a.delayTime + g * c;
        a.delayTime = e;
        a.duration = c;
    ...
    G.prototype._isAnchoredToOrigin = function () {
        return true
    };
    G.prototype._initColors = function (a) {
        this.fillStyle = this.fillStyle || a
    };
    ...
    A.prototype = new f;
    A.constructor = A;
    A.prototype._initXAxis = function () {};
    A.prototype._initYAxis = function () {};
    A.prototype._initVisibleData = function () {};
    A.prototype._getYValues = function () {
    ...
    A.prototype._render = function (v) {
        if (!this.data) return;
        var k = this.chart.gridArea,
            r = k.width,
            p = k.height,
        ...
        if (h < 0) return;
        for (var y = k.x + r / 2, z = k.y + p / 2, x = Math.PI * 2 / o, f = -Math.PI / 2, m = this.fillStyles, c = 0; c < l; c++) {
            var e = j[c],
                n = 100 * e / o,
                i = f + e * x,
                g = new qb(y, z, h, f, i);
        ...
        for (var f = -Math.PI / 2, c = 0; c < l; c++) {
            ...
            if (e == 0) continue;
            var B = this._getLabelText(s),
                d = new q(B);
            d.textBaseline = "top";
            a.extend(d, this.labels);
            var w = d.measure(this.chart.ctx),
                t = this._getSliceCenter(y, z, (f + i) / 2, h * .6);
            d.x = t.x - w.width / 2;
            d.y = t.y - w.height / 2;
            d.context = {
                chart: this.chart,
    ...
    A.prototype._getSliceCenter = function (c, d, b, a) {
        return {
            x: c + a * Math.cos(b),
            y: d + a * Math.sin(b)
        }
    };
    A.prototype._getLegendItems = function (d) {
        var e = [];
    ...
    A.prototype._initColors = function (b, a) {
        this.palette = a
    };
    A.prototype._getTooltip = function (a) {
        var d = this.chart.stringFormat(a.percentage, "%.2f%%"),
            b = "<b>" + a.value + " (" + d + ")</b><br/>",
            c = a.dataItem[0];
        if (c) b = c + "</br>" + b;
        return b
    };
    A.prototype._addSliceAnimation = function (c, g, f) {
        var b = this._getAnimation();
        if (!b || b.enabled === false) return;
        var a = new jb(b, c, "endAngle", c.startAngle, c.endAngle),
            d = a.duration / f,
            e = a.delayTime + g * d;
        a.delayTime = e;
        a.duration = d;
    ...
    A.prototype.getPercentage = function (b) {
        var a = this.getTotal();
        return 100 * b / a
    };
    ...
    Db.prototype = new L;
    Db.constructor = Db;
    Db.prototype._createShape = function () {
        return null
    };
    ...
    Eb.prototype = new L;
    Eb.constructor = Eb;
    Eb.prototype._createShape = function (c, b) {
        var a = new v(c);
        this._setShapeSettings(a);
        b.push(a);
        this._addLengthAnimation(a);
    ...
    x.prototype._renderCatData = function (w) {
        if (!this.data) return;
        var r = this.chart.gridArea,
            N = r.y,
            M = r.y + r.height,
            h = this.realYAxis.getCrossingPosition();
        h = b.fitInRange(h, N, M);
        h = Math.round(h);
        var c = this.chart.series._findStackedClusters(this, this.type),
            F = this.data.length,
            I = r.width / this.realXAxis.getZoom(),
            D = I / F,
            L = D / c.groupCount,
            m = Math.round(this.pointWidth * L),
            H = c.groupCount * m,
            v = (D - H) / 2;
        v = Math.round(v + c.groupIndex * m);
        for (var C = [], B = [], s = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), J = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, g, d, e = 0; e < F; e++) {
            d = this.data[e];
            if (d == null) continue;
            var q = this._getXValue(d, e);
            d = this.dataValues[q];
            if (d == null) continue;
            var l = this._scaleValue(s, d.value, q);
            f = e;
            f = Math.round(this.realXAxis.getCatPosition(f) + v);
            g = Math.round(this.realYAxis.getPosition(l));
            var o = this._getPrevStackedPosition(s, c.index, q, h, this.realYAxis, l >= 0),
                x = g,
                p;
            if (g <= o) p = o - g;
            else {
            ...
            var n = d.actualValue,
                E = this._getStackedTotal(s, q),
                G = n > 0 ? E.positive : E.negative,
                z = G != 0 ? 100 * Math.abs(n) / Math.abs(G) : 0,
                t = {
                    chart: this.chart,
                    series: this,
                    dataItem: this.data[e],
            ...
            this._setShapeSettings(k, e);
            w.push(k);
            this._addAnimation(k, c.index, c.count);
            f += m / 2;
            if (this.markers && this.realYAxis.isValueVisible(l)) {
                var u = this._getMarker(f, x, null, l);
                u.context = t;
                C.push(u);
                this._addShapeAnimation(u, c.index, c.count)
            }
            if (this.labels && this.labels.visible !== false && d.actualValue != 0) {
                var y = n;
                switch (this.labels.valueType) {
                    case "percentage":
                        y = z
                }
                var A = this.labels.position == "outside",
                    K = A ? J : -p / 2,
                    j = this._getDataPointLabel(d.actualValue, f, x, K, y);
                if (!A) j.textBaseline = "middle";
                j.context = t;
    ...
    x.prototype._renderLinearData = function (u) {
        if (!this.data) return;
        var r = this.chart.gridArea,
            L = r.y,
            I = r.y + r.height,
            h = this.realYAxis.getCrossingPosition();
        h = b.fitInRange(h, L, I);
        h = Math.round(h);
        for (var e = this.chart.series._findStackedClusters(this, this.type), m = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), K = this.data.length, E = r.width / this.realXAxis.getZoom(), H = this._calcColumnScale(m) * E, w = this.pointWidth * H, B = [], A = [], F = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, g, c, d = 0; d < K; d++) {
            c = this.data[d];
            if (c == null) continue;
            var q = this._getXValue(c, d);
            c = this.dataValues[q];
            if (c == null) continue;
            var l = this._scaleValue(m, c.value, q);
            f = this.data[d][0];
            f = this.realXAxis.getCatPosition(f);
            g = Math.round(this.realYAxis.getPosition(l));
            var o = this._getPrevStackedPosition(m, e.index, q, h, this.realYAxis, l >= 0),
                v = g,
                p;
            if (g <= o) p = o - g;
            else {
            ...
            var n = c.actualValue,
                C = this._getStackedTotal(m, q),
                D = n > 0 ? C.positive : C.negative,
                y = D != 0 ? 100 * Math.abs(n) / Math.abs(D) : 0,
                s = {
                    chart: this.chart,
                    series: this,
                    dataItem: this.data[d],
            ...
            if (this.markers && this.realYAxis.isValueVisible(l)) {
                var t = this._getMarker(f, v, null, l);
                t.context = s;
                B.push(t);
                this._addShapeAnimation(t, e.index, e.count)
            }
            if (this.labels && this.labels.visible !== false && c.actualValue != 0) {
                ...
                var z = this.labels.position == "outside",
                    G = z ? F : -p / 2,
                    j = this._getDataPointLabel(c.actualValue, f, v, G, x);
    ...
    y.prototype._renderCatData = function (v) {
        if (!this.data) return;
        var w = this.chart.gridArea,
            F = w.x,
            M = F + w.width,
            k = this.realYAxis.getCrossingPosition();
        k = b.fitInRange(k, F, M);
        k = Math.round(k);
        var c = this.chart.series._findStackedClusters(this, this.type),
            G = this.data.length,
            J = w.height / this.realXAxis.getZoom(),
            D = J / G,
            N = D / c.groupCount,
            h = Math.round(this.pointWidth * N),
            I = c.groupCount * h,
            u = (D - I) / 2;
        u = Math.round(u + c.groupIndex * h);
        for (var C = [], B = [], r = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), K = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, f, j, d, e = 0; e < G; e++) {
            d = this.data[e];
            if (d == null) continue;
            var p = this._getXValue(d, e);
            d = this.dataValues[p];
            if (d == null) continue;
            var m = this._scaleValue(r, d.value, p);
            f = e;
            j = Math.round(this.realXAxis.getCatPosition(f) - u - h);
            f = Math.round(this.realYAxis.getPosition(m));
            var o = this._getPrevStackedPosition(r, c.index, p, k, this.realYAxis, m >= 0),
                x = f,
                q;
            if (f <= o) q = o - f;
            else {
            ...
            var n = d.actualValue,
                E = this._getStackedTotal(r, p),
                H = n > 0 ? E.positive : E.negative,
                z = H != 0 ? 100 * Math.abs(n) / Math.abs(H) : 0,
                s = {
                    chart: this.chart,
                    series: this,
                    dataItem: this.data[e],
            ...
            this._setShapeSettings(l, e);
            v.push(l);
            this._addAnimation(l, c.index, c.count);
            j += h / 2;
            if (this.markers && this.realYAxis.isValueVisible(m)) {
                var t = this._getMarker(x, j, null, m);
                t.context = s;
                C.push(t);
                this._addShapeAnimation(t, c.index, c.count)
            }
            if (this.labels && this.labels.visible !== false && d.actualValue != 0) {
                var y = n;
                switch (this.labels.valueType) {
                ...
                var A = this.labels.position == "outside",
                    L = A ? K : -q / 2,
                    g = this._getDataPointLabel(d.actualValue, x, j, L, y);
                if (!A) {
                ...
                B.push(g);
                this._addShapeAnimation(g, c.index, c.count)
            }
        }
        a.merge(v, C);
        a.merge(v, B)
    };
    y.prototype._renderLinearData = function (t) {
        if (!this.data) return;
        var u = this.chart.gridArea,
            D = u.x,
            K = D + u.width,
            h = this.realYAxis.getCrossingPosition();
        h = b.fitInRange(h, D, K);
        h = Math.round(h);
        for (var q = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), f = this.chart.series._findStackedClusters(this, this.type), M = this.data.length, F = u.height / this.realXAxis.getZoom(), J = this._getSeriesFromThisType(), I = this._calcColumnScale(J) * F, w = this.pointWidth * I, B = [], A = [], G = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, e, l, c, d = 0; d < M; d++) {
            c = this.data[d];
            if (c == null) continue;
            var o = this._getXValue(c, d);
            c = this.dataValues[o];
            if (c == null) continue;
            var k = this._scaleValue(q, c.value, o);
            e = this.data[d][0];
            l = Math.round(this.realXAxis.getCatPosition(e));
            e = Math.round(this.realYAxis.getPosition(k));
            var n = this._getPrevStackedPosition(q, f.index, o, h, this.realYAxis, k >= 0),
                v = e,
                p;
            if (e <= n) p = n - e;
            else {
            ...
            var m = c.actualValue,
                C = this._getStackedTotal(q, o),
                E = m > 0 ? C.positive : C.negative,
                y = E != 0 ? 100 * Math.abs(m) / Math.abs(E) : 0,
                r = {
                    chart: this.chart,
                    series: this,
                    dataItem: this.data[d],
            ...
            if (this.markers && this.realYAxis.isValueVisible(k)) {
                var s = this._getMarker(v, l, null, k);
                s.context = r;
                B.push(s);
                this._addShapeAnimation(s, f.index, f.count)
            }
            if (this.labels && this.labels.visible !== false && c.actualValue != 0) {
                var x = m;
                switch (this.labels.valueType) {
                ...
                var z = this.labels.position == "outside",
                    H = z ? G : -p / 2,
                    g = this._getDataPointLabel(c.actualValue, v, l, H, x);
                if (!z) {
                    g.textBaseline = "middle";
                    g.textAlign = "center"
                }
    ...
    y.prototype._getSeriesFromThisType = function () {
        return this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName)
    };
    ...
    y.prototype._scaleValue = function (b, a) {
        return a
    };
    ...
    db.prototype = new x;
    db.constructor = x;
    db.prototype._initVisibleData = function () {
        x.prototype._initVisibleData.call(this);
        this.min = 0;
        this.max = 100
    };
    db.prototype._getPixelMargins = function (b) {
        if (b.isVertical() || this.data == null) return {
            left: 0,
            right: 0
        };
        var e = 4,
    ...
    db.prototype._scaleValue = function (a, d, b) {
    ...
    db.prototype._getTooltip = function (b) {
        ...
        if (this.title) {
            ...
            a = '<span style="color:' + e + '">' + this.title + "</span>: " + a
        }
        return a
    };
    ...
    eb.prototype = new y;
    eb.constructor = y;
    eb.prototype._initVisibleData = function () {
        y.prototype._initVisibleData.call(this);
        this.min = 0;
        this.max = 100
    };
    eb.prototype._getPixelMargins = function (b) {
        if (b.isVertical() == false || this.data == null) return {
            left: 0,
            right: 0
        };
        var e = 4,
    ...
    eb.prototype._scaleValue = function (a, d, b) {
        var c = this._getStackedTotal(a, b).positive || 1;
        return 100 * d / c
    };
    eb.prototype._getTooltip = function (b) {
        var d = this.chart.stringFormat(b.percentage, "%.2f%%"),
            a = "<b>" + b.value + " (" + d + ")</b><br/>";
        if (this.title) {
            var e = c.getColorFromFillStyle(this.fillStyle);
    ...
    J.prototype._renderCatData = function (u) {
        ...
        for (var o, j, k, n, e, f, a = 0; a < g; a++) {
            ...
            e = h[1];
            f = h[2];
            o = Math.round(this.realXAxis.getCatPosition(n) + d);
    ...
    J.prototype._renderLinearData = function (r) {
        for (var s = this.chart.gridArea, u = this.data.length, m = s.width / this.realXAxis.getZoom(), q = this._getSeriesFromThisType(), n = this._calcColumnScale(q) * m, k = this.pointWidth * n, l, h, j, g, e, f, b = 0; b < u; b++) {
            var c = this.data[b];
            ...
            l = this.realXAxis.getPosition(g);
    ...
    r.prototype = new p;
    r.constructor = r;
    r.prototype._initXYData = function () {
        this._initXYDataRange(1, 3)
    };
    r.prototype._initCatValueData = function () {
        this._initCatValueDataRange(1, 3)
    };
    r.prototype._initDateValueData = function () {
        this._initDateValueDataRange(1, 3)
    };
    r.prototype._initVisibleCatValueData = function () {
        this._initVisibleCatValueDataRange(1, 3)
    };
    r.prototype._initVisibleXYData = function () {
        this._initVisibleXYDataRange(1, 3)
    };
    r.prototype._renderCatData = function (s) {
        ...
        for (var k, l, o, n, f, g, a = 0; a < h; a++) {
            ...
            f = j[1];
            g = j[2];
            o = Math.round(this.realXAxis.getCatPosition(n) - e - d);
            k = Math.round(this.realYAxis.getPosition(f));
    ...
    r.prototype._renderLinearData = function (r) {
        for (var s = this.chart.gridArea, k = this.data.length, n = s.height / this.realXAxis.getZoom(), q = this._getSeriesFromThisType(), p = this._calcColumnScale(q) * n, l = this.pointWidth * p, h, j, m, g, e, f, b = 0; b < k; b++) {
            var c = this.data[b];
            if (c == null || a.isArray(c) == false) continue;
            g = c[0];
            e = c[1];
    ...
    r.prototype._getTooltip = function (b) {
        var a = "From: <b>" + b.from.toString() + "</b></br>To: <b>" + b.to.toString() + "</b>";
        if (this.title) {
            var d = c.getColorFromFillStyle(this.fillStyle);
            a = '<div style="color:' + d + '">' + this.title + "</div>" + a
    ...
    T.prototype._initData = function () {
        r.prototype._initData.call(this);
        var c = this.min,
            b = this.max;
        if (a.type(c) == "date") c = c.getTime();
        if (a.type(b) == "date") b = b.getTime();
    ...
    T.prototype._initVisibleData = function () {
        r.prototype._initVisibleData.call(this);
        var c = this.min,
            b = this.max;
        if (a.type(c) == "date") c = c.getTime();
        if (a.type(b) == "date") b = b.getTime();
    ...
    T.prototype._resolveAxisType = function (a) {
        var b = a.location;
        if (!b) return;
        if (b == "bottom" || b == "top") {
            a.type = "dateTime";
        ...
        r.prototype._resolveAxisType.call(this, a)
    };
    ...
    r.prototype._getTooltip = function (b) {
        var d = this.realYAxis,
            a = "From: " + d._getTooltip(b.from) + "To: " + d._getTooltip(b.to);
        if (this.title) {
            var e = c.getColorFromFillStyle(this.fillStyle);
            a = '<div style="color:' + e + '">' + this.title + "</div>" + a
        }
        return a
    };
    ...
    H.prototype._render = function (p) {
        if (!this.data) return;
        var q = this.chart.gridArea,
            j = this.data.length,
            d, f, h, g, e, l = q.width / this.realXAxis.getZoom(),
            i;
        if (this.xAxisType == "CategoryAxis") i = this.pointWidth * l / j;
        else {
            var n = this._calcColumnScale([this]) * l;
            i = this.pointWidth * n
        }
        for (var c = 0; c < j; c++) {
            var b = this.data[c];
            ...
            var k = this._createShape(d, f, h, g, e, i);
            k.context = o;
    ...
    nb.prototype = new H;
    nb.constructor = nb;
    nb.prototype._setShapeSettings = function (a) {
    ...
    nb.prototype._createShape = function (g, d, f, e, b, c) {
        var a = new fb(g, d, f, e, b, c);
        this._setShapeSettings(a);
        return a
    };
    ...
    E.prototype._render = function (l) {
        if (!this.data) return;
        for (var x = this.data.length, i = this.markers != null && this.markers.isVisible(), u = this.labels != null && this.labels.visible !== false, e = [], j = [], p = [], n = [], v = i ? this.markers.size / 2 : 0, g, h, d, y = this.realYAxis.cx, r = this.realYAxis.cy, c = 0; c < x; c++) {
            var f = this.data[c];
            if (f === null) {
                e.push(null);
                e.push(null);
            ...
            h = r;
            var s = b.rotatePointAt(g, h, w, y, r);
            g = s.x;
            h = s.y;
            e.push(g);
            e.push(h);
            ...
            if (u) {
                var t = this._getLabelValue(d, c),
                    m = this._getDataPointLabel(d, g, h, v, t);
                m.context = o;
                this.chart.elem.trigger("dataPointLabelCreating", m);
                n.push(m)
            }
        }
    ...
    Cb.prototype = new E;
    Cb.constructor = Cb;
    Cb.prototype._createShape = function (b) {
        var a = new Q(b);
        this._setShapeSettings(a);
        return a
    };
    ...
    z.prototype._render = function (m) {
        if (!this.data) return;
        for (var y = this.data.length, h = this.markers != null && this.markers.isVisible(), v = this.labels != null && this.labels.visible !== false, c = [], j = [], q = [], o = [], w = h ? this.markers.size / 2 : 0, f, g, i, d, z = this.realYAxis.cx, s = this.realYAxis.cy, e = 0; e < y; e++) {
            var k = this.data[e];
            if (k === null) {
                c.push(null);
                c.push(null);
            ...
            g = s;
            var t = b.rotatePointAt(f, g, x, z, s);
            f = t.x;
            g = t.y;
            c.push(f);
            c.push(g);
            ...
            if (v) {
                var u = this._getLabelValue(d, e),
                    n = this._getDataPointLabel(d, f, g, w, u);
                n.context = p;
                this.chart.elem.trigger("dataPointLabelCreating", n);
                o.push(n)
            }
        }
    ...
    Bb.prototype = new z;
    Bb.constructor = Bb;
    Bb.prototype._createShape = function (b) {
        var a = new Q(b);
        this._setShapeSettings(a);
        return a
    };
    ...
    ub.prototype = new z;
    ub.constructor = ub;
    ub.prototype._createShape = function () {
        return null
    };
    ...
    R.prototype._initData = function () {
        ...
        this.xAxisType = l;
        for (var j = this.tData = this._getTrendlineResult(), f = h, e = k, d = h, c = k, m = j.length, i = 0; i < m; i++) {
            var g = j[i];
            if (g == null) continue;
            var a = g[0];
            if (d > a) d = a;
    ...
    R.prototype._getTrendlineResult = function () {
    ...
    R.prototype._getRegression = function (m, g) {
    ...
    R.prototype._getLinearRegression = function (a, b) {
        return this._getRegression(a, b)
    };
    R.prototype._getExpRegression = function (d, e) {
        var a = this._getRegression(d, e),
            c = Math.exp(a[0]),
            b = Math.exp(a[1]);
        return [c, b]
    };
    R.prototype._render = function (k) {
        if (!this.data) return;
        var c = this.tData,
            b = [],
            g = 1;
    ...
    K.prototype = new p;
    K.constructor = K;
    K.prototype._render = function (b) {
        if (!this.data) return;
        var a = this._getXAxisType();
        this.xAxisType = a;
        switch (a) {
    ...
    K.prototype._renderCatValueData = function (j) {
        for (var o = this.data.length, f = this.markers != null && this.markers.isVisible(), c = [], i = [], n = [], l = [], q = f ? this.markers.size / 2 : 0, h, k, p, d, e = 0; e < o; e++) {
            var g = this.data[e];
            if (g === null) {
                c.push(null);
    ...
    K.prototype._renderXYData = function (j) {
    ...
    K.prototype._createShape = function (c, b) {
        var a = new C(c);
        this._setShapeSettings(a);
        b.push(a);
        this._addLengthAnimation(a);
    ...
    K.prototype._getPixelMargins = function (a) {
        return f.prototype._getPixelMargins(a)
    };
    ...
    Ab.prototype = new K;
    Ab.constructor = Ab;
    Ab.prototype._createShape = function (c, b) {
        var a = new v(c);
        this._setShapeSettings(a);
        b.push(a);
        this._addLengthAnimation(a);
    ...
    Y.prototype = new K;
    Y.constructor = Y;
    Y.prototype._createShape = function (i, h) {
        var g = [];
        a.merge(g, i);
        var c = new C(g);
        this._setShapeSettings(c);
    ...
    t.prototype._render = function (b) {
        if (!this.data) return;
        var a = this._getXAxisType();
        this.xAxisType = a;
        switch (a) {
    ...
    t.prototype._renderCatValueData = function (k) {
    ...
    t.prototype._renderXYData = function (i) {
    ...
    t.prototype._addMarkersAndLabels = function (g, m, i, p, q, b, h, o, d, e, l) {
        var k = 0,
            r = o ? o : b;
        if (this.markers && this.markers.isVisible()) {
            var f = {
    ...
    t.prototype._getDataPointLabel = function (j, i, d, c, f, g) {
    ...
    xb.prototype = new t;
    xb.constructor = xb;
    xb.prototype._createShape = function (c, d, b) {
        var a = new ib(c, d, true);
        this._setShapeSettings(a);
        b.push(a);
        this._addLengthAnimation(a);
        return a
    ...
    o.prototype._resolveType = function (a) {
        if (a.type) return;
        var b = this.chart.series.items;
        if (b.length < 1) return;
        b[0]._resolveAxisType(a)
    };
    o.prototype._initSeriesAxes = function () {
        var b = [];
    ...
    o.prototype._initRanges = function () {
        for (var b = this.items, a = 0; a < b.length; a++) {
            var c = b[a];
            c._initRange()
        }
    };
    o.prototype._resetWH = function () {
    ...
    o.prototype._getAxesInLoc = function (e) {
    ...
    o.prototype._getVAxes = function () {
        for (var d = [], b = this.items, a = 0; a < b.length; a++) {
            var c = b[a];
    ...
    o.prototype._getHAxes = function () {
        for (var d = [], b = this.items, a = 0; a < b.length; a++) {
            var c = b[a];
    ...
    o.prototype._getTotalWidth = function () {
    ...
    o.prototype._getTotalHeight = function () {
    ...
    o.prototype._updateOrigins = function () {
        for (var b = this.items, a = 0; a < b.length; a++) {
            var c = b[a];
            c._updateOrigin()
        }
    };
    o.prototype._correctOrigins = function () {
        for (var b = this.items, a = 0; a < b.length; a++) {
            var c = b[a];
            c._correctOrigin && c._correctOrigin()
        }
    };
    o.prototype._updateCrossings = function () {
        var d = this.verCrossingAxis,
            c = this.horCrossingAxis;
        if (d)
            for (var e = d.getPosition(d.crossing), f = this._getHAxes(), b = 0; b < f.length; b++) {
                var a = f[b];
                a.crossOffsetY = e - a.y;
                if (a.location == "top") a.crossOffsetY -= a.height
            }
        if (c)
            for (var e = c.getPosition(c.crossing), g = this._getVAxes(), b = 0; b < g.length; b++) {
                var a = g[b];
                a.crossOffsetX = e - a.x;
                if (a.location == "left") a.crossOffsetX -= a.width
            }
    };
    o.prototype._initCrossingAxes = function () {
        for (var g = this._getVAxes(), f = this._getHAxes(), d = null, e = null, a = 0; a < g.length; a++) {
            var c = g[a];
            if (!b.isNull(c.crossing)) {
                e = c;
                break
            }
        }
        ...
        this.horCrossingAxis = d;
        this.verCrossingAxis = e
    };
    o.prototype.getZoomableAxes = function () {
        for (var d = [], b = this.items, a = 0; a < b.length; a++) {
            var c = b[a];
    ...
    l.prototype = new kb;
    l.constructor = l;
    l.prototype._initSeries = function () {
        for (var c = new w(null, this.chart), d = this.chart.series.items, b = 0; b < d.length; b++) {
            var a = d[b];
            (a.realXAxis == this || a.realYAxis == this) && c.items.push(a)
        }
        this.series = c
    };
    l.prototype._setVisibleRanges = function () {
    ...
    l.prototype._moveVisibleRange = function (f, g) {
    ...
    l.prototype._mouseWheelZoom = function (f) {
    ...
    l.prototype._scaleVisibleRange = function (a, f) {
    ...
    l.prototype._scaleToRegion = function (j, k) {
        var c = this.chart.gridArea,
            d = c.fitHor(j.locX),
            f = c.fitVer(j.locY),
            e = c.fitHor(k.locX),
    ...
    l.prototype._sliderZoom = function (a) {
    ...
    l.prototype.getCatPosition = function (a) {
    ...
    F.prototype.getLabel = function (d) {
        ...
        b = b || "";
        return l.prototype.getLabel.call(this, b)
    };
    ...
    m.prototype = new l;
    m.constructor = m;
    m.prototype._initRange = function () {
        var i = this.series;
        i._initRanges();
        var g, c;
        ...
        var p = this._addPlotsInRange(g, c);
        g = p.min;
        c = p.max;
        if (!b.isNull(this.minimum)) g = this.minimum;
        if (!b.isNull(this.maximum)) c = this.maximum;
        if (this.skipEmptyDays) c -= this.totalEmptyDaysTicks;
        var n = Math.abs(c - g);
        if (n == 0) n = 1;
        var m = 0,
            l = 0,
            e = i._getPixelMargins(this);
        if (this.isAxisVertical) {
            e.left = b.isNull(this.bottomMargin) ? e.left + .5 : this.bottomMargin;
            e.right = b.isNull(this.topMargin) ? e.right + .5 : this.topMargin
        } else {
            e.left = b.isNull(this.leftMargin) ? e.left + .5 : this.leftMargin;
            e.right = b.isNull(this.rightMargin) ? e.right + .5 : this.rightMargin
        }
        var o = n / this.length;
        m = o * e.left;
        l = o * e.right;
        if (this.logarithmic === true) {
            m = Math.max(0, b.log(m, this.logBase));
            l = Math.max(0, b.log(l, this.logBase))
        }
        var a = g - m,
            d = c + l,
        ...
        if (this.logarithmic === true) {
            ...
            if (a < q) a = q;
            a = b.log(a, this.logBase);
            d = b.log(d, this.logBase);
            var j = this._calculateActualIntervalLogarithmic(a, d);
            a = b.round(Math.floor(a / j) * j);
            d = b.round(Math.ceil(d / j) * j)
        }
        this._setMinMax(a, d);
        this._setVisibleRanges();
    ...
    m.prototype._addPlotsInRange = function (b, a) {
    ...
    m.prototype._calculateActualIntervalLogarithmic = function (e, d) {
        if (this.interval) return this.interval;
        var c = (d - e) / 3,
    ...
    m.prototype._getIntervals = function (c, a, h) {
        if (this.logarithmic === false) return l.prototype._getIntervals.call(this, c, a);
    ...
    m.prototype._getLogarithmicMinorIntervals = function (m, k) {
    ...
    m.prototype._getIntervalCount = function () {
        return Math.ceil(this.actualMaximum - this.actualMinimum)
    };
    m.prototype.getCrossingPosition = function () {
        return this.getPosition(this.getCrossing())
    };
    m.prototype.getOrientation = function (b) {
    ...
    m.prototype.getPosition = function (a) {
        if (this.logarithmic == true) a = b.log(a, this.logBase);
        var c = l.prototype.getPosition.call(this, a);
        return c
    };

    function j(c) {
        var b = a.jqChartDateFormat.masks,
            d = a.extend(true, {}, this.defaults, {
                labels: {
    ...
    j.prototype._initRange = function () {
        ...
        m.prototype._initRange.call(this);
    ...
    j.prototype._getIntervalStart = function (j, b, e) {
        if (e == null) return j;
        var a = new Date(j);
        if (b > 0 && b != 1)
    ...
    j.prototype._getIntervals = function (f, c) {
        var i = [],
    ...
    j.prototype.getPosition = function (b) {
        ...
        var d = m.prototype.getPosition.call(this, b - c);
        return d
    };
    ...
    s.prototype._getTickMarks = function (a, k) {
    ...
    s.prototype._getGridLines = function (a, g) {
        if (a == null || a.visible != true) return [];
    ...
    s.prototype._render = function (d) {
    ...
    s.prototype._getRenderShape = function (b) {
        var d = this.getPosition(b),
            a = d - this.origin + this.extent,
            c = this._createRenderShape(this.cx - a, this.cy - a, a);
        return c
    };
    s.prototype._createRenderShape = function (f, g, e) {
        var a = this.sharedAxis;
        if (this.renderStyle != "polygon") {
            if (!b.isNull(a.startAngle) && !b.isNull(a.endAngle)) {
                var j = b.radians(a.startAngle) - Math.PI / 2,
                    k = b.radians(a.endAngle) - Math.PI / 2;
                return new Jb(f, g, e, j, k)
            }
            return new bb(f, g, e)
        }
        for (var c = [], h = this.sharedAxis.actualMaximum, l = 2 * Math.PI / h, f = this.cx, g = this.cy - e, d = 0; d < h; d++) {
            var i = b.rotatePointAt(f, g, d * l, this.cx, this.cy);
            c.push(i.x);
            c.push(i.y)
        }
        return new Q(c)
    ...
    I.prototype._updateOrigin = function () {
        this.origin = this.cx;
        this.length = 2 * Math.PI * this.radius
    };
    I.prototype._correctOrigin = function () {
    ...
    I.prototype._getAngle = function (b) {
    ...
    I.prototype._getLabels = function () {
        var f = this.labels;
    ...
    I.prototype._render = function (m) {
        var f = [],
            g = this.actualMaximum;
        if (g == 0) return;
    ...
    D.prototype._render = function (o) {
        ...
        for (var t = d, u = e - this.radius, p = this.renderLinesOverGraph, j = this._getIntervals(this.actualInterval), q = this._getIntervalsLength(j), g = 0; g < q; g++) {
            var r = j[g],
                i = this._getAngle(r) + Math.PI / 2,
                k = b.rotatePointAt(s, m, i, d, e),
                l = b.rotatePointAt(t, u, i, d, e),
                c = new n(k.x, k.y, l.x, l.y);
            c.strokeStyle = this.strokeStyle;
            c.lineWidth = this.lineWidth;
            c.strokeDashArray = this.strokeDashArray;
