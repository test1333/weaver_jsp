...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/hsproject/project/view/hs-prj-change-record-list.jsp" method=post>
		...
		<%
		String backfields = "rownum,id,bgzds,prjid,projecttype,operater,changedate,changetime ";
		String fromSql  =  " from (select * from uf_prj_changerecord where prjid='"+prjid+"' and (status ='0' or status = '' or status is null) order by id desc) t1";
		String sqlWhere =  " 1=1 ";
		...
		if("1".equals(canSeeChange)){
           operateString = "<operates width=\"20%\">"+
							...
							"     <operate isalwaysshow=\"true\" href=\"javascript:deleteChange();\" linkkey=\"id\" linkvaluecolumn=\"id\" text=\"删除\" index=\"1\"/> "+
		...
		"			<head>";
				tableString +="<col width=\"6%\" text=\"序号\" column=\"rownum\" orderkey=\"rownum\" />"+
						"<col width=\"40%\" text=\"变更字段\" column=\"bgzds\" orderkey=\"bgzds\"  linkvaluecolumn=\"id\" linkkey=\"billid\" href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=765&amp;formId=-2542&amp;opentype=0&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\" />"+ 				
	...
	<script type="text/javascript">
		...
		function refersh() {
  		...
  		function addchange(){
  			...
  			var prjtype="<%=prjtype%>";
		    var title = "";
      	    var url = "/formmode/view/AddFormMode.jsp?mainid=0&modeId=765&formId=-2542&type=1&field107373="+prjid+"&field107365="+prjtype;                    
  		...
  		function deleteChange(id){
			...
			if (null != xhr) {
			xhr.open("GET","/hsproject/project/aciton/delete-changerecord.jsp?recordid="+id, false);
