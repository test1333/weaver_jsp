...
<script type="text/javascript" src="/js/swfupload/handlers_wev8.js"></script>
	...
	String isxmjl = Util.null2String(request.getParameter("isxmjl"));
	...
	<BODY>
		...
		<FORM id=report name=report action="/hsproject/project/aciton/submit-project-info.jsp" method=post enctype="multipart/form-data">
			...
			<%
				if("1".equals(isxmjl)){
			%>
			<input type="hidden" name="submitType_mt" id="submitType_mt"  value="edit2">
			<%		
				}else{
			%>
			...
			<%
					for(ProjectFieldBean pfb:pfblist){
						...
						if((!"1".equals(isxmjl) && "manager".equals(pfb.getFieldname()))||"members".equals(pfb.getFieldname())){
