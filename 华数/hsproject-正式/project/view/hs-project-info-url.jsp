...
<%
  ...
  if(userid1 == 1){
    ...
    url_3 = "/hsproject/project/view/hs-prj-change-record-list.jsp?prjid="+prjid+"&prjtype="+prjtype+"&canSeeChange="+canSeeChange;
  ...
  String url_9 = "/hsproject/project/view/hs-prj-purchase-money-list.jsp?prjid="+prjid;
%>
	...
	<div class="e8_box demo2">
		<div class="e8_boxhead">
		    ...
		    <ul class="tab_menu">
		       <li class="current">
				...
				<li>
					<a target="tabcontentframe" href="<%=url_9%>">项目申购列表<span id="allNum_span"></span></a>
				</li>
				<li>
	    ...
	    <div class="tab_box">
	        <div>
				 ...
				 <iframe src="<%=url_9 %>" onload="update()" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
