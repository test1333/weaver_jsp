...
<%
	...
	for(ProjectFieldBean pfb:pfblist){
		...
		if("0".equals(isCommon)){
			if("edit1".equals(submitType_mt) || "edit2".equals(submitType_mt)){
	...
	if("add".equals(submitType_mt)){
		...
		pii.editProjectInfo(pidComMap,pidDefMap,prjid,""+userid,"0");
	}else if("edit1".equals(submitType_mt)){
		pii.editProjectInfo(pidComMap,pidDefMap,prjid,""+userid,"1");
	}else if("edit2".equals(submitType_mt)){
		pii.editProjectInfo(pidComMap,pidDefMap,prjid,""+userid,"2");
	}
