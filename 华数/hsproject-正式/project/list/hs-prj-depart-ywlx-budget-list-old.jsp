...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<%
		String backfields = "id,year,department,(select typename from uf_prj_businesstype where id=a.businesstype) as businesstype,budget,(select isnull(sum(isnull(t3.usedmoney,0)),0) from hs_projectinfo t,uf_project_type t1,uf_prj_usedmoney t2,uf_prj_usedmoney_dt1 t3 where  t.id=t2.prjid and t2.id=t3.mainid and t3.year=a.year and t.prjtype=t1.id and t.belongdepart=a.department and t1.businesstype=a.businesstype) as amount";
		String fromSql  =  " from uf_prj_depbudget a";
		String sqlWhere =  " 1=1  ";
		if(userid !=1){
		...
		"			<head>";
				tableString +="<col width=\"20%\" text=\"年份\" column=\"year\" orderkey=\"year\" />"+ 
                		...
                		"<col width=\"20%\" text=\"业务类型\" column=\"businesstype\" orderkey=\"businesstype\" />"+ 
                		"<col width=\"20%\" text=\"预算总额\" column=\"budget\" orderkey=\"budget\" />"+ 
                		"<col width=\"20%\" text=\"实际发生额\" column=\"amount\" orderkey=\"amount\" linkvaluecolumn=\"id\" linkkey=\"ysid\" href= \"/hsproject/project/list/hs-prj-depart-ywlx-budget-list-detail-Url.jsp\" target=\"_fullwindow\"/>"+                               
						"</head>"+
		 "</table>";
	//showExpExcel="false"
	%>
