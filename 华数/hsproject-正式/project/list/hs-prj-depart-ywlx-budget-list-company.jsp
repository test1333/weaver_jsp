...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	boolean flagaccount = weaver.general.GCONST.getMOREACCOUNTLANDING();
	 ...
	 String out_pageId = "bmys_yw01-company_"+subcompany;
	...
	<BODY>
		...
		<FORM id=report name=report action="/hsproject/project/list/hs-prj-depart-ywlx-budget-list-company.jsp" method=post>
		...
		String fromSql  =  " from (select * from uf_prj_depbudget where company='"+subcompany+"' order by department asc,id desc) a";
		String sqlWhere =  " 1=1  ";
		...
		"			<head>";
				tableString +="<col width=\"6%\" text=\"序号\" column=\"rownum\" orderkey=\"rownum\" />"+
						...
						"<col width=\"10%\" text=\"部门\" column=\"department\" orderkey=\"department\" transmethod=\"weaver.hrm.company.DepartmentComInfo.getDepartmentname\" />"+
						...
						"<col width=\"19%\" text=\"实际发生额(获取)\" column=\"amounthq\" orderkey=\"amounthq\" linkvaluecolumn=\"id\" linkkey=\"ysid\" href= \"/hsproject/project/list/hs-prj-depart-ywlx-budget-list-detail-Url.jsp\" target=\"_fullwindow\"/>"+
						"</head>"+
		 "</table>";
	//showExpExcel="false"
	%>
