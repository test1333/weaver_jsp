...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/hsproject/project/list/hs-self-project-list.jsp" method=post>
		...
		String sqlWhere =  " 1=1 and (manager='"+userid+"' or ','||members||',' like '%,"+userid+",%')";
		if(!"".equals(prjname)){
