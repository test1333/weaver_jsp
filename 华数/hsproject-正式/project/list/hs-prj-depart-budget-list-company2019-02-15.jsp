...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<%
		String backfields = "rownum,id,year,department,budget,amount,case when nvl(budget,0) =0 then 0 else round(nvl(amount,0)/budget,2)*100 end||'%' as fsl";
		...
		"			<head>";
				tableString +="<col width=\"6%\" text=\"序号\" column=\"rownum\" orderkey=\"rownum\" />"+
						"<col width=\"20%\" text=\"年份\" column=\"year\" orderkey=\"year\" />"+ 
						...
						"<col width=\"20%\" text=\"发生率\" column=\"fsl\" orderkey=\"fsl\" />"+   
						"</head>"+
		 "</table>";
	//showExpExcel="false"
	%>
