...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	Map<String, String> countMap = pii.getPersonPrjCount(String.valueOf(userid));
	...
	<BODY>
		...
		<FORM id=report name=report action="/hsproject/project/list/hs-project-list.jsp" method=post>
			...
			<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;">
				...
				<wea:group context="查询条件">
					...
					<wea:item>
					<brow:browser viewType="0"  name="xmjl" browserValue="<%=xmjl %>"
					browserOnClick=""
					browserUrl="/systeminfo/BrowserMain.jsp?url=/hrm/resource/ResourceBrowser.jsp?selectedids="
					hasInput="true" isSingle="false" hasBrowser = "true" isMustInput='1'
					completeUrl="/data.jsp" width="165px"
					browserSpanValue="<%=Util.toScreen(ResourceComInfo.getResourcename(xmjl),user.getLanguage())%>">
					</brow:browser>
					</wea:item>
			...
			<div>
			<span>&nbsp;&nbsp;登入人项目总数:<%=countMap.get("xmzs")%>&nbsp;&nbsp;&nbsp;&nbsp;在建项目总数:<%=countMap.get("zjxms")%>&nbsp;&nbsp;&nbsp;&nbsp;异常项目总数:<%=countMap.get("ycxmzs")%></span>
			</div>
		</FORM>
		<%
		...
		"			<head>";
				...
				"<col width=\"12%\" text=\"项目名称\" column=\"name\" orderkey=\"name\"  otherpara=\"column:id\"  transmethod='hsproject.util.TransUtil.getPrjNameForColor' linkvaluecolumn=\"id\" linkkey=\"id\" href= \"/hsproject/project/view/hs-project-info-url.jsp\" target=\"_fullwindow\"/>"+ 
						"<col width=\"10%\" text=\"项目编号\" column=\"procode\" orderkey=\"procode\" />"+
                		...
                		"<col width=\"12%\" text=\"项目预算\" column=\"prjbudget\" orderkey=\"prjbudget\" />"+
                		"<col width=\"10%\" text=\"项目开始时间\" column=\"begindate\" orderkey=\"begindate\" />"+
                		"<col width=\"10%\" text=\"项目结束时间\" column=\"enddate\" orderkey=\"enddate\" />"+
                		"<col width=\"12%\" text=\"项目状态\" column=\"status\" orderkey=\"status\" />"+
                		"<col width=\"10%\" text=\"是否延期\" column=\"isdelay\" orderkey=\"isdelay\"  />"+
