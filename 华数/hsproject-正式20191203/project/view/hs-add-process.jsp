		...
		<FORM id=report name=report action="/hsproject/project/aciton/submit-process-info.jsp" method=post enctype="multipart/form-data">
			...
			<%	
					...
					<%
							...
							}else if("processtype".equals(pfb.getFieldname())){
								fieldValue = biu.getProcessType(processtype);

							}else if("prjid".equals(pfb.getFieldname())){
								fieldValue = new ProjectInfoDao().getPrjName(prjid);

							}else{
								fieldValue = etm.doProcessEditTrans(pfb,"");
