	...
	<script type="text/javascript">
		...
		function refersh() {
  		...
  		function editmoney() { 
			...
			var url = "";
			if(billid != "-1"){
				url="/formmode/view/AddFormMode.jsp?type=2&modeId=793&formId=-2550&billid="+billid+"&opentype=0";
			}else{
				url="/formmode/view/AddFormMode.jsp?type=1&modeId=793&formId=-2550&opentype=0&field107424="+prjid+"&field107427="+procode;
			}
