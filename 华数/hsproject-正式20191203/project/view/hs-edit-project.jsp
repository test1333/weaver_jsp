					...
					%>
								...
								<%
									if(!"".equals(attach)){
											...
											String fileName="";
											String fileId="";
											sql = "select a.docid,b.imagefileid,b.imagefilename from docimagefile a,imagefile b where a.imagefileid=b.imagefileid and a.docid in ("+ attach + ")";
											rs.execute(sql);
											while (rs.next()) {
								...
								%>
								 ...
								 <a target="_blank" href="/weaver/weaver.file.FileDownload?fileid=<%=fileId%>&download=1"><%=fileName%></a>&nbsp&nbsp
