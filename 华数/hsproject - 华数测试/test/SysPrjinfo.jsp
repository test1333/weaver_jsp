...
<%@ page import="hsproject.util.SysnProjectInfo2" %>
...
<%
	...
	RCMenu += "{同步项目数据,javascript:onCheckup1(),_self} " ;
	RCMenuHeight += RCMenuHeightStep ;

%>
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
	<FORM id=report name=report action=/hsproject/test/SysPrjinfo.jsp method=post>
		...
		if("1".equals(multiIds)){
				SysnProjectInfo2 pid = new SysnProjectInfo2();
	  			pid.sysnprj();
	  			pid.sysprocess();
	  			pid.sysndoc();
			boolean isOver = true;
...
<wea:group context="同步项目数据" attributes="test">
