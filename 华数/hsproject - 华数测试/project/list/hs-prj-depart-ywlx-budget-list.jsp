...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<%
		String backfields = "rownum,id,year,department,(select typename from uf_prj_businesstype where id=a.businesstype) as businesstype,budget,amount";
		String fromSql  =  " from (select * from uf_prj_depbudget order by id desc) a";
		String sqlWhere =  " 1=1  ";
		if(userid !=1){
