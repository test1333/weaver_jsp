...
<%
	...
	url_1 = "/hsproject/project/list/hs-project-yq-list-company.jsp?subcompany="+subcompany;
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">延期项目信息列表</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       <li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">延期项目信息列表<span id="allNum_span"></span></a>
				</li>
