...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "bmys_ywdetail02";
	...
	<BODY>
		...
		String sqlWhere =  " t.id=t2.prjid and t2.id=t3.mainid and t.prjtype=t1.id and t.belongdepart='"+department+"' and t1.businesstype='"+businesstype+"' and t3.year='"+year+"' and isnull(t3.usedmoney,0)>0 ";
