...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/hsproject/project/view/hs-prj-usedmoney-list.jsp" method=post>
		...
		<%
		String backfields = "rownum,id,year,usedmoney ";
		String fromSql  =  " from  (select * from uf_prj_usedmoney_dt1 where mainid='"+mainid+"' order by id asc) t1";
		String sqlWhere =  " 1=1 ";
		...
		String operateString= "";
		  tableString =" <table tabletype=\"none\" pagesize=\""+ PageIdConst.getPageSize(out_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+out_pageId+"\" >"+         
				   "	   <sql backfields=\""+backfields+"\" sqlform=\""+fromSql+"\" sqlwhere=\""+Util.toHtmlForSplitPage(sqlWhere)+"\"  sqlorderby=\""+orderby+"\"  sqlprimarykey=\"id\" sqlsortway=\"asc\" sqlisdistinct=\"false\" sumColumns=\"usedmoney\" showCountColumn=\"true\" decimalFormat=\"%,.2f\" />"+
		operateString+
		"			<head>";
	...
	<script type="text/javascript">
		...
		function refersh() {
  		...
  		function editmoney() { 
			...
			var url = "";
			if(billid != "-1"){
				url="/formmode/view/AddFormMode.jsp?type=2&modeId=566&formId=-2406&billid="+billid+"&opentype=0";
			}else{
				url="/formmode/view/AddFormMode.jsp?type=1&modeId=566&formId=-2406&opentype=0&field100929="+prjid+"&field100930="+procode;
			}
