...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		String fromSql  =  " from (select * from uf_prj_changerecord where prjid='"+prjid+"' order by id desc) t1";
		String sqlWhere =  " 1=1 ";
		...
		"			<head>";
				tableString +="<col width=\"6%\" text=\"序号\" column=\"rownum\" orderkey=\"rownum\" />"+
						"<col width=\"40%\" text=\"变更字段\" column=\"bgzds\" orderkey=\"bgzds\"  linkvaluecolumn=\"id\" linkkey=\"billid\" href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=560&amp;formId=-2403&amp;opentype=0&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\" />"+ 				
	...
	<script type="text/javascript">
		...
		function refersh() {
  		...
  		function addchange(){
  			...
  			var prjtype="<%=prjtype%>";
		    var title = "";
      	    var url = "/formmode/view/AddFormMode.jsp?mainid=0&modeId=560&formId=-2403&type=1&field100916="+prjid+"&field100910="+prjtype;                    
