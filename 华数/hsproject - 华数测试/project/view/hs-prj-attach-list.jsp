...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		String sqlWhere =  " 1=1 and docid in("+docids+")";
		...
		"			<head>";
				tableString +="<col width=\"6%\" text=\"序号\" column=\"rownum\" orderkey=\"rownum\" />"+
                		...
                		"<col width=\"30%\" text=\"阶段名称\" column=\"docid\" orderkey=\"docid\" transmethod='hsproject.impl.ProcessInfoImpl.getProcessName' />"+                                  
						"</head>"+
		 "</table>";
	//showExpExcel="false"
	%>
	...
	<script type="text/javascript">
		...
		function downloadDocImgsSingle(id,docid){
			...
			window.open("/weaver/weaver.file.FileDownload?fieldvalue="+docid+"&fileid="+id+"&download=1&downloadBatch=0&requestid=&votingId=0");
