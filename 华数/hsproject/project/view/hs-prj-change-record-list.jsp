...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/hsproject/project/list/hs-prj-change-record-list.jsp" method=post>
		...
		<%
		String backfields = "id,bgzds,prjid,projecttype,operater,changedate,changetime ";
		String fromSql  =  " from uf_prj_changerecord ";
		...
		operateString+
		"			<head>";
				tableString +="<col width=\"40%\" text=\"变更字段\" column=\"bgzds\" orderkey=\"bgzds\"  linkvaluecolumn=\"id\" linkkey=\"billid\" href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=243&amp;formId=-401&amp;opentype=0&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\" />"+ 				
	...
	<script type="text/javascript">
		...
		function refersh() {
  		...
  		function addchange(){
  			...
  			var prjtype="<%=prjtype%>";
		    var title = "";
      	    var url = "/formmode/view/AddFormMode.jsp?mainid=0&modeId=243&formId=-401&type=1&field16033="+prjid+"&field16039="+prjtype;                    
