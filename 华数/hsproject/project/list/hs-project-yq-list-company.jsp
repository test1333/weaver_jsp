...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "hsxmlbcompyq_"+subcompany;
	...
	<BODY>
		...
		<%
		String backfields = "id,name, procode,prjtype,manager,members,begindate,enddate,status,belongdepart,belongCompany";
