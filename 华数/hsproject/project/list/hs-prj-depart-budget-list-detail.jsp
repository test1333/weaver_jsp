...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "bmys_detail02";
    String ysid = Util.null2String(request.getParameter("ysid"));
    String year = "";
    String department = "";
    String businesstype = "";
    String sql = "select year,department,businesstype from uf_prj_depbudget where id="+ysid;
    rs.executeSql(sql);
    if(rs.next()){
	...
	<BODY>
		...
		String sqlWhere =  " t.id=t2.prjid and t2.id=t3.mainid and t.prjtype=t1.id and t.belongdepart='"+department+"' and t3.year='"+year+"' and isnull(t3.usedmoney,0)>0 ";
		...
		operateString+
		"			<head>";
				tableString +="<col width=\"20%\" text=\"项目名称\" column=\"name\" orderkey=\"name\" />"+ 
						"<col width=\"20%\" text=\"项目编号\" column=\"procode\" orderkey=\"procode\" />"+
