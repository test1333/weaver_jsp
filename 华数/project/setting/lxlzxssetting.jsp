...
<input type=hidden name=method value="lxlzxssetting"/>
		...
		<table class=ViewForm>
         ...
         <table class=ViewForm id="catalogTable">
			...
			<TR class=Spacing>
             ...
             <%
             int i = -1; 
             rs.executeSql("Select * From formtable_main_245_dt1  order by id asc ");
             while(rs.next()) {  
            	 i++;
            	 String id = rs.getString("id"); 
            	 String lzmc = rs.getString("lzmc");   
             ...
             <tr>
				...
				<td width="30%"> 
					  <INPUT class="inputStyle" type="text"  name=lzmc value="<%=lzmc%>"> 
				</td>  
				<td  width="30%">
				 <INPUT class="inputStyle" type="text"  name=px value="<%=px%>"> 
					</td>
				<%-- <td width="30%">
...
<tr>
	...
	<td width="50%"> 
		<INPUT type=text class="inputStyle"   name=lzmc value="">
	</td>  
	 <td width="30%">
			<INPUT class="inputStyle"  type="text"  name=px >
				</td>
	<!--<td width="30%">
...
function doSave() {
	...
	document.getElementById("rownum").value=rows;
	weaver.submit();
}
