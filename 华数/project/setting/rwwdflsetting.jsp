...
<input type=hidden name=method value="rwwdflsetting"/>
		...
		<table class=ViewForm>
         ...
         <table class=ViewForm id="catalogTable">
			...
			<TR class=Spacing> 
             ...
             <%
             int i = -1; 
             rs.executeSql("Select * From formtable_main_248_dt1  order by id asc ");
             while(rs.next()) {  
            	 i++;
            	 String id = rs.getString("id"); 
            	 String flmc = rs.getString("flmc");  
            	 String xh = rs.getString("sx");  
             %>
             <tr>
				<td width="10">
				...
				<td width="30%"> 
					  <INPUT class="inputStyle" id="flmc<%=i%>" type="text" name=flmc value="<%=flmc %>" >
				</td>  
				 <td  width="30%">
					<INPUT class="inputStyle" id="xh<%=i%>" type="text" name=sx value="<%=xh %>" >
				</td>
				<%--<td width="30%">
...
<tr>
	...
	<td width="50%"> 
		<INPUT class="inputStyle" id="flmc##row##" type="text"  name=flmc >
	</td>  
	 <td width="30%">
