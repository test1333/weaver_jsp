...
<input type=hidden name=method value="mrlcbsetting"/>
		...
		<table class=ViewForm>
         ...
         <table class=ViewForm id="catalogTable">
			...
			<TR class=Spacing> 
             ...
             <%
             int i = -1; 
             rs.executeSql("Select * From formtable_main_246_dt1  order by id asc ");
             while(rs.next()) {  
            	 i++;
            	 String id = rs.getString("id"); 
            	 String lcbmc = rs.getString("lcbmc");  
             ...
             <tr>
				...
				<td width="30%"> 
					  <INPUT class="inputStyle" id="lcbmc<%=i%>" type="text" name=lcbmc value="<%=lcbmc %>" >
				</td>  
				 <td  width="30%">
					<INPUT class="inputStyle" id="xh<%=i%>" type="text" name=xh value="<%=xh %>" >
				</td>
				<%--<td width="30%">
...
<tr>
	...
	<td width="50%"> 
		<INPUT class="inputStyle" id="lcbmc##row##" type="text"  name=lcbmc >
	</td>  
	 <td width="30%">
			<INPUT class="inputStyle" id="xh##row##" type="text"  name=xh>
				</td>
	<!--<td width="30%">
