...
er.addStringValue("日期", "Header");  
er.addStringValue("里程碑数", "Header"); 
er.addStringValue("关注数", "Header");  
er.addStringValue("1月", "Header"); 
er.addStringValue("2月", "Header");  
er.addStringValue("3月", "Header"); 
er.addStringValue("4月", "Header"); 
er.addStringValue("5月", "Header"); 
er.addStringValue("6月", "Header"); 
er.addStringValue("7月", "Header"); 
er.addStringValue("8月", "Header"); 
er.addStringValue("9月", "Header"); 
er.addStringValue("10月", "Header"); 
er.addStringValue("11月", "Header"); 
er.addStringValue("12月", "Header"); 
 
while(RecordSet.next()){ 
	er = es.newExcelRow();
	String tprojid=RecordSet.getString("id");
	...
	er.addStringValue(ProjectTransMethod.getStoneAcountNoHref(Util.null2String(tprojid)), "Border");
	er.addStringValue(ProjectTransMethod.getAttentionAcountNoHref(Util.null2String(tprojid)), "Border");  
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"1"), "Border");  
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"2"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"3"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"4"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"5"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"6"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"7"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"8"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"9"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"10"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"11"), "Border"); 
	er.addStringValue(ProjectTransMethod.getStoneNamesNoHref(tprojid,"12"), "Border");   
	 
}
ExcelFile.setFilename("项目里程碑列表导出"); 
ExcelFile.addSheet("项目里程碑列表", es); 
%>
