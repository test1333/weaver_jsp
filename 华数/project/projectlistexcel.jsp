...
//RCMenu += "{导出Excel,javascript:OnExportExcel(),_self}" ;
//RCMenuHeight += RCMenuHeightStep ; 
...
<input name=start type=hidden value="<%=start%>">
 ...
 <TABLE width="100%">
     ...
     tableString+=" <col width=\"6%\"  text=\"项目经理\" column=\"xmjlname\"   orderkey=\"t1.xmjlname\"     />"; 
...
function OnExportExcel(){ 
		window.open("projectlistexcel.jsp?sqlwhere=<%=java.net.URLEncoder.encode(sqlWhere) %>");  
}
