...
RCMenuHeight += RCMenuHeightStep ;
%>
	<BUTTON class=btnDelete id=Delete accessKey=D  style="display:none" id=domysave  onclick='if(isdel()){ondelete();}'><U>D</U>-<%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></BUTTON>
<%}%>
</DIV>
	...
	<TD vAlign=top>
	  ...
	  <TABLE class=ViewForm>
        ...
        <TR>
          ...
          <TD class=Field>
            <INPUT class=InputStyle maxLength=50 name="Name"  onchange='checkinput("Name","Nameimage"),checkCustomerNameFun()' value="<%=Util.toScreenToEdit(RecordSet.getString("name"),user.getLanguage())%>" SIZE="35">
        ...
        <TR>
          ...
          <TD class=Field>
            ...
            <SPAN id=Abbrevimage><%if(RecordSet.getString("engname").equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN>
          </TD>
        </TR><tr><td class=Line colspan=2></td></tr>        
        <TR>
          ...
          <TD class=Field>
            ...
            <SPAN id=Address1image>
                <%if(RecordSet.getString("address1").equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%>
            </SPAN>
          </TD>
        </TR><tr><td class=Line colspan=2></td></tr>        
        <TR>
        ...
        <TR>
          ...
          <TD class=Field>
            ...
            <SPAN id=Emailimage>
                <%if(RecordSet.getString("email").equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%>
            </SPAN>
          </TD>
        </TR><tr><td class=Line colspan=2></td></tr>        
        <TR>
...
%>
	  ...
	  <!--TABLE class=ViewForm>
        ...
        <TR class=Spacing>
          <TD class=Line1 colSpan=2></TD></TR><tr><td class=Line colspan=2></td></tr>
		<TR>
...
-->
		...
		<TR>
          ...
          <BUTTON class=Browser onClick="onShowTypeID()"></BUTTON> 
              ...
              <SPAN id=Typespan>
              	<%if(RecordSet.getString("type").equals("")||RecordSet.getString("type").equals("0")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%>
        ...
        <TR>
          ...
          <BUTTON class=Browser onClick="onShowDescriptionID()"></BUTTON> 
              <SPAN id=Descriptionspan>
                <%if(RecordSet.getString("description").equals("")||RecordSet.getString("description").equals("0")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%>
                <%=Util.toScreen(CustomerDescComInfo.getCustomerDescname(RecordSet.getString("description")),user.getLanguage())%>
              </SPAN> 
              <INPUT type=hidden name=Description value=<%=RecordSet.getString("description")%>></TD>
         </TR><tr><td class=Line colspan=2></td></tr>        
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(576,user.getLanguage())%></TD>
          <TD class=Field><BUTTON class=Browser onClick="onShowSizeID()"></BUTTON> 
              <SPAN id=Sizespan>
                <%if(RecordSet.getString("size_n").equals("")||RecordSet.getString("size_n").equals("0")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%>
                <%=Util.toScreen(CustomerSizeComInfo.getCustomerSizedesc(RecordSet.getString("size_n")),user.getLanguage())%>
              </SPAN> 
        ...
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser onClick="onShowSourceID()"></BUTTON> 
              <SPAN id=Sourcespan>
                <%if(RecordSet.getString("source").equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%>
                <%=Util.toScreen(ContactWayComInfo.getContactWayname(RecordSet.getString("source")),user.getLanguage())%>
              </SPAN> 
              <INPUT type=hidden name=Source value=<%=RecordSet.getString("source")%>></TD>
        </TR><tr><td class=Line colspan=2></td></tr>        
        <TR>
          ...
          <BUTTON class=Browser onClick="onShowSectorID()"></BUTTON> 
              <SPAN id=Sectorspan>
                ...
                %>
                <%if(seclist.equals("")||seclist.equals("0")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%>
                <%=seclist%>
              </SPAN> 
              <INPUT type=hidden name=Sector value=<%=RecordSet.getString("sector")%>></TD>
        </TR><tr><td class=Line colspan=2></td></tr>   
<%if(!user.getLogintype().equals("2")) {%>			
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(1278,user.getLanguage())%></TD>
          <TD class=Field><BUTTON class=Browser id=SelectManagerID onClick="onShowManagerID()"></BUTTON> <span 
            id=manageridspan><a href="/hrm/resource/HrmResource.jsp?id=<%=RecordSet.getString("manager")%>"><%=Util.toScreen(ResourceComInfo.getResourcename(RecordSet.getString("manager")),user.getLanguage())%></a></span> 
        ...
        <TR>
          ...
          <TD class=Field> 
              <span class=InputStyle id=departmentspan>
                <%if(RecordSet.getString("department").equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%>
        ...
        <TR>
		  ...
		  <TD class=Field> 
		    ...
		    <SPAN id=seclevelimage>
                <%if(RecordSet.getString("seclevel").equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%>
            </SPAN>
		  </TD>
	    </TR><tr><td class=Line colspan=2></td></tr>		
	<%}else{%>
...
sub onShowStatusID()
	...
	Statusspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
	weaver.Status.value=""
	end if
	end if
end sub
...
sub onShowRatingID()
	...
	Ratingspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
	weaver.Rating.value=""
	end if
	end if
end sub
			...
			if(ajax.responseText != null || ajax.responseText != ""){
				...
				if(retstr == 1){
				  if(!window.confirm("<%=SystemEnv.getHtmlLabelName(23303,user.getLanguage())%>")){
				    ...
				    document.getElementById("Nameimage").innerHTML = "<IMG src='/images/BacoError.gif' align=absMiddle>";
				  }
				}
			}
	    }catch(e){
