...
<%if((isSub==1)&&(RecordSetS.getString("id").equals(CLogID))){%>
	      <td><img border=0 src="/images/ArrowRightBlue.gif"></img><%=RecordSetS.getString("subject")%></td>
...
<%}else{
%>
	      <td><img border=0 src="/images/ArrowRightBlue.gif"></img><a href="/CRM/data/ViewContactLogDetail.jsp?log=<%=log%>&CLogID=<%=RecordSetS.getString("id")%>"><%=Util.toScreen(RecordSetS.getString("subject"),user.getLanguage())%></a></td>
		  <td>
