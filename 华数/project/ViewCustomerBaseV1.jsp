...
if(curstatus>0){
	if(curstatus==1){ 
		...
		statussql=" update wasu_projectbase set zcdate='"+CurrentDate+"',spstatus=4 where id="+CustomerID; 
	}
  ...
  <TR>
	...
	<TD vAlign=top>
	  ...
	  <TABLE class=ViewForm>
        ...
        <TR>
          <TD>项目经理</TD>
          <TD class=Field><%=Util.toScreen(ResourceComInfo.getResourcename(RecordSet.getString("xmjl")),user.getLanguage())%></TD>
        </TR><tr><td class=Line colspan=2></td></tr>
        <TR>
          <TD>所属公司</TD>
        ...
        <TR>
          <TD>项目种类</TD>
          <TD class=Field><%=RecordSet.getString("xmlz").equals("0")?"客户化项目":"一般投资项目"%></TD>
        </TR><tr><td class=Line colspan=2></td></tr>
        <TR>
          <TD>项目种类</TD> 
          <TD class=Field><%=RecordSet.getString("xmlb")%></TD>
        </TR><tr><td class=Line colspan=2></td></tr>
        <TR>
          <TD>联系电话</TD>
        ...
        <TR>
          ...
          <%  int lxlzxs=RecordSet.getInt("lxlzxs");
              ...
              rs.executeSql(" select * from formtable_main_"+lxlzwhformid+"_dt1  where id="+lxlzxs); 
              rs.next();
     ...
     <td>
	  ...
	  <TABLE class=ViewForm>
        ...
        <TR class=Title>
			...
			<TD align=right > <a href="#" onclick="addNewDoc(1)">添加</a>
			 </TD>
          </TR>
        <TR class=Spacing>
          <TD class=Line1 colSpan=3></TD></TR> 
        ...
        <TR>
		  ...
		  &nbsp;&nbsp;&nbsp;
		   <a href="#" onClick="onDel('/project/DocUploadOperation.jsp?method=delete&fileid=<%=rs.getString("fileid")%>&projid=<%=CustomerID%>',this,'toDel1_<%=index1++ %>')" target="_self"><%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></a>
		  </TD> 
        </TR><tr><td class=Line colspan=3></td></tr> 
        <%} %>
...
<!--立项申请end--> 
	 ...
	 <TABLE class=ViewForm>
        ...
        <TR class=Title>
			...
			<TD align=right > <a href="#" onclick="addNewDoc(2)">添加</a>
			 </TD>
          </TR>
        <TR class=Spacing>
          <TD class=Line1 colSpan=3></TD></TR> 
        ...
        <TR>
		  ...
		  &nbsp;&nbsp;&nbsp;
		   <a href="#" onClick="onDel('/project/DocUploadOperation.jsp?method=delete&fileid=<%=rs.getString("fileid")%>&projid=<%=CustomerID%>',this,'toDel2_<%=index2++ %>')" target="_self"><%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></a>
		  </TD> 
        </TR><tr><td class=Line colspan=3></td></tr> 
        <%} %>
     ...
     <td>
	  ...
	  <TABLE class=ViewForm>
        ...
        <TR class=Title>
			...
			<TD align=right > <a href="#" onclick="addNewDoc(3)">添加</a>
			 </TD>
          </TR>
        <TR class=Spacing>
          <TD class=Line1 colSpan=3></TD></TR> 
        ...
        <TR>
		  ...
		  &nbsp;&nbsp;&nbsp;
		   <a href="#" onClick="onDel('/project/DocUploadOperation.jsp?method=delete&fileid=<%=rs.getString("fileid")%>&projid=<%=CustomerID%>',this,'toDel3_<%=index3++ %>')" target="_self"><%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></a>
		  </TD> 
        </TR><tr><td class=Line colspan=3></td></tr> 
        <%} %>
...
<!--立项报告end-->
     ...
     <td>
	  ...
	  <TABLE class=ViewForm>
        ...
        <TR class=Title>
            <TH colspan=2>预算卡</TH>
			<TD align=right > <a href="#" onclick="addNewDoc(4)">添加</a>
			 </TD>
          </TR>
        <TR class=Spacing>
          <TD class=Line1 colSpan=3></TD></TR> 
        ...
        <TR>
		  ...
		  &nbsp;&nbsp;&nbsp;
		   <a href="#" onClick="onDel('/project/DocUploadOperation.jsp?method=delete&fileid=<%=rs.getString("fileid")%>&projid=<%=CustomerID%>',this,'toDel4_<%=index4++ %>')" target="_self"><%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></a>
		  </TD> 
        </TR><tr><td class=Line colspan=3></td></tr> 
        <%} %>
     ...
     <td>
	  ...
	  <TABLE class=ViewForm>
        ...
        <TR class=Title>
			...
			<TD align=right > <a href="#" onclick="addNewDoc(5)">添加</a>
			 </TD>
          </TR>
        <TR class=Spacing>
          <TD class=Line1 colSpan=3></TD></TR> 
        ...
        <TR>
		  ...
		  &nbsp;&nbsp;&nbsp;
		   <a href="#" onClick="onDel('/project/DocUploadOperation.jsp?method=delete&fileid=<%=rs.getString("fileid")%>&projid=<%=CustomerID%>',this,'toDel5_<%=index5++ %>')" target="_self"><%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></a>
		  </TD> 
        </TR><tr><td class=Line colspan=3></td></tr> 
        <%} %>
     ...
     <td>
	  ...
	  <TABLE class=ViewForm>
        ...
        <TR class=Title>
			...
			<TD align=right > <a href="#" onclick="addNewDoc(6)">添加</a>
			 </TD>
          </TR>
        <TR class=Spacing>
          <TD class=Line1 colSpan=3></TD></TR> 
        ...
        <TR>
		  ...
		  &nbsp;&nbsp;&nbsp;
		  <a href="#" onClick="onDel('/project/DocUploadOperation.jsp?method=delete&fileid=<%=rs.getString("fileid")%>&projid=<%=CustomerID%>',this,'tdDel6_<%=index6++%>')" target="_self"><%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></a>
		  </TD> 
        </TR><tr><td class=Line colspan=3></td></tr> 
        <%} %>
