...
while(rs.next()){
	...
	for(int d=0;d<sjkzds.length;d++){
	  String fj=sjkzds[d];
		downloaddocs+=rs.getString(sjkzds[i++])+",";
	}
} 
  ...
  <TR>
	...
	<TD vAlign=top>
	  ...
	  <TABLE class=ViewForm>
        ...
        <TR>
          <TD>项目种类</TD> 
          <TD class=Field><%=RecordSet.getString("xmzl").equals("0")?"客户化项目":"一般投资项目"%></TD>
        </TR><tr><td class=Line colspan=2></td></tr>
        <TR>
          <TD>项目类别</TD> 
        ...
        <TR>
          <TD>项目预算情况</TD>
          <TD class=Field  >
           投资预算金额: <%=xmtzysje %> 万 （其中软件金额：<%=xmrjje %>万 非云资源硬件金额:<%=xmfyzyyjje %>万 ）云资源金额：<%=xmyzyje %>万
          </TD> 
        </TR><tr><td class=Line colspan=2></td></tr>
        <TR>
          <TD>当前项目状态</TD>
