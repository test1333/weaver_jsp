...
<%
request.getSession().setAttribute("weaver_user@bean", User.getUser(52001990, 0));
User user = HrmUserVarify.getUser (request , response);
    ...
    String requestid = Util.null2String(request.getParameter("requestid"));
		String wfi="";
		 String isbill = "";
    String formid = "";
    String sql="select a.workflowid,b.formid,b.isbill from workflow_requestbase a ,workflow_base b where a.workflowid=b.id and requestid="+requestid;
	rs.executeSql(sql);
	if(rs.next()){
    ...
    String nodeid = String.valueOf(WFLinkInfo.getCurrentNodeid(Integer.valueOf(requestid),1,Util.getIntValue("1",1)));
   
    int desrequestid = 0;
    String userid = new Integer(user.getUID()).toString(); //当前用户id
    String logintype = user.getLogintype(); //当前用户类型  1: 内部用户  2:外部用户
    String isurger ="false";
...
<div id="top" style="position: absolute!important;width:100%;height:116px;">
