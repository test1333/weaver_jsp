		  ...
		  <%
			...
			String orderby = "";
			 ...
			 tableString=""+
			        ...
			        "<head>"+                             
			              "<col width=\"15%\"  text=\"\" column=\"id\" otherpara='column:creater+column:createdate+column:createtime+column:remark+column:docids+column:crmids+column:projectids+column:requestids+column:accessory+column:tskids+"+user.getLanguage()+"' transmethod=\"weaver.proj.util.ProjectTransUtil.getMessageContent\"    />"+
			        "</head>"+
			        "</table>"; 
