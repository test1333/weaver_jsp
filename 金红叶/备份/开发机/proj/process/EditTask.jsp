...
//var task_status="field62";//任务状态
var task_filenum="field81";//交付物数量
var task_filedesc="field82";//交付物说明
...
//alert("task_type_val="+task_type_val);
...
jQuery.post("/appdevjsp/HQ/ITProject/CheckJFW.jsp", {
				...
				if(result1 == 1){
				jQuery("#field61span").text("上阶段未完成或者上阶段交付物未提交完毕");
				jQuery("#field61span").css("color","red");
				cansubmit = "1";
				}
			});
}
