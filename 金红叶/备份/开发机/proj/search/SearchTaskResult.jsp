...
if(!"".equals(xl)){
	if(Util.getIntValue(xl,0)==0){
		sqlWhere+=" and tt1.xl =0 ";
	}else{
		sqlWhere+=" and tt1.xl =1 ";
	}
}
...
String backfields = " tt1.id,tt1.subject,tt1.hrmid,tt1.prjid,tt1.begindate,tt1.enddate,tt1.actualbegindate,tt1.finish,tt1.status,tt1.islandmark, "+
					" case tt1.xl when 0 then '任务' when 1 then '阶段' else '' end as type ";
...
String tableString=""+
        ...
        "<head>"+                             
              ...
              "<col width=\"12%\"  text=\""+SystemEnv.getHtmlLabelName(22168,user.getLanguage())+"\" column=\"begindate\"  orderkey=\"begindate\"/>"+
