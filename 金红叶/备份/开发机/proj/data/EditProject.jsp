...
function datainput(){
    ...
    //20161230 sop字段联动
    function sopmanager(){
    	var managerid  = jQuery("#customfield16").val();
    	...
    	url = encodeURI(url);
    		jQuery.ajax({
       			...
       			var temp = new Array();
   				 temp = data.toString().split(","); 
   				 var lfgcval = "#customfield17";
   				 var lfgcspan = "#customfield17span";
    ...
    function comuser(userid){
    	...
    	url = encodeURI(url);
    		jQuery.ajax({
       			...
       			var temp = new Array();
   				temp = data.toString().split(","); 
   				var ckr = "#customfield10";
   				var ckrspan = "#customfield10span";
    ...
    function comtype_cg(){
    	var comuserid = jQuery("#customfield10").val();
		comtype(comuserid);
    }
    ...
    function commanager(){
    	...
    	url = encodeURI(url);
    		jQuery.ajax({
       			...
       			var temp = new Array();
   				temp = data.toString().split(","); 
   				var manger = "#customfield9";
   				var mangerspan = "#customfield9span";
    ...
    jQuery(document).ready(function(){
	       ...
	       if(type=="1"){
	       		...
	       		//commanager();     //CMO负责人
	       		bindchange("#customfield10", comtype_cg);
	       		bindchange("#customfield24", commanager);

	       		/*SOP*/
	       		bindchange("#customfield16", sopmanager);
	       	}
    });
