...
//System.out.println("generateTemplateFile"+generateTemplateFile);
...
String responsepage="prjimptab.jsp?isFromTab=1&isGeneratedTemplateFile=1&isdialog="+isdialog;
if(isdata==2) responsepage="prjtskimptab.jsp?isFromTab=1&isGeneratedTemplateFile=1&isdialog="+isdialog;
...
}else if("e2".equalsIgnoreCase(msgType) ||"e5".equalsIgnoreCase(msgType)){
