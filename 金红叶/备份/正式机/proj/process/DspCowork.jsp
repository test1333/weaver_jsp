...
String sqlWhere =SQLUtil.filteSql(RecordSet.getDBType(),  " where t1.id=t2.sourceid and t1.relatedprj='"+ProjID+"' and ( t1.principal='"+CurrentUser+"' or ','+t2.content+',' like '%,"+CurrentUser+",%' ) ");
...
String tableString = "";
int perpage=10;                                 
String backfields = " t1.id,t1.name,t1.creater,t1.createdate,t1.createtime ";
String fromSql  = " cowork_items t1,coworkshare t2 ";
...
tableString =   " <table instanceid=\"CptCapitalAssortmentTable\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+
                ...
                "           <col width=\"5%\"  text=\""+SystemEnv.getHtmlLabelName(1339,user.getLanguage())+"\" column=\"createtime\" orderkey=\"createtime\"  />"+
                ...
                "           <col width=\"5%\"  text=\""+SystemEnv.getHtmlLabelName(18831,user.getLanguage())+"\" column=\"name\" orderkey=\"name\" href='/cowork/Viewcowork.jsp' linkkey='id' linkvaluecolumn='id'  />"+
                "       </head>"+
                /**"		<operates>"+
