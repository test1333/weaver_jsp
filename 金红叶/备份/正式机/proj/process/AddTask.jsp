...
<%
String partentid_define = Util.null2String(request.getParameter("parentid"));
String sql_subDate="";
String sup_temp_begin="";
String sup_temp_end="";
if(!"".equals(partentid_define)){
	sql_subDate =" select beginDate||' '||begintime as temp_begin,enddate||' '||endtime as temp_end from prj_taskprocess where id = "+partentid_define+" ";
	rs.executeSql(sql_subDate);
	if(rs.next()){
...
if(partentid_define!=""){
	jQuery("select[name="+task_type+"]").val(0);
