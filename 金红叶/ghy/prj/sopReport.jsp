...
sql="select b.selectname from cus_formdict a, cus_selectitem b where a.id = b.fieldid and Upper(a.fieldname) = Upper('sop_cmo_team') and b.selectvalue='"+comzb+"' and rownum=1";

rs.executeSql(sql);
if(rs.next()){
	comzb_val = Util.null2String(rs.getString("selectname"));
}
...
<HTML>
  ...
  <link type="text/css" rel="stylesheet" href="/wui/theme/ecology8/skins/default/wui_wev8.css" />
	<BODY >
		...
		<FORM id=report name=report action="/ghy/prj/sopReport.jsp" method=post>
	...
	<div style="width:3020px; ">	
	<div class="table-head" style="width:3000px; ">
			<table class="ViewForm1  outertable" scrolling="auto">
    <tbody>		
        <tr>			
            <td>
            <table class="ViewForm1  maintable" scrolling="auto">
                <colgroup>  <col width="80px"></col><col width="120px"></col><col width="100px"></col><col width="100px"></col><col width="100px"></col><col width="100px"></col><col width="100px"></col>
	...
	<div class="table-body" id="div22" style="width:3020px; ">
	<table class="ViewForm1  outertable" scrolling="auto">
    <tbody>		
        <tr>			
            <td>
            <table class="ViewForm1  maintable" scrolling="auto">
                ...
                <tbody>
					...
					String sj5="";
					String mqwc5="";
					String backfields = " select f_get_taskinfo(a.id,b.sop_status,'4') as color,a.id,a.procode,a.name,f_get_HRSName(b.sop_sop_contact,'1','') as sop_sop_contact,f_get_HRSName(b.sop_sop_contact,'2','') as sub_contact,b.sop_business_flow,"+
