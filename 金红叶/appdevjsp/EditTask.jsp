...
<%
String sql_rwzt="select machine from uf_machine";
String rwztid="";
rs.executeSql(sql_rwzt);
String machine="DEV";
if(rs.next()){
...
rs.executeSql(" select isactived from prj_taskprocess where id = "+taskrecordid+"");
if(rs.next()){
...
var task_type_val=jQuery("select[name="+task_type+"]").val();
...
jQuery.post("/appdevjsp/HQ/ITProject/CheckJFW.jsp", {
				...
				if(result1 == 1){
                var pp11=document.getElementsByName(rwztid)[0].getAttribute("sb");
				jQuery("#sbHolderSpan_"+pp11).css("display","none");
				jQuery("#"+rwztid+"span").text("上阶段未完成或者上阶段交付物未提交完毕");
				jQuery("#"+rwztid+"span").css("color","red");
				cansubmit = "1";
				}
			});
}
