...
String sql11=" select count(1) from prj_taskprocess a ,prj_projectinfo b where a.prjid=b.id and a.id="+taskrecordid+" and a.xl=1 and b.status<>0 ";
RecordSet.executeSql(sql11);
int count11=0;
if(RecordSet.next()){
  count11 = RecordSet.getInt(1);
}
//td8154 
   //文档部分
