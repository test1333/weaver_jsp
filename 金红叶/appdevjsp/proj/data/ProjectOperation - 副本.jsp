                                ...
                                for (int i=0 ;i<rowIndexs.length;i++){
                                    ...
                                    **/
                                    ...
                                    if(taskrecordid>0){
										...
										String strsqlForTask="update Prj_TaskProcess set subject='"+taskName+"',hrmid='"+manager+"',begintime='"+begintime+"',endtime='"+endtime+"',begindate='"+beginDate+"',enddate='"+endDate+"',workday="+workLong+",fixedcost="+budget+",prefinish="+beforeTask+",parentid="+parentid+",level_n="+level+",dsporder="+i+",status="+status+",parentids='"+parentids+"',parenthrmids='"+parenthrmids+"',xl='"+lx+"' where prjid="+ProjID+" and taskIndex="+rowIndex;
