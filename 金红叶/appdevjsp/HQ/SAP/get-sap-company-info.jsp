...
<script language=javascript src="/js/ecology8/hrm/HrmSearchInit_wev8.js"></script>
	<script type="text/javascript">	
		...
		function onCheckup1(){
			if(window.confirm('是否要要同步SAP工厂数据？')){
...
<%
	...
	RCMenu += "{获取SAP工厂数据,javascript:onCheckup1(),_self} " ;
	RCMenuHeight += RCMenuHeightStep ;

%>
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
	<FORM id=report name=report action=/appdevjsp/HQ/SAP/get-sap-company-info.jsp method=post>
		...
		if("1".equals(multiIds)){
			GetSapCompanyInfoAction aa = new GetSapCompanyInfoAction();
			aa.execute();
			boolean isOver = true;
			if(isOver){
...
<wea:group context="获取SAP工厂数据" attributes="test">

<wea:item>&nbsp;&nbsp;</wea:item><wea:item>&nbsp;&nbsp;</wea:item><wea:item>&nbsp;&nbsp;</wea:item>
		<wea:item>
		<table width="30%">
			<tr>
				<td><input name="hi1" type="button" value="获取SAP工厂数据" class="e8_btn_top_first" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;  max-width: 100px;width:100px;height:30px;font-size:15px;" onClick="onCheckup()"></td>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
