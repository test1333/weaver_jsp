...
<HTML>
	...
	<BODY>
		...
		<FORM id=report name=report action="" method=post>
			...
			<div>
				...
				<wea:item attributes="{'display':'none','id':'xmitem'}">姓名</wea:item>
				<wea:item attributes="{'display':'none','id':'xmitem1'}"><INPUT name="empname" id="empname" class='InputStyle' style="width:160px" value="<%=empname%>">
				</wea:item>

				<wea:item attributes="{'display':'none','id':'xbitem'}">性别</wea:item>
				<wea:item attributes="{'display':'none','id':'xbitem1'}">
				...
				<wea:item attributes="{'display':'none','id':'gsmitem'}">公司名</wea:item>
				<wea:item attributes="{'display':'none','id':'gsmitem1'}"><INPUT name="company" id ="company" class='InputStyle' style="width:200px" value="<%=company%>">
				</wea:item>

				<wea:item attributes="{'display':'none','id':'sfitem'}">省份</wea:item>
				<wea:item attributes="{'display':'none','id':'sfitem1'}">
	...
	function showhide(){
		var type_val=jQuery("#type").val();
			if(type_val == ""){
				jQuery("#xmitem").css('display','none');
				jQuery("#xmitem1").css('display','none');
				jQuery("#empname").val("");
				jQuery("#xbitem").css('display','none');
				jQuery("#xbitem1").css('display','none');
				jQuery("#sex").val("");
				jQuery("#gsmitem").css('display','none');
				jQuery("#gsmitem1").css('display','none');
				jQuery("#company").val("");
				jQuery("#sfitem").css('display','none');
				jQuery("#sfitem1").css('display','none');
				jQuery("#province").val("");
			}else if(type_val == "0"){
				jQuery("#xmitem").removeAttr("style");
				jQuery("#xmitem1").removeAttr("style");
				jQuery("#xbitem").removeAttr("style");
				jQuery("#xbitem1").removeAttr("style");
				jQuery("#gsmitem").css('display','none');
				jQuery("#gsmitem1").css('display','none');
				...
				jQuery("#gsmitem").removeAttr("style");
				jQuery("#gsmitem1").removeAttr("style");
				jQuery("#sfitem").removeAttr("style");
				jQuery("#sfitem1").removeAttr("style");
			}
	}
