...
%>
	...
	String fromSql  = " from uf_Con_ku_Legal_IN2 ";
...
tableString =" <table tabletype=\"none\" pagesize=\""+ PageIdConst.getPageSize(tmc_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+tmc_pageId +"\">"+
    ...
    "			<head>";
		...
		" href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=1187&amp;formId=-239&amp;opentype=0&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\"/>"+
