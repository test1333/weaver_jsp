...
%>
	...
	String backfields = " id,C_No,version, cost,Dept,Edate "; 
	String fromSql  = " from uf_Con_ku_Legal_IN3 ";
...
tableString =" <table tabletype=\"none\" pagesize=\""+ PageIdConst.getPageSize(tmc_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+tmc_pageId +"\">"+
    ...
    "			<head>";
		...
		" href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=1124&amp;formId=-240&amp;opentype=0&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\"/>"+
	 "				<col width=\"10%\"  text=\"合同费用 \" column=\"cost\" orderkey=\"cost\"   />"+
