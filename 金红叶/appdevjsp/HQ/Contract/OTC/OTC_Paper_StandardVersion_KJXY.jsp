...
%>
	...
	String backfields = " a.*"; 
	String fromSql  = " from uf_Con_ku_OTC_Agree a";
	...
	operateString+
	"			<head>";
	tableString+="<col width=\"17%\" text=\"合同编号\" column=\"ZCON_NO\" orderkey=\"ZCON_NO\" linkvaluecolumn=\"id\" linkkey=\"billid\" "+
		" href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=2425&amp;formId=-547&amp;opentype=0&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\"/>"+
		  "				<col width=\"10%\"  text=\"系统单号\" column=\"OBJECT_ID\" orderkey=\"OBJECT_ID\"   />"+
		"				<col width=\"10%\"  text=\"甲方(卖方）\" column=\"ZORG_NAME\" orderkey=\"ZORG_NAME\"   />"+
		  "				<col width=\"10%\"  text=\"乙方(买方）\" column=\"ZSOLD_NAME\" orderkey=\"ZSOLD_NAME\"   />"+
		"				<col width=\"10%\"  text=\"合同有效期(开始) \" column=\"ZYXQC\" orderkey=\"ZYXQC\"   />"+
  "				<col width=\"10%\"  text=\"合同有效期(终止) \" column=\"ZYXQZ\" orderkey=\"ZYXQZ\" />"+
