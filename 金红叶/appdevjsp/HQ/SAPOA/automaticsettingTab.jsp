...
if(_fromURL.equals("2")){
	...
	loadurl1="/appdevjsp/HQ/SAPOA/automaticsettingEdit.jsp?"+request.getQueryString();
	loadurl2="/appdevjsp/HQ/SAPOA/automaticsettingAddDetail.jsp?"+request.getQueryString();
