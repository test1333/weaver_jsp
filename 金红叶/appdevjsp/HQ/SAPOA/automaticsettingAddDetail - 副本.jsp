			...
			<wea:item attributes="{'colspan':'2','isTableList':'true'}">
				<table class=ListStyle cellspacing=1>
					...
					<%if(i%2==0){%><tr class=DataLight><%}%>
						...
						<%
						  String yanzh="select SAPFIELDNAME,CHANGETYPE,CHANGEINFO,REMARK ,ISACTIVEz  from  zoa_wffield_map where TID= (select ID from zoa_wftable_map where fid ="+viewid+"   and TYPE='M'  ) and FIELDNAME = UPPER('"+SapFieldlable+"')";
