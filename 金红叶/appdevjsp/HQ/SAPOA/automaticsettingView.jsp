...
<table id="topTitle" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="rightSearchSpan" style="text-align:right; width:500px!important">
			...
			<input type="button" value="<%=SystemEnv.getHtmlLabelName(93 ,user.getLanguage()) %>" class="e8_btn_top" onclick="onBackUrl('/appdevjsp/HQ/SAPOA/automaticsettingEdit.jsp?typename=<%=typename %>&viewid=<%=viewid %>')"/>
...
function getTest()
{
    ...
    jQuery.ajax({
        type: "POST",
        url: "/appdevjsp/HQ/SAPOA/automaticCheck.jsp",
        data: params,
