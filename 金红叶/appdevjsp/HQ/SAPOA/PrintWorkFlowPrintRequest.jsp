...
int langu=user.getLanguage();
		request.getRequestDispatcher("/appdevjsp/HQ/SAPOA/PrintRequest.jsp?requestid="+requestid+"&pernr_f="+pernr_f+"&lan="+saplan+"&isprint=1&fromFlowDoc=1").forward(request, response);
