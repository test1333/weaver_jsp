...
<%
	String url_1 = "";
	url_1 = "/appdevjsp/HQ/SAPOA/overtime/report/wokflowOverTimeDt.jsp";
%>
</head>
 <BODY scroll="no">
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">审批超时统计明细</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li>
					<a target="tabcontentframe" href="<%=url_1%>">审批超时统计明细<span id="allNum_span"></span></a>
				</li>
		    </ul>
