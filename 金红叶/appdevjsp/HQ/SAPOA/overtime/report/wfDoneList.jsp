...
<wea:layout type="4col">
	...
	String fromSql  = " from WfDoneOTView f ";
	...
	if(searchType == 1){
		...
		sqlWhere = sqlWhere + " and optime > lasttime  AND optime - lasttime   < 480 ";
	}else if(searchType == 3){
		sqlWhere = sqlWhere + " and optime > lasttime  AND optime - lasttime   < 960 ";
