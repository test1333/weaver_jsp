...
$(function(){
	...
	$("#tblTask").fancytree({
		...
		renderColumns: function(event, data) {
			...
			var lxHtml="<span>"+lx_val+"</span>";   
            
			$tdList.eq(3).html(lxHtml);
			$tdList.eq(4).html(parentindexHtml+levelHtml+templatetaskidHtml+rowindexHtml+tasknameHtml+worklongHtml);
			$tdList.eq(5).html(begindateHtml);
			$tdList.eq(6).html(enddateHtml);
