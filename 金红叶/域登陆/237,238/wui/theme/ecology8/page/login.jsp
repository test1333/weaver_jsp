...
var message000='<%=message0%>';
var checkflag = "0";
if(message000 == "-110"){
	checkflag= "1";
}
var checkemobileLogin = "";
var loginid=form1.loginid.value;
jQuery.ajax({
	type: "POST",
	url: "/wui/theme/ecology8/page/checkEmobilelogin.jsp",
	data: {'loginid':loginid},
	dataType: "text",
	async:false,//同步   true异步
	success: function(data){
			data=data.replace(/^(\s|\xA0)+|(\s|\xA0)+$/g, '');
			checkemobileLogin=data;
	}
});
if(checkemobileLogin == "1"){
	checkflag= "1";
}
if(checkflag == "1"){
	$("#normalLogin").hide();
	            ...
	            success:function(content){
					if (jQuery.trim(content) != '0' && jQuery.trim(content) != '9') {
						...
						if(jQuery.trim(content)==""){
							content = "/portal/plugin/main.jsp";
						}else{
							content=content.replace("/wui/main.jsp","/portal/plugin/main.jsp");
						}
