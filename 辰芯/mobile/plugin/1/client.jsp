...
if(workflowRequestInfo != null){
    isfavourite = "true".equals(workflowRequestInfo.getIsfavourite());
}
    ...
    function getOperationList() {
        ...
        if(!("-1005".equals(module) || "-1004".equals(module))){
            ...
            if (workflowRequestInfo.getDeleteName()!=null&&!workflowRequestInfo.getDeleteName().equals("")) { 
	            operatorType = 10;
	            operationJson.append("{\\\"name\\\": \\\"").append(workflowRequestInfo.getDeleteName()).append("\\\", \\\"type\\\":\\\"" + operatorType).append("\\\", \\\"callback\\\":\\\"doDelete()\\\"},");
	        }
...
<%} %>
                    ...
                    <%}%>
                    <input type="hidden" id="isSubmitDirect" name="isSubmitDirect" value="0" />
                    <%
    ...
    */
                ...
                if (data.error) {
                    ...
                    if (data.logs != undefined && data.logs != null && count != "0") {
                        ...
                        function(i, item) {
                            ...
                            var operateDateTime = item.operateDateTime ;
                            ...
                            */
                            viewsignHtml += "<div class='signRow_operate'><div class=\"signRow_operatorname\">" + operatorName + "&nbsp;&nbsp;"+operatorDept+"</div> <div class=\"signRow_operateTime\">" + operateType + " 于 " + operateDateTime + "</div></div>";
    ...
    function showDialog(url, data) {
        ...
        <% //} %>
	        ...
	        if(returnIdField == "isSubmitDirect") {
				if("0" == oldVal) {
					oldVal = "";
					oldName = "";
				}
	        ...
	        if (returnIdField == "forwardresourceids") {
	            ...
	            splitChar = ":";
	            wfpars="wfid="+js_workflowid+"&currentnodeid="+js_nodeid+"&forwardflag=1";
	            ...
	            splitChar = ":";
	            wfpars="wfid="+js_workflowid+"&currentnodeid="+js_nodeid+"&forwardflag=2";
	            ...
	            splitChar = ":";
	            wfpars="wfid="+js_workflowid+"&currentnodeid="+js_nodeid+"&forwardflag=3";
	        } else if(returnIdField == "rejectToNodeid"){
	            browserName = ""+SystemEnv.getHtmlNoteName(4642);
	        } else if(returnIdField == "isSubmitDirect"){
	            browserName = "<%=SystemEnv.getHtmlLabelName(384066, user.getLanguage()) %>";
	        } else {
    ...
    function setBrowserData(fieldID, fieldSpan, keys, vals, clickType, call_fnaFyFunCallBack) {
        ...
        if (clickType == 0) {
            ...
            if (fieldID == "forwardresourceids") {
    			...
    			if("2" == getIsSubmitDirectNode()) { // 选择退回后再提交的处理方式
    				showIsSubmitDirectDialog();
    				return false;
    			}
            ...
            } else if(fieldID == "isSubmitDirect"){
                setTimeout(function () {
                    var flag = confirm(""+SystemEnv.getHtmlNoteName(4640));
                    if (flag) {
                        $('#src').val("reject");
