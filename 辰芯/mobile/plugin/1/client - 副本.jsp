                ...
                if (data.error) {
                    ...
                    if (data.logs != undefined && data.logs != null && count != "0") {
                        ...
                        function(i, item) {
                            ...
                            */
                            viewsignHtml += "<div class='signRow_operate'><div class=\"signRow_operatorname\">" + operatorName + "</div> <div class=\"signRow_operateTime\">" + operateType + " 于 " + operateDateTime + "</div></div>";
