...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "jxdfckbm1_xm";
	String sql = "";
	...
	<BODY>
		...
		<FORM id=report name=report action="/cx/jx/xmwd/df/jxdf-bm-xm-list.jsp" method=post>
		...
		operateString+
		"			<head>";
			tableString +="<col width=\"6%\" text=\"项目所在部门\" column=\"cmssbm\" orderkey=\"cmssbm\"  transmethod=\"weaver.hrm.company.DepartmentComInfo.getDepartmentname\"/>"+ 
		    "<col width=\"6%\" text=\"项目名称\" column=\"xmmcname\" orderkey=\"xmmcname\" />"+ 
			"<col width=\"5%\" text=\"工号\" column=\"workcode\" orderkey=\"workcode\" />"+ 
			"<col width=\"5%\" text=\"姓名\" column=\"ryid\" orderkey=\"ryid\"  transmethod='weaver.proj.util.ProjectTransUtil.getResourceNamesWithLink'/> "+ 
			...
			"<col width=\"6%\"  text=\"绩效考核得分\" column=\"khzgdf\" orderkey=\"khzgdf\"  />"+
			"<col width=\"6%\"  text=\"绩效考核等级\" column=\"khpjdjname\" orderkey=\"khpjdjname\"  />"+
			"<col width=\"6%\"  text=\"员工考核比重\" column=\"ygkhqz\" orderkey=\"ygkhqz\"  />"+		
			"<col width=\"6%\"  text=\"项目考核等级\" column=\"xmkhdj\" orderkey=\"xmkhdj\"  />"+
			"<col width=\"6%\"  text=\"项目考核系数\" column=\"xmkhxs\" orderkey=\"xmkhxs\"  />"+
			"<col width=\"6%\"  text=\"特别激励系数\" column=\"tsjlxs\" orderkey=\"tsjlxs\"  />"+
			"<col width=\"6%\"  text=\"季度奖金系数\" column=\"jdjjxs\" orderkey=\"jdjjxs\"  />"+
			"<col width=\"6%\"  text=\"季度激励系数\" column=\"jdtbxs\" orderkey=\"jdtbxs\"  />"+
			"<col width=\"6%\"  text=\"在职时间系数\" column=\"zzsjxs\" orderkey=\"zzsjxs\"  />"+
			"<col width=\"6%\"  text=\"单据编号\" column=\"bdbh\" orderkey=\"bdbh\" linkkey=\"requestid\" linkvaluecolumn=\"requestid\" href=\"/workflow/request/ViewRequest.jsp\" target=\"_fullwindow\" />"+
