...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		String fromSql  =  "  from (select id,lastname,workcode,jobtitle,(select jobtitlename from hrmjobtitles where id=a.jobtitle) as titlename,ejbm,sjbm,year,zq,zzzhdf,(select djmc from uf_jxlevel_map where ks&lt;a.zzzhdf and js>=a.zzzhdf) as zhkhdj,'"+year+"'+'_'+'"+zq+"' as khzq,khqz from"+
