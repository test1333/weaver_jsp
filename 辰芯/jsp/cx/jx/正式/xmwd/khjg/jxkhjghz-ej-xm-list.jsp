...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "jxkhjghzej_xm";
	...
	<BODY>
		...
		<FORM id=report name=report action="/cx/jx/xmwd/khjg/jxkhjghz-ej-xm-list.jsp" method=post>
		...
		<%
		String backfields = " departmentid,id,lastname,workcode,jobtitle, titlename,ejbm,sjbm,year,zq,zzzhdf,zhkhdj,khzq,(select field1 from cus_fielddata where id=t.id and scopeid=-1) as yglx,'"+year+"年"+month+"' as zqspan,convert(varchar(20),khqz)+'%' as khqz,(select zzsjxs from uf_ygzzsjxs  where xm=t.id and khzqnf='"+year+"' and khzq='"+zq+"') as zzsjxs,[dbo].[get_tbjlxs_hz_xmwd]('"+year+"','"+zq+"',t.id) as tbjlxs,[dbo].[get_ygjxzhxs_hz_xmwd]('"+year+"','"+zq+"',t.id) as ygjxzhxs";
		String fromSql  =  "  from (select departmentid,id,lastname,workcode,jobtitle,(select jobtitlename from hrmjobtitles where id=a.jobtitle) as titlename,ejbm,sjbm,year,zq,zzzhdf,(select djmc from uf_jxlevel_map where ks&lt;a.zzzhdf and js>=a.zzzhdf) as zhkhdj,'"+year+"'+'_'+'"+zq+"' as khzq,khqz from"+
