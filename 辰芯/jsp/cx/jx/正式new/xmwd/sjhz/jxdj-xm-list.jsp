...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "jxdjckbm1_xm_1";
	String sql = "";
	...
	<BODY>
		...
		<FORM id=report name=report action="/cx/jx/xmwd/sjhz/jxdj-xm-list.jsp" method=post>
		...
		<%
		String backfields = " keyid,khzq,xmmc,dj,convert(varchar(20),fbyq)+'%' as fbyq,convert(varchar(20),ztfbrls)+'%' as ztfbrls,convert(varchar(20),sjfbrls)+'%' as sjfbrls,convert(varchar(20),sjfbqk)+'%' as sjfbqk,jcjg";
		String fromSql  =  " from (select 1 as keyid ,'"+year+"年"+month+"' as khzq,xmmc,'A' as dj ,isnull([dbo].[get_fbyq]('"+year+"','"+zq+"',a.id,'0'),0) as fbyq,cast(isnull([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')*[dbo].[get_fbyq]('"+year+"','"+zq+"',a.id,'0')/100,0) as numeric(10,1)) as ztfbrls,cast(isnull([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'0'),0.0) as numeric(10,1)) as sjfbrls,case when [dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')=0.000 then 0.00 else cast([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'0')/[dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')*100 as numeric(10,2)) end as sjfbqk,[dbo].[get_jyjg]('"+year+"','"+zq+"',a.id,'0') as jcjg from uf_xmxx a where id="+xmid+" "+
		"union all "+
		" select 2 as keyid ,'"+year+"年"+month+"' as khzq,xmmc,'B' as dj ,isnull([dbo].[get_fbyq]('"+year+"','"+zq+"',a.id,'1'),0) as fbyq,cast(isnull([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')*[dbo].[get_fbyq]('"+year+"','"+zq+"',a.id,'1')/100,0) as numeric(10,1)) as ztfbrls,cast(isnull([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'1'),0.0) as numeric(10,1)) as sjfbrls,case when [dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')=0.000 then 0.00 else cast([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'1')/[dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')*100 as numeric(10,2)) end  as sjfbqk,[dbo].[get_jyjg]('"+year+"','"+zq+"',a.id,'1') as jcjg from uf_xmxx a where id="+xmid+" "+
		"union all "+
		" select 3 as keyid ,'"+year+"年"+month+"' as khzq,xmmc,'C' as dj ,isnull([dbo].[get_fbyq]('"+year+"','"+zq+"',a.id,'2'),0) as fbyq,cast(isnull([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')*[dbo].[get_fbyq]('"+year+"','"+zq+"',a.id,'2')/100,0) as numeric(10,1)) as ztfbrls,cast(isnull([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'2'),0.0) as numeric(10,1)) as sjfbrls,case when [dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')=0.000 then 0.00 else cast([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'2')/[dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')*100 as numeric(10,2)) end  as sjfbqk,[dbo].[get_jyjg]('"+year+"','"+zq+"',a.id,'2') as jcjg from uf_xmxx a where id="+xmid+" "+
 "union all "+
		" select 4 as keyid ,'"+year+"年"+month+"' as khzq,xmmc,'D' as dj ,isnull([dbo].[get_fbyq]('"+year+"','"+zq+"',a.id,'3'),0) as fbyq,cast(isnull([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')*[dbo].[get_fbyq]('"+year+"','"+zq+"',a.id,'3')/100,0) as numeric(10,1)) as ztfbrls,cast(isnull([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'3'),0.0) as numeric(10,1)) as sjfbrls,case when [dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')=0.000 then 0.00 else cast([dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'3')/[dbo].[get_xmrls]('"+year+"','"+zq+"',a.id,'')*100 as numeric(10,2)) end  as sjfbqk,[dbo].[get_jyjg]('"+year+"','"+zq+"',a.id,'3') as jcjg from uf_xmxx a where id="+xmid+" ) a"; 
		String sqlWhere =  " 1=1 ";
		if("".equals(zq)){
			sqlWhere += " and 1=2 ";
		}
