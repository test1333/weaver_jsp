...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "jxzdckejxmwd";
	...
	<BODY>
		...
		<FORM id=report name=report action="/cx/jx/xmwd/jxzdck-ej-xm-list.jsp" method=post>
		...
		<%
		String backfields = " ryid,lastname,workcode,sjbm,jobtitle,(select jobtitlename from hrmjobtitles where id=a.jobtitle) as titlename,erjm,status,year,zq,requestid,keyid,bdbh,xmmc,(select xmmc from uf_xmxx where id=a.xmmc) as xmmcname";
