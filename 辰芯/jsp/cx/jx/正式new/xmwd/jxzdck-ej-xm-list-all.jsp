...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "jxzdckejxmwd_all";

	SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM");
	String tablename = "formtable_main_293";
	...
	<BODY>
		...
		<FORM id=report name=report action="/cx/jx/xmwd/jxzdck-ej-xm-list-all.jsp" method=post>
