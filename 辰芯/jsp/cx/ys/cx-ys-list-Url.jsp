...
<%
  Integer lg=(Integer)user.getLanguage();
	String url_1 = "";
	url_1 = "/cx/ys/cx-ys-list.jsp";
	String url_2 = "/cx/ys/cx-ys-list-history.jsp";
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">预算数据查看</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       <li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">新版本<span id="allNum_span"></span></a>
				</li>
				 <li >
					<a target="tabcontentframe" href="<%=url_2%>">历史版本<span id="allNum_span"></span></a>
				</li>
