...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/cx/jx/dfhz/jxdfhz-sj-list.jsp" method=post>
		...
		tableString =" <table tabletype=\"none\" pagesize=\""+ PageIdConst.getPageSize(out_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+out_pageId+"\" >"+         
				...
				"sumColumns=\"slevel,alevel,blevel,clevel,dlevel\" showCountColumn=\"true\" decimalFormat=\"%,.2f|%,.2f|%,.2f|%,.2f\" />" +
		operateString+
		"			<head>";
		tableString +="<col width=\"14%\" text=\"部门名称\" column=\"departmentname\" orderkey=\"departmentname\" /> "+
			"<col width=\"12%\"  text=\"年份\" column=\"year\" orderkey=\"year\"  />"+
			"<col width=\"14%\"  text=\"周期\" column=\"zq\" orderkey=\"zq\"  />"+
			"<col width=\"12%\"  text=\"S(杰出)\" column=\"slevel\" orderkey=\"slevel\"  />"+
			"<col width=\"12%\"  text=\"A(优秀)\" column=\"alevel\" orderkey=\"alevel\"  />"+
			"<col width=\"12%\"  text=\"B(良好)\" column=\"blevel\" orderkey=\"blevel\"  />"+
			"<col width=\"12%\"  text=\"C(一般)\" column=\"clevel\" orderkey=\"clevel\"  />"+
			"<col width=\"12%\"  text=\"D(需改进)\" column=\"dlevel\" orderkey=\"dlevel\"  />"+
