...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "jxkhjghzcksj";
	String sql = "";
	...
	<BODY>
		...
		<FORM id=report name=report action="/cx/jx/khjg/jxkhjghz-sj-list.jsp" method=post>
