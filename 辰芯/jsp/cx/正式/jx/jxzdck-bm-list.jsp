...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/cx/jx/jxzdck-bm-list.jsp" method=post>
		...
		<%
		String backfields = " fqri,ryid,lastname,workcode,sjbm,jobtitle,(select jobtitlename from hrmjobtitles where id=a.jobtitle) as titlename,erjm,status,year,zq,billid,keyid,bdbh ";
		...
		tableString +="<col width=\"10%\" text=\"姓名\" column=\"ryid\" orderkey=\"ryid\"  transmethod='weaver.proj.util.ProjectTransUtil.getResourceNamesWithLink'/> "+ 
			...
			"<col width=\"15%\"  text=\"单据编号\" column=\"bdbh\" orderkey=\"bdbh\" linkkey=\"billid\" linkvaluecolumn=\"billid\" href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=15&amp;formId=-68&amp;opentype=0\" target=\"_fullwindow\" />"+
