...
<HTML>
	...
	<BODY>
		...
		String backfields = "d.description status,"+
		                    " case when LEFT(SUBSTRING(b.realtakeordermonth,6,2),1)='0' then SUBSTRING(b.realtakeordermonth,7,1) else SUBSTRING(b.realtakeordermonth,6,2) end +'月' takeordermonth,c.name cusumer,a.name,b.realquity,b.realsingleprice,b.realitembuget,b.pcentchange ,b.pertotalmoney, "+
		...
		String orderby = " b.realtakeordermonth asc ";
		String tableString = "";
		String tiaojian=" and LEFT(b.realtakeordermonth,7) in( ";
		String tiaojian2=" and LEFT(b.realtakeordermonth,7) in( ";
        for(int i=0;i<=11;i++){
		String aa="";
		int bb;
			if(now_month+i>12){		
...
<wea:layout attributes="{'expandAllGroup':'true'}">
	<div id="TimeDate">
		<wea:item attributes="{'isTableList':'true'}">
		    <wea:layout type="table" attributes="{'cols':'35','cws':'100px,200px,200px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px,150px'}">
