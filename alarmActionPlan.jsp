...
<HTML>
	...
	<BODY>
		...
		String backfields = "id as idkey ,actionid,xdfa,famb,sjwc,jzrq,wcbl,decode(xdzt,0,'未开始',1,'进行中',2,'已完成','未开始') as xdzt,decode(is_done,'1','查看',decode('"+caozuo+"','1','审批中','2','进展维护','编辑')) as xianshi";
		...
		"			<head>";
		 ...
		 "  <col width=\"20%\" text=\"行动方案\" column=\"xdfa\" orderkey=\"xdfa\"/>"+
			...
			if("0".equals(caozuo)){
			tableString+="               <col width=\"10%\" text=\"操作\" column=\"xianshi\" orderkey=\"xianshi\" linkkey=\"billid\" linkvaluecolumn=\"idkey\"  href=\"/formmode/view/AddFormMode.jsp?mainid=0&amp;modeId=1&amp;formId=-2&amp;type=2&amp;Id=41\" target=\"_fullwindow\"   />";			
