...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		String sqlWhere = " where 1=1 and bz='"+bz+"' and gs='"+subid+"' and requestid in (select requestid from request_hb_record where sfcl='0' )";
	   ...
	   function doservice(){
		  ...
		  if(ids!=null && ids!=""){
			//  alert(ids);
				...
				if (null != xhr1) {
					xhr1.open("GET","/zj/certificate/do-services-hb.jsp?requestids="+ids, false);
