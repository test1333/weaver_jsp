...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/zj/certificate/create-certificate.jsp" method=post>
		...
		String fromSql  = " v_create_certificate ";
	   ...
	   function doservice(){
		  ...
		  if(ids!=null && ids!=""){
			//  alert(ids);
				...
				if (null != xhr) {
					xhr.open("GET","/zj/certificate/do-services-pz.jsp?requestids="+ids, false);
