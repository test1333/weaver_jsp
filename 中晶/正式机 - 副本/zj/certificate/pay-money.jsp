...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/zj/certificate/pay-money.jsp" method=post>
			...
			<table id="topTitle" cellpadding="0" cellspacing="0">
				<tr>
					...
					<input type="button" value="合并付款" class="e8_btn_top_first" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis; max-width: 100px;" onclick="doservice();"/>
		...
		<%
		String backfields = "requestid,requestname,sqr,sqrq,case when bz='1' then '美元' else '人民币'end as bz,fkje,fkfs,(select skyh from uf_skfs where id=fkfs) as fkfsname";                 
		String fromSql  = " v_fukuan_requestFlow ";
		String sqlWhere = " where 1=1 and bz='"+bz+"' and gs='"+subid+"'";
		...
		"			<head>";
			...
			"               <col width=\"20%\" text=\"收款人\" column=\"sqr\" orderkey=\"sqr\" otherpara=\"column:sqr\" transmethod=\"weaver.general.WorkFlowTransMethod.getWFSearchResultName\"/>"+
			"               <col width=\"10%\" text=\"申请日期\" column=\"sqrq\" orderkey=\"sqrq\"/>"+
			"               <col width=\"10%\" text=\"币种\" column=\"bz\" orderkey=\"bz\"  />"+
			"               <col width=\"10%\" text=\"付款金额\" column=\"fkje\" orderkey=\"fkje\" />"+
			"               <col width=\"20%\" text=\"付款方式\" column=\"fkfsname\" orderkey=\"fkfsname\" />"+
	   ...
	   function doservice(){
		  ...
		  if(ids!=null && ids!=""){
			//  alert(ids);
				...
				if (null != xhr) {
					xhr.open("GET","/zj/certificate/do-services.jsp?requestids="+ids, false);
