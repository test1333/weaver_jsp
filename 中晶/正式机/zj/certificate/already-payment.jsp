...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<%
		String backfields = "id,requestid,requestname,sqr,sqrq,bz,bzid,fkje,seq,fkfs,(select skyh from uf_skfs where id=fkfs) as fkfsname,requestmark ";                 
		...
		"			<head>";
			...
			"               <col width=\"8%\" text=\"申请人\" column=\"sqr\" otherpara=\"column:sqr\" transmethod=\"weaver.general.WorkFlowTransMethod.getWFSearchResultName\"/>"+
			"               <col width=\"8%\" text=\"申请日期\" column=\"sqrq\"/>"+
			"               <col width=\"8%\" text=\"币种\" column=\"bz\"   />"+
			"               <col width=\"8%\" text=\"付款金额\" column=\"fkje\"  />"+
			"               <col width=\"18%\" text=\"付款方式\" column=\"fkfsname\" />"+	
