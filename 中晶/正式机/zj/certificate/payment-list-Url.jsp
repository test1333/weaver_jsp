...
<%
	...
	String url_5 = "";
	String url_6="";
	url_1 = "/zj/certificate/payment-list.jsp?bz=0&subid=5";
	url_2 = "/zj/certificate/payment-list.jsp?bz=1&subid=5";
	url_3 = "/zj/certificate/payment-list.jsp?bz=0&subid=7";
	url_4 = "/zj/certificate/payment-list.jsp?bz=1&subid=7";
	url_5 = "/zj/certificate/payment-list.jsp?bz=0&subid=6";
	url_6 = "/zj/certificate/payment-list.jsp?bz=1&subid=6";
%>
