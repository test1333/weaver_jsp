...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		RCMenu += "{生成凭证,javascript:doservice(),_self} " ;
		RCMenuHeight += RCMenuHeightStep ;
		%>
		<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
		<FORM id=report name=report action="/zj/jz/certificate/create-certificate.jsp" method=post>
		...
		"			<head>";
			...
			"               <col width=\"20%\" text=\"申请日期\" column=\"sqrq\"/>"+
			"               <col width=\"10%\" text=\"币种\" column=\"bz\"   />"+
			"               <col width=\"20%\" text=\"付款金额\" column=\"fkje\"  />"+
         ...
         //alert(ids);
		  if(ids!=null && ids!=""){
			//  alert(ids);
				...
				if (null != xhr) {
					xhr.open("GET","/zj/jz/certificate/do-services-pz.jsp?requestids="+ids, false);
