...
<%
	...
	String url_5= "";
	String url_6="";
	url_1 = "/zj/jz/certificate/create-certificate.jsp?bz=0&subid=5";
	url_3 = "/zj/jz/certificate/create-certificate.jsp?bz=0&subid=7";
	url_5 = "/zj/jz/certificate/create-certificate.jsp?bz=0&subid=6";
%>
