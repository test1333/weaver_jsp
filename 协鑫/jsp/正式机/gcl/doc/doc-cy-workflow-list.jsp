        ...
        <td valign="top">
            <%
                ...
                String backfields = "wjbt,fwbh,gwbh,"+emp_id+" as ryid,a.requestid,b.requestname,b.creater," +
                        ...
                        "from workflow_currentoperator c,workflow_flownode d where c.nodeid=d.nodeid and d.nodeid=1707132 and " +
                        " c.operatedate is not null and c.requestid=a.requestid)||'/'||" +
                        "(select count(1) from workflow_currentoperator c,workflow_flownode d where c.nodeid=d.nodeid and d.nodeid=1707132 and " +
                        " c.operatedate is  null and c.requestid=a.requestid" +
                        ")||'/'||(select count(1) from workflow_currentoperator c,workflow_flownode d where c.nodeid=d.nodeid and d.nodeid=1707132 and c.requestid=a.requestid)" +
                        " as ckzt ";
