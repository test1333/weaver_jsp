...
String yzxxid = ccu.CreateChangeDataInfo("4",dataid,emp_id);
...
String qtxxid  = ccu.CreateChangeDataInfo("5",dataid,emp_id);
 ...
 String tableNameYzxx = du.getBillTableName("GSYZXXBG");
...
<script type="text/javascript">
	...
	function queryCompanyType(type){
		if(type == "1"){
			...
			jQuery("#frame2list").attr("src","/formmode/view/AddFormMode.jsp?type=2&modeId=<%=ccu.getModeid(tableNameYzxx)%>&formId=<%=ccu.getFormId(tableNameYzxx)%>&billid=<%=yzxxid%>&opentype=0");
...
<div class="OBoxW "   id="top_div"> 
           ...
           <li>
					...
					<li>
						<a href="javascript:queryCompanyType('4');" ><div><div>印章信息</div> </div> </a>
					</li>
					<li>
