...
<%
    ...
    String oaxx = "";
    String qccxx = "";
    String sql = "select b.oaxx,b.qccxx from "+tablename+" a,"+tablename+"_dt1 b where a.id=b.mainid and a.gsid='"+gsid+"' and b.lx='1' ";
    rs.execute(sql);
    if(rs.next()){
    ...
    <table class=Viewform id="searchTable" >
        ...
        <COLGROUP>
           ...
           <!-- <TR class=Title>
            ...
            <tr>
                <td></td>
                <td class="fname">系统名称</td>
                <td class="fname">企查查名称</td>
                <td></td>
            </tr>
            <tr>
                <td></td>
