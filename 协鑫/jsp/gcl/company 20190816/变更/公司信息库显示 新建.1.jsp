<table class="ViewForm ">
    <tbody>
        <tr>
            <td><br />
            <div align="center"><font class="reqname">新增公司</font></div>
            ...
            <table class="ViewForm maintable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fname"><input id="$label869624$" class="Label" name="label869624" value="币种" type="text" /></td>
                        <td class="fvalue"><input id="$field869626$" class="InputStyle" name="field869626" value="[可编辑]币种" type="text" /></td>
                    </tr>
                    <tr>
             ...
             <table style="width: 100%; word-wrap: break-word; left: 0px" id="table0button" class="form" name="table0button">
                <tbody>
                    ...
                    <tr>
                        <td align="left">&nbsp;</td>
                        <td align="right">
                        <div id="div0button"><button accesskey="A" id="$addbutton0$" class="BtnFlow" name="addbutton0" onclick="addRow0(0);return false;"><u>A</u>-添加</button><button accesskey="E" id="$delbutton0$" class="BtnFlow" name="delbutton0" onclick="deleteRow0(0);return false;"><u>E</u>-删除</button></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                        <table style="width: 100%" id="oTable0" class="ListStyle detailtable" name="oTable0">
           ...
           <table style="width: 100%; word-wrap: break-word; left: 0px" id="table1button" class="form" name="table1button">
                <tbody>
                    ...
                    <tr>
                        <td align="left">&nbsp;</td>
                        <td align="right">
                        <div id="div1button"><button accesskey="A" id="$addbutton1$" class="BtnFlow" name="addbutton1" onclick="addRow1(1);return false;"><u>A</u>-添加</button><button accesskey="E" id="$delbutton1$" class="BtnFlow" name="delbutton1" onclick="deleteRow1(1);return false;"><u>E</u>-删除</button></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                        <table style="width: 100%" id="oTable1" class="ListStyle detailtable" name="oTable1">
                            <colgroup><col width="34%"></col><col width="33%"></col><col width="33%"></col></colgroup>
                            <tbody>
                                <tr class="header detailtitle">
            ...
            <table style="width: 100%; word-wrap: break-word; left: 0px" id="table2button" class="form" name="table2button">
                <tbody>
                    <tr>
                        <td align="left">&nbsp;</td>
                        <td align="right">
                        <div id="div2button"><button accesskey="A" id="$addbutton2$" class="BtnFlow" name="addbutton2" onclick="addRow2(2);return false;"><u>A</u>-添加</button><button accesskey="E" id="$delbutton2$" class="BtnFlow" name="delbutton2" onclick="deleteRow2(2);return false;"><u>E</u>-删除</button></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                        <table style="width: 100%" id="oTable2" class="ListStyle detailtable" name="oTable2">
                            <colgroup><col width="34%"></col><col width="33%"></col><col width="33%"></col></colgroup>
                            <tbody>
                                <tr class="header detailtitle">
            ...
            <table class="ViewForm maintable">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="fvalue"><input id="$field869651$" class="InputStyle" name="field869651" value="[可编辑]公章-全称" type="text" /></td>
                        <td class="fname"><input id="$label869652$" class="Label" name="label869652" value="保管人" type="text" /></td>
                        <td class="fvalue"><input id="$field869652$" class="InputStyle" name="field869652" value="[可编辑]保管人" type="text" /></td>
                        <td class="fname"><input id="$label869653$" class="Label" name="label869653" value="实际存放地" type="text" /></td>
                        <td class="fvalue"><input id="$field869653$" class="InputStyle" name="field869653" value="[可编辑]实际存放地" type="text" /></td>
                        <td class="fname"><input id="$label869672$" class="Label" name="label869672" value="保管部门" type="text" /></td>
                        <td class="fvalue"><input id="$field869672$" class="InputStyle" name="field869672" value="[可编辑]保管部门" type="text" /></td>
                    </tr>
                    <tr>
                        <td class="fname"><input id="$label869654$" class="Label" name="label869654" value="法人章-全称" type="text" /></td>
                        <td class="fvalue"><input id="$field869654$" class="InputStyle" name="field869654" value="[可编辑]法人章-全称" type="text" /></td>
                        <td class="fname"><input id="$label869655$" class="Label" name="label869655" value="保管人" type="text" /></td>
                        <td class="fvalue"><input id="$field869655$" class="InputStyle" name="field869655" value="[可编辑]保管人" type="text" /></td>
                        <td class="fname"><input id="$label869656$" class="Label" name="label869656" value="实际存放地" type="text" /></td>
                        <td class="fvalue"><input id="$field869656$" class="InputStyle" name="field869656" value="[可编辑]实际存放地" type="text" /></td>
                        <td class="fname"><input id="$label869673$" class="Label" name="label869673" value="保管部门" type="text" /></td>
                        <td class="fvalue"><input id="$field869673$" class="InputStyle" name="field869673" value="[可编辑]保管部门" type="text" /></td>
                    </tr>
                    <tr>
                        <td class="fname"><input id="$label869657$" class="Label" name="label869657" value="财务章-全称" type="text" /></td>
                        <td class="fvalue"><input id="$field869657$" class="InputStyle" name="field869657" value="[可编辑]财务章-全称" type="text" /></td>
                        <td class="fname"><input id="$label869658$" class="Label" name="label869658" value="保管人" type="text" /></td>
                        <td class="fvalue"><input id="$field869658$" class="InputStyle" name="field869658" value="[可编辑]保管人" type="text" /></td>
                        <td class="fname"><input id="$label869659$" class="Label" name="label869659" value="实际存放地" type="text" /></td>
                        <td class="fvalue"><input id="$field869659$" class="InputStyle" name="field869659" value="[可编辑]实际存放地" type="text" /></td>
                        <td class="fname"><input id="$label869674$" class="Label" name="label869674" value="保管部门" type="text" /></td>
                        <td class="fvalue"><input id="$field869674$" class="InputStyle" name="field869674" value="[可编辑]保管部门" type="text" /></td>
                    </tr>
                    <tr>
                        <td class="fname"><input id="$label869660$" class="Label" name="label869660" value="合同章-全称" type="text" /></td>
                        <td class="fvalue"><input id="$field869660$" class="InputStyle" name="field869660" value="[可编辑]合同章-全称" type="text" /></td>
                        <td class="fname"><input id="$label869661$" class="Label" name="label869661" value="保管人" type="text" /></td>
                        <td class="fvalue"><input id="$field869661$" class="InputStyle" name="field869661" value="[可编辑]保管人" type="text" /></td>
                        <td class="fname"><input id="$label869662$" class="Label" name="label869662" value="实际存放地" type="text" /></td>
                        <td class="fvalue"><input id="$field869662$" class="InputStyle" name="field869662" value="[可编辑]实际存放地" type="text" /></td>
                        <td class="fname"><input id="$label869675$" class="Label" name="label869675" value="保管部门" type="text" /></td>
                        <td class="fvalue"><input id="$field869675$" class="InputStyle" name="field869675" value="[可编辑]保管部门" type="text" /></td>
                    </tr>
            ...
            <div>&nbsp;</div>
             ...
             <table class="ViewForm maintable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="fname"><input id="$label869617$" class="Label" name="label869617" value="地级市" type="text" /></td>
                        <td class="fvalue"><input id="$field869617$" class="InputStyle" name="field869617" value="[可编辑]地级市" type="text" /></td>
                    ...
                    <tr>
                        ...
                        <td class="fname"><input id="$label869606$" class="Label" name="label869606" value="一级类别" type="text" /></td>
                        <td class="fvalue"><input id="$field869606$" class="InputStyle" name="field869606" value="[可编辑]一级类别" type="text" /></td>
                    </tr>
                    <tr>
                        <td class="fname"><input id="$label869610$" class="Label" name="label869610" value="法人版块" type="text" /></td>
                        <td class="fvalue"><input id="$field869610$" class="InputStyle" name="field869610" value="[可编辑]法人版块" type="text" /></td>
                        <td class="fname"><input id="$label869611$" class="Label" name="label869611" value="管理板块" type="text" /></td>
                        <td class="fvalue"><input id="$field869611$" class="InputStyle" name="field869611" value="[可编辑]管理板块" type="text" /></td>
                    </tr>
                    <tr>
                        ...
                        <td class="fname"><input id="$label869607$" class="Label" name="label869607" value="产业大类" type="text" /></td>
                        <td class="fvalue"><input id="$field869607$" class="InputStyle" name="field869607" value="[可编辑]产业大类" type="text" /></td>
                    </tr>
                    <tr>
                        <td class="fname"><input id="$label869608$" class="Label" name="label869608" value="产业细类" type="text" /></td>
                        <td class="fvalue"><input id="$field869608$" class="InputStyle" name="field869608" value="[可编辑]产业细类" type="text" /></td>
                        <td class="fname"><input id="$label869609$" class="Label" name="label869609" value="子业态" type="text" /></td>
                        <td class="fvalue"><input id="$field869609$" class="InputStyle" name="field869609" value="[可编辑]子业态" type="text" /></td>
                    </tr>
                    <tr>
