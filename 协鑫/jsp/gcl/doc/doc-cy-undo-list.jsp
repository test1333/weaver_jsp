									...
									<TABLE width="100%">
										<tr>
											...
											<div id="list1">
												...
												String backfields =" id,requestid,(select requestname from workflow_requestbase where requestid=a.requestid) as requestname,gwbh,fwbh,fwrq,wjbt,fwzt,tjbm,tjrfb,tjren,tjrq,(select mj from "+tablenamemj+" where id=a.mj) as mjname,mj,mjts,(select jjcd from "+tablenamejjcd+" where id=a.jjcd) as jjcdname,jjcd,jjcdts,sjzzcyr,sjzzjsrq||' '||sjzzjssj as sjzccysj,bcjzzcyr,bcjzzjsrq||' '||bcjzzjssj as bcjzzjssj, bcjzzcyrq||' '||bcjzzcysj as bcjzzcysj,(select t.requestid from "+wftablename+" t,workflow_requestbase t1 where t1.requestid = t.requestid and t1.currentnodetype=0 and t.sjcyid=a.id and rownum=1) as wtjcyzlc ,(select t1.requestname from "+wftablename+" t,workflow_requestbase t1 where t1.requestid = t.requestid and t1.currentnodetype=0 and t.sjcyid=a.id and rownum=1) as requestname2";
												String fromSql  = " from  "+tablename+" a ";
												String sqlWhere = " cllx='0' and 1=1 ";
												...
												tableString =" <table  tabletype=\"none\" pagesize=\""+perpage+"\" >"+
													...
													"              <col width=\"8%\" text=\"流程\" column=\"requestname\" orderkey=\"requestname\" linkvaluecolumn=\"requestid\" linkkey=\"requestid\" href=\"/workflow/request/ViewRequest.jsp\" target=\"_fullwindow\" />"+
														...
														" 	<col width=\"8%\" text=\"未提交传阅子流程\" column=\"requestname2\" orderkey=\"requestname2\" linkvaluecolumn=\"wtjcyzlc\" linkkey=\"requestid\" href=\"/workflow/request/ViewRequest.jsp\" target=\"_fullwindow\" />"+
															
														" 	<col width=\"6%\" text=\"操作\" column=\"requestid\" orderkey=\"requestid\"  otherpara=\"column:id\" transmethod=\"gcl.doc.workflow.DocUtil.getCYButton\" hide=\"true\" />"+
