...
<TABLE width="100%">
    <tr>
        <td valign="top">
            ...
            " 	<col width=\"20%\" text=\"所属单位\" column=\"subcompanyid1\" orderkey=\"subcompanyid1\" transmethod=\"weaver.hrm.company.SubCompanyComInfo.getSubCompanyname\"  />" +
