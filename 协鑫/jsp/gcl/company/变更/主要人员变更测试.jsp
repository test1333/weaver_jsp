<table class="ViewForm">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td valign="top"><br />
            <table style="width: 100%; word-wrap: break-word; left: 0px" id="table3button" class="form" name="table3button">
                <tbody>
                    <tr>
                        <td style="font-size: 0pt" height="15" colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left">&nbsp;</td>
                        <td align="right">
                        <div id="div3button"><button accesskey="A" id="$addbutton3$" class="BtnFlow" name="addbutton3" onclick="addRow3(3);return false;"><u>A</u>-添加</button><button accesskey="E" id="$delbutton3$" class="BtnFlow" name="delbutton3" onclick="deleteRow3(3);return false;"><u>E</u>-删除</button></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                        <table style="width: 100%" id="oTable3" class="ListStyle detailtable" name="oTable3">
                            <colgroup><col width="34%"></col></colgroup>
                            <tbody>
                                <tr class="header detailtitle">
