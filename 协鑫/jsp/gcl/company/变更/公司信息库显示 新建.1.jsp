                                    ...
                                    <table id="oTable1" class="ListStyle detailtable" style="width: 100%" name="oTable1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="detailtable"><input id="$field1775245$" class="InputStyle" name="field1775245" value="[可编辑]开始日期" type="text" /></td>
                                                <td class="detailtable"><input id="$field1775246$" class="InputStyle" name="field1775246" value="[可编辑]结束日期" type="text" /></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    </td>
                                    ...
                                    <table id="oTable2" class="ListStyle detailtable" style="width: 100%" name="oTable2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="detailtable"><input id="$field1775248$" class="InputStyle" name="field1775248" value="[可编辑]开始日期" type="text" /></td>
                                                <td class="detailtable"><input id="$field1775249$" class="InputStyle" name="field1775249" value="[可编辑]结束日期" type="text" /></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    </td>
