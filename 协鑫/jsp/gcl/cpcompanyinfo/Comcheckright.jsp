...
//			}
		    ...
		    <td colspan=3>
			  ...
			  <ul class="FL">
			    ...
			    <ul class="OContRightMsg2 FR" style="height: 20px">
					...
					<li><a onclick="javaScript:onPermissionDel('<%=opertype%>','frmmain2','1');" class="hover" style="font-size: 12px;color: #fff;cursor: pointer;"><div><div><%=SystemEnv.getHtmlLabelName(23777,user.getLanguage())%></div></div></a></li>
				    <li>&nbsp;</li>
				</ul>  
        ...
        <FORM name="frmmain2_2" action="" method="post">
            <%
                opertype = 22;//操作类型
            %>
            <table style="width:100%;font-size: 12px" border="0" cellpadding="0" cellspacing="1" class="stripe OTable">
	...
	function resDirAccessRightAdd(opertype){
		...
		var msg = window.showModalDialog("/cpcompanyinfo/ComcheckAccessRightAdd.jsp?opertype="+opertype+"&comid=<%=comid%>",window, "dialogWidth:450px; dialogHeight:250px; dialogLeft:"+xposition+"px; dialogTop:"+yposition+"px; status:no;scroll:no;resizable=no;");
   	 	if(msg=='1'){
