...
String titlename =SystemEnv.getHtmlLabelName(125907,user.getLanguage());
String needfav ="1";
String needhelp ="";
int temp=0;
	...
	<td valign="top" >
		...
		<script type="text/javascript">
			...
			function dosave_gd(){
					...
					if(mm(arr)){
							alert("<%=SystemEnv.getHtmlLabelName(31340,user.getLanguage()) %>【"+mm(arr)+"】!");
							return;
					}		
					if(l>0){
