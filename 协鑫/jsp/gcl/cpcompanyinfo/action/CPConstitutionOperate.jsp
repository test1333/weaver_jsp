...
<%
	...
	String REGISTERCAPITAL = Util.null2String(request
			.getParameter("registercapital_zc"));
	String PAICLUPCAPITAL = Util.null2String(request
			.getParameter("paiclupcapital_zc"));
	...
	if ("add".equals(method)) {
		...
		strSql
				.append(" (PAICLUPCAPITAL,REGISTERCAPITAL,companyid,aggregateinvest,currencyid,isvisitors,boardvisitors,visitbegindate,");
		strSql
		...
		strSql.append(" values('"+PAICLUPCAPITAL+"','"+REGISTERCAPITAL+"'," + companyid + ",'" + aggregateinvest
		...
		if(isaddversion.equals("add")){
			...
			if(rs.next()){
				...
				strSql.setLength(0);
				strSql.append("insert into CPCONSTITUTIONVERSION (PAICLUPCAPITAL,REGISTERCAPITAL,constitutionid,versionnum,versionname,versionmemo,versionaffix,Createdatetime,");
				...
				strSql.append(" values ('"+PAICLUPCAPITAL+"','"+REGISTERCAPITAL+"',"+constitutionid+",'"+versionnum+"','"+versionname+"','"+versionmemo+"','"+versionaffix+"','"+date2Version+"',");
		...
		if(isaddversion.equals("add")){
			...
			if(maxnum.equals("") || maxnum.compareTo(versionnum)<0){
				...
				strSql.append(" REGISTERCAPITAL='"+REGISTERCAPITAL+"',");
				strSql.append(" PAICLUPCAPITAL='"+PAICLUPCAPITAL+"',");
		...
		//版本号重复
		out.clear();
		out.print("版本号"+versionnum+"已经存在,数据保存失败!");
	}
		...
		if(rs.next()){
			...
			cpconstitution.setRegistercapital(rs.getString("REGISTERCAPITAL"));
			cpconstitution.setPaiclupcapital(rs.getString("PAICLUPCAPITAL"));
