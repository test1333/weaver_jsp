...
<%
	...
	String chairman = Util
			.null2String(request.getParameter("chairman_dsh"));
	String faren = Util
...
//		System.out.println("SQL:"+strSql.toString());
		...
		if(!ProManageUtil.checkEdition("director", "", companyid, versionnum)){
			...
			if(isaddversion.equals("add")){
                ...
                while (rs.next()) {
                    old_dsh+="届数:"+rs.getString("sessions");
                    old_dsh+=",董事姓名:"+rs.getString("officename")+"<br/>";
                }
                ...
                rs.executeSql(mysql1);
                while (rs.next()) {
                    old_jsh+="届数:"+rs.getString("sessions");
                    old_jsh+=",监事姓名:"+rs.getString("supername")+"<br/>";
                }
            ...
            if (rs.next()) {
                ...
                if (!old_faren.equals(new_faren)) {
                    beforeStr+="法人:"+old_faren+"<br/>";
                    afterStr+="法人:"+new_faren+"<br/>";
                }
                if (!old_zjl.equals(new_zjl)) {
                    beforeStr+="总经理:"+old_zjl+"<br/>";
                    afterStr+="总经理:"+new_zjl+"<br/>";
                }
