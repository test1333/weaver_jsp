...
<html>
	...
	<body>
        		...
        		String tableString="";	
				String pagesize="10";
				String backfields=" tt1.plog_id,tt1.plog_coding,tt1.plog_proname,tt1.plog_desc,tt1.plog_data,tt1.plog_person,"+language+" as language,tt1.plog_time,t1.companyname,t3.name ";
...
//out.print(sqlwhere);
			    ...
			    "<head>";
                    ...
                    tableString+="	<col   text=\""+"业务名称" +"\" width=\"270\"  column=\"plog_proname\"       transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getYwmc\"	 	 />";
