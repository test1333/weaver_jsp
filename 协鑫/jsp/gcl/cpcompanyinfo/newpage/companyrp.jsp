...
<%
    ...
    String fromsqlwhere=Util.null2String(request.getParameter("fromsqlwhere"));
//    out.println("fromsqlwhere:"+fromsqlwhere);
...
//    System.out.println("sqlwhere:"+sqlwhere);
	...
	tableString .append(" <table instanceid=\"workflowRequestListTable\" tabletype=\"none\" pagesize=\"100000\" width=\"100%\" isfixed=\"true\" isnew= \"true\" _style= \"true\"> ");
	...
	tableString .append(" <head>");         
	 if(zrrid.equals(businesstype)){
	 		...
	 		tableString.append("	<col   text=\""+SystemEnv.getHtmlLabelName(714,user.getLanguage()) +"\"  column=\"archivenum\"   orderkey=\"archivenum\"  align=\"center\"   		width=\"5%\"  />");
		    tableString.append("	<col   text=\""+SystemEnv.getHtmlLabelName(28100,user.getLanguage()) +"\" column=\"companyregion\"    align=\"center\" transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getCompanyRegion\" width=\"5%\"	 />");
		    tableString.append("	<col   text=\""+SystemEnv.getHtmlLabelName(31445,user.getLanguage()) +"\" column=\"companyname\"   align=\"center\"  width=\"5%\"	otherpara=\""+refCompanyNameParam+"\"  transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.setCompanyNameRef\" />");
		    tableString.append("	<col  text=\""+SystemEnv.getHtmlLabelName(30585,user.getLanguage()) +"\" column=\"companyid\"        otherpara=\""+refComlog+"\"   align=\"center\"   width=\"5%\"   transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getOperating\" />");
	 }else{
	 	    tableString.append("	<col   text=\""+"管理隶属" +"\"  column=\"businesstype\"   orderkey=\"businesstype\"  align=\"center\" transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getGuanliguishu\"  	width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"公司全称" +"\"  column=\"companyname\"   orderkey=\"companyname\"  align=\"center\"   		width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"股东名册/股东比例" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"  transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getGdmc\"  		width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"董事名册" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   	transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getDsmc\" 	width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"监事名册" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   	transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getJsmc\"	width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"法定代表人" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getFaren\"		width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"总经理" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   	transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getZjl\"	width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"成立时间" +"\"  column=\"foundingtime\"   orderkey=\"foundingtime\"  align=\"center\"   		width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"注册地址" +"\"  column=\"companyaddress\"   orderkey=\"companyaddress\"  align=\"center\"   		width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"注册号" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getYyzzNo\"		width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"代码证号" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getZzjgNo\"		width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"税务登记号" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getSwdjgNo\"		width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"注册资金" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   	transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getZczj\"	width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"实际出资情况" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"  transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getGdsjcz\" 		width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"用途" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   	transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getGdyt\"	width=\"5%\"  />");
	 	    tableString.append("	<col   text=\""+"年检情况" +"\"  column=\"companyid\"   orderkey=\"companyid\"  align=\"center\"   transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getNjqk\"		width=\"5%\"  />");
//	 	    tableString.append("	<col   text=\""+"法人" +"\"  column=\"archivenum\"   orderkey=\"archivenum\"  align=\"center\"   		width=\"5%\"  />");
//	 	    tableString.append("	<col   text=\""+"董事会" +"\"  column=\"archivenum\"   orderkey=\"archivenum\"  align=\"center\"   		width=\"5%\"  />");
//	 	    tableString.append("	<col   text=\""+"公司证照" +"\"  column=\"archivenum\"   orderkey=\"archivenum\"  align=\"center\"   		width=\"5%\"  />");
//	 	    tableString.append("	<col   text=\""+"股东" +"\"  column=\"archivenum\"   orderkey=\"archivenum\"  align=\"center\"   		width=\"5%\"  />");
//	 	    tableString.append("	<col   text=\""+"章程" +"\"  column=\"archivenum\"   orderkey=\"archivenum\"  align=\"center\"   		width=\"5%\"  />");
...
//		    tableString.append("	<col   text=\""+SystemEnv.getHtmlLabelName(20668,user.getLanguage()) +"\" column=\"registercapital\"    align=\"center\"  width=\"8%\" />");
		    tableString.append("	<col   text=\""+SystemEnv.getHtmlLabelName(23797,user.getLanguage()) +"\" column=\"usefulenddate\"   width=\"5%\"	 align=\"center\" otherpara=\""+refFarenParam+"_"+language+"\"  transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getToCompairDate2\"  />");
		    tableString.append("	<col   text=\""+SystemEnv.getHtmlLabelName(30936,user.getLanguage()) +"\" column=\"appointenddate\"    align=\"center\"   width=\"5%\" otherpara=\""+refDshParam+"_"+language+"\"  transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getToCompairDate2\" />");
		    tableString.append("	<col   text=\""+SystemEnv.getHtmlLabelName(30958,user.getLanguage()) +"\" column=\"companyid\"    align=\"center\"   width=\"5%\" otherpara=\""+refZhzhParam+"_"+language+"\"  transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getToCompairLicenseDate2\" />");
		    tableString.append("	<col   text=\""+SystemEnv.getHtmlLabelName(28421,user.getLanguage()) +"\" column=\"companyid\"    align=\"center\"   width=\"5%\" otherpara=\""+language+"\"   transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getToGd2\"  />");
		    tableString.append("	<col   text=\""+SystemEnv.getHtmlLabelName(30941,user.getLanguage()) +"\" column=\"effectenddate\"    align=\"center\"   width=\"5%\" otherpara=\""+refZhchParam+"_"+language+"\"  transmethod=\"weaver.cpcompanyinfo.CompanyInfoTransMethod.getToCompairDate2\" />");
	 }
...
<body>
<FORM id=searchForm name=searchForm action="CompanyInfoList.jsp" method=post style='display:none' >
...
<div style='display:none' >
    <button onclick="toggle(this)" id="ishideBtn"><%="1".equals(ishide)?"显示条件":"隐藏条件" %></button>
                                        ...
                                        <div style="">
                                            <wea:SplitPageTag   tableString="<%=tableString.toString()%>"  mode="run"  isShowTopInfo="false" isShowBottomInfo="false"/>
	</div>
...
function toggle(obj){
    ...
    function viewreport(){
        var url="/cpcompanyinfo/newpage/companyrp.jsp?businesstype=<%=businesstype %>&fromsqlwhere=<%=sqlwhere %>";
        window.open(url);
    }
