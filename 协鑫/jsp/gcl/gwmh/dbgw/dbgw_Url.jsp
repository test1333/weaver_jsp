...
<%
	String arrOtherTab="[";
	// arrOtherTab+="{	title:'公文子流程代办',autoScroll : true,url:'/gcl/gwmh/dbgw_all.jsp',id:'t8887'}";
	arrOtherTab+=",{title:'人事任免',autoScroll : true,url:'/gcl/gwmh/dbgw_rsrm.jsp',id:'t8888'}";
	arrOtherTab+=",{title:'行政公告',autoScroll : true,url:'/gcl/gwmh/dbgw_xzgg.jsp',id:'t8889'}";
	arrOtherTab+=",{title:'会议纪要',autoScroll : true,url:'/gcl/gwmh/dbgh_hyjy.jsp',id:'t8890'}";
	arrOtherTab+="]";
			...
			<table cellpadding="0" cellspacing="0" width="100%" border="0">
			  	<tr>
					...
					<td>
						<div id="tab-center" >
							<ul>
								<li sid='OA1'  first=yes url='/gcl/gwmh/dbgw/dbgw_all.jsp'><div class="tab-selected tab-item" ><a href='javascript:void(0)'>待办传阅子流程</a></div><li-->
								<li sid='OA2'  url='/gcl/gwmh/dbgw/dbgw_rsrm.jsp'><div class="tab-item" ><a href='javascript:void(0)'>人事任免</a></div><li>
								<li sid='OA3'  url='/gcl/gwmh/dbgw/dbgw_xzgg.jsp'><div class="tab-item" ><a href='javascript:void(0)'>行政公告</a></div><li>
								<li sid='OA4'  url='/gcl/gwmh/dbgw/dbgh_hyjy.jsp'><div class="tab-item" ><a href='javascript:void(0)'>会议纪要</a></div><li>
							</ul>
						</div>
					</td>
					<td width="6px" style="">
	...
	<tr style="height:100%">
		<td colspan="3" style="height:100%">
		  ...
		  <div id="content" style="height:100%">
				<iframe src='/gcl/gwmh/dbgw/dbgw_all.jsp'  id='iframepage'  frameBorder=0 scrolling=auto width=100% height='100%' onload="loading()"  style='display:block;'></iframe>
		  </div>
		</td>
	</tr>
</table>
