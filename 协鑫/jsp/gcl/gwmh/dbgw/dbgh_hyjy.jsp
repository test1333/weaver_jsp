    ...
    <tr>
        <td valign="top">
            <%
                ...
                String sqlWhere = " where a.requestid = b.requestid and b.isremark not in(2,4,8,9) and b.islasttimes=1  and a.workflowid = 690125  and c.gwlx =3 and b.userid ='"+emp_id+"'";
				// if (emp_id!=1) {
