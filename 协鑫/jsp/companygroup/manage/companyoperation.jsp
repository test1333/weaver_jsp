...
<%
	...
	if(user != null)  {
		...
		if(method.equals("queryCompanyForSelect")){//AB公司-公司来源
			...
			/* String key = Util.null2String(request.getParameter("key"));
			String value = Util.null2String(request.getParameter("value"));
			System.out.println("输入条件"+key+"%%%"+value+"%%%");
			String ids = cm.getGroupHighLights(groupid,key,value);
			...
			System.out.println(" 公司查询"+xml);  */
			
			/* out.println("<?xml version=\"1.0\" encoding=\"GBK\"?>");
			out.println("<item id=\"341\" cnName=\"lm001\" enName=\"\" archivenum=\"lm001\" selected=\"false\" Investment=\"342/100.0|343/22.0\" isshow=\"342/1|343/1\">");
			out.println("<item id=\"342\" cnName=\"lm002\" enName=\"我是英文公司\" archivenum=\"lm002\" selected=\"true\"/>");
			out.println("<item id=\"343\" cnName=\"lm003\" enName=\"\" archivenum=\"lm003\" selected=\"false\"/></item>"); */
