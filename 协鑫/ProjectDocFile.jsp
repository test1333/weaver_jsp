...
String[] arr = {"178","181","182","160","163","164","161","178","165","167","168","159","162"};
	...
	String sql = "select * from workflow_billfield where fieldhtmltype=6 and billid in("+str+") and viewtype=0";
...
//	out.prinln(projectID);	
	...
	String backfields = " t1.id, t1.docCreaterId,t1.userType,t1.doccreatedate,t1.doccreatetime,t1.docStatus,"
		+"t1.docSubject,t1.maincategory,t1.subCategory,t1.secCategory,t1.docextendname,t1.ownerid,t1.ownerType,"
		+"(select imagefileid from docimagefile d where d.docid=t1.id) as fileid,'附件' as sy"; 
...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(PageIdConst.HRM_ONLINEUSER,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+PageIdConst.HRM_ONLINEUSER+"\">"+
    ...
    "			<head>";                                                                                                                                                  
		...
		"       <col width=\"5%\"  text=\" \" column=\"docextendname\" orderkey=\"docextendname\" transmethod=\"weaver.splitepage.transform.SptmForDoc.getDocIconByExtendName\"/>"+
	 	"		<col width=\"20%\"  text=\""+SystemEnv.getHtmlLabelName(58,user.getLanguage())+"\" labelid=\"58\" column=\"id\" otherpara=\"column:docSubject\" transmethod=\"weaver.splitepage.transform.SptmForDoc.getDocNameForDocMonitor\"  orderkey=\"docSubject\" linkvaluecolumn=\"fileid\" linkkey=\"fileid\" href=\"/weaver/weaver.file.FileDownload?coworkid=-1\" target=\"_fullwindow\" />"+
