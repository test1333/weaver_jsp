...
Call LMConfig_U_ByInfoInsert (2,3954002,2);
Call LMInfo_Insert (3954004,3954005,'/images_face/ecologyFace_2/LeftMenuIcon/level3.gif','/gcl/company/company-info-list-ex.jsp',2,3954002,2,13);
select * from LeftMenuInfo where parentid=3954002 for update
