...
er.addStringValue("申请金额");//可用预算数
String lastOrgNameKey = "";
String feeperiodFullNameKey = "";

String sql = "select *,approvalAmt+actualAmt sqje from "+rptTbName+" where guid1 = '"+StringEscapeUtils.escapeSql(_guid1)+"' order by id";
rs.executeSql(sql);
while(rs.next()){
	...
	String sqje = Util.null2String(rs.getString("sqje"));
	...
	er.addStringValue(fnaSplitPageTransmethod.fmtAmount(sqje));
}
