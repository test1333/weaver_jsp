...
//}
	...
	String approve = "";
	String workprocess = "";
	String sql3 = "select checkwriteend,approve,workprocess from uf_checkrecord where id = "+checkid+"";
	rs.executeSql(sql3);
		if(rs.next()){
	...
	if(approve.equals("")){
		...
		RCMenu += "{盘点结束,javascript:checkWriteEnd(),_self} " ;
		...
		RCMenu += "{提交,javascript:approval(),_self} " ;
		RCMenuHeight += RCMenuHeightStep ;
  }
}
   if(count_cc!=0&&!approve.equals("")&&workprocess.equals("2")){
		...
		<FORM id=report name=report action="" method=post>
			...
			<table id="topTitle" cellpadding="0" cellspacing="0">
				...
				<%}%>
				<%if(count_vv!=0&&approve.equals("")&&!isEnd.equals("")){%>	
					<input type="button" 
						value="提交"
		...
		String backfields = " a.id as cate,b.id as idkey,a.catename, c.goodsname,b.goodscate,b.goodsname as goodsnamex, "+
		                   "  b.goodsno,b.originalx, b.original,b.actual,b.stock,b.difference,b.remark,b.explanation,b.assets, "+
		...
		if(count_ss!=0&&isEnd.equals("")){
		    ...
		    operateString =  "<operates width=\"20%\">"+
		                    ...
		                    "</operates>";
		}else if(count_vv!=0&&workprocess.equals("1")){
		    operateString = "<operates width=\"20%\">"+
		                    " <popedom transmethod=\"weaver.hrm.common.SplitPageTagOperate.getBasicOperate\" otherpara=\""+String.valueOf(user.isAdmin())+":true:true:true:true\"></popedom> "+
		...
		if(isEnd.equals("")){
			...
			"				<col width=\"20%\" labelid=\"备注说明\" text=\"备注说明\" column=\"remark\" orderkey=\"remark\"/>"+
		"			</head>"+
	" </table>";
	}else{
				...
				"				<col width=\"12%\" labelid=\"资产名称\" text=\"资产名称\" column=\"goodsname\" orderkey=\"goodsname\" linkvaluecolumn=\"assets\" linkkey=\"billid\" href=\"/formmode/view/ViewMode.jsp?type=0&amp;modeId=82&amp;formId=-122\" target=\"_fullwindow\" />"+
				"				<col width=\"13%\" labelid=\"资产编号\" text=\"资产编号\" column=\"goodsno\" orderkey=\"goodsno\"/>"+
				...
				"				<col width=\"12%\" labelid=\"备注\" text=\"备注\" column=\"remark\" orderkey=\"remark\"/>"+
				"				<col width=\"13%\" labelid=\"批注\" text=\"批注\" column=\"commenton\" orderkey=\"commenton\"/>"+
			"			</head>"+
		" </table>";
	}
	...
	<script type="text/javascript">
	   ...
	   diag_vote.close();
		...
		function checkWriteEnd() {
			...
			document.report.action = "/seahonor/jsp/IsEndRefersh.jsp";
