...
<html>
	<head>
		...
		<script type="text/javascript"> 
			...
			function getParam(){
				return "currentdate="+document.frmMain.currentdate.value+"&resourceId="+$GetEle("resourceId").value+"&departmentId="+$GetEle("departmentId").value+"&rstr="+randomString(10)+"&subCompanyId="+$GetEle("subCompanyId").value;
			}
