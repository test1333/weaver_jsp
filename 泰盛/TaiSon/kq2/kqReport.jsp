			...
			function exportExcel(){
				if(check_form(document.frmMain,"fromDate,toDate")){
					if(document.frmMain.fromDate.value > document.frmMain.toDate.value) {
						...
						document.getElementById("excels").src = "kqReportExcel.jsp?cmd=HrmScheduleDiffReport&tnum=20078&fromDate="+document.frmMain.fromDate.value+"&toDate="+document.frmMain.toDate.value+"&resourceId="+$GetEle("resourceId").value+"&departmentId="+$GetEle("departmentId").value+"&subCompanyId="+$GetEle("subCompanyId").value;
					}
				}
			}
		</script>
