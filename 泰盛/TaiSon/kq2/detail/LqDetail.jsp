...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/TaiSon/kq/detail/LqDetail.jsp" method=post>
		...
		String sqlWhere =  " 1=1 and a.emp_id=b.id and b.departmentid=c.id and  atten_day <='"+toDate+"' and atten_day>='"+fromDate+"' and nvl(isex,-1)='1'";
	...
	<script type="text/javascript">
		...
		function exportExcel(){
				document.getElementById("excels").src = "/TaiSon/kq/kqReportExcel.jsp?cmd=HrmScheduleDiffNoSignDetail&tnum=20091&fromDate=<%=fromDate%>&toDate=<%=toDate%>&resourceId=<%=resourceId%>&departmentId=<%=departmentId%>&subCompanyId=<%=subCompanyId%>";
		}
