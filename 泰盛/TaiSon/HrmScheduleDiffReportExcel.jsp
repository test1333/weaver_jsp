...
<table  border=1  bordercolor=black style="border-collapse:collapse;" width="100%" >
	...
	<tbody>
		<tr>
			<td colspan="<%=12+qSize%>" align="center" ><font size=4><b><%=fileName%></b></font></td>
		</tr>
		<tr>
			<td colspan="<%=12+qSize%>" align="right" ></td>
		</tr>
		<tr>
	...
	%>
		<tr>
			...
			<%
				String oldbeLate=Util.null2String(strUtil.vString(scheduleMap.get("beLate")));
				String beLate = "";
				if(!"".equals(oldbeLate)) {
					if(Util.getIntValue(oldbeLate, 0)<=2) {
						beLate = "0";
					}else {
						beLate = String.valueOf(Util.getIntValue(oldbeLate,0)-2);
					}
				}
			
			%>
			<td align="right"><%=beLate%></td>
