...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/TaiSon/kq/detail/BelateDetail.jsp" method=post>
		...
		String sqlWhere =  " 1=1 and a.emp_id=b.id and b.departmentid=c.id and  atten_day <='"+toDate+"' and atten_day>='"+fromDate+"' and nvl(late_times,0)>0";
		...
		"			<head>";
				tableString +="<col width=\"13%\" text=\""+SystemEnv.getHtmlLabelName(124,user.getLanguage())+"\" column=\"departmentName\" orderkey=\"departmentName\"  />"+ 
							...
							"<col width=\"10%\" text=\""+SystemEnv.getHtmlLabelName(20035,user.getLanguage())+"\" column=\"signTime\" orderkey=\"signTime\"  />"+ 
	...
	<script type="text/javascript">
		...
		function exportExcel(){
				document.getElementById("excels").src = "/TaiSon/kq/kqReportExcel.jsp?cmd=HrmScheduleDiffBeLateDetail&tnum=20088&fromDate=<%=fromDate%>&toDate=<%=toDate%>&resourceId=<%=resourceId%>&departmentId=<%=departmentId%>&subCompanyId=<%=subCompanyId%>";
		}
