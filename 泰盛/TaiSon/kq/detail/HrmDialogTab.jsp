		...
		<%
			...
			if(_fromURL.equals("NetworkSegmentStrategyAdd")){
				...
				if(cmd.equals("schedulediff")){//考勤相关报表
					...
					url = "/hrm/report/schedulediff/"+method+".jsp?isdialog=1&fromDate="+fromDate+"&toDate="+toDate+"&validDate="+validDate+"&subCompanyId="+subCompanyId+"&departmentId="+departmentId+"&resourceId="+resourceId;
					...
					String resourceId = Util.null2String(request.getParameter("resourceId"));
					title = "15880,17463";
					url = "/TaiSon/kq/detail/HrmScheduleDiffMonthAttDateDetail.jsp?isdialog=1&curDate="+curDate+"&resourceId="+resourceId;
				}
				...
				url = "/hrm/schedule/PSLPeriodAdd.jsp?isdialog=1&subcompanyid="+subcompanyid;
			}else if(_fromURL.equals("PSLPeriodEdit")){
				//中端--考勤管理--带薪病假有效期设置编辑
				title = "24036";
				String subcompanyid = Util.null2String(kv.get("subcompanyid"));
				url = "/hrm/schedule/PSLPeriodEdit.jsp?isdialog=1&id="+id+"&subcompanyid="+subcompanyid;
			}else if(_fromURL.equals("PSLBatchAdd")){
				//中端--考勤管理--带薪病假批量处理设置
				title = "24038";
				String subcompanyid = Util.null2String(kv.get("subcompanyid"));
				url = "/hrm/schedule/PSLBatchAdd.jsp?isdialog=1&subcompanyid="+subcompanyid;
			}else if(_fromURL.equals("PSLBatchEdit")){
				//中端--考勤管理--带薪病假批量处理设置
				title = "24038";
				String subcompanyid = Util.null2String(kv.get("subcompanyid"));
				url = "/hrm/schedule/PSLBatchEdit.jsp?isdialog=1&id="+id+"&subcompanyid="+subcompanyid;
				...
				String alloption = Util.null2String(request.getParameter("alloption"));
