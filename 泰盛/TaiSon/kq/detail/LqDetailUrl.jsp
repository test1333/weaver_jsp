...
<%
  ...
  Integer lg=(Integer)user.getLanguage();
	String url_1 = "";
	url_1 = "/TaiSon/kq/detail/LqDetail.jsp?fromDate="+fromDate+"&toDate="+toDate+"&subCompanyId="+subCompanyId+"&departmentId="+departmentId+"&resourceId="+resourceId;
%>
