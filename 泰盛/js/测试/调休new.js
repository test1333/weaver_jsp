...
var leaveMonth = "#field35890";//跨越辅助字段
var startTime = "#field16273";
var endTime = "#field16275"; 
var fqsjjy = "#field16905"; //发起时间校验
        ...
        if(leaveTypeValue === '27'){
            if(annualLeaveDaysValue > 0){
                if(breakOffDaysValue === '0'){
                     window.Dialog.alert("温馨提示：请优先使用年休假，年休假剩余天数为（"+annualLeaveDaysValue+"天），调休假剩余天数为（"+breakOffDaysValue+"天）");
                   flag = "0";
				   return;
                }
            }
