...
<wea:layout type="4col">
	...
	while(rs.next()){
		...
		CrmFieldComInfo comInfo = new CrmFieldComInfo("CRM_SellChance",rs.getString("id")) ;
		%>
...
function searchSubject(){
	...
	window.frmmain.action = "/CRM/sellchance/ListSellChance.jsp?&subject="+searchSubject;
