...
//modify start by tangjianyong 2017-11-01
tableString += 
			"<col width=\"20%\"  text=\""+SystemEnv.getHtmlLabelName(345,user.getLanguage())+"\" column=\"description\" orderkey=\"description\"/>"+
			"<col width=\"19%\"  text=\""+SystemEnv.getHtmlLabelName(229,user.getLanguage())+"\" column=\"name\" orderkey=\"name\" otherpara=\"column:id+column:crmid\"  transmethod=\"weaver.crm.report.CRMContractTransMethod.getContactName\"/>"+
			"<col width=\"8%\"  text=\""+SystemEnv.getHtmlLabelName(15534,user.getLanguage())+"\" column=\"urgentLevel\" orderkey=\"urgentLevel\"   otherpara=\""+language+"\" transmethod=\"weaver.splitepage.transform.SptmForCrm.getUrgentName\"/>"+			
			...
			"<col width=\"8%\"  text=\"联系人\" column=\"lxrname\" orderkey=\"lxrname\" />"+
			"<col width=\"10%\"  text=\"联系人电话\" column=\"lxrtel\" orderkey=\"lxrtel\"/>"+
			...
			"<col width=\"10%\"  text=\""+SystemEnv.getHtmlLabelName(1275,user.getLanguage())+"\"  column=\"begindate\" orderkey=\"begindate\" otherpara=\"column:begintime\" transmethod=\"weaver.splitepage.transform.SptmForCrm.getTime\"/>";
//modify end by tangjianyong 2017-11-01
