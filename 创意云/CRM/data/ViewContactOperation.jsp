...
<%
	...
	//添加联系记录
		...
		String lxrname = Util.null2String(request.getParameter("lxrname"));
		String lxrtel = Util.null2String(request.getParameter("lxrtel"));
		 if(!"".equals(workplanid)){
			String  sql_lxr="insert into contact_record_person(workplanid,name,tel) values("+workplanid+",'"+lxrname+"','"+lxrtel+"')";
			 rs.executeSql(sql_lxr);
		 }
