...
<%
	...
	url_1 = "/fx/annual/jsp/AnnualUndo.jsp";
	//url_2 = "/Mubea/guard/jsp/GuardDone.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">年假发放</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">待发放<span id="allNum_span"></span></a>
				</li>
				<!--<li class="">
					<a target="tabcontentframe" href="<%=url_2%>">已处理</a>
				</li>
                <li class="">
