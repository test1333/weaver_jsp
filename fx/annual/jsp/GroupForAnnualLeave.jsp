...
<%
	...
	url_1 = "/fx/annual/jsp/fx_annual_leave.jsp";
    url_2 = "/fx/annual/jsp/fx_tiaoxiu_leave.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">假期查询</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">年假列表<span id="allNum_span"></span></a>
				</li>
				<li class="">
					<a target="tabcontentframe" href="<%=url_2%>">调休列表</a>
				</li>
                <!--<li class="">
