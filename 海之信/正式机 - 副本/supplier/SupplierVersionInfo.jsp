...
//	alert(123);
	var title = "";
	var url = "/seahonor/crm/CustomVersionInfoDetail.jsp?type=supplier&customID="+id;
...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(tmc_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+tmc_pageId +"\">"+
    ...
    operateString+
    "			<head>";
		tableString+="<col width=\"15%\" labelid=\"17401\" text=\"供应商名称\" column=\"name\" orderkey=\"name\"/>"+
	...
	"				<col width=\"10%\" labelid=\"-9371\" text=\"邮编编码\" column=\"zipcode\" orderkey=\"zipcode\"   />"+
	"				<col width=\"10%\" labelid=\"-9370\" text=\"公司邮箱\" column=\"email\" orderkey=\"email\"   />"+
