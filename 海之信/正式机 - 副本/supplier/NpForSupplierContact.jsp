...
//	out.prinln(tmp_name_x);	
	...
	String backfields = " id,Name,SysNo,dept,Position,tel,(select name from uf_supplier where id=f.Supplier) as cname,'未校对' as status "; 
	String fromSql  = " from uf_Contacts f ";
	String sqlWhere = " where SuperID is null and dealStatus=0 and isnull(Supplier,'')<>'' ";
	String orderby = " id " ;
	String tableString = "";
...
+		"	   <sql backfields=\""+backfields+"\" sqlform=\""+fromSql+"\" sqlwhere=\""+Util.toHtmlForSplitPage(sqlWhere)+"\"  sqlorderby=\""+orderby+"\"  sqlprimarykey=\"id\" sqlsortway=\"desc\" sqlisdistinct=\"false\"/>"+
    operateString+
    "			<head>";                                                                                                                                        
		tableString+="<col width=\"10%\" labelid=\"17062\" text=\"联系人名字\" column=\"Name\" orderkey=\"Name\" linkvaluecolumn=\"id\" linkkey=\"billid\" href=\"/formmode/view/ViewMode.jsp?type=0&amp;modeId=64&amp;formId=-63&amp;opentype=0&amp;customid=83&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\"/>"+
	  "				<col width=\"10%\" labelid=\"17401\" text=\"供应商名称\" column=\"cname\" orderkey=\"cname\"  />"+
...
%>
	...
	function onCheckup(){
		...
		//		alert("ids = " + ids);
				...
				document.report.action = "/seahonor/supplier/NpForSupplierContactOper.jsp";
			//	obj.disabled = true;
