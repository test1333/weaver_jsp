	...
	<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;">
		...
		<table width="90%" align="center">
	  	  	<colgroup> <col width="35%" /><col width="10%" /><col /></colgroup> 
	  	       ...
	  	       <tr> 
	  	       	<% 
					String sql = "select id,Name,tel,mobile,email,Address,Postcode from uf_Contacts where SuperID is null and dealStatus in(0,1) and Supplier="+customID;
	  	           ...
	  	           <td>
						    ...
						    <tbody>
						        ...
						        <tr style="min-height: 18.75pt;">
						            ...
						            <td valign="top" style="border-width: 0.5pt 0.5pt medium medium; border-style: solid solid none none; border-color: windowtext black currentColor currentColor; font-size: 14pt;" colspan="5"><a href="javascript:openNewInfo1(<%=tmp_id%>);"><font face="宋体"><strong><%=tmp_name%></strong></font></a></td>
						        </tr>
						        <tr style="min-height: 14.25pt;">
...
<script type="text/javascript">
	function openNewInfo1(id) {
		...
		var title = ""; 
		var url = "/formmode/view/ViewMode.jsp?type=0&modeId=64&formId=-63&opentype=0&customid=83&viewfrom=fromsearchlist&billid="+id;
			
		var diag_vote = new window.top.Dialog();
		diag_vote.currentWindow = window;
		diag_vote.Width = 1250;
