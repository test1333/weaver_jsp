...
<%
	...
	String val = request.getParameter("val");
	    ...
	    sql = "select f.Sender,(select lastname from HrmResource where id = f.Sender) as lastname,f.DateTime,fd.Money,fd.ReceiverAdd,fd.kdcode,fd.id as val_detail from formtable_main_76 f,formtable_main_76_dt1 fd where f.id=fd.mainid and fd.id in( " + val +"0 )";//( " + ids + "0 )";
	    rs.executeSql(sql);       
	    //out.print("sql="+sql);
