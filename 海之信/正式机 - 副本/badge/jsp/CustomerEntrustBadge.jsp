...
<HTML>
	...
	String temp_val = "CustomerEntrustBadge";
	%>
	<BODY>
		<div id="tabDiv">
		...
		<FORM id=report name=report action=CustomerEntrustBadge.jsp method=post>
		...
		String backfields = " id,requestid,(select requestname from workflow_requestbase wr where wr.requestid=f.requestId) as request_name,Application,ApplicationDate, Customer ";
		String fromSql  = " from  formtable_main_88 f ";
		//String sqlWhere = " 1=1 ";
