...
<HTML>
	...
	<BODY>
		...
		<FORM id=report name=report action=BadgeOut.jsp method=post>
		...
		String backfields = " id,requestid,(select requestname from workflow_requestbase wr where wr.requestid=f.requestId) as request_name,Application,ApplicationDate,LendSeal ";
		String fromSql  = " from  formtable_main_83 f ";
		//String sqlWhere = " 1=1 ";
		...
		tableString+="<col width=\"25%\" labelid=\"18104\" text=\"流程名称\" column=\"request_name\" orderkey=\"requestid\" linkvaluecolumn=\"requestid\" linkkey=\"requestid\" href=\"/workflow/request/ViewRequest.jsp\" target=\"_fullwindow\" />"+	
			...
			"		<col width=\"10%\" labelid=\"-9650\" text=\"借出印章\" column=\"LendSeal\" orderkey=\"LendSeal\" transmethod=\"seahonor.info.SealInfo.getTreeSealName\"  />"+
		"			</head>"+
	" </table>";
	%>
