...
<%
	...
	url_1 = "/seahonor/attend/jsp/annual/AnnualManagementView.jsp?subCompanyId="+subcompanyid+"&cmd=f&departmentid="+departmentid+"";
 ...
 <BODY scroll="no">
	...
	<div class="e8_box demo2">
		<div class="e8_boxhead">
		    ...
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">年假<span id="allNum_span"></span></a>
				</li>
		    </ul>
