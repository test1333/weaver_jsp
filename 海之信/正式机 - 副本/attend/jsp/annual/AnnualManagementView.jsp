...
if(Util.null2String(request.getParameter("subCompanyId")).length()==0
		&&Util.null2String(request.getParameter("departmentid")).length()==0){
...
//out.print("annualyear="+annualyear);
String tempannualyear = tempyear+"-12-31";
String showname="";
String excelname="";
String sql="";
if(departmentid>0){
...
<wea:layout type="2col" attributes="{'expandAllGroup':'true'}">
  ...
  <%
    ...
    er.addStringValue(SystemEnv.getHtmlLabelName(21811,user.getLanguage()));
