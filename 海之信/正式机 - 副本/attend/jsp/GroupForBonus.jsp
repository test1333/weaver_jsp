...
<%
	...
	url_1 = "/seahonor/attend/jsp/BonusPersonalAll.jsp";
		
	url_2 = "/seahonor/attend/jsp/BonusPersonalDetail.jsp";
	
	url_3 = "/seahonor/attend/jsp/SH_leave_info_new.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">补贴管理</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">汇总<span id="allNum_span"></span></a>
				</li>
				<li class="">
					<a target="tabcontentframe" href="<%=url_2%>">详细</a>
				</li>
		    </ul>
