...
function setCompany(nodeid){
    ...
    //document.SearchForm.action="AnnualManagementHelp.jsp";
	document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=AnnualManagementView&subcompanyid1=-1&cmd=";
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=AnnualManagementView&subcompanyid1="+subid+"&cmd="+cmd;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=AnnualManagementView&departmentid="+deptid+"&subcompanyid1="+subCompanyId+"&cmd="+cmd;;
    document.SearchForm.submit();
}
