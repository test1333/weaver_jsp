...
<%
	...
	if("0".equals(type)){
		...
		String sql_insert_borrow = "insert into uf_BorrowHandleRd (Applicant,Admin,CheckId,Idkey,Assetsname,BorrowNum,Project,ReturnDate,Remark,Mainid,AssetsCate,AssetsNo, "+
		 						   "Layplace,CreateDate,Price,Account,Stock,LeftStock,Brand,Sizex,Configuration)"+
								" values("+applicant+","+userid+","+checkid+","+idkey+","+assets+","+num+","+project+",'"+deTime+"','"+remark+"',"+main_handleid+",'"+goodscate+"',"+
		...
		int num2 = 0;
		String sql_b = "select sum(alreadlyreturn) as num2 from uf_goodsborrow where "+
		...
		String sql_insert_Receive = "insert into uf_ReceiveHandleRd (CheckId,Idkey,Applicant,Admin,CheckId,Idkey,Assetsname,ReceiveNum,Project,Remark,Mainid," +
									" AssetsCate,Layplace,Price,Accout,Stock,LeftStock) "+
								" values("+checkid+","+idkey+","+applicant+","+userid+","+checkid+","+idkey+","+assets+","+num+","+project+",'"+remark+"',"+main_handleid+", "+
		...
		String sql_insert_Rb = "insert into uf_RbHandleRd (CheckId,Idkey,Applicant,Admin,CheckId,Idkey,Assetsname,ReturnBackNum,Remark,Mainid) "+
								" values("+checkid+","+idkey+","+applicant+","+userid+","+checkid+","+idkey+","+assets+","+num+",'"+remark+"',"+main_handleid+")";
		...
		String sql_insert_Loss = "insert into uf_LossHandleRd (CheckId,Idkey,Applicant,Admin,CheckId,Idkey,Assetsname,LossNum,Remark,Mainid) "+
								" values("+checkid+","+idkey+","+applicant+","+userid+","+checkid+","+idkey+","+assets+","+num+",'"+remark+"',"+main_handleid+")";
		...
		String sql_insert_Scrap = "insert into uf_ScrapHandleRd (CheckId,Idkey,Applicant,Admin,CheckId,Idkey,Assetsname,ScrapNum,Account,Remark,Mainid) "+
								" values("+checkid+","+idkey+","+applicant+","+userid+","+checkid+","+idkey+","+assets+","+num+",'"+currency+"','"+remark+"',"+main_handleid+")";
		...
		String sql_insert_Repair = "insert into uf_RepairHandleRd (CheckId,Idkey,Applicant,Admin,CheckId,Idkey,Assetsname,isInPeriod,Account,RepairDays,Content,Remark,Mainid) "+
					" values("+checkid+","+idkey+","+applicant+","+userid+","+checkid+","+idkey+","+assets+","+isindate+",'"+currency+"',"+days+",'"+content+"','"+remark+"',"+main_handleid+")";
