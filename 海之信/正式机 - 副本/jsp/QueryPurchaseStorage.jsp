...
<HTML>
	...
	<BODY>
		...
		String fromSql  = " from  formtable_main_48 f ";
		String sqlWhere = " 1=1 ";
		...
		operateString+
		"			<head>";
		tableString+="<col width=\"25%\" labelid=\"141\" text=\"流程名称\" column=\"request_name\" orderkey=\"requestid\" linkvaluecolumn=\"requestid\" linkkey=\"requestid\" href=\"/workflow/request/ViewRequest.jsp\" target=\"_fullwindow\" />"+
		"<col width=\"25%\" labelid=\"141\" text=\"采购单\" column=\"requestname\" orderkey=\"selectpurchaseorder\" />"+
			"		<col width=\"10%\" labelid=\"124\" text=\"系统编号\" column=\"Sysno\" orderkey=\"Sysno\" />"+		
			"		<col width=\"10%\" labelid=\"141\" text=\"申请人\" column=\"applicant\" orderkey=\"applicant\" transmethod=\"weaver.hrm.resource.ResourceComInfo.getResourcename\" />"+
			"		<col width=\"10%\" labelid=\"124\" text=\"申请日期\" column=\"applicantdate\" orderkey=\"applicantdate\" />"+
