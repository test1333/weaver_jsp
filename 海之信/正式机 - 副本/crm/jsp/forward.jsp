...
<%
    ...
    String falg="0";
	 ...
	 if("editcustom".equals(type)){
	   ...
	   String cur_node = "";
		...
		if("1".equals(falg)){
		 response.sendRedirect("/formmode/view/AddFormMode.jsp?mainid=0&modeId=185&formId=-304&type=2&Id=673&billid="+billid1);  
		}else{
		 response.sendRedirect("/formmode/view/AddFormMode.jsp?mainid=0&modeId=185&formId=-304&type=0&Id=673&billid="+billid1);  	
		}
	}
	...
	if("editcontact".equals(type)){
	   ...
	   String cur_node = "";
		...
		if("1".equals(falg)){
		 response.sendRedirect("/formmode/view/AddFormMode.jsp?mainid=0&modeId=191&formId=-313&type=2&Id=698&billid="+billid1);  
		}else{
		 response.sendRedirect("/formmode/view/AddFormMode.jsp?mainid=0&modeId=191&formId=-313&type=0&Id=698&billid="+billid1);  	
		}
	}
