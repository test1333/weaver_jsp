                    ...
                    <TR>
                      ...
                      <TD class="e8_tblForm_field">
                      		<select name="remindtype" id="remindtype" onchange="remindtypeChange()" style="width: 200px;">
                      			<option value="1" <%if(remindtype==1){%>selected="selected"<%} %> >即时提醒<!-- 即时提醒 --></option>
                      			<option value="2" <%if(remindtype==2){%>selected="selected"<%} %> >到期提醒<!-- 到期提醒 --></option>
                      			<option value="3" <%if(remindtype==3){%>selected="selected"<%} %> >循环提醒<!-- 循环提醒 --></option>
                      		</select>
                      </TD>
                    </TR>         
                      	...
                      	<table>
                      		<tr>
                      			...
                      			<brow:browser viewType="0" id="reminddatefield" name="reminddatefield" browserValue="<%=reminddatefield+"" %>" 
									...
									browserSpanValue="<%=getFieldShowName(reminddatefield+"") %>"
								></brow:browser>
							</td>
                      			<td class="e8_tblForm_f">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=SystemEnv.getHtmlLabelName(82218,user.getLanguage())%><!-- 时间字段 --> </td>
                      			<td class="e8_tblForm_f">
                      			<brow:browser viewType="0" id="remindtimefield" name="remindtimefield" browserValue="<%=remindtimefield+"" %>" 
									...
									completeUrl="/data.jsp" linkUrl=""  width="222px"
									browserDialogWidth="510px"
									browserSpanValue="<%=getFieldShowName(remindtimefield+"") %>"
								></brow:browser>
							</td>
                      		</tr>
                      	</table>
				...
				<COLGROUP>
			  	...
			  	<TBODY>
                    ...
                    <TR  >
				       ...
				       <TD class="e8_tblForm_field">
				       		<!-- 
				       	 	<input type="radio"  <%if(remindway==1){%>checked="checked"<%} %> name="remindway" value="1" onclick="changeRemindway();">微信企业号
				       	 	 -->
                      		<input type="radio" name="remindway" <%if(id.equals("0")||remindway==2){%>checked="checked"<%} %> value="2" onclick="changeRemindway();">系统提醒<!-- 短信提醒 -->
				     ...
				     <TR   id="emailTR" style="display: none;">
				       <td class="e8_tblForm_label" width="20%"><%=SystemEnv.getHtmlLabelName(82223,user.getLanguage())%><!-- 邮件标题 --></TD>
				       <TD class="e8_tblForm_field">
                   			...
                   			<select id="subjectSelect" name="subjectSelect" style="width: 200px;" onchange="varSelectChange('subjectSelect','subject');checkinput('subject','subjectSpan')">
                   				...
                   				<%
                   				if(formid!=0){
	                   				sql = "select a.fieldname,b.indexdesc from workflow_billfield a,htmllabelindex b where  a.billid="+formid+" and a.fieldlabel=b.id and (a.detailtable='' or a.detailtable is null)";
	                   				rs.executeSql(sql);
	                   				while(rs.next()){
				       		...
				       		<!-- 
				       			提示：邮件标题可以取表单字段的值，可通过上面的select框进行选择字段
				       			表现形式为：$fieldname$,其中fieldname为所选择表单中主表中的字段。
				       		 -->
                     			<span title='<%=SystemEnv.getHtmlLabelName(82362,user.getLanguage())%>&#10;<%=SystemEnv.getHtmlLabelName(82363,user.getLanguage())%>' id="remind">
                    ...
                    <TR id="senderTR" style="display: none;">
				       <td class="e8_tblForm_label" width="20%">提醒创建人<!-- 短信发送人 --></TD>
				       <TD class="e8_tblForm_field">
				       		<table style="width: 100%;">
				       			<colgroup>
				       				<col style="width: 25%">
				       			...
				       			<tr>
				       				<td >
					       				<select id="sendertype" name="sendertype" onchange="changeSenderType();">
							       	 		<option value="1" <%if(sendertype==1){%>selected="selected"<%} %> >系统管理员<!-- 系统管理员 --></option>
							       	 		<option value="2" <%if(sendertype==2){%>selected="selected"<%} %> >单人力资源字段<!-- 单人力资源字段 --></option>
							       	 	</select>
							       	</td>
							       		<td >
				       					<%
			                    			...
			                    			String sendName1 = fieldInfo.getFieldName(sendValue1, 17, "");
				       				
					       				%>
				       					<span id="sendspan1" style="display:none">
								         	<brow:browser viewType="0" name="sendspan1" browserValue="<%=sendValue1 %>" browserOnClick="" 
								         		browserUrl="/systeminfo/BrowserMain.jsp?url=/hrm/resource/ResourceBrowser.jsp?resourceids=" 
								         		hasInput="true"  width="50%" isSingle="false" hasBrowser="true" completeUrl="/data.jsp?type=17" browserSpanValue="<%=sendName1 %>" isMustInput="2">
								         	</brow:browser>
							         	</span>
				       				</td>
                    ...
                    <TD class="e8_tblForm_label">提醒内容</TD>
                      <TD class="e8_tblForm_field">
							<textarea name="remindcontenttext" id="remindcontenttext"  rows="3" style="width: 70%">
							<%=remindcontenttext %></textarea>
                      </TD>
                    </TR>  
                    ...
                    <TD class="e8_tblForm_label">
                      ...
                      <TD class="e8_tblForm_field">
                      		<select name="receivertype" id="receivertype" onchange="changeReceivertype();" >  
					           <option value="1" <%if(receivertype==1){%>selected="selected"<%} %> >人员</option> <!-- 人员 -->
					           <option value="2" <%if(receivertype==2){%>selected="selected"<%} %>>分部</option><!-- 分部 -->
					           <option value="3" <%if(receivertype==3){%>selected="selected"<%} %>>部门</option><!-- 部门 -->
					           <option value="4" <%if(receivertype==4){%>selected="selected"<%} %>>角色</option><!-- 角色 -->
					           <option value="5" <%if(receivertype==5){%>selected="selected"<%} %>>所有人</option><!-- 所有人 -->
					         </select>
