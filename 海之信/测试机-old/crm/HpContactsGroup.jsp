		 ...
		 <table width="90%" align="center">
	  	      ...
	  	      <tr>
				 <% 
					...
					String tmp_zm="";
					String tmp_fm="";
					String sql = "select id,Name,picHead,picend from uf_Contacts where SuperID is null and dealStatus in(0,1) and GroupName="+customID;
	                String sql1="";
					 ...
					 <table align="center" style="border:1px solid #000000;" cellpadding="0"cellspacing="1">
						 ...
						 <tr>
							 <td style="text-align:right;" >
								 <input type="button"  class="e8_btn_top" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis; max-width: 100px;width:70px;height:25px;font-size:15px;"  value="另一面" onClick="changeImage(<%=tmp_zm%>,<%=tmp_fm%>,<%=flag%>)"/>
								 <input type="hidden" name="imagetext<%=flag%>" id="imagetext<%=flag%>" value="0"/>
							</td>
					    </tr>
					 </table>
					 <br/>
