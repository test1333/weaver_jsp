...
%>
	...
	String backfields = " id,bt,content,modedatacreater,modedatacreatedate+' '+modedatacreatetime as createTime "; 
	String fromSql  = " from uf_ContactsDy ";
	String sqlWhere = " where contactsName = " + customID 
		+ " and (modedatacreater="+user_id+" or Area=0 or ','+CAST(AreaType as varchar(6000))+','  like '%,"+user_id+",%') " ;
	...
	if(!"".equals(beginDate)){
		sqlWhere +=  " and modedatacreatedate >='"+beginDate+"'";
	}
	if(!"".equals(endDate)){
		sqlWhere +=  " and modedatacreatedate <='"+endDate+"'";
	}
...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(tmc_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+tmc_pageId +"\">"+
    ...
    "			<head>";
	  ...
	  "				<col width=\"15%\" labelid=\"882\" text=\"创建人\" column=\"modedatacreater\" orderkey=\"modedatacreater\" transmethod=\"weaver.hrm.resource.ResourceComInfo.getResourcename\"  />"+
