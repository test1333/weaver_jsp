...
<%
	...
	url_1 = "/seahonor/express/jsp/ForTheCost.jsp?ExpressCompany="+ExpressCompany;
		
	url_2 = "/seahonor/jsp/ForTheCost.jsp";

	url_3 = "/seahonor/jsp/ForTheCost.jsp";
 ...
 <BODY scroll="no">
	...
	<div class="e8_box demo2">
		<div class="e8_boxhead">
		    ...
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">待结算<span id="allNum_span"></span></a>
				</li>
			 <!-- <li class="">
