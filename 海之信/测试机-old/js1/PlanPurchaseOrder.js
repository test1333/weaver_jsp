	...
	var qj_id = "#field6647"; // 选择采购单
	var Name_id = "field6592_"; // 商品名称
	var qjxxID_id = "field6608_"; // 计划数量
	var qjxx_id = "field6609_"; // 计划单价
	var ycgsl_id = "field6648_"; // 已采购数量
		...
		//	alert("qj_id_val= "+qj_id_val);
			...
			xhr.open("GET","/seahonor/jsp/PlanPurchaseOrder.jsp?id="+qj_id_val, false);//通过流程按钮选择的值，通过jquery把值传到jsp页面中去。
