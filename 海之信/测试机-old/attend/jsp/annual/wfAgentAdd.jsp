	...
	<wea:layout  >
		...
		<wea:item attributes="{'isTableList':'true'}">	
	        ...
	        <tr >
			 ...
			 <td height="44"   class="field"  colspan="2"  ><!-- 代理已有待办事宜 -->
