...
//全部收回逻辑
        ...
        if(flag){
            response.sendRedirect("/seahonor/jsp/SH_Set_Agent_info.jsp?infoKey=3&isSetAgent=1");
            return;
        }else{
            response.sendRedirect("/seahonor/jsp/SH_Set_Agent_info.jsp?infoKey=4&isSetAgent=0");
            return;
        }
    }
}
