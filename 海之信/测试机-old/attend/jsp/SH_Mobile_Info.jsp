...
<HTML>
	...
	<BODY>
		...
		+" rt.EmployeeName,rt.ReplaceStartDate,rt.ReplaceStartTime,rt.ReplaceEndTime,DateName(weekday,ms.operate_date) as weekday, "
		...
		String sqlWhere = " ms.id not in(select InvalidID from uf_Invalid_out where isActive=0) ";
		...
		tableString+="<col width=\"5%\" labelid=\"413\" text=\"姓名\" column=\"operater\" orderkey=\"operater\" transmethod=\"weaver.hrm.resource.ResourceComInfo.getResourcename\" />"+
			"		<col width=\"8%\" labelid=\"33563\" text=\"移动签到日期\" column=\"operate_date\" orderkey=\"operate_date\" />"+
			"		<col width=\"5%\" labelid=\"18518\" text=\"星期\" column=\"weekday\" orderkey=\"weekday\" />"+
			"		<col width=\"8%\" labelid=\"20035\" text=\"移动签到时间\" column=\"operate_time\" orderkey=\"operate_time\" />"+
			"		<col width=\"15%\" labelid=\"110\" text=\"移动考勤地址\" column=\"address\" orderkey=\"address\" />"+
