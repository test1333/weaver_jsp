...
<HTML>
	...
	String needfav ="1";
	String needhelp ="";
	int userid = user.getUID();//获取当前登录用户ID
	...
	<BODY>
		...
		String backfields = " empid,workcode,relatedID,dedutime,deduAlltime ";
		String fromSql  = " from uf_deduction_relate ";
		String sqlWhere = " where relatedID = -1 ";
		//out.println("select "+ backfields + fromSql + sqlWhere);
		//System.out.println(sqlWhere);
		String orderby = " empid " ;
		String tableString = "";
		...
		tableString+="<col width=\"18%\" labelid=\"413\" text=\"姓名\" column=\"empid\" orderkey=\"empid\" transmethod=\"weaver.hrm.resource.ResourceComInfo.getResourcename\" />"+
			...
			"		<col width=\"18%\" labelid=\"-11\" text=\"关联ID\" column=\"relatedID\" orderkey=\"relatedID\" />"+
