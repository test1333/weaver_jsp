...
<%
	...
	url_2 = "/seahonor/shattenddept.jsp?deptid="+departmentid;

	url_3 = "/seahonor/shattendpersonal.jsp?userid="+userid;
 ...
 <BODY scroll="no">
	...
	<div class="e8_box demo2">
		<div class="e8_boxhead">
			...
			<li class="">
					<a target="tabcontentframe" href="<%=url_2 %>">部门</a>
			</li>
		       	<li class="">
