 ...
 <script type="text/javascript">
	...
	$(".ulDiv").leftNumMenu(treeData,{
		...
		clickFunction:function(attr,level,numberType){
			   ...
			   frame.attr("src","/seahonor/attend/agent/wfAgentAll.jsp?menutype="+method+"&menuid="+objid+"&agentFlag="+agentFlag+"&agented=1");
		}
	});
	...
	function refreshTree(ag)
	{
        ...
        if(req){
            req.open("post","/seahonor/attend/agent/wfAgentAllTreeList.jsp?agentFlag="+ag+"&isrefreshTree=y",true);
