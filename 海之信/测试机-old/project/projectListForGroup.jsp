...
//	out.prinln(tmp_name_x);	
	...
	String sqlWhere = " where custom  in(select id from uf_custom where CustomGroup="+customID+" and SuperID is null)";
...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(tmc_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+tmc_pageId +"\">"+
    ...
    "			<head>";
	  ...
	  "				<col width=\"10%\" labelid=\"1268\" text=\"公司名称\" column=\"customName\" orderkey=\"customName\"  />"+
