...
<%
	String url_1 = "";
	String url_2 = "";
	url_1 = "/seahonor/jsp/AssetsCheckEnd.jsp";
	url_2 = "/seahonor/jsp/AssetsCheckEnd2.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">盘点记录</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">监盘复核中<span id="allNum_span"></span></a>
				</li>
				<li class="current">
					<a target="tabcontentframe" href="<%=url_2%>">监盘结束<span id="allNum_span"></span></a>
				</li>
		    </ul>
