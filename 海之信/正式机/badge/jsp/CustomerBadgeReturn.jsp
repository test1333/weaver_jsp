...
<HTML>
	...
	String temp_val = "CustomerBadgeReturn";
	%>
	<BODY>
		<div id="tabDiv">
		...
		<FORM id=report name=report action=CustomerBadgeReturn.jsp method=post>
		...
		String backfields = " id,requestid,(select requestname from workflow_requestbase wr where wr.requestid=f.requestId) as request_name,Application,ApplicationDate, CustomerBadgeReturn ";
		String fromSql  = " from  formtable_main_87 f ";
		//String sqlWhere = " 1=1 ";
		...
		tableString+="<col width=\"25%\" labelid=\"18104\" text=\"流程名称\" column=\"request_name\" orderkey=\"requestid\" linkvaluecolumn=\"requestid\" linkkey=\"requestid\" href=\"/workflow/request/ViewRequest.jsp\" target=\"_fullwindow\" />"+	
			...
			"		<col width=\"10%\" labelid=\"-9666\" text=\"客户证章退还\" column=\"CustomerBadgeReturn\" orderkey=\"CustomerBadgeReturn\" transmethod=\"seahonor.info.SealInfo.getTreeSealName\"  />"+
		"			</head>"+
	" </table>";
	%>
