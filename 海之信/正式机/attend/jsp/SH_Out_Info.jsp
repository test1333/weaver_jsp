...
<HTML>
	...
	String outPlan_pageId = "outPlan_info";
	...
	<BODY>
		...
		<input type="hidden" name="pageId" id="pageId" value="<%=outPlan_pageId%>"/>
		...
		String backfields = " EmployeeName,(select departmentid from HrmResource where id=EmployeeName) as dept,ReplaceStartDate,ReplaceStartTime+'~'+ReplaceEndTime as out_time,address,client,address_leave,client_leave,standard ";
		String fromSql  = " from sh_out_plan_info_new ";
		String sqlWhere = " 1=1 ";
		//out.println("select "+ backfields + fromSql + sqlWhere);
		//System.out.println(sqlWhere);
		String orderby = " dept,EmployeeName,ReplaceStartDate " ;
		String tableString = "";
		...
		if(!"".equals(fromdate)){
			...
			if(!"".equals(enddate)){
				...
				sqlWhere +=" and ReplaceStartDate='"+today_date+"' ";
			}
		}

	    tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(outPlan_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+outPlan_pageId+"\">"+
		...
		operateString+
		"			<head>";
		tableString+="<col width=\"5%\" labelid=\"413\" text=\"姓名\" column=\"EmployeeName\" orderkey=\"EmployeeName\" transmethod=\"weaver.hrm.resource.ResourceComInfo.getResourcename\" />"+
			"		<col width=\"8%\" labelid=\"-10992\" text=\"外出日期\" column=\"ReplaceStartDate\" orderkey=\"ReplaceStartDate\" />"+
			"		<col width=\"7%\" labelid=\"-10966\" text=\"外出时间\" column=\"out_time\" orderkey=\"out_time\" />"+
			"		<col width=\"8%\" labelid=\"-9223\" text=\"考勤标准\" column=\"standard\" orderkey=\"standard\" />"+
			"		<col width=\"12%\" labelid=\"-10148\" text=\"前往客户或者政府\" column=\"client\" orderkey=\"client\" />"+
			"		<col width=\"18%\" labelid=\"-10557\" text=\"外勤上班地址\" column=\"address\" orderkey=\"address\" />"+
			"		<col width=\"12%\" labelid=\"-10555\" text=\"离开客户或者政府\" column=\"client_leave\" orderkey=\"client_leave\"/>"+
			"		<col width=\"18%\" labelid=\"-10556\" text=\"外勤下班地址\" column=\"address_leave\" orderkey=\"address_leave\" />"+
		"			</head>"+
	" </table>";
	%>
