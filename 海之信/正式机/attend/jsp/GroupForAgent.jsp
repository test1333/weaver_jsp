...
<%
	...
	url_1 = "/seahonor/attend/jsp/SH_Set_Agent_info.jsp";
		
	url_2 = "/seahonor/attend/jsp/SH_Set_Agent_info_1.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">设置代理</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">未开启<span id="allNum_span"></span></a>
				</li>
				<li class="">
					<a target="tabcontentframe" href="<%=url_2%>">已开启(授权他人)</a>
				</li>
                <li class="">
