...
<HTML>
	...
	<BODY>
		...
		String backfields = " id,operater,operate_date+' '+operate_time as op_time,address,ReplaceStartTime+'~'+ReplaceEndTime as out_time,ReplaceStartDate,weekday,client,cAddress,client_leave,address_leave,active,standard ";
		...
		if(!"".equals(fromdate)){
			...
			if(!"".equals(enddate)){
				...
				sqlWhere +=" and operate_date='"+today_date+"' ";
			}
		}
		...
		tableString+="<col width=\"5%\" labelid=\"413\" text=\"姓名\" column=\"operater\" orderkey=\"operater\" transmethod=\"weaver.hrm.resource.ResourceComInfo.getResourcename\" />"+
			...
			"		<col width=\"10%\" labelid=\"125531\" text=\"签到地址\" column=\"address\" orderkey=\"address\" />"+
			...
			"		<col width=\"10%\" labelid=\"-10557\" text=\"外勤上班地址\" column=\"cAddress\" orderkey=\"cAddress\"/>"+
			"		<col width=\"8%\" labelid=\"-10555\" text=\"离开客户或者政府\" column=\"client_leave\" orderkey=\"client_leave\" />"+
			"		<col width=\"10%\" labelid=\"-10556\" text=\"外勤下班地址\" column=\"address_leave\" orderkey=\"address_leave\"/>"+
	...
	<script type="text/javascript">
		...
		function invalidRecord(){
			...
			Dialog.confirm("确认移除考勤记录？", function (){
	        		report.action="/seahonor/attend/jsp/RemoveRecord_new.jsp?id="+ids;
					report.submit();
