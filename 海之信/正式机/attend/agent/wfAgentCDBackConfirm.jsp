...
<BODY>
<FORM id=weaver name=weaver action="/seahonor/attend/agent/wfAgentOperatorNew.jsp" method=post>
...
<table width="98%"   border="0"  >
  <%if(!method.equals("editAgent")){%>
   <tr  >
    <td   width="60px" rowspan="2" valign="middle" align="right"><img style="margin-right: 10px;" id="Icon_undefined" align="absmiddle" src="/wui/theme/ecology8/skins/default/rightbox/icon_query_wev8.png" width="26" height="26"></td>
	<td   width="331" valign="middle" align="left"><%=SystemEnv.getHtmlLabelName(-11051,user.getLanguage()) %>  <a href="#" style="color:#0000FF" onclick="onagentedit()"><%=overlapAgent %></a>  <%=SystemEnv.getHtmlLabelName(-11052,user.getLanguage()) %></td>
  </tr>
  <tr>
  ...
  <tr  >
    ...
    <input type="radio" checked="checked" name="overlapAgenttype" value="1"><%=SystemEnv.getHtmlLabelName(-11053,user.getLanguage()) %>&nbsp;</td>
  </tr>
    <tr >
    <td align="left" valign="middle" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <input type="radio"  <%if(method.equals("editAgent")){%> checked="checked" <%} %> name="overlapAgenttype" value="2"><%=SystemEnv.getHtmlLabelName(-11054,user.getLanguage()) %>&nbsp;</td>
  </tr>
  <%}else{ %>
	   <tr  >
	    <td   width="60px" rowspan="2" valign="middle" align="right"><img style="margin-right: 10px;" id="Icon_undefined" align="absmiddle" src="/wui/theme/ecology8/skins/default/rightbox/icon_query_wev8.png" width="26" height="26"></td>
		<td   width="331" valign="middle" align="left"><%=SystemEnv.getHtmlLabelName(-11051,user.getLanguage()) %>  <a href="#" style="color:#0000FF" onclick="onagentedit()"><%=overlapAgent %></a>  <%=SystemEnv.getHtmlLabelName(-11052,user.getLanguage())+"<br>"+SystemEnv.getHtmlLabelName(16631,user.getLanguage()) +SystemEnv.getHtmlLabelName(-11054,user.getLanguage())  %>?
		<input type="hidden"   name="overlapAgenttype" value="2">
		</td>
	  </tr>
  <%} %>
</table>  
...
function sumbitform(){
 ...
 function onagentedit(){
  var   dialog2 = new window.top.Dialog();
		...
		dialog2 = new window.top.Dialog();
		dialog2.currentWindow = window;
		var url = "/seahonor/attend/agent/wfAgentMyCondit.jsp?agentFlag=0&agented=0&overlapagentstrid=<%=overlapagentstrid%>";
