...
//	out.prinln(tmp_name_x);	
	...
	String sqlWhere = " where SuperID is null and dealStatus in(0,1) and Supplier="+customID+" ";
	String orderby = " id " ;
	String tableString = "";
...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(PageIdConst.HRM_ONLINEUSER,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+PageIdConst.HRM_ONLINEUSER+"\">"+
    ...
    operateString+
    "			<head>";                                                                                                                                                  
		tableString+="<col width=\"10%\" labelid=\"572\" text=\"联系人\" column=\"Name\" orderkey=\"Name\" linkvaluecolumn=\"id\" linkkey=\"billid\" href=\"/formmode/view/ViewMode.jsp?isfromTab=0&amp;modeId=1&amp;formId=-2&amp;type=0&amp;billid=79&amp;iscreate=1&amp;opentype=0&amp;customid=0&amp;isclose=1&amp;templateid=0\" target=\"_fullwindow\"/>"+
