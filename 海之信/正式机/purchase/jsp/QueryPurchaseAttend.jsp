...
<%
	...
	url_1 = "/seahonor/purchase/jsp/QueryPurchaseStorage.jsp?userid="+userid;
		
	//url_2 = "/seahonor/jsp/BadgeOut.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">采购入库查询</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">采购入库申请流程列表<span id="allNum_span"></span></a>
				</li>
			<!--  <li class="">
