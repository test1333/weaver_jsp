...
//	out.prinln(tmp_name_x);	
	...
	String sqlWhere = " where SuperID is null and dealStatus=1 and GroupName="+customID+" ";
	String orderby = " id " ;
	String tableString = "";
...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(tmc_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+tmc_pageId +"\">"+
    ...
    operateString+
    "			<head>";                                                                                                                                                  
		tableString+="<col width=\"10%\" labelid=\"572\" text=\"联系人\" column=\"Name\" orderkey=\"Name\" linkvaluecolumn=\"id\" linkkey=\"billid\" href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=63&amp;formId=-63&amp;opentype=0&amp;customid=81&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\"/>"+
