...
var sqrq="#field15628";//申请日期
var jkbz="#field15629";//借款币种
var jkr="#field15627";//借款人
var zzjebz="#field15705";//转账金额标准
var sftgmm="#field15706";//是否跳过密码
var dissftgmm="#disfield15706";//是否跳过密码
var bz_dt1="#field15663_";//币种明细1
var bz1_dt1="#disfield15663_";
var ybye_dt1="#field15637_";//原币金额 明细1
var yqje_dt1="#field15638_";//逾期金额 明细1
var tbyczrq_dt2="#field15642_";//特别延长至*日期 明细2
var jkje_dt2="#field15641_";//借款金额 明细2
var zffs_dt2="#field15644_";//支付方式 明细2
var diszffs_dt2="#disfield15644_";//dis支付方式 明细2
var tbyczrq_dt3="#field15651_";//特别延长至*日期 明细3
var jkje_dt3="#field15650_";//借款金额 明细3
var zffs_dt3="#field15653_";//支付方式 明细3
var diszffs_dt3="#disfield15653_";//dis支付方式 明细3
  	   ...
  	   if(jQuery(bz_dt1+i).length>0){
  	       ...
  	       if(Number(ybye_val) !=0){
  	        ...
  	        if(Number(yqje_val) !=0){
  	        	yqje_val=Number(ybye_val).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,');
