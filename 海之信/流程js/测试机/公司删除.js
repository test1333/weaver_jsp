		                             ...
		                             // alert(datalength);
		                              ...
		                              var length1=Number(text_arr.length)-1+Number(datalength);
		                            	...
		                            	if(tmp_arr[2]=='1'){
									     ...
									     var ssjturl="";
									     if(tmp_arr[7] !=""){
									     	 ssjturl= "<a href=\\\"/formmode/view/ViewMode.jsp?type=0&modeId=61&formId=-68&billid="+tmp_arr[7]+"\\\" target=\\\"_blank\\\">"+tmp_arr[8]+"</a>";
									     }
		                               ...
		                               datatxt=datatxt+"'wdfield14351':'"+tmp_arr[3]+"','wdfield14351span':'"+tmp_arr[4]+"','wdfield14354':'"+tmp_arr[5]+"','wdfield14354span':'"+tmp_arr[5]+"','wdfield14355':'"+tmp_arr[6]+"','wdfield14355span':'"+tmp_arr[6]+"','wdfield14356':'"+tmp_arr[7]+"','wdfield14356span':'"+ssjturl+"',";
...
//  }
		    ...
		    $.each(datas, function(i, value) {
		        if(key==this.key){
		         ...
		         //	alert(tmp_arr[0]);
				   ...
				   this.wdfield14347=tmp_arr[2];
		          this.wdfield14347span=tmp_arr[2];
				  this.wdfield14352=urlval;
		          this.wdfield14352span=url;
		          this.wdfield14351=tmp_arr[3];
		          this.wdfield14351span=tmp_arr[4];
		          this.wdfield14354=tmp_arr[5];
		          this.wdfield14354span=tmp_arr[5];
		          
		          this.wdfield14355=tmp_arr[6];
		          this.wdfield14355span=tmp_arr[6];
		          this.wdfield14356=tmp_arr[7];
		          this.wdfield14356span=ssjturl;
		          
		          this.wdfield14357=tmp_arr[9];
		          this.wdfield14357span=tmp_arr[9];
		          this.wdfield14358=tmp_arr[10];
		          this.wdfield14358span=tmp_arr[10];
		          
		          this.wdfield14359=tmp_arr[11];
		          this.wdfield14359span=tmp_arr[11];
		          this.wdfield14360=tmp_arr[12];
		          this.wdfield14360span=tmp_arr[12];
		          
		          this.wdfield14361=tmp_arr[13];
		          this.wdfield14361span=tmp_arr[13];
		          this.wdfield14362=tmp_arr[14];
		          this.wdfield14362span=tmp_arr[15];
		          
		          this.wdfield14364=tmp_arr[16];
		          this.wdfield14364span=tmp_arr[16];
		          this.wdfield14365=tmp_arr[17];
		          this.wdfield14365span=tmp_arr[17];
		          ...
		          this.wdfield14366=tmp_arr[18];
		          this.wdfield14366span=tmp_arr[18];
		          this.wdfield14367=tmp_arr[19];
		          this.wdfield14367span=tmp_arr[19];
		          
		          this.wdfield14368=tmp_arr[20];
		          this.wdfield14368span=tmp_arr[20];
		          this.wdfield14369=tmp_arr[21];
		          this.wdfield14369span=tmp_arr[21];
		          
		          this.wdfield14370=tmp_arr[22];
		          this.wdfield14370span=tmp_arr[22];
		         }
		        }	
		    })
  ...
  function dodetail(){
		...
		$.each(datas, function(i, value) {
		   ...
		   this.wdfield14352="";
		   this.wdfield14352span="";
		   var ssjtid=this.wdfield14356;
		   var ssjtspan=this.wdfield14356span;
		   //alert(gsid);
		   if(gsid !=""){
  ...
  function geteditinfo(gsid){
  	  ...
  	  var xhr2 = null;
				...
				if (null != xhr2) {				
					xhr2.open("GET","/seahonor/crm/jsp/geteditDeleteCustom.jsp?gsid="+gsid, false);
