...
var hqmm="#field15953";//获取密码
var mmyz="#field15952";//密码验证	
...
jQuery(document).ready(function(){
	...
	checkCustomize = function () {
		var sftgmm_val = jQuery(sftgmm).val();
		if(sftgmm_val !="0"){
		  	var hqmm_val = jQuery(hqmm).val();
		  	var mmyz_val = jQuery(mmyz).val();
		  	if(hqmm_val != mmyz_val){
		  	  alert("密码不对，请重新输入");
		  	  return false;	
		    }
	    }
