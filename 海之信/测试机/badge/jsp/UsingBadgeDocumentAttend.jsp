...
<%
  String idkey = Util.null2String(request.getParameter("idkey"));
	String url_1 = "";
	url_1 = "/seahonor/badge/jsp/UsingBadgeDocument.jsp?idkey="+idkey+"";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">用印文档</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">用印文档<span id="allNum_span"></span></a>
				</li>
		    </ul>
