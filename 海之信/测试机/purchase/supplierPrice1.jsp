...
<%!
	public String getSupplierName(String sid){
		String reName = "";
		RecordSet recordSet = new RecordSet();
		String sql = "select customName as name from uf_custom where id='"+sid+"'";
		recordSet.executeSql(sql);
		if(recordSet.next()) {
...
<wea:layout type="twoCol" attributes="{'expandAllGroup':'true'}">
	...
	<%if(roleID == 1){%>
		<wea:item><brow:browser viewType="0"  name="supplier_01" browserValue="<%=supplier_01 %>"
							...
							browserUrl="/systeminfo/BrowserMain.jsp?url=/interface/CommonBrowser.jsp?type=browser.sureGYS"
	...
	<%}%>
		...
		<wea:item>
			<table width=100% class="table">
				...
				<tr>
					<td>挂牌单价</td>
					<td><input maxLength=10 size=30 name="original101" value="<%=original101%>"  onKeyPress="ItemDecimal_KeyPress(this.name,15,2)" onBlur="checknumberje(this)"></td>
				...
				<tr>
					<td>商定单价</td>
					<td><input maxLength=10 size=30 name="price_01" value="<%=price_01%>"  onKeyPress="ItemDecimal_KeyPress(this.name,15,2)" onBlur="checknumberje(this)" onFocus="changenumber1(this)"></td>					
				    <td >
...
<script language=javascript>
    ...
    function checkselect(){
		...
		if (roleid == "1"){
		 ...
		 gpdj1  = document.getElementsByName('original101')[0].value;	
		 gpdj2  = document.getElementsByName('original201')[0].value;	
		 gpdj3  = document.getElementsByName('original301')[0].value;		
		 sddj1  = document.getElementsByName('price_01')[0].value;	
		 sddj2  = document.getElementsByName('price_02')[0].value;	
		 sddj3  = document.getElementsByName('price_03')[0].value;
		}
		if (roleid == "2"){
		 ...
		 gys3  = document.getElementsByName('supplier_03_02')[0].value;
		  ...
		  gpdj1  = document.getElementsByName('original102')[0].value;	
		 gpdj2  = document.getElementsByName('original202')[0].value;	
		 gpdj3  = document.getElementsByName('original302')[0].value;		
		 sddj1  = document.getElementsByName('price_01_02')[0].value;	
		 sddj2  = document.getElementsByName('price_02_02')[0].value;	
		 sddj3  = document.getElementsByName('price_03_02')[0].value;
		}
		if (roleid == "3"){
		 ...
		 gpdj1  = document.getElementsByName('original103')[0].value;	
		 gpdj2  = document.getElementsByName('original203')[0].value;	
		 gpdj3  = document.getElementsByName('original303')[0].value;		
		 sddj1  = document.getElementsByName('price_01_03')[0].value;	
		 sddj2  = document.getElementsByName('price_02_03')[0].value;	
		 sddj3  = document.getElementsByName('price_03_03')[0].value;
		}
		if (roleid == "4"){
		 ...
		 gpdj1  = document.getElementsByName('original104')[0].value;	
		 gpdj2  = document.getElementsByName('original204')[0].value;	
		 gpdj3  = document.getElementsByName('original304')[0].value;		
		 sddj1  = document.getElementsByName('price_01_04')[0].value;	
		 sddj2  = document.getElementsByName('price_02_04')[0].value;	
		 sddj3  = document.getElementsByName('price_03_04')[0].value;
		}
		...
		if(selCheck1.checked && ""==gpdj1){
           alert("请填写选择的供应商对应的挂牌单价信息。");
		   	return false;
		}
		if(selCheck2.checked && ""==gpdj2){
           alert("请填写选择的供应商对应的挂牌单价信息。");
		   	return false;
		}
		if(selCheck3.checked && ""==gpdj3){
           alert("请填写选择的供应商对应的挂牌单价信息。");
		   	return false;
		}
		if(selCheck1.checked && ""==sddj1){
           alert("请填写选择的供应商信息。");
		   	return false;
		}
		if(selCheck2.checked && ""==sddj2){
           alert("请填写选择的供应商信息。");
		   	return false;
		}
		if(selCheck3.checked && ""==sddj3){
           alert("请填写选择的供应商信息。");
		   	return false;
		}
		return true;
	...
	function openSupplier(id){
		...
		title = "供应商";
		url="/formmode/view/ViewMode.jsp?type=0&modeId=52&formId=-59&opentype=0&customid=76&viewfrom=fromsearchlist&mainid=0&billid="+id;
	...
	function checknumberje(objectname)
{
	...
	objectname.value=formatNum(objectname.value);
}
