...
<%
	...
	String Spec103 = Util.null2String(request.getParameter("Spec103"));	
	String Spec104 = Util.null2String(request.getParameter("Spec104"));	
	String Spec201 = Util.null2String(request.getParameter("Spec201"));	
	String Spec202 = Util.null2String(request.getParameter("Spec202"));	
	String Spec203 = Util.null2String(request.getParameter("Spec203"));	
	String Spec204 = Util.null2String(request.getParameter("Spec204"));	
	String Spec301 = Util.null2String(request.getParameter("Spec301"));	
	String Spec302 = Util.null2String(request.getParameter("Spec302"));	
	String Spec303 = Util.null2String(request.getParameter("Spec303"));	
	String Spec304 = Util.null2String(request.getParameter("Spec304"));

	String beizhu101 = Util.null2String(request.getParameter("beizhu101"));	
	String beizhu102 = Util.null2String(request.getParameter("beizhu102"));	
	String beizhu103 = Util.null2String(request.getParameter("beizhu103"));	
	String beizhu104 = Util.null2String(request.getParameter("beizhu104"));	
	String beizhu201 = Util.null2String(request.getParameter("beizhu201"));	
	String beizhu202 = Util.null2String(request.getParameter("beizhu202"));	
	String beizhu203 = Util.null2String(request.getParameter("beizhu203"));	
	String beizhu204 = Util.null2String(request.getParameter("beizhu204"));	
	String beizhu301 = Util.null2String(request.getParameter("beizhu301"));	
	String beizhu302 = Util.null2String(request.getParameter("beizhu302"));	
	String beizhu303 = Util.null2String(request.getParameter("beizhu303"));	
	String beizhu304 = Util.null2String(request.getParameter("beizhu304"));

	String weight101 = Util.null2String(request.getParameter("weight101"));	
	String weight102 = Util.null2String(request.getParameter("weight102"));	
	String weight103 = Util.null2String(request.getParameter("weight103"));	
	String weight104 = Util.null2String(request.getParameter("weight104"));	
	String weight201 = Util.null2String(request.getParameter("weight201"));	
	String weight202 = Util.null2String(request.getParameter("weight202"));	
	String weight203 = Util.null2String(request.getParameter("weight203"));	
	String weight204 = Util.null2String(request.getParameter("weight204"));	
	String weight301 = Util.null2String(request.getParameter("weight301"));	
	String weight302 = Util.null2String(request.getParameter("weight302"));	
	String weight303 = Util.null2String(request.getParameter("weight303"));	
	String weight304 = Util.null2String(request.getParameter("weight304"));

	String color101 = Util.null2String(request.getParameter("color101"));	
	String color102 = Util.null2String(request.getParameter("color102"));	
	String color103 = Util.null2String(request.getParameter("color103"));	
	String color104 = Util.null2String(request.getParameter("color104"));	
	String color201 = Util.null2String(request.getParameter("color201"));	
	String color202 = Util.null2String(request.getParameter("color202"));	
	String color203 = Util.null2String(request.getParameter("color203"));	
	String color204 = Util.null2String(request.getParameter("color204"));	
	String color301 = Util.null2String(request.getParameter("color301"));	
	String color302 = Util.null2String(request.getParameter("color302"));	
	String color303 = Util.null2String(request.getParameter("color303"));	
	String color304 = Util.null2String(request.getParameter("color304"));
	...
	String otherPrice101 = Util.null2String(request.getParameter("otherPrice101"));
	String otherPrice102 = Util.null2String(request.getParameter("otherPrice102"));
	String otherPrice103 = Util.null2String(request.getParameter("otherPrice103"));
	String otherPrice104 = Util.null2String(request.getParameter("otherPrice104"));
	String otherPrice201 = Util.null2String(request.getParameter("otherPrice201"));
	String otherPrice202 = Util.null2String(request.getParameter("otherPrice202"));
	String otherPrice203 = Util.null2String(request.getParameter("otherPrice203"));
	String otherPrice204 = Util.null2String(request.getParameter("otherPrice204"));
	String otherPrice301 = Util.null2String(request.getParameter("otherPrice301"));
	String otherPrice302 = Util.null2String(request.getParameter("otherPrice302"));
	String otherPrice303 = Util.null2String(request.getParameter("otherPrice303"));
	String otherPrice304 = Util.null2String(request.getParameter("otherPrice304"));
	...
	String zxwd101 = Util.null2String(request.getParameter("zxwd101"));
	String zxwd102 = Util.null2String(request.getParameter("zxwd102"));
	String zxwd103 = Util.null2String(request.getParameter("zxwd103"));
	String zxwd104 = Util.null2String(request.getParameter("zxwd104"));
	String zxwd201 = Util.null2String(request.getParameter("zxwd201"));
	String zxwd202 = Util.null2String(request.getParameter("zxwd202"));
	String zxwd203 = Util.null2String(request.getParameter("zxwd203"));
	String zxwd204 = Util.null2String(request.getParameter("zxwd204"));
	String zxwd301 = Util.null2String(request.getParameter("zxwd301"));
	String zxwd302 = Util.null2String(request.getParameter("zxwd302"));
	String zxwd303 = Util.null2String(request.getParameter("zxwd303"));
	String zxwd304 = Util.null2String(request.getParameter("zxwd304"));
...
//		mapStr.put("forNum", Numbers);
      if("1".equals(roleID)){
		...
		mapStr.put("Spec104", Spec101);
		mapStr.put("Spec201", Spec201);
		mapStr.put("Spec202", Spec201);
		mapStr.put("Spec203", Spec201);
		mapStr.put("Spec204", Spec201);
		mapStr.put("Spec301", Spec301);
		mapStr.put("Spec302", Spec301);
		mapStr.put("Spec303", Spec301);
		mapStr.put("Spec304", Spec301);

		mapStr.put("beizhu101", beizhu101);
		mapStr.put("beizhu102", beizhu101);
		mapStr.put("beizhu103", beizhu101);
		mapStr.put("beizhu104", beizhu101);
		mapStr.put("beizhu201", beizhu201);
		mapStr.put("beizhu202", beizhu201);
		mapStr.put("beizhu203", beizhu201);
		mapStr.put("beizhu204", beizhu201);
		mapStr.put("beizhu301", beizhu301);
		mapStr.put("beizhu302", beizhu301);
		mapStr.put("beizhu303", beizhu301);
		mapStr.put("beizhu304", beizhu301);

		mapStr.put("weight101", weight101);
		mapStr.put("weight102", weight101);
		mapStr.put("weight103", weight101);
		mapStr.put("weight104", weight101);
		mapStr.put("weight201", weight201);
		mapStr.put("weight202", weight201);
		mapStr.put("weight203", weight201);
		mapStr.put("weight204", weight201);
		mapStr.put("weight301", weight301);
		mapStr.put("weight302", weight301);
		mapStr.put("weight303", weight301);
		mapStr.put("weight304", weight301);

		mapStr.put("color101", color101);
		mapStr.put("color102", color101);
		mapStr.put("color103", color101);
		mapStr.put("color104", color101);
		mapStr.put("color201", color201);
		mapStr.put("color202", color201);
		mapStr.put("color203", color201);
		mapStr.put("color204", color201);
		mapStr.put("color301", color301);
		mapStr.put("color302", color301);
		mapStr.put("color303", color301);
		mapStr.put("color304", color301);
		...
		mapStr.put("otherPrice101", otherPrice101);
		mapStr.put("otherPrice102", otherPrice101);
		mapStr.put("otherPrice103", otherPrice101);
		mapStr.put("otherPrice104", otherPrice101);
		mapStr.put("otherPrice201", otherPrice201);
		mapStr.put("otherPrice202", otherPrice201);
		mapStr.put("otherPrice203", otherPrice201);
		mapStr.put("otherPrice204", otherPrice201);
		mapStr.put("otherPrice301", otherPrice301);
		mapStr.put("otherPrice302", otherPrice301);
		mapStr.put("otherPrice303", otherPrice301);
		mapStr.put("otherPrice304", otherPrice301);
		...
		mapStr.put("zxwd101", zxwd101);
		mapStr.put("zxwd102", zxwd101);
		mapStr.put("zxwd103", zxwd101);
		mapStr.put("zxwd104", zxwd101);
		mapStr.put("zxwd201", zxwd201);
		mapStr.put("zxwd202", zxwd201);
		mapStr.put("zxwd203", zxwd201);
		mapStr.put("zxwd204", zxwd201);
		mapStr.put("zxwd301", zxwd301);
		mapStr.put("zxwd302", zxwd301);
		mapStr.put("zxwd303", zxwd301);
		mapStr.put("zxwd304", zxwd301);
		...
		mapStr.put("Spec104", Spec102);
		mapStr.put("Spec202", Spec202);
		mapStr.put("Spec203", Spec202);
		mapStr.put("Spec204", Spec202);
		mapStr.put("Spec302", Spec302);
		mapStr.put("Spec303", Spec302);
		mapStr.put("Spec304", Spec302);

        mapStr.put("beizhu102", beizhu102);
		mapStr.put("beizhu103", beizhu102);
		mapStr.put("beizhu104", beizhu102);
		mapStr.put("beizhu202", beizhu202);
		mapStr.put("beizhu203", beizhu202);
		mapStr.put("beizhu204", beizhu202);
		mapStr.put("beizhu302", beizhu302);
		mapStr.put("beizhu303", beizhu302);
		mapStr.put("beizhu304", beizhu302);

		mapStr.put("weight102", weight102);
		mapStr.put("weight103", weight102);
		mapStr.put("weight104", weight102);
		mapStr.put("weight202", weight202);
		mapStr.put("weight203", weight202);
		mapStr.put("weight204", weight202);
		mapStr.put("weight302", weight302);
		mapStr.put("weight303", weight302);
		mapStr.put("weight304", weight302);

		mapStr.put("color102", color102);
		mapStr.put("color103", color102);
		mapStr.put("color104", color102);
		mapStr.put("color202", color202);
		mapStr.put("color203", color202);
		mapStr.put("color204", color202);
		mapStr.put("color302", color302);
		mapStr.put("color303", color302);
		mapStr.put("color304", color302);
		...
		mapStr.put("otherPrice102", otherPrice102);
		mapStr.put("otherPrice103", otherPrice102);
		mapStr.put("otherPrice104", otherPrice102);
		mapStr.put("otherPrice202", otherPrice202);
		mapStr.put("otherPrice203", otherPrice202);
		mapStr.put("otherPrice204", otherPrice202);
		mapStr.put("otherPrice302", otherPrice302);
		mapStr.put("otherPrice303", otherPrice302);
		mapStr.put("otherPrice304", otherPrice302);
		...
		mapStr.put("zxwd102", zxwd102);
		mapStr.put("zxwd103", zxwd102);
		mapStr.put("zxwd104", zxwd102);
		mapStr.put("zxwd202", zxwd202);
		mapStr.put("zxwd203", zxwd202);
		mapStr.put("zxwd204", zxwd202);
		mapStr.put("zxwd302", zxwd302);
		mapStr.put("zxwd303", zxwd302);
		mapStr.put("zxwd304", zxwd302);
		...
		mapStr.put("Spec104", Spec103);
		mapStr.put("Spec203", Spec203);
		mapStr.put("Spec204", Spec203);
		mapStr.put("Spec303", Spec303);
		mapStr.put("Spec304", Spec303);

		mapStr.put("beizhu103", beizhu103);
		mapStr.put("beizhu104", beizhu103);
		mapStr.put("beizhu203", beizhu203);
		mapStr.put("beizhu204", beizhu203);
		mapStr.put("beizhu303", beizhu303);
		mapStr.put("beizhu304", beizhu303);

		mapStr.put("weight103", weight103);
		mapStr.put("weight104", weight103);
		mapStr.put("weight203", weight203);
		mapStr.put("weight204", weight203);
		mapStr.put("weight303", weight303);
		mapStr.put("weight304", weight303);

		mapStr.put("color103", color103);
		mapStr.put("color104", color103);
		mapStr.put("color203", color203);
		mapStr.put("color204", color203);
		mapStr.put("color303", color303);
		mapStr.put("color304", color303);
		...
		mapStr.put("otherPrice103", otherPrice103);
		mapStr.put("otherPrice104", otherPrice103);
		mapStr.put("otherPrice203", otherPrice203);
		mapStr.put("otherPrice204", otherPrice203);
		mapStr.put("otherPrice303", otherPrice303);
		mapStr.put("otherPrice304", otherPrice303);
		...
		mapStr.put("zxwd103", zxwd103);
		mapStr.put("zxwd104", zxwd103);
		mapStr.put("zxwd203", zxwd203);
		mapStr.put("zxwd204", zxwd203);
		mapStr.put("zxwd303", zxwd303);
		mapStr.put("zxwd304", zxwd303);
	  }else{
		...
		mapStr.put("Spec104", Spec104);
		mapStr.put("Spec204", Spec204);
		mapStr.put("Spec304", Spec304);

		mapStr.put("beizhu104", beizhu104);
		mapStr.put("beizhu204", beizhu204);
		mapStr.put("beizhu304", beizhu304);

		mapStr.put("weight104", weight104);
		mapStr.put("weight204", weight204);
		mapStr.put("weight304", weight304);

		mapStr.put("color104", color104);
		mapStr.put("color204", color204);
		mapStr.put("color304", color304);
		...
		mapStr.put("otherPrice104", otherPrice104);
		mapStr.put("otherPrice204", otherPrice204);
		mapStr.put("otherPrice304", otherPrice304);
		...
		mapStr.put("zxwd104", zxwd104);
		mapStr.put("zxwd204", zxwd204);
		mapStr.put("zxwd304", zxwd304);
	  }
