...
<%
	...
	String url_1 = "";
	url_1 = "/seahonor/expenses/gr-borrow-info.jsp?jkr="+jkr+"&bz="+bz;
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">个人借款余额明细表</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>"个人借款余额明细表<span id="allNum_span"></span></a>
				</li>
