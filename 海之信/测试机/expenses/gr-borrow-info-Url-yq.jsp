...
<%
	...
	String jkr=keyid.split("_")[0];
	String bz=keyid.split("_")[1];
	String url_1 = "";
	url_1 = "/seahonor/expenses/gr-borrow-info-yq.jsp?jkr="+jkr+"&bz="+bz;
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">个人逾期借款余额明细表</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>"个人逾期借款余额明细表<span id="allNum_span"></span></a>
				</li>
