...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		"'借款' as lx,jkye,jkrq as jkrq,jkdqr as jkdqr,yqts+'天' as yqts,xglc,(select requestname from workflow_requestbase where requestid=xglc) as requestname";
							         
		String fromSql  = " uf_personal_borrow t";
		String sqlWhere = " where 1=1  and ISNULL(jkye,0)>0 and sfyq='0' and jkr='"+jkr+"' and bz='"+bz+"'";
	    ...
	    tableString =" <table tabletype=\"none\" pagesize=\""+ PageIdConst.getPageSize(out_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+out_pageId+"\" >"+         
				   "	   <sql backfields=\""+backfields+"\" sqlform=\""+fromSql+"\" sqlwhere=\""+Util.toHtmlForSplitPage(sqlWhere)+"\"  sqlorderby=\""+orderby+"\"  sqlprimarykey=\"id\" sqlsortway=\"desc\" sqlisdistinct=\"false\" sumColumns=\"jkye\" showCountColumn=\"true\" decimalFormat=\"%,.2f\"/>"+
		operateString+
		"			<head>";
			tableString+= " <col width=\"10%\" text=\"币种\" column=\"bz\" orderkey=\"bz\" />"+
			"               <col width=\"10%\" text=\"类型\" column=\"lx\" orderkey=\"lx\" />"+
			"               <col width=\"10%\" text=\"金额\" column=\"jkye\" orderkey=\"jkye\"  transmethod=\"seahonor.action.expenses.TransMethod.getTransNum\" />"+
