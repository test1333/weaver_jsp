...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		String fromSql  = " (select t.id,t.bz,t.jkye,isnull((select jkye from uf_personal_borrow where sfyq='0' and id=t.id),0) as yqje,t.jkr,(select departmentid from hrmresource where id=t.jkr) as departmentid from uf_personal_borrow t where ISNULL(t.jkye,0)>0 and sfyq='0' ) a ";
		...
		"			<head>";
			...
			"               <col width=\"10%\" text=\"借款余额\" column=\"jkye\" transmethod=\"seahonor.action.expenses.TransMethod.getTransNum\" linkkey=\"keyid\" linkvaluecolumn=\"keyid\"  href=\"/seahonor/expenses/gr-borrow-info-Url-yq.jsp\"/>"+
