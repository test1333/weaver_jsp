				...
				<COLGROUP>
			  	...
			  	<TBODY>
                    ...
                    <TD class="e8_tblForm_label">提醒内容</TD>
                      <TD class="e8_tblForm_field">
							<textarea name="remarks" id="remarks"  rows="3" style="width: 70%">
							<%=remarks %></textarea>
                      </TD>
                    </TR>  
				...
				<COLGROUP>
			  	...
			  	<TBODY>
				     <%
                      ...
                      <TD class="e8_tblForm_field">
                      		<brow:browser viewType="0"  name="stopID" browserValue="<%=stopID %>"
								browserUrl="/systeminfo/BrowserMain.jsp?url=/interface/MultiCommonBrowser.jsp?type=browser.StopInfoOther"
								hasInput="true" isSingle="true" hasBrowser = "true" isMustInput='1'
								completeUrl="/data.jsp?type=4" width="120px"
								linkUrl=""browserSpanValue="<%=stopID %>"></brow:browser>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						中止条件关联值
							<select style="width: 120px;" class=InputStyle id="selStopInfo" name="selStopInfo" >
						         	<option value="1" <%if(selStopInfo==1){%>selected="selected"<%} %>>固定值</option>
						         	<option value="2" <%if(selStopInfo==2){%>selected="selected"<%} %>>关联字段值</option>
						         </select>
						 
							<input type="text" style="width: 60%;" name="stopUqID" id="stopUqID" value="<%=stopID %>" />
                      </TD>
                    </TR> 
