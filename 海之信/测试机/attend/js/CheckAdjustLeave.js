    ...
    jQuery(document).ready(function() {
        ...
        var adjustHours = "#field6028"; //调休小时数
        var annualleft = "#field6029"; //年假剩余天数
        var overworkleft1 = "#field6022"; //加班剩余小时1
        var overworkleft2 = "#field6023"; //加班剩余小时2
        ...
        checkCustomize = function() {
            ...
            var leavehours1_val = DateDiff(leaveEndDate_val,leaveStartDate_val);
            var leavehours2_val = 0.5 * (1+Number(leaveEndTime_val) - Number(leaveStartTime_val));
            var leavehours_val = (leavehours1_val + leavehours2_val) * 8;
            jQuery(leavehours).val(leavehours_val);
            //alert("请假小时数="+leavehours1_val+"+"+leavehours2_val+"="+leavehours_val);
