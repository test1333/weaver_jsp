...
<HTML>
	...
	<BODY>
		...
		<%
		String backfields = " emp_id,(select departmentid from HrmResource where id=emp_id) as dept,workcode,isnull(absence,0) as absence,isnull(deduction,0) as deduction,CONVERT(varchar(7),countdate,23) as countdate";
		//表单中的字段
		String fromSql  = " from uf_leave_deduction ";//sql查询的表
		String sqlWhere = " where countdate = '"+tmp_enddate+"' ";//where条件
		//out.println("select "+ backfields + fromSql +"where"+ sqlWhere);
		
		String orderby = " dept,emp_id " ;//排序关键字
		String tableString = "";
		...
		operateString +="     <operate  	href=\"javascript:onagentedit();\" text=\"查看明细\" otherpara=\"ct+column:emp_id+column:emp_id\" index=\"0\"/>";
		operateString +=" </operates>";
