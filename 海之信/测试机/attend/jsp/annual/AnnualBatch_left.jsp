...
function initTree(){
	...
	tree.add(rti = new WebFXLoadTreeItem("","/hrm/schedule/AnnualLeftXML.jsp?rightStr=<%=rightStr%>"));
...
function setCompany(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=AnnualBatchView&companyid="+comid;
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=AnnualBatchView&subcompanyid1="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=AnnualBatchView&departmentid="+deptid+"&subcompanyid1="+subCompanyId;
    document.SearchForm.submit();
}
