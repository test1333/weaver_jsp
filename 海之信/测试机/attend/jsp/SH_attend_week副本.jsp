...
String sql = " select atten_start_time,atten_end_time,out_type,late_times,early_leave_times from uf_all_attend_info "
+" where emp_id = "+emp_id+" and  atten_day = '"+atten_day+"' ";
recordSet.executeSql(sql);
String temp1 = "<td style=\"background:#92D050 ; color:white \">  ";
	String temp2 = "<td style=\"background:#538DD5 \">  ";
		String temp3 = "<td style=\"background:#FF0000\">  ";
			if(recordSet.next()) {
	...
	<HTML>
		...
		<BODY>
			...
			<div>
			<TABLE width="96%" style="margin-left: 2%;margin-top: 1px;margin-right: 2%;font-size: 9pt;" border="0px" bordercolor="#DADADA" cellspacing="1px">
			    <colgroup>
			    <col width="10%"></col>
			    <col width="5%"></col>
			    <col width="10%"></col>
				...
				<TABLE width="96%" style="background:white;margin-left: 2%;margin-top: 5px;margin-right: 2%;font-size: 9pt;" border="1px" bordercolor="#D3D3D3" cellspacing="0px">
					<tr>
						<td valign="top">
							<TABLE width="100%" >
								<colgroup>
								...
								<TBODY>
									...
									%>
									<tr class="ListStyle" align="center" style="color:#FFF;height: 40px;background-color: #008DF6;">
										<td>部门</td>
										<td>姓名</td>
										<td colspan="2">周一</td>
										<td colspan="2">周二</td>
									...
									<tr align="center">
										...
										if(firstday>26){
											...
											out.println("<td colspan=\"2\"><a href=javascript:this.addFieldTrigger("+emp_id+",'"+tmp_date+"')><font color=\"#948787\">"+firstday+"日</a></font><br/>");
										...
										out.println("</td>");
											...
											out.println("<td colspan=\"2\"><a href=javascript:this.addFieldTrigger("+emp_id+",'"+tmp_date+"')>"+firstday+"日</a><br/>");
											//out.println("tmp_date="+tmp_date);
											out.println(getEmpAttenInfo(recipient,tmp_date));
										out.println("</td>");
										}
										...
										firstday ++;
											...
											out.println("<td colspan=\"2\">test</td>");
										}
