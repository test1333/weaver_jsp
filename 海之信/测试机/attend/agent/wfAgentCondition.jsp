...
<FORM name="frmmain" action="/seahonor/attend/agent/wfAgentConditionOperator.jsp" method="post">
<%
		...
		jQuery.ajax({
			 ...
			 dataType: 'json',
				...
				if(msg.done.success=="success"){
					...
					Dialog.alert("加载数据 失败："+msg.done.info);
				   	returnstr="2";
				}
			 }
		 });
