	...
	<wea:layout>
		...
		<wea:item attributes="{'isTableList':'true'}">	
	        ...
	        <tr >
			 ...
			 <%=SystemEnv.getHtmlLabelName(-11012,user.getLanguage())%>
			 </td>
			 <td	class="field" colspan="3">
			 <%=workflowname %>
			 </td>
...
function onShowAgentCondition(){
		...
		var url = "/seahonor/attend/agent/wfAgentCondition.jsp?agentid=<%=agentid%>&types=editcondition";
