...
<%  RecordSet rs2= new RecordSet();  
 ...
 String sql2="select id from uf_contacts where guid is not null and dealStatus=0 and superid is null and guid <> ''";
 rs2.executeSql(sql2);
 while(rs2.next()){

    String gsid = Util.null2String(rs2.getString("id"));
	   String flag = "0";
	 	String tablename="";//表名
		String zdm="";//字段名
		String keyzd="";//关键字段
