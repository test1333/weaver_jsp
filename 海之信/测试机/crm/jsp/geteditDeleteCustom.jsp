...
<%
    ...
    String gsid = request.getParameter("gsid");
	 ...
	 String gswxh="";
	 String sql_dt="";
	 String sql="select id,customName,CutomStatus,gswwm,gsjczw,CustomGroup,Address,Telphone,Fax ,Postcode,zcdz,gszt,Website,zczb,sszb,khyh,yhzh,sh ,gswxh from uf_custom where superid is null and id='"+gsid+"' ";	
