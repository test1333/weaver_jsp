...
<%
    String lxrid = request.getParameter("lxrid");
	 ...
	 String lzsj = "";
	 String sql_dt="";
	 String sql="select id,name,dealStatus,wwm,lxrcm,GroupName,customName,dept,Position,mobile,tel,Fax,bgdz,Postcode,Email,grwxh,jtdz,zzdh,lxrsr,qz,status,lzsj from uf_contacts where superid is null and id='"+lxrid+"'";
