	...
	<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;">
		...
		<table width="90%" align="center">
	  	  	<colgroup> <col width="35%" /><col width="10%" /><col /></colgroup> 
	  	       ...
	  	       <tr> 
	  	       	<% 
					String sql = "select id,Name,tel,mobile,email,Address,Postcode from uf_Contacts where SuperID is null and dealStatus=1 and GroupName="+customID;
...
<script type="text/javascript">
	function openNewInfo1(id) {
		...
		var title = "";
		var url = "/formmode/view/AddFormMode.jsp?type=0&modeId=63&formId=-63&opentype=0&customid=81&viewfrom=fromsearchlist&billid="+id;
