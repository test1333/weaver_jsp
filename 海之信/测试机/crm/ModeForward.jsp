...
//	String tmp_val = "@"+java.net.URLEncoder.encode(ResourceComInfo.getResourcename(empID))+"%20%20";
	...
	if("editcustomD".equals(type)){
		response.sendRedirect("/formmode/view/AddFormMode.jsp?modeId=57&formId=-64&type=0&billid="+customID);  

	}
	if("editcontactD".equals(type)){
		response.sendRedirect("/formmode/view/AddFormMode.jsp?modeId=98&formId=-143&type=0&billid="+customID);  
	...
	if("gyspj".equals(type)){
		response.sendRedirect("/formmode/view/AddFormMode.jsp?modeId=135&formId=-236&type=1&field11562="+customID);  
	}
