...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(tmc_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+tmc_pageId +"\">"+
    ...
    "			<head>";
	 ...
	 "				<col width=\"10%\"  text=\"公司简称\" column=\"gsjczw\" orderkey=\"gsjczw\"   />"+
	  ...
	  "				<col width=\"5%\" labelid=\"567\" text=\"版本\" column=\"Version\" orderkey=\"Version\"  linkvaluecolumn=\"id\" linkkey=\"billid\" href=\"/formmode/view/ViewMode.jsp?type=0&amp;modeId=52&amp;formId=-59&amp;opentype=0&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\" />"+
