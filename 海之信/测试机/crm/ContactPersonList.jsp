...
<body>
	    ...
	    <div> <a href="/formmode/view/AddFormMode.jsp?modeId=5&formId=-6&type=1&field5823=<%=customID%>" target="_blank">新增联系人</a>  </div>
	  <br><br><br>
				<%
	  	  			String sql = "select id,Name,tel,mobile,email,Address,Postcode from uf_Contacts where customName="+customID;
	  	  		%>
	  <div id="div1" >
