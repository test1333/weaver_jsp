...
<%
    ...
    String fromSql = " from gb_bidPurchaseView v join " +
            " (select r.requestId,CGY,dtId from formtable_main_244 f left join  workflow_requestbase r " +
            " on f.requestId=r.requestid where r.currentnodetype in(0,1,2)) a on v.id = a.dtId ";//sql查询的表
