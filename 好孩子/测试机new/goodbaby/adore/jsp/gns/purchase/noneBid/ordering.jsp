...
<%
    String backfields = " p.id,dataId,WLMC,a.cgsl,gysId,GYSMC,a.requestId,v.SQRXX,needDate,flowNum," +
            " PP,XH,GG,DW,SL,YGDJ,p.FKBFB,p.FKJE ";
    //表单中的字段
    String fromSql = " from gb_noneBidPurchaseView v join " +
            " (select r.requestId,cgsl,SQRXX,dtId,contactDtId from formtable_main_234 f left join  workflow_requestbase r " +
            " on f.requestId=r.requestid where r.currentnodetype in(0,1,2)) a " +
            " on v.id = a.dtId join gb_noneFrameworkContactFlow p on a.contactDtId = p.id ";//sql查询的表
