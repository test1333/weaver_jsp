...
<%
    ...
    //表单中的字段
    String fromSql = " from gb_noneBidPurchaseView v join gb_noneFrameworkContactFlow p on v.id = p.dtId ";//sql查询的表
...
<script type="text/javascript">
    ...
    function openDialog () {
        ...
        dlg.Width = 1080// 定义长度
        dlg.Height = 720
        dlg.URL = '/goodbaby/adore/jsp/gns/purchase/noneBid/editPOAmount.jsp?id=' + ids + '&userId=' + userId
        dlg.Title = '编辑采购数量'
        dlg.show()
    }
