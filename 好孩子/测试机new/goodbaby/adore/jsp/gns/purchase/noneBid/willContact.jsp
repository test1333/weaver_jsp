...
<%
    ...
    //表单中的字段
    String fromSql = " from gb_noneBidPurchaseView ";//sql查询的表
    String sqlWhere = " id not in (select isnull(dtId,0) from formtable_main_233) ";//where条件
