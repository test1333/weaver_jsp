...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		RCMenu += "{批量下载凭证,javascript:downloadxmlAll(),_self} " ;
		RCMenuHeight += RCMenuHeightStep ;
		%>
		...
		<FORM id=report name=report action="/goodbaby/payment/operationpz.jsp" method=post>
			...
			<table id="topTitle" cellpadding="0" cellspacing="0">
				<tr>
					...
					<input type="button"  value="批量下载凭证" class="e8_btn_top" onClick="downloadxmlAll()" />
		...
		function downloadxmlAll() {
			...
			var ids = _xtable_CheckedCheckboxId();
			 if(ids!=null && ids!=""){
				...
				jQuery.ajax({
						type: "POST",
						url: "/goodbaby/payment/getdocidsall.jsp",
						data: {'lbids':ids},
						dataType: "text",
						async:false,//同步   true异步
						success: function(data){
