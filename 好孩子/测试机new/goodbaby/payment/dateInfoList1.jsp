...
<wea:layout type="4col">
	...
	String fromSql  = " from (select id,flag,pklcid,pcno,cnqr,(select pkbh from "+tablename_pk+" where requestid = pklcid) as pkbhs ,(select u.GYSMC from uf_suppmessForm u where u.id =gys ) as gysmc, bcyf,bcsf, khh,yhzh,lhh,jgh,zhsk,cnaps,remark from uf_fkzjb) uu ";
