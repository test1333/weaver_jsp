...
<%
    String backfields = " id,JBRXM,HTMC,HTBH,f.htsxrq,f.HTJZRQ,(select selectname from workflow_selectitem where fieldid='13248' and selectvalue=HTXZ) as HTXZ," +
            "(select selectname from workflow_selectitem where fieldid='13252' and selectvalue=QYZT) as QYZT,(select GYSMC from uf_suppmessForm where id=vendor) as GYSMC,vendor,f.requestId," +
            "(select selectname from workflow_selectitem where fieldid='13289' and selectvalue=XMYS) as XMYS,FKQ";
    //表单中的字段
    String fromSql = " from formtable_main_232 f left join  workflow_requestbase r on f.requestId=r.requestid ";//sql查询的表
   ...
   // out.println("select "+ backfields + fromSql +"where"+ sqlWhere);
    ...
    tableString += "    <col width=\"8%\" text=\"合同/项目名称\" column=\"HTMC\" orderkey=\"HTMC\" />" +
            "    		<col width=\"12%\" text=\"合同编号\" column=\"HTBH\" orderkey=\"HTBH\" />" +
            "		    <col width=\"6%\" text=\"经办人姓名\" column=\"JBRXM\" orderkey=\"JBRXM\" " +
            "           transmethod=\"weaver.hrm.resource.ResourceComInfo.getResourcename\" />" +
            "		    <col width=\"6%\" text=\"合同性质\" column=\"HTXZ\" orderkey=\"HTXZ\" />" +
            "		    <col width=\"11%\" text=\"签约主体\" column=\"QYZT\" orderkey=\"QYZT\" />" +
            "		    <col width=\"4%\" text=\"付款期\" column=\"FKQ\" orderkey=\"FKQ\" />" +
            "		    <col width=\"6%\" text=\"项目预算\" column=\"XMYS\" orderkey=\"XMYS\" />" +
            "		    <col width=\"7%\" text=\"合同生效日期\" column=\"htsxrq\" orderkey=\"htsxrq\" />" +
            "		    <col width=\"7%\" text=\"合同截止日期\" column=\"HTJZRQ\" orderkey=\"HTJZRQ\" />" +
            "		    <col width=\"11%\" text=\"供应商\" column=\"GYSMC\" orderkey=\"GYSMC\" " +
            " 			linkvaluecolumn=\"vendor\" linkkey=\"billid\" " +
            " 			href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=41&amp;formId=-202\" target=\"_fullwindow\" />" +
            "		    <col width=\"13%\" text=\"流程\" column=\"requestId\" orderkey=\"requestId\" " +
