...
<%
    ...
    String backfields = " id,'"+CWNY+"' as cwny,(select dbo.get_some_month(w.wlmc,w.CKID,'"+CWNY+"')) as qcsl,(select dbo.get_some_month_IN(w.wlmc,w.CKID,'"+CWNY+"')) as byrk,"+
	...
	"u.WLBM,u.WLname,(select b.dw from uf_unitForms b where b.id = u.DW) as DW,(select dbo.get_some_stock_mount(w.wlmc,w.CKID,'"+CWNY+"')) as kykc ";
    String fromSql  = "from uf_materialDatas u join (select wlmc,CKID from  uf_stock group by wlmc,CKID) w on u.id=w.wlmc ";
    String sqlWhere = " 1=1 ";
    ...
    tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(leave_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+leave_pageId+"\">"+
            ...
            operateString +
            "           <head>";
    tableString+="       <col width=\"12%\"  text=\"财务年月\" column=\"cwny\" orderkey=\"cwny\"  />"+
			"       <col width=\"12%\" text=\"仓库\" column=\"ckmc\" orderkey=\"ckmc\" />"+
			"       <col width=\"12%\"  text=\"物料名称\" column=\"WLname\" orderkey=\"WLname\"  />"+
            "       <col width=\"12%\" text=\"物料编码\" column=\"WLBM\" orderkey=\"WLBM\" />"+
			"       <col width=\"8%\" text=\"单位\" column=\"DW\" orderkey=\"DW\" />"+
			"       <col width=\"8%\" text=\"期初数量\" column=\"qcsl\" orderkey=\"qcsl\" />"+
		    "       <col width=\"8%\" text=\"本月入库\" column=\"byrk\" orderkey=\"byrk\" />"+
			"       <col width=\"8%\" text=\"本月出库\" column=\"byck\" orderkey=\"byck\" />"+
			"       <col width=\"8%\" text=\"可用库存\" column=\"kykc\" orderkey=\"kykc\" linkvaluecolumn=\"WLBM\" linkkey=\"WLBM\" href= \"/goodbaby/daisy/stock/stockinfodt_url.jsp\" target=\"view_window\"/>"+
