...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(pageID,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+pageID+"\">"+
    ...
    operateString+
    "			<head>";                                                                                                                                                  
	  tableString+="<col width=\"9%\" text=\"项目名称\" column=\"WLMC\" orderkey=\"WLMC\" linkvaluecolumn=\"id\" linkkey=\"billid\" href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=45&amp;formId=-211&amp;opentype=0&amp;customid=44&amp;viewfrom=fromsearchlist\" target=\"_fullwindow\" />"+
