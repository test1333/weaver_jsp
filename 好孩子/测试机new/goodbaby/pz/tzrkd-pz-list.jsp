...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/goodbaby/pz/tzrkd-pz-list.jsp" method=post>
		...
		String sqlWhere =  " a.requestid=b.requestid and a.id=c.mainid and a.cgdl='1' and b.currentnodetype=3 ";
		...
		tableString +="<col width=\"10%\" text=\"入库单号\" column=\"rkdh\" orderkey=\"rkdh\"  />"+ 
			"<col width=\"8%\" text=\"收货人\" column=\"shr\" orderkey=\"shr\" transmethod='weaver.proj.util.ProjectTransUtil.getResourceNamesWithLink'/>"+ 
			"<col width=\"10%\" text=\"供应商\" column=\"gys\" orderkey=\"gys\"  />"+ 
			"<col width=\"10%\" text=\"收货仓库\" column=\"shckmc\" orderkey=\"shckmc\"  />"+ 
			"<col width=\"8%\" text=\"一级成本中心\" column=\"yjcbzx\" orderkey=\"yjcbzx\"  />"+ 
			...
			"<col width=\"10%\"  text=\"相关流程\" column=\"requestnamenew\" orderkey=\"requestid\" linkvaluecolumn=\"requestid\" linkkey=\"requestid\" href=\"/workflow/request/ViewRequest.jsp\" target=\"_fullwindow\" />"+
			"<col width=\"10%\"  text=\"凭证\" column=\"imagefilename\" orderkey=\"imagefilename\" linkvaluecolumn=\"imagefileid\" linkkey=\"fileid\" href=\"/weaver/weaver.file.FileDownload?download=1\" target=\"_bank\" />"+
