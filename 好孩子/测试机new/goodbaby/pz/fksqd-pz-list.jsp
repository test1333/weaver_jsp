...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<%
		String backfields = " a.requestid as keyid,a.requestid,b.lastoperatedate,a.lcbh,(select GYSMC from uf_suppmessForm where id=a.skrmc) as gysmc,(select yjcbzx from uf_gns_deptyjcbzx where dept=a.zjlbm) as yjcbzx,b.requestnamenew,(select imagefileid from docimagefile where docid=convert(varchar(20),a.pzfj)) as imagefileid,(select imagefilename from docimagefile where docid=convert(varchar(20),a.pzfj)) as imagefilename,(select buydl from uf_buydl where id=a.cglb) as cglb,case when gzrq is null then b.lastoperatedate else gzrq end as pzrq,bcje";
		...
		tableString +="<col width=\"10%\" text=\"付款单号\" column=\"lcbh\" orderkey=\"lcbh\"  />"+ 
			...
			"<col width=\"10%\" text=\"金额\" column=\"bcje\" orderkey=\"bcje\"  />"+ 
