...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
  ...
  String out_pageId = "gnsreportbj_1";
	String sql = "";
	...
	<BODY>
		...
		<FORM id=report name=report action="/goodbaby/gnsbb/gns-report-bj.jsp" method=post>
		...
		<%
		String backfields = "a.requestid,a.xjdh,a.WLBM,a.WLMC,a.SL,(select dw from uf_unitForms where id=a.DW)as dw,(select name from crm_customerinfo where id=b.gysmc) as gysmc,c.BJJE,c.BJDJ,c.HJJE";
		String fromSql  =  " from formtable_main_228 a,formtable_main_228_dt2 b,formtable_main_227 c";
		String sqlWhere =  " a.id=b.mainid and a.requestid=c.aid and b.gysmc=c.gysbm1  ";
	  if(!"".equals(xjdh)){
			sqlWhere +=" and a.XJDH like '%"+xjdh+"%' ";
		}

		if(!"".equals(wlmc)){
			sqlWhere +=" and a.WLMC like '%"+wlmc+"%' ";
		}
		if(!"".equals(wlbm)){
			sqlWhere +=" and a.WLBM like '%"+wlbm+"%' ";
		}
		...
		"			<head>";
		tableString +=
		  "<col width=\"15%\" text=\"询价单号\" column=\"XJDH\" orderkey=\"XJDH\"  linkvaluecolumn=\"requestid\" linkkey=\"requestid\" href=\"/workflow/request/ViewRequest.jsp\" target=\"_fullwindow\"/>"+ 
			...
			"<col width=\"10%\" text=\"单价\" column=\"BJDJ\" orderkey=\"BJDJ\"  />"+ 		
			"<col width=\"10%\" text=\"总价\" column=\"HJJE\" orderkey=\"HJJE\"  />"+ 
			"<col width=\"10%\" text=\"议价\" column=\"BJJE\" orderkey=\"BJJE\"  />"+ 
			"</head>"+
		 "</table>";
