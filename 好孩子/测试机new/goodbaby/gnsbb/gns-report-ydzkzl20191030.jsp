...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
  ...
  String out_pageId = "gnsreportydzkzl_1";
	String sql = "";
	...
	<BODY>
		...
		<%
		String backfields = "gsmc,gsdm,yjcbzx,gys,gysbh,gysmc,qcje,qmje,bqzj,je1,je2,je3,je4,je5,je6,je7,je8,je9,je10";
		String fromSql  =  " from (select (select gsmc from uf_yjcbzxdzb where yjcbzxmc=a.yjcbzx) as gsmc,(select ksdm from uf_yjcbzxdzb where yjcbzxmc=a.yjcbzx) as gsdm,yjcbzx,gys,gysmc,gysbh "+
											",dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'0','') as qcje,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'1','') as qmje,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'2','') as bqzj,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','1') as je1,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','2') as je2,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','3') as je3,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','4') as je4,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','5') as je5,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','6') as je6,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','7') as je7,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','8') as je8,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','9') as je9,dbo.f_get_gnsbb_rkyfzkzl(yjcbzx,gys,'3','10') as je10 "+
