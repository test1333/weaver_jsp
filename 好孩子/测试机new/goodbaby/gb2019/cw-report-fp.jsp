...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "cwreportfp_3";
	String sql = "";
	...
	<BODY>
		...
		<%
		String backfields = "requestid,dtid,keyid,workflowid,(select workflowname from workflow_base where id=a.workflowid) as workflowname,createdate,requestmark,userid_new,sqr,sqryx,cbzx1,cbzxbmmc,gszt,invoicetype,km,ywlx,je,se,kdkje,bxje,sjbxje,bz,invoicenumber,nodename"+
