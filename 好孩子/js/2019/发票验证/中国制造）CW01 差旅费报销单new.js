...
var kdkje_dt1 = "#field17596_";//明细1可抵扣金额
var jtgjlx_dt1 = "#field17184_";//明细1交通工具类型
var pmje_dt1 = "#field17598_";//明细1票面金额
var ryfjf_dt1 = "#field17593_";//明细1燃油附件费

var sjbxje_dt1 = "#field17594_";//明细1实际报销金额
var bxje_dt1 = "#field17130_";//明细1报销金额
var sjbxje_dt2 = "#field17603_";//明细2实际报销金额
var bxje_dt2 = "#field17138_";//明细2报销金额
var sjbxje_dt3 = "#field17607_";//明细3实际报销金额
var bxje_dt3 = "#field17146_";//明细3报销金额
var sjbxje_dt4 = "#field17611_";//明细4实际报销金额
var bxje_dt4 = "#field17154_";//明细4报销金额
...
var t0 = {
    _index: 0,
    lcbh: 'field17089' /** 流程编号-varchar(300)**/,
    sqr: 'field17090' /** 申请人-int**/,
    sqbm: 'field17091' /** 申请部门-int**/,
    gs: 'field17092' /** 公司1-int**/,
    gh: 'field17093' /** 申请人工号-varchar(300)**/,
    zw: 'field17094' /** 职位-int**/,
    skrmc: 'field17095' /** 收款人名称-varchar(300)**/,
    skyhmc: 'field17096' /** 收款银行名称-varchar(300)**/,
    skyhzh: 'field17097' /** 收款银行账号-varchar(300)**/,
    cbzx: 'field17098' /** 成本中心（费用归属部门）OLD-int**/,
    cbzxbm: 'field17099' /** 成本中心编码-varchar(300)**/,
    djrq: 'field17100' /** 单据日期-char(10)**/,
    zje: 'field17101' /** 总金额-decimal(15,2)**/,
    beiz: 'field17102' /** 备注-text**/,
    whbyj: 'field17103' /** 未还备用金-decimal(15,2)**/,
    jklsjl: 'field17104' /** 借款历史记录-varchar(4000)**/,
    bcsfje: 'field17105' /** 本次实发金额-decimal(15,2)**/,
    bcsfjedx: 'field17106' /** 本次实发金额大写-decimal(15,2)**/,
    xgfj: 'field17107' /** 相关附件-text**/,
    bz: 'field17119' /** 币种-int**/,
    zj: 'field17120' /** 总计-varchar(30)**/,
    tdr: 'field17121' /** 填单人-int**/,
    tdryx: 'field17122' /** 填单人部门-varchar(300)**/,
    tdrgh: 'field17123' /** 填单人工号-varchar(300)**/,
    sqryx: 'field17124' /** 申请人部门-varchar(300)**/,
    zffs: 'field17125' /** 支付方式-int**/,
    jt: 'field17126' /** 交通总金额-decimal(15,2)**/,
    zs: 'field17127' /** 住宿总金额-decimal(15,2)**/,
    cf: 'field17128' /** 餐费总金额-decimal(15,2)**/,
    qrf: 'field17129' /** 其他费用总金额-decimal(15,2)**/,
    sqrq: 'field17160' /** 申请日期-char(10)**/,
    cs: 'field17161' /** 城市-int**/,
    sfgc: 'field17164' /** 是否工厂-int**/,
    zjl: 'field17165' /** 总经理-int**/,
    xglc: 'field17166' /** 相关出差申请单(其他)-varchar(4000)**/,
    jec: 'field17167' /** 金额差-decimal(15,2)**/,
    whje: 'field17168' /** 未还金额-decimal(15,2)**/,
    manager: 'field17169' /** 部门主管-int**/,
    bmjl: 'field17170' /** 总经理上级-int**/,
    bm: 'field17171' /** 部门-int**/,
    gs1: 'field17172' /** 公司-int**/,
    pzfj: 'field17173' /** 凭证附件-text**/,
    ysbh: 'field17174' /** 预算编号-varchar(300)**/,
    tdrbm: 'field17175' /** 填单部门-int**/,
    cbzx1: 'field17176' /** 成本中心（费用归属部门）-browser.cbzx**/,
    jl: 'field17177' /** 经理-int**/,
    sfcg: 'field17178' /** 是否出国-int**/,
    sfcbz: 'field17179' /** 是否超标准-int**/,
    sfxyggbmsp: 'field17180' /** 是否需要归口部门审批-int**/,
    jobLevel: 'field17195' /** 申请人职级-int**/,
    company: 'field17196' /** 公司-browser.Company**/,
    ccxg: 'field17197' /** 相关出差申请单-int**/
}
var t1 = {
    _index: 1,
    fyfsrq: 'field17108' /** 费用发生日期-char(10)**/,
    cfcs: 'field17109' /** 出发城市1-int**/,
    mddcs: 'field17110' /** 目的地城市1-int**/,
    jtgj: 'field17111' /** 交通工具-varchar(300)**/,
    jtgjje: 'field17112' /** 交通工具金额-varchar(30)**/,
    fjfy: 'field17113' /** 房间费用-varchar(30)**/,
    cf: 'field17114' /** 餐费-varchar(30)**/,
    qtfy: 'field17115' /** 其他费用-varchar(30)**/,
    hj: 'field17116' /** 合计-varchar(30)**/,
    bz: 'field17117' /** 备注-varchar(300)**/,
    sfcbz: 'field17118' /** 是否超标准-int**/,
    bxje: 'field17130' /** 报销金额-decimal(15,2)**/,
    bz1: 'field17131' /** 币种-browser.huin**/,
    hl: 'field17132' /** 汇率-decimal(15,4)**/,
    rmbje: 'field17133' /** 人民币金额-decimal(15,2)**/,
    cf1: 'field17162' /** 出发城市-int**/,
    mdd1: 'field17163' /** 目的地城市-int**/,
    cfcs2: 'field17181' /** 出发城市-browser.cs**/,
    mdcs2: 'field17182' /** 目的城市-browser.cs**/,
    cwdj: 'field17183' /** 等级-int**/,
    jtgjlx1: 'field17184' /** 交通工具类型-int**/,
    fxsj: 'field17185' /** 飞行时间-decimal(15,1)**/,
    jpzk: 'field17186' /** 票价折扣-int**/,
    ccje: 'field17198' /** 超出金额-decimal(15,2)**/
}
var t2 = {
    _index: 2,
    fyfsrq: 'field17134' /** 费用发生日期-char(10)**/,
    jdmc: 'field17135' /** 酒店名称-varchar(200)**/,
    qzrq: 'field17136' /** 起住日期-char(10)**/,
    jsrq: 'field17137' /** 结束日期-char(10)**/,
    bxje: 'field17138' /** 报销金额-decimal(15,2)**/,
    bz1: 'field17139' /** 币种-browser.huin**/,
    hl: 'field17140' /** 汇率-decimal(15,4)**/,
    rmbje: 'field17141' /** 人民币金额-decimal(15,2)**/,
    bz: 'field17142' /** 备注-varchar(300)**/,
    sfcbz: 'field17143' /** 是否超标准-int**/,
    cs: 'field17187' /** 城市-browser.cs**/,
    sl: 'field17188' /** 税率-decimal(15,2)**/,
    sj: 'field17189' /** 税金-decimal(15,2)**/,
    cfdq2: 'field17190' /** 地区-int**/,
    qylb: 'field17191' /** 区域类别-int**/,
    ccje: 'field17199' /** 超出金额-decimal(15,2)**/
}
var t3 = {
    _index: 3,
    fyfsrq: 'field17144' /** 费用发生日期-char(10)**/,
    cflx: 'field17145' /** 餐费类型-int**/,
    bxje: 'field17146' /** 报销金额-decimal(15,2)**/,
    bz1: 'field17147' /** 币种-browser.huin**/,
    hl: 'field17148' /** 汇率-decimal(15,4)**/,
    rmbje: 'field17149' /** 人民币金额-decimal(15,2)**/,
    bz: 'field17150' /** 备注-varchar(300)**/,
    sfcbz: 'field17151' /** 是否超标准-int**/,
    zc: 'field17192' /** 早餐-char(1)**/,
    wc: 'field17193' /** 午餐-char(1)**/,
    wanc: 'field17194' /** 晚餐-char(1)**/,
    ccje: 'field17200' /** 超出金额-decimal(15,2)**/
}
var t4 = {
    _index: 4,
    fyfsrq: 'field17152' /** 费用发生日期-char(10)**/,
    sx: 'field17153' /** 事项-varchar(300)**/,
    bxje: 'field17154' /** 报销金额-decimal(15,2)**/,
    bz1: 'field17155' /** 币种-browser.huin**/,
    hl: 'field17156' /** 汇率-decimal(15,4)**/,
    rmbje: 'field17157' /** 人民币金额-decimal(15,2)**/,
    bz: 'field17158' /** 备注-varchar(300)**/,
    sfcbz: 'field17159' /** 是否超标准-int**/
}
</script>	
