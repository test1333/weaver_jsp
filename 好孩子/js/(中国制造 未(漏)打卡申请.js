...
<script type="text/javascript">
	var sqrq="#field6804";//申请日期
	var degzr="#field11002";//第二工作日
	var syrq="#field11003";//上月日期
	
	var xbkrq_dt1="#field6810_";//需补卡日期
jQuery(document).ready(function () {
    var applyType = 'field6813' // 未打卡类型
    var afterWorkTime = 'field6812' // 下班时间
