...
<%
    ...
    String tablename_ht = gg.getTableName("FKJHT");
    String[] ids;
    String sql;
    String idkey = "1";
    ...
    for (String id : ids) {
        if (!"0".equals(id)) {
            ...
            rs.executeSql("select * from "+tablename_ht+" where WLBH='" + itemNumber + "'");
            while (rs.next()) {
                //遍历所有字段
...
//            flowMap.put("HL", contactReqMap.get("hl"));
            ...
            String newReq = createRequest(290, userId, title, "0", flowMap);
            if (!"".equals(newReq)) {
                idkey = "0";
            }
        }
