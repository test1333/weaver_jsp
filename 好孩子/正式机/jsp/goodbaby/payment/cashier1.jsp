...
<wea:layout type="4col">
	...
	String fromSql  = " from (select xx,cnpdcc,id,con,(select pkbh from  "+tablename_pk+" where requestid = pklcid ) as pkbh,pklcid,pcno from [dbo].[gb_cashierConfirm1] ) u ";
...
%>
	...
	function showVi(vid){
		if(vid=="") return ;
		var url = "/goodbaby/payment/dateInfoList1.jsp?pklcid="+vid;
		var title = "基本信息查看";
