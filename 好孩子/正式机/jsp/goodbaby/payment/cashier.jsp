...
<wea:layout type="4col">
	...
	String fromSql  = " from (select xx,cnpdcc,id,con,(select pkbh from  "+tablename_pk+" where requestid = pklcid ) as pkbh,pklcid,pcno from [dbo].[gb_cashierConfirm] ) u ";
