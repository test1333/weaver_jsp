    ...
    <div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;">
        <wea:layout type="4col">
            <wea:group context="查询条件">
                ...
                <wea:item>
                    <input type="text" id="company" name="company" style='width:80%' value="<%=company%>">
                </wea:item>
...
//            "   href= \"/goodbaby/daisy/payment/payReqList/paydtList.jsp?fkqx=" + fkqx + "&amp;bz=" + bz + "\" target=\"view_window\"/>" +
            "   <col width=\"7%\" text=\"收款银行\" column=\"khh\" orderkey=\"khh\" />" +
            "   <col width=\"7%\" text=\"收款银行账号\" column=\"yhzh\" orderkey=\"yhzh\" />" +
            "   <col width=\"7%\" text=\"收款行联行号\" column=\"lhh\" orderkey=\"lhh\" />" +
            "   <col width=\"7%\" text=\"收款行机构号\" column=\"jgh\" orderkey=\"jgh\" />" +
            "   <col width=\"7%\" text=\"是否中行收款标识\" column=\"zhsk\" orderkey=\"zhsk\" />" +
            "   <col width=\"7%\" text=\"CNAPS行号\" column=\"CNAPS\" orderkey=\"CNAPS\" />" +
