...
<%
	String url_1 = "";
	url_1 = "/goodbaby/whfp/Purchase.jsp";
	String url_2 = "/goodbaby/whfp/Purchase1.jsp";
	String url_3 = "/goodbaby/whfp/Purchase2.jsp";
	String url_4 = "/goodbaby/whfp/Purchase3.jsp";
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">入库单申请发票</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">零星类未申请发票<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_2%>">零星类已申请发票<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_3%>">非零星类未申请发票<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_4%>">非零星类已申请发票<span id="allNum_span"></span></a>
				</li>
		    </ul>
