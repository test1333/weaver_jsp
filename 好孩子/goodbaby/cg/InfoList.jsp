...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(pageID,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+pageID+"\">"+
    ...
    operateString+
    "			<head>";                                                                                                                                                  
	  tableString+="<col width=\"16%\" text=\"采购类型\" column=\"CGLX\" orderkey=\"CGLX\"  linkkey=\"billid\"  linkvaluecolumn=\"id\"  href=\"/formmode/view/AddFormMode.jsp?type=0&amp;modeId=55&amp;formId=-255&amp;opentype=0&amp;customid=50&amp;viewfrom=fromsearchlist\"  target=\"_fullwindow\"  />"+
