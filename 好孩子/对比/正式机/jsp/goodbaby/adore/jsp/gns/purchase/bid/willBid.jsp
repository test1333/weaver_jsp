...
<%
    String backfields = " id,dataId,WLMC,WLBM,gysId,GYSMC,requestId,SQRXX,needDate,flowNum,PP,XH,GG,DW,SL,YGDJ ";
    //表单中的字段
    String fromSql = " from gb_bidPurchaseView ";//sql查询的表
    String sqlWhere = " id not in (select isnull(dtId,0) from formtable_main_244) ";//where条件
    ...
    tableString += "    <col width=\"33%\" text=\"物料名称\" column=\"WLMC\" orderkey=\"WLMC\" " +
            ...
            "           href=\"/workflow/request/ViewRequest.jsp?ismonitor=1\" target=\"_fullwindow\" />" +
            "	</head>" +
            " </table>";
%>
...
<script type="text/javascript">
    ...
    function createWorkflow () {
        ...
        Dialog.confirm('确定发起流程', function () {
            report.action = 'createBidFlow.jsp?id=' + ids + '&userId=' + userId
            report.submit()
