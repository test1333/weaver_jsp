...
<%
	String aid = Util.null2String(request.getParameter("id"));
	String kbsj = "";
	String zbwjbh = "";
	if(aid.length()>0){
		String sql ="select a.ZBWJBH, a.jzbqrq+' '+a.jzbqsj as  ykbsj  from formtable_main_231 a where a.id ='"+aid+"' ";
		rs.executeSql(sql);
		if(rs.next()){
	...
	String url_1 = "";
	url_1 = "/goodbaby/ztb/bidList2.jsp?aid="+aid+"&kbsj="+kbsj+"&a=0&zbwjbh="+zbwjbh+"&lc=0";
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">招标单</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">招标单信息<span id="allNum_span"></span></a>
				</li>
			</ul>
