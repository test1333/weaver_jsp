...
String tablename_rkd = gg.getTableName("RKD");
if(fphm.length()>4){
	String mainid = "";
	String sql1 = "insert into uf_invoice(gys,xtkh,fphm,fpze,whsj,formmodeid,modedatacreater) values ('"+gsyids+"','"+xtgysids+"','"+fphm+"','"+fphj+"',CONVERT(varchar(16),GETDATE(),120),55,1)";
	//out.print("sql1----"+sql1+"----");
	rs.executeSql(sql1);
