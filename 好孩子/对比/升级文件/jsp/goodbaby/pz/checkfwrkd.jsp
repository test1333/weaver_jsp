...
"where a.requestid=b.requestid and a.cgdl='3' and b.currentnodetype=3 and (select yjcbzx from uf_cbzx where id=a.cbzx) = '"+yjcbzx+"' and b.lastoperatedate<='"+enddate+"' and b.lastoperatedate>='"+begindate+"'";
rs.executeSql(sql);
if(rs.next()){
