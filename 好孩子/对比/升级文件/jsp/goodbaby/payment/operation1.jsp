...
<wea:layout type="4col">
	...
	<%	
	String backfields = " uu.id,uu.gysmc,uu.pkbhs, uu.pklcid,uu.bcyf,uu.bcsf,uu.khh,uu.yhzh,uu.lhh,uu.jgh,case when uu.zhsk='0' then '是' else '否' end as zhsk,uu.cnaps,uu.remark "; 
	String fromSql  = " from (select id,pklcid,flag,(select pkbh from "+tablename_pk+" where requestid = pklcid) as pkbhs ,(select u.GYSMC from uf_suppmessForm u where u.id =gys ) as gysmc, bcyf,bcsf, khh,yhzh,lhh,jgh,zhsk,cnaps,remark from uf_fkzjb) uu ";
	String sqlWhere = " where  1=1 and flag = 0 ";	
	// if(userid!=1){
