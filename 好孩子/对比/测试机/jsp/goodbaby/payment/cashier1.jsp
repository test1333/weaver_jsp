...
<wea:layout type="4col">
	...
	String fromSql  = " from (select xx,cnpdcc,id,con,(select pkbh from  formtable_main_205 where requestid = pklcid ) as pkbh,pklcid,pcno from [dbo].[gb_cashierConfirm1] ) u ";
