...
//     out.println("select "+ backfields + fromSql +"where"+ sqlWhere);
    ...
    tableString = " <table tabletype=\"checkbox\" pagesize=\"" + PageIdConst.getPageSize(late_pageId, user.getUID(), PageIdConst.HRM) + "\" pageId=\"" + late_pageId + "\">" +
            ...
            "	<head>";
    tableString += "		    <col width=\"30%\" text=\"排款流程\" column=\"requestid\" orderkey=\"requestid\" " +
...
<script type="text/javascript">
    ...
    function showVi(vid){
        if(vid=="") return ;
       // alert(vid);
        var url = "/goodbaby/daisy/payment/editPayYS.jsp?requestid="+vid;
        var title = "付款";
