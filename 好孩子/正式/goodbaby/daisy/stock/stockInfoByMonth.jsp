...
<%
    ...
    String backfields = " u.id,'"+CWNY+"' as cwny,w.rkjg,(select dbo.get_some_month(w.wlmc,w.CKID,'"+CWNY+"')) as qcsl,(select dbo.get_some_month_IN(w.wlmc,w.CKID,'"+CWNY+"')) as byrk,"+
    ...
    String fromSql  = "from uf_materialDatas u join (select wlmc,CKID,rkrq,rkly,rkjg from uf_stock group by wlmc,CKID,rkrq,rkly,rkjg) w on u.id=w.wlmc ";
    String sqlWhere = " w.rkly=0 and substring(w.rkrq,1,7)= '"+CWNY+"'";
