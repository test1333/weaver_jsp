...
<HEAD>
    ...
    <%
        ...
        String sql = "";
        sql = " select count(id) as num_admin from HrmRoleMembers where roleid in(109,111) and resourceid=" + userId;
        rs.executeSql(sql);
        if (rs.next()) {
        ...
        String url_6 = "biding.jsp";
        String url_7 = "willBid.jsp";
        ...
        <div class="e8_ultab">
            ...
            <div>
                <ul class="tab_menu">
                    ...
                    %>
                    <li class="current">
                        <a target="tabcontentframe" href="<%=url_7%>">待招投标<span id="allNum_span"></span></a>
                    </li>
                    <li class="">
                        <a target="tabcontentframe" href="<%=url_6%>">招投标中</a>
                    </li>
                    <li class="">
                        <a target="tabcontentframe" href="<%=url_5%>">待合同</a>
                    </li>
                    <li class="">
