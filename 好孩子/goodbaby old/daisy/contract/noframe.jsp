...
<%
    String backfields = " id,JBRXM,HTMC,HTBH,BBJE,HTSXRQ,HTJZRQ,(select selectname from workflow_selectitem where fieldid='12359' and selectvalue=HTXZ) as HTXZ," +
           "(select selectname from workflow_selectitem where fieldid='13354' and selectvalue=QYZT) as QYZT," +
            "(select GYSMC from uf_suppmessForm where id=f.GYSMC) as GYS,GYSMC,f.requestId,FKQ";
    //表单中的字段
    String fromSql = " from formtable_main_207 f left join  workflow_requestbase r on f.requestId=r.requestid ";//sql查询的表
