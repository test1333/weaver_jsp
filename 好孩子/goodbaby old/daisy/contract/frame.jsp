...
<%
    String backfields = " id,JBRXM,HTMC,HTBH,HTSXRQ,HTJZRQ,(select selectname from workflow_selectitem where fieldid='14891' and selectvalue=HTXZ) as HTXZ," +
            "(select selectname from workflow_selectitem where fieldid='14896' and selectvalue=QYZT) as QYZT,(select GYSMC from uf_suppmessForm where id=vendor) as GYSMC,vendor,f.requestId," +
            "(select selectname from workflow_selectitem where fieldid='15060' and selectvalue=XMYS) as XMYS,FKQ";
    //表单中的字段
    String fromSql = " from formtable_main_259 f left join  workflow_requestbase r on f.requestId=r.requestid ";//sql查询的表
    ...
    tableString += "    <col width=\"8%\" text=\"合同/项目名称\" column=\"HTMC\" orderkey=\"HTMC\" />" +
            ...
            "		    <col width=\"10%\" text=\"签约主体\" column=\"QYZT\" orderkey=\"QYZT\" />" +
            "		    <col width=\"10%\" text=\"付款期\" column=\"FKQ\" orderkey=\"FKQ\" />" +
            "		    <col width=\"10%\" text=\"项目预算\" column=\"XMYS\" orderkey=\"XMYS\" />" +
            "		    <col width=\"10%\" text=\"合同生效日期\" column=\"HTSXRQ\" orderkey=\"HTSXRQ\" />" +
            "		    <col width=\"10%\" text=\"合同截止日期\" column=\"HTJZRQ\" orderkey=\"HTJZRQ\" />" +
