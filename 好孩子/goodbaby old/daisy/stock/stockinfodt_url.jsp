...
<HTML><HEAD>
    ...
    <%
        ...
        String url_1 = "";
        String url_2 = "";
        url_1 = "/goodbaby/daisy/stock/stockinfo.jsp?CWNY="+CWNY+"&WLBM="+WLBM+"&CKID="+CKID;
    %>
</head>
<BODY scroll="no">
    ...
    <div class="e8_boxhead">
        ...
        <div class="e8_ultab">
            <div class="e8_navtab" id="e8_navtab">
                <span id="objName">库存明细</span>
            </div>
            <div>
                <ul class="tab_menu">
                    <li>
                        <a target="tabcontentframe" href="<%=url_1%>">库存明细<span id="allNum_span"></span></a>
                    </li>
                </ul>
