...
<HTML><HEAD>
    ...
    <%
        String url_3 = "/goodbaby/daisy/payment/payReqList/payList.jsp";
        String url_1 = "/goodbaby/daisy/payment/willPay/arrangePayList.jsp";
        String url_2 = "/goodbaby/daisy/payment/willPay/PaidList.jsp";
        String url_4 = "/goodbaby/daisy/payment/payReqList/payList-query.jsp";
    ...
    <div class="e8_boxhead">
        ...
        <div class="e8_ultab">
            <div class="e8_navtab" id="e8_navtab">
                <span id="objName">排款计划</span>
            </div>
            <div>
                <ul class="tab_menu">
                     <li class="current">
                        <a target="tabcontentframe" href="<%=url_4%>">待排款-查询<span id="allNum_span"></span></a>
                    </li>
                    <li>
                        <a target="tabcontentframe" href="<%=url_3%>">待排款<span id="allNum_span"></span></a>
                    </li>
                    <li>
                        <a target="tabcontentframe" href="<%=url_1%>">未付款<span id="allNum_span"></span></a>
                    </li>
                    <li>
                        <a target="tabcontentframe" href="<%=url_2%>">已付款<span id="allNum_span"></span></a>
                    </li>
                </ul>
