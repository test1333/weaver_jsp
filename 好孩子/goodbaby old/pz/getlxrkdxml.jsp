...
"where a.requestid=b.requestid and a.cgdl='2' and b.currentnodetype=3 and (select yjcbzx from uf_cbzx where id=a.cbzx) = '"+yjcbzx+"' and b.lastoperatedate<='"+enddate+"' and b.lastoperatedate>='"+begindate+"'";
rs.executeSql(sql);
while(rs.next()){
	rqids = rqids+flag+Util.null2String(rs.getString("requestid"));
	flag = ",";
}
CreateLxRkdXMl crx = new CreateLxRkdXMl();
String xmlString =crx.CreateXML(begindate,enddate,yjcbzx,scr,rqids);
response.reset();
out.clear();  
//response.setContentType("application/x-download"); 
response.setContentType("application/x-msdownload");
String filedisplay = begindate.substring(0,4)+begindate.substring(5,7)+"零星类入库财务凭证.xml";  
