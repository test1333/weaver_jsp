...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/goodbaby/pz/fw-rkd-list.jsp" method=post>
		...
		<%
		String backfields = "  a.requestid as keyid,a.requestid,b.lastoperatedate,a.cbzx,a.SHCK,a.rkdh,a.shr,a.xtgys,(select yjcbzx from uf_cbzx where id=a.cbzx) as yjcbzx,(select CKMC from uf_stocks where id=a.shck) as shckmc,(select name from crm_customerinfo where id=a.xtgys) as gys,b.requestnamenew";
		String fromSql  =  " from "+lrktablename+" a,workflow_requestbase b";
		String sqlWhere =  " a.requestid=b.requestid and a.cgdl='1' and b.currentnodetype=3 ";
		...
		operateString+
		"			<head>";
		tableString +="<col width=\"10%\" text=\"入库单号\" column=\"rkdh\" orderkey=\"rkdh\"  />"+ 
			"<col width=\"10%\" text=\"收货人\" column=\"shr\" orderkey=\"shr\" transmethod='weaver.proj.util.ProjectTransUtil.getResourceNamesWithLink'/>"+ 
			"<col width=\"15%\" text=\"供应商\" column=\"gys\" orderkey=\"gys\"  />"+ 
			"<col width=\"15%\" text=\"收货仓库\" column=\"shckmc\" orderkey=\"shckmc\"  />"+ 
			...
			"<col width=\"25%\"  text=\"相关流程\" column=\"requestnamenew\" orderkey=\"requestid\" linkvaluecolumn=\"requestid\" linkkey=\"requestid\" href=\"/workflow/request/ViewRequest.jsp\" target=\"_fullwindow\" />"+
	...
	<script type="text/javascript">
		...
		function createpz() {
			...
			if(yjcbzx_val != "" && begindate_val != "" && enddate_val != ""){
				...
				jQuery.ajax({
					type: "POST",
					url: "/goodbaby/pz/checkfwrkd.jsp",
				...
				if(result == "1"){
					...
					window.open("/goodbaby/pz/getfwrkdxml.jsp?yjcbzx="+yjcbzx_val+"&begindate="+begindate_val+"&enddate="+enddate_val+"&scr="+scr_val);
				}
