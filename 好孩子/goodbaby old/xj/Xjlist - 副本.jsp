...
<input type="hidden" name="pageId" id="pageId" value="<%= PageIdConst.HRM_ONLINEUSER %>"/>
	...
	<div class="zDialog_div_content" id="differencehandle" name="differencehandle">
				...
				<wea:group context="" attributes="{'samePair':'SetInfo','groupOperDisplay':'none','itemAreaDisplay':'block'}">
					...
					<%
					String sqls = "select count(id) as cont from  formtable_main_222 where aid ='"+rid+"'  ";
					int a = 0;
					rs.executeSql(sqls);
					if(rs.next()){
						a = rs.getInt("cont");
					...
					String strsql = "select d.yjyq,d.BJJE,d.HJJE,(select c.name from  crm_customerinfo c where id =d.GYSBM1) as GYS from formtable_main_222  d where d.aid = '"+rid+"'  order by d.BJJE asc ";
