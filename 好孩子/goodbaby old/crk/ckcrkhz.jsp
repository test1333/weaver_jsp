            ...
            <table class="ViewForm1  maintable" scrolling="auto">
                ...
                <tbody>
					 ...
					 %>		 
						...
						<%
						 sql = "select gysmc,je from v_ckr_list where cwny='"+month+"' and ckid="+ckid+" and rkly='0'";
						 rs.executeSql(sql);
						 while(rs.next()){
						%>
						<tr  bgcolor="#FFD966">
						...
						<%
						 sql = "select (select cbzxbmmc from uf_cbzx a,"+lrktablename+" b where a.id=b.cbzx and b.requestid=lch ) as cbzx,je from v_ckr_list where cwny='"+month+"' and ckid="+ckid+" and rkly='1' and (thbs is null or thbs ='1')";
						 rs.executeSql(sql);
						 while(rs.next()){
						%>
						<tr bgcolor="#FFBE00">
						...
						<%
						 sql = "select gysmc,je from v_ckr_list where cwny='"+month+"' and ckid="+ckid+" and rkly='1' and thbs ='0'";
						 rs.executeSql(sql);
						 while(rs.next()){
						%>
						<tr bgcolor="#FFBE00">
