...
<input type="hidden" name="pageId" id="pageId" value="<%= PageIdConst.HRM_ONLINEUSER %>"/>
	...
	<div class="zDialog_div_content" id="differencehandle" name="differencehandle">
				...
				<wea:group context="" attributes="{'samePair':'SetInfo','groupOperDisplay':'none','itemAreaDisplay':'block'}">
					...
					<%
					String sqls = "select count(id) as cont from  formtable_main_250 where zhurid ='"+rid+"'  ";
					int a = 0;
					rs.executeSql(sqls);
					if(rs.next()){
						a = rs.getInt("cont");
					...
					// String strsql = "select d.zbj,d.zbj1,(select c.name from  crm_customerinfo c where c.id =d.xtkh) as GYS from formtable_main_250  d where d.zhurid = '"+rid+"'  order by d.zbj1 asc ";
