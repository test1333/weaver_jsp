...
<wea:layout type="4col">
	...
	String fromSql  = " from formtable_main_250 d, workflow_requestbase  c  ";
	String sqlWhere = " where  d.requestid=c.requestid  and c.workflowid = 229  and (d.zbj>0 or d.zbj1>0)";	
	...
	// String backfields = "d.id,b.BM_1,b.WLMC_1,b.GYSBM,b.GYSMC,b.GG_1+' '+b.XH_1  as GGXH,b.PP_1,BJJE_1,d.requestid,c.requestname "; 
	// String fromSql  = " from formtable_main_223 d, workflow_requestbase  c  ";
	// String sqlWhere = " where  d.requestid=c.requestid  and c.workflowid = 215 and b.mainid =d.id and b.BJJE_1>0";
