...
%>
	...
	<FORM id=report name=report action="/goodbaby/whfp/Purchase.jsp" method=post>
...
tableString =" <table tabletype=\"checkbox\" pagesize=\""+ PageIdConst.getPageSize(tmc_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+tmc_pageId +"\">"+
    ...
    "			<head>";
		...
		"<col width=\"11%\"  text=\"物料类型\" column=\"lxmc\" orderkey=\"lxmc\"/>"+
		"<col width=\"11%\"  text=\"入库单号\" column=\"RKDH\" orderkey=\"RKDH\"/>"+
		"<col width=\"11%\"  text=\"入库日期\" column=\"rksj\" orderkey=\"rksj\"/>"+
		"<col width=\"11%\"  text=\"入库单位\" column=\"dw\" orderkey=\"dw\"/>"+
		"<col width=\"11%\"  text=\"入库数量\" column=\"SJSHSL_1\" orderkey=\"SJSHSL_1\"/>"+
		"<col width=\"11%\"  text=\"实际价格(含税)\" column=\"DJ_1\" orderkey=\"DJ_1\"/>"+
		"<col width=\"11%\"  text=\"仓库名称\" column=\"ck\" orderkey=\"ck\"/>"+
		"<col width=\"11%\"  text=\"物料编码\" column=\"WLBH_1\" orderkey=\"WLBH_1\"/>"+
		"<col width=\"11%\"  text=\"供应商\" column=\"xtkhmc\" orderkey=\"xtkhmc\"/>"+
	"          </head>"+
    " </table>";
%>
	...
	<script type="text/javascript">
		...
		function whfp(){
			...
			// alert(checkresult);
			 ...
			 if(checkresult == "3"){
				top.Dialog.alert("所选开票项，仓库不同，请重新选择");
				return ;
			 }
			...
			var url = "/goodbaby/whfp/whfpInfoUrl.jsp?ids="+ids+"&type=insert&wplx=lx";
			var title = "";
