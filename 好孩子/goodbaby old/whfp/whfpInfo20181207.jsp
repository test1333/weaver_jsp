...
String cgddtable = "formtable_main_240";
String kjtable = "formtable_main_207";
String zjlbm = "";
String fpbz = "";
String fpbzid = "";
String fpsl ="";
     ...
     <button class="addbtn_p" type="button" id="addbutton0" name="addbutton0" onclick="addrow();return false;" title="添加"></button> 
			...
			<table id = "mytable" class = "tab">
				...
				<tr>
					...
					<td><input datatype="text" style="ime-mode:disabled" viewtype="1" type="text" class="input11 InputStyle" id="fph_0" name="fph_0" onkeyup="this.value=this.value.replace(/[^0-9a-zA-Z\-]/g,'')" onblur="checkinput2('fph_0','fph_0span',this.getAttribute('viewtype'))" value="" onchange="" onpropertychange="" _listener=""><span id="fph_0span" style="word-break:break-all;word-wrap:break-word"><img src="/images/BacoError_wev8.gif" align="absMiddle"></span></td>
					...
					<td> <input class="input11" type="text" id="bz_0" value="<%=fpbz%>" disabled/></td>
				
					<td><input datalength="2" datatype="float" style="ime-mode:disabled" onafterpaste="if(isNaN(value))execCommand('undo')" viewtype="1" type="text" class="input11 InputStyle" id="fpsl_0" name="fpsl_0" onkeypress="ItemDecimal_KeyPress('fpsl_0',15,2)" onblur="checkFloat(this);checkinput2('fpsl_0','fpsl_0span',this.getAttribute('viewtype'))" value="<%=fpsl%>" onchange="" onpropertychange="" _listener=""><span id="fpsl_0span" style="word-break:break-all;word-wrap:break-word"></span></td>
					<td><input datalength="2" datatype="float" style="ime-mode:disabled" onafterpaste="if(isNaN(value))execCommand('undo')" viewtype="1" type="text" class="input11 InputStyle" id="fpjews_0" name="fpjews_0" onkeypress="ItemDecimal_KeyPress('fpjews_0',15,2)" onblur="checkFloat(this);checkinput2('fpjews_0','fpjews_0span',this.getAttribute('viewtype'))" value="" onchange="" onpropertychange="" _listener=""><span id="fpjews_0span" style="word-break:break-all;word-wrap:break-word"><img src="/images/BacoError_wev8.gif" align="absMiddle"></span></td>
					<td><input datalength="2" datatype="float" style="ime-mode:disabled" onafterpaste="if(isNaN(value))execCommand('undo')" viewtype="1" type="text" class="input11 InputStyle" id="fpsj_0" name="fpsj_0" onkeypress="ItemDecimal_KeyPress('fpsj_0',15,2)" onblur="checkFloat(this);checkinput2('fpsj_0','fpsj_0span',this.getAttribute('viewtype'))" value="" onchange="" onpropertychange="" _listener=""><span id="fpsj_0span" style="word-break:break-all;word-wrap:break-word"><img src="/images/BacoError_wev8.gif" align="absMiddle"></span></td>
					<td> <input class="input11" type="text" id="fpje_0" value="" readonly/></td>
				...
				<tr id="heji1">
					...
					<td></td>
					<td></td>
					<td><div id="fpjewshj">0.00</div></td>
					<td><div id="fpsjhh">0.00</div></td>
					<td><div id="fpjehj">0.00</div></td>
					<td></td>
				</tr>
