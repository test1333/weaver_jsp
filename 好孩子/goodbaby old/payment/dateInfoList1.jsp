...
<wea:layout type="4col">
	...
	String fromSql  = " from (select id,flag,pklcid,pcno,cnqr,(select pkbh from formtable_main_205 where requestid = pklcid) as pkbhs ,(select u.GYSMC from uf_suppmessForm u where u.id =gys ) as gysmc, bcyf,bcsf, khh,yhzh,lhh,jgh,zhsk,cnaps,remark from uf_fkzjb) uu ";
	String sqlWhere = " where  1=1 and flag = 1 and cnqr = 1 and pcno= '"+pc+"' and pklcid='"+pklcid+"' ";	
	// if(userid!=1){
