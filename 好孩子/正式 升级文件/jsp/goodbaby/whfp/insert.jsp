...
if(fphm.length()>4){
	...
	String cgdlm = "";
	String yjcbzxmain = "";
	String sql1 = "insert into uf_invoice(bz,fprq,fpjews,zjlbm,gys,xtkh,fphm,fpze,whsj,formmodeid,modedatacreater,fplx,sl,sj) values ('"+fpbz+"','"+fprqarr[i]+"','"+dgjes[i]+"','"+zjlbm+"','"+gsyids+"','"+xtgysids+"','"+ph[i]+"','"+fpjeharr[i]+"',CONVERT(varchar(10),GETDATE(),120),55,1,";
	...
	String contactReq = "";
	sql1 = "select contactReq from uf_invoice_dt1 a,"+cgddtable+" b where a.ddlc = b.requestid and contactdtid is not null and mainid="+mainid;
	rs.executeSql(sql1);
	if(rs.next()){
