...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		<FORM id=report name=report action="/goodbaby/crk/rkdwkp-list.jsp" method=post>
		...
		String sqlWhere =  " a.requestid=b.requestid  and b.currentnodetype=3 and a.requestid not in(select rid from uf_invoice_dt1 where rid is not null)";
