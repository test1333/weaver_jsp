	...
	<BODY>
		...
		<FORM id=report name=report action="/alarm/alarmActionReport.jsp" method=post>
			...
			<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;">
				...
				browserUrl="/systeminfo/BrowserMain.jsp?url=/interface/CommonBrowser.jsp?type=browser.AREAL"
			  hasInput="true"  hasBrowser = "true" isMustInput='1' isSingle="false"
				...
				browserUrl="/systeminfo/BrowserMain.jsp?url=/interface/CommonBrowser.jsp?type=browser.PROVINCE"
				...
				browserUrl="/systeminfo/BrowserMain.jsp?url=/interface/CommonBrowser.jsp?type=browser.BUSINESS"
				hasInput="true" isSingle="true" hasBrowser = "true" isMustInput='1'
				 width="120px"
			    linkUrl=""
				...
				browserUrl="/systeminfo/BrowserMain.jsp?url=/interface/CommonBrowser.jsp?type=browser.CUSTOMER"
				hasInput="true" isSingle="true" hasBrowser = "true" isMustInput='1'
				 width="120px"
			    linkUrl=""
				...
				browserUrl="/systeminfo/BrowserMain.jsp?url=/interface/CommonBrowser.jsp?type=browser.KPI"
				hasInput="true" isSingle="true" hasBrowser = "true" isMustInput='1'
				 width="120px"
			    linkUrl=""
		...
		String sqlWhere = " where 1=1 and a.creat_ind='Y' ";
		...
		"			<head>";
			...
			"               <col width=\"5%\" text=\"渠道\" column=\"channel\" orderkey=\"channel\" display=\"false\"/>"+
			"               <col width=\"8%\" text=\"销售大区\" column=\"area\" orderkey=\"area\" />"+
			"               <col width=\"10%\" text=\"销售省办\" column=\"province\" orderkey=\"province\" display=\"false\"/>"+
			"               <col width=\"10%\" text=\"营业所\" column=\"sales_grp\" orderkey=\"sales_grp\" display=\"false\"/>"+
			"               <col width=\"7%\" text=\"责任人\" column=\"rptdesc\" orderkey=\"rptdesc\"/>"+
			"               <col width=\"10%\" text=\"客户\" column=\"zcustomer\" orderkey=\"zcustomer\" display=\"false\"/>"+	
			"               <col width=\"8%\" text=\"品类\" column=\"category\" orderkey=\"category\" display=\"false\"/>"+
			"               <col width=\"7%\" text=\"KPI指标\" column=\"kfname\" orderkey=\"kfname\"/>"+
			"               <col width=\"5%\" text=\"达成率\" column=\"acheive\" orderkey=\"acheive\" display=\"false\"/>"+
			"               <col width=\"8%\" text=\"预警层级\" column=\"a_level\" orderkey=\"a_level\" display=\"false\"/>"+
			"               <col width=\"8%\" text=\"创建日期\" column=\"alarm_dat\" orderkey=\"alarm_dat\"/>"+	
			"               <col width=\"8%\" text=\"行动方案\" column=\"actionid\" orderkey=\"actionid\" display=\"false\"/>"+
			"               <col width=\"12%\" text=\"行动描述\" column=\"xdfa\" orderkey=\"xdfa\"/>"+
