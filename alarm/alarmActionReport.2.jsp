...
<HTML>
	...
	<BODY>
		...
		String backfields = "a.alarm_id,a.channel,getTextValue('AREAL',7,a.area) area,getTextValue('PROVINCE',7,a.province) province,getTextValue('BUSINESS',7,a.sales_grp) as sales_grp,a.rptdesc,getTextValue('CUSTOMER',7,a.zcustomer) zcustomer,a.category,"+
		                    "getTextValue('KPI',7,kfcode) kfname,a.acheive,a.a_level||'级' as a_level,a.alarm_dat,b.actionid,b.xdfa,b.modedatacreatedate,a.tjsj,a.spsj,"+
		...
		"			<head>";
			...
			"               <col width=\"8%\" text=\"渠道\" column=\"channel\" orderkey=\"channel\"/>"+
			...
			"               <col width=\"8%\" text=\"达成率\" column=\"acheive\" orderkey=\"acheive\"/>"+
