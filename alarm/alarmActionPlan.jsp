...
<HTML>
	...
	String sql="select  getTextValue('AREAL',"+language+",area)||getTextValue('PROVINCE',"+language+",province)||getTextValue('BUSINESS',"+language+",sales_grp) as zuzhidanwei,duration,kfcode,getTextValue('KPI',"+language+",kfcode) as namedesc,approvestatus from uf_alarm_info where creat_ind='Y'"+   " and alarm_id= "+alarmid;
	rs.execute(sql);
	if(rs.next()){
	 ...
	 sql="select is_approve,is_send from uf_action_plan where rownum=1 and alarmid='"+alarmid+"'";
		 ...
		 String queren="0";
		  ...
		  requestid1 = rs.getInt(1);
		   ...
		   sql="select is_approve from uf_alarm_info where creat_ind='Y' and alarm_id='"+alarmid+"'";
