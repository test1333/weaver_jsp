...
<HTML>
	...
	<BODY>
		...
		<FORM id=report name=report action="/ghy/jsp/GHY_TPM_Rep_SAP_Status.jsp" method=post>
			...
			<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;">
				...
				<wea:group context="查询条件">
                 <wea:item>Request Id</wea:item>
				<wea:item>
				  <input name="rqid" id="rqid" class="InputStyle" type="text" value="<%=rqid%>"/>
				</wea:item>
		...
		<%
		String backfields = "rownum as num ,requestid";
		String fromSql  = " v_ghy_isnull ";
		String sqlWhere = " where 1=1 ";
		String orderby = " num asc";
		String tableString = "";
		if(!"".equals(rqid)){
		  sqlWhere +=" and requestid = '"+rqid+"'";
		}
		...
		operateString+
		"			<head>";
			tableString+= " <col width=\"45%\" text=\"序号\" column=\"num\" orderkey=\"num\"/>"+
			"               <col width=\"45%\" text=\"requestId\" column=\"requestid\" orderkey=\"requestid\"/>"+
