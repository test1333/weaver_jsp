...
<%
	...
	String url_2 = "";
	String url_3 = "";
	url_1 = "/alarm/undoAlarmAction.jsp";
	
	url_2 = "/alarm/pendingApprovalAlarm.jsp";
	url_3 = "/alarm/pendingApprovalAction.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">Alarm Action</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">待创建Action<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_2%>">待审批Action<span id="allNum_span"></span></a>
				</li>
				<li >
					<a target="tabcontentframe" href="<%=url_3%>">待结项审批Action<span id="allNum_span"></span></a>
				</li>
		    </ul>
