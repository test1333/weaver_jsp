...
<HTML>
	...
	<BODY>
		...
		<%
		String backfields = "id,alarm_id,alarm_id as alarmid,kfcode,kfname,duration,target_val,actual_val,decode(lxsp,1,'立项审批',2,'待提交') approvestatus,is_plan,Receipt_NO,requestid,R_Level,decode(lxsp,1,'立项审批','待提交') as xianshi";			  
		...
		"			<head>";
			...
			"               <col width=\"11%\" text=\"指标名称\" column=\"kfname\" orderkey=\"kfname\"/>"+
