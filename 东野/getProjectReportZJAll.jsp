...
<HTML>
	...
	<BODY>
		...
		<div id="dialog">
		 ...
		 <input type="hidden" name="pageId" id="pageId" value="<%=all_pageId%>"/>
		...
		<FORM id=report name=report action="/CRM/report/getProjectReportZJAll.jsp" method=post>
		...
		String backfields = "d.description status,"+
		                    " LEFT(b.takeordermonth1,7) takeordermonth,c.name cusumer,a.name,b.quity2,"+
							" CONVERT(VARCHAR(15),CAST(CONVERT(DECIMAL(12,2),LTRIM(b.singleprice2)) AS MONEY),1) as singleprice, CONVERT(VARCHAR(15),CAST(CONVERT(DECIMAL(12,2),LTRIM(b.itembuget2)) AS MONEY),1) as itembuget,b.pcentchange1 ,"+
							" CONVERT(VARCHAR(15),CAST(CONVERT(DECIMAL(12,2),LTRIM(b.pertotalmoney1)) AS MONEY),1) as pertotalmoney,"+
							" LEFT(b.peroutmonth2,7) peroutmonth, "+
							" LEFT(b.persalemonth2,7)  persalemonth, "+
							" LEFT(b.peracceptancemonth2,7) peracceptancemonth,"+
							"  CONVERT(VARCHAR(15),CAST(CONVERT(DECIMAL(12,2),LTRIM(b.peroutmoney2)) AS MONEY),1) as peroutmoney ";
														
		String fromSql  = " Prj_ProjectInfo a join cus_fielddata b on a.id=b.id left join CRM_CustomerInfo c on b.customer = c.id join Prj_ProjectStatus d on a.status=d.id";
		String sqlWhere = " where 1=1 and a.prjtype = 37 and b.scopeid = 37 ";
		String orderby = " b.takeordermonth1 desc ";
		String tableString = "";
		...
		String time="'"+Integer.valueOf(year)+"-"+time_month+"'";
		 sqlWhere+= " and LEFT(b.takeordermonth1,7) in("+time+")";
		}
	    ...
	    tableString =" <table tabletype=\"none\" pagesize=\""+ PageIdConst.getPageSize(all_pageId,user.getUID(),PageIdConst.HRM)+"\" pageId=\""+all_pageId+"\" >"+
		...
		operateString+
		"			<head>";
			tableString+= " <col align=\"right\" width=\"8%\" text=\"項目狀態\" column=\"status\" orderkey=\"status\" />"+
			"               <col align=\"right\" width=\"10%\" text=\"客戶\" column=\"cusumer\" orderkey=\"cusumer\"/> "+
			"               <col align=\"right\" width=\"10%\" text=\"設備名稱\" column=\"name\" orderkey=\"name\" />"+
			"               <col align=\"right\" width=\"8%\" text=\"單價\" column=\"singleprice\" orderkey=\"singleprice\" />"+
			"               <col align=\"right\" width=\"8%\" text=\"台數\" column=\"quity\" orderkey=\"quity\" />"+
			"               <col align=\"right\" width=\"10%\" text=\"總價\" column=\"itembuget\" orderkey=\"itembuget\"/>"+
			"               <col align=\"right\" width=\"10%\" text=\"接單月份\" column=\"takeordermonth\" orderkey=\"takeordermonth\"/>"+	
			"               <col align=\"right\" width=\"10%\" text=\"預計出貨月份\" column=\"peroutmonth\" orderkey=\"peroutmonth\" />"+
			"               <col align=\"right\" width=\"10%\" text=\"預計出貨金額\" column=\"peroutmoney\" orderkey=\"peroutmoney\"/>"+
			"               <col align=\"right\"  width=\"8%\" text=\"成交機會\" column=\"pcentchange\" orderkey=\"pcentchange\" />"+
			"               <col align=\"right\" width=\"8%\" text=\"成交淨額\" column=\"pertotalmoney\" orderkey=\"pertotalmoney\"/>"+		
