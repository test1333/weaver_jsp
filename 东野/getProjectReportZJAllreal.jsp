...
<HTML>
	...
	<BODY>
		...
		<FORM id=report name=report action="/CRM/report/getProjectReportZJAllreal.jsp" method=post>
		...
		String backfields = "d.description status,"+
		                    "  LEFT(b.realtakeordermonth2,7) takeordermonth,c.name cusumer,a.name,b.realquity2,CONVERT(VARCHAR(15),CAST(CONVERT(DECIMAL(12,2),LTRIM(b.realsingleprice2)) AS MONEY),1) as realsingleprice,"+
							" CONVERT(VARCHAR(15),CAST(CONVERT(DECIMAL(12,2),LTRIM(b.realitembuget2)) AS MONEY),1) as realitembuget,b.pcentchange1 ,CONVERT(VARCHAR(15),CAST(CONVERT(DECIMAL(12,2),LTRIM(b.pertotalmoney1)) AS MONEY),1) as pertotalmoney, "+
							"  LEFT(b.peroutmonth2,7) peroutmonth, "+
							"  LEFT(b.persalemonth2,7) persalemonth, "+
							"  LEFT(b.peracceptancemonth2,7) peracceptancemonth,CONVERT(VARCHAR(15),CAST(CONVERT(DECIMAL(12,2),LTRIM(b.persalemoney2)) AS MONEY),1) as persalemoney ,CONVERT(VARCHAR(15),CAST(CONVERT(DECIMAL(12,2),LTRIM(b.peracceptancemoney2)) AS MONEY),1) as peracceptancemoney ";
		...
		String orderby = " b.realtakeordermonth2 desc ";
		String tableString = "";
		...
		String time="'"+Integer.valueOf(year)+"-"+time_month+"'";
		 sqlWhere+= " and LEFT(b.realtakeordermonth2,7) in("+time+")";
		}
