...
var reqid_dt = "field13884_";
      ...
      function fl_getBudget() {
        ...
        function fl_dtChange(tmpObj, nowRow) {
          ...
          alert("3");
            ...
            get_cpt_info(tmp_cptNumber, oadate, tmp_budget,tmp_money,tmp_KSTAR,tmp_keyNum,tmp_dept);
        });
    ...
    function get_cpt_info(tmp_cptNumber, oadate, tmp_budget,tmp_money,tmp_KSTAR,tmp_keyNum,tmp_dept) {
