...
String sqlWhere = " where d.cptstockinid=m.id and m.ischecked=1 and m.checkerid in(" +new CommonShareManager().getContainsSubuserids(""+ user.getUID())+")  ";
if(!"".equals(nameQuery)){
...
function onViewDetail(id){
	if(id){
		var url="/cpt/capital/CptInstockCheck.jsp?isdialog=1&id="+id+"&from=viewdetail";
