...
String sql1 = "select t1.fieldname,t2.fieldlabel from CptSearchDefinition t1 left outer join cptDefineField t2 on lower(t1.fieldname)=lower(t2.fieldname) where t1.mouldid = -1  ";
rs1.executeSql(sql1);
while(rs1.next()){
