...
<jsp:useBean id="CptDetailColumnUtilNew" class="weaver.cpt.util.CptDetailColumnUtilNew" scope="page"/>
...
<div class="subgroupmain" style="width: 100%;margin-left:0px;"></div>
 <script>
 	 ...
 	 var items=<%=CptDetailColumnUtilNew.getDetailColumnConf("CptUse", user) %>;
...
function onSubmit()
{
	...
	var dtjson= group1.getTableJson();
   	...
   	if(dtinfo){
   		...
   		checkdtifover(dtjson,6,2,function(){
