...
<%
    ...
    //System.out.println("tree queryStr:"+queryStr);
%>
<HTML>
<HEAD>
<LINK REL=stylesheet type=text/css HREF=/css/Weaver_wev8.css>
	...
	<%--<link rel="stylesheet" href="/cpt/css/zTreeStyle_wev8.css" type="text/css">--%>
	<%--<link rel="stylesheet" href="/wui/theme/ecology8/page/perfect-scrollbar/perfect-scrollbar_wev8.css" type="text/css">--%>
...
<table height="100%" width="100%" cellspacing="0" cellpadding="0" >
    <tr>
    	<td>
    		<IFRAME name=optFrame id=optFrame width=100% height="320px" frameborder=no scrolling=auto src="/cpt/capital/CapitalBrowserList.jsp?isCapital=<%=isCapital %>&<%=queryStr %>">
