...
<form id="capitalqueryform" name="capitalqueryform" action="/cpt/capital/CapitalBrowserList.jsp"  target="optFrame">
...
<%
	...
	String sql_condition="select t1.*,t2.* from cpt_browdef t1,cptDefineField t2 where t1.iscondition=1 and t1.fieldid=t2.id  order by t1.displayorder";
...
<table height="100%" width="100%" cellspacing="0" cellpadding="0">
    <tr>
    	<td>
    		<IFRAME name=optFrame id=optFrame width=100% height="318px" frameborder=no scrolling=auto src="/cpt/capital/CapitalBrowserList.jsp?isCapital=<%=isCapital %>&<%=queryStr %>">
