...
if(detachable==0){
    response.sendRedirect("CptCapitalModify.jsp");
    return;
}
%>
...
<IFRAME name=leftframe id=leftframe src="/cpt/capital/CptCapMod_left.jsp" width="100%" height="100%" frameborder=no scrolling=no>
...
<IFRAME name=contentframe id=contentframe src="/cpt/capital/CptCapitalModify.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
</tr>
  </TBODY>
