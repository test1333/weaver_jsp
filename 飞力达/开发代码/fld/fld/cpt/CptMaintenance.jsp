...
<TABLE class=Form>
  ...
  <TR> 
    ...
    <TD vAlign=top><!-- table width="100%">
        ...
        <tr> 
          <td><a 
          href="/cpt/car/ListCarInfo.jsp">车辆管理</a></td>
        </tr>
        </tbody> 
      </table --> </TD>
  </TR>
   <!--TR> 
    <TD vAlign=top> 
      <table width="100%">
        <tbody> 
        <tr class=Section> 
          <th><%=SystemEnv.getHtmlLabelName(1360,user.getLanguage())%></th>
        </tr>
        <tr class=Separator> 
          <td class=sep1></td>
        </tr>
        <tr> 
          <td><a href="maintenance/CptCapitalCheckStock.jsp"><%=SystemEnv.getHtmlLabelName(1506,user.getLanguage())%></a></td>
        </tr>
       </tbody> 
      </table>
    </TD>
