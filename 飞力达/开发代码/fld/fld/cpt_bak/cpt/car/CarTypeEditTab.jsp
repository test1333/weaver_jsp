...
<%
String carName = SystemEnv.getHtmlLabelName(17630,user.getLanguage());
String carDesc = SystemEnv.getHtmlLabelName(17630,user.getLanguage());
String tempquerystring = Util.null2String(request.getQueryString());

String url = "/cpt/car/CarTypeEdit.jsp?"+tempquerystring;
%>
<html><HEAD>
