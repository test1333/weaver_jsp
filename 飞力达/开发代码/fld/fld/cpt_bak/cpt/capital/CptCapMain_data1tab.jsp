...
<%
	...
	url = "CptCapitalMaintenance.jsp?init=1&paraid="+parentid;
	...
	<div class="e8_box demo2">
		<div class="e8_boxhead">
		    ...
		    <ul class="tab_menu">
					...
					<li class="current" isdata=1>
						<a target="tabcontentframe" href="<%=url %>"><%=SystemEnv.getHtmlLabelName(15316,user.getLanguage()) %></a>
					</li>
