...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		RCMenu += "{Export Excel,javascript:_xtable_getAllExcel(),_self} " ;
		RCMenu += "{import,javascript:daoru(),_self} " ;
		}
		RCMenuHeight += RCMenuHeightStep ;
		%>
		<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
		<FORM id=report name=report action="/ego/peixun/ego-peixun-list.jsp" method=post>
		...
		String fromSql  =  " from v_peixun_list ";
		String sqlWhere =  " 1=1 ";
	...
	<script type="text/javascript">
		...
		function daoru() {
		var title = "Import";
		var url = "/systeminfo/BrowserMain.jsp?url=/ego/peixun/ExcelIn.jsp";
