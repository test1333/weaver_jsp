...
<%
  String checkid = Util.null2String(request.getParameter("Checkid"));
	...
	url_2 = "/seahonor/jsp/HandleDetail.jsp?Checkid="+checkid+"";
	url_3 = "/seahonor/jsp/AssetsCheck2.jsp?Checkid="+checkid+"";
	...
	<div class="e8_box demo2">
		<div class="e8_boxhead">
		    ...
		    <ul class="tab_menu">
				...
				<li class="current">
					<a target="tabcontentframe" href="<%=url_2%>">处理详细<span id="allNum_span"></span></a>
				</li>
				<li class="current">
					<a target="tabcontentframe" href="<%=url_3%>">非盘资产<span id="allNum_span"></span></a>
				</li>
		    </ul>
