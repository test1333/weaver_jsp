...
<script type="text/javascript">
 ...
 var sfmap2="#disfield6581";//是否匹配
    var sfmap_dt1="field6582_";//是否匹配-明细
    var shsl_dt1 ="field6452_";//收货数量
    var ddsl_dt1 ="field6438_";//订单数量
    var pozt_dt1="field6604_";//po状态
    var shcs="#field6599";//收货次数
    var shcsz="#field6600";//收货次数真
    var shcs_dt1="field6601_";//收货次数-明细
    var sfqbgb="#field6609";//是否全部关闭
    var sfqbgb2="#disfield6609";//是否全部关闭
